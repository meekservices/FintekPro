...
const NIC_INDUSTRY_MAP: Record<string, { industry: string; sector: string; subSector?: string }> = {
  ...
  '10': { industry: 'Food Products', sector: 'FMCG', subSector: 'Food Processing' },
  ...
  '26': { industry: 'Electronics', sector: 'Technology', subSector: 'Hardware' },
  ...
  '34': { industry: 'Industrial Machinery Repair', sector: 'Industrial Services' },
  '35': { industry: 'Power Generation', sector: 'Utilities', subSector: 'Power' },
  ...
  '45': { industry: 'Motor Vehicle Trade', sector: 'Automobile', subSector: 'Auto Dealers' },
  '46': { industry: 'Wholesale Trade', sector: 'Trading' },
  '47': { industry: 'Retail Trade', sector: 'Retail' },
  '48': { industry: 'E-Commerce', sector: 'Technology', subSector: 'Digital Commerce' },
  '49': { industry: 'Land Transport', sector: 'Transportation' },
  '50': { industry: 'Water Transport', sector: 'Transportation' },
  '51': { industry: 'Air Transport', sector: 'Transportation', subSector: 'Aviation' },
  ...
  '62': { industry: 'IT Services', sector: 'Technology', subSector: 'Software' },
  '63': { industry: 'Information Services', sector: 'Technology' },
  '64': { industry: 'Financial Services', sector: 'Financial Services', subSector: 'Banking & Finance' },
  '65': { industry: 'Insurance', sector: 'Financial Services', subSector: 'Insurance' },
  '66': { industry: 'Financial Auxiliaries', sector: 'Financial Services', subSector: 'NBFC' },
  '67': { industry: 'Stock Exchange Services', sector: 'Financial Services', subSector: 'Capital Markets' },
  ...
  '71': { industry: 'Architecture & Engineering', sector: 'Professional Services' },
  '72': { industry: 'R&D', sector: 'Technology', subSector: 'Research' },
  '73': { industry: 'Advertising', sector: 'Media & Entertainment' },
  '74': { industry: 'Other Professional Services', sector: 'Professional Services' },
  '75': { industry: 'Veterinary', sector: 'Healthcare' },
  '76': { industry: 'Asset Management', sector: 'Financial Services', subSector: 'Asset Management' },
...
const NIC_FIRST_DIGIT_FALLBACK: Record<string, { industry: string; sector: string }> = {
...
export function classifyIndustryFromCIN(cin: string): IndustryClassification | null {
  if (!cin || cin.length < 6) {
    return null;
  }
...
export function enrichCompanyWithNICClassification(company: {
  ...
  const needsSector = !company.sector || company.sector.toLowerCase() === 'unknown';
  const needsIndustry = !company.industry || company.industry.toLowerCase() === 'unknown';
