 ...
 * Admin only endpoint
 */
router.get('/admin/negotiations', requireAdmin, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/admin/dashboard-metrics', requireAdmin, async (req: Request, res: Response) => {
  try {
