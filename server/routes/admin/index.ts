  ...
  app.get("/api/admin/compliance-dashboard", requireAdmin, async (req, res) => {
    ...
    res.json({
      ...
      regulatoryGaps: [
        ...
        { id: '3', title: 'Key Facts Statement (KFS) for Loans', description: 'Generate and display standardized Key Facts Statement for all loan products as per RBI Digital Lending Guidelines 2022.', regulator: 'RBI', riskLevel: 'high', status: 'in_progress', category: 'disclosure', estimatedEffort: 'medium', regulatoryReference: 'RBI/2022-23/111 DOR.FIN.REC.65/03.10.038/2022-23', targetCompletionDate: new Date(now.getTime() + 30 * 24 * 60 * 60 * 1000).toISOString() },
        { id: '4', title: 'AI Advisory Risk Disclosure', description: 'Display mandatory risk disclosure for AI-generated investment recommendations per SEBI AI/ML guidelines.', regulator: 'SEBI', riskLevel: 'medium', status: 'in_progress', category: 'disclosure', estimatedEffort: 'low', regulatoryReference: 'SEBI Consultation Paper on AI/ML 2024', targetCompletionDate: new Date(now.getTime() + 14 * 24 * 60 * 60 * 1000).toISOString() },
        ...
        { id: '9', title: 'Consent Audit Trail', description: 'Maintain immutable audit trail of all user consents for data processing activities.', regulator: 'MCA', riskLevel: 'low', status: 'in_progress', category: 'data_protection', estimatedEffort: 'low', regulatoryReference: 'Digital Personal Data Protection Act 2023', targetCompletionDate: new Date(now.getTime() + 21 * 24 * 60 * 60 * 1000).toISOString() },
