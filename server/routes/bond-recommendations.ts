...
import {
	aiBondRecommendationService,
	BondRecommendationParams,
} from "../services/ai-bond-recommendation-service";
import { db } from "../db";
...
router.post("/generate", async (req: Request, res: Response) => {
	try {
		...
		if (!categoryEnabled) {
			return res.json({
				...
				data: {
					bonds: [],
					allocation: [],
					summary: "Bonds category is currently not available",
				},
		...
		const params: BondRecommendationParams = {
			...
			preferredBondTypes: req.body.preferredBondTypes || [
				"g_sec",
				"corporate_bond",
				"ncd",
				"tax_free_bond",
		...
		const recommendations =
			await aiBondRecommendationService.generateRecommendations(params);
		...
		investmentHorizon: [
			{
				...
				description: "Lower duration, higher liquidity",
			},
			{
				value: "medium",
			...
			},
			{
				...
				description: "Higher yields, more duration risk",
			},
		],
		riskTolerance: [
			{
			...
			},
			{
				...
				description: "Stability with some growth",
			},
			{
				value: "moderate",
				label: "Moderate",
		...
		bondTypes: [
			{
				...
				description: "Sovereign backed, safest",
			},
			{
				value: "sdl",
				label: "State Development Loans",
				description: "State government bonds",
			},
			{
				value: "t_bill",
				label: "Treasury Bills",
				description: "Short-term govt securities",
			},
			{
				value: "sgb",
				label: "Sovereign Gold Bonds",
				description: "Gold + fixed coupon",
			},
			{
				value: "corporate_bond",
				label: "Corporate Bonds",
				description: "Company issued bonds",
			},
			{
				value: "ncd",
				label: "NCDs",
			...
			},
			{
				...
				description: "Infra project financing",
			},
		],
		minimumRatings: [
			...
			{ value: "BBB", label: "Investment Grade (BBB+)" },
			{
				value: "any",
				label: "Any Rating",
				description: "Including high yield",
			},
		],
		yieldPreference: [
			{
				value: "safety_first",
				label: "Safety First",
				description: "Prioritize credit quality",
			},
			{
				value: "balanced",
				label: "Balanced",
				description: "Balance yield and safety",
			},
			{
				value: "high_yield",
				label: "High Yield",
		...
		liquidityNeeds: [
			{
				...
				description: "May need quick access",
			},
			{
				value: "medium",
				label: "Medium Liquidity",
				description: "Some flexibility needed",
			},
			{
				value: "low",
				label: "Low Liquidity",
				description: "Can hold to maturity",
			},
		],
	});
});
