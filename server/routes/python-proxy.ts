...
// ── Analytics ────────────────────────────────────────────────────────────
router.get(
	"/api/python/analytics/portfolio-summary",
	requireAuth,
	async (req, res) => {
...
router.get(
	"/api/python/analytics/capital-gains",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/analytics/capital-gains",
			"capital-gains",
		);
	},
);
...
router.get(
	"/api/python/analytics/amc-breakdown",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/analytics/amc-breakdown",
			"amc-breakdown",
		);
	},
);
...
router.post("/api/python/quant/xirr", requireAuth, async (req, res) => {
	return proxyToPython(req, res, "/api/quant/xirr", "xirr", {
		xirr: null,
...
router.get(
	"/api/python/quant/portfolio-xirr",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/quant/portfolio-xirr",
			"portfolio-xirr",
			{ xirr: null, label: "Portfolio XIRR unavailable" },
		);
	},
);

router.get(
	"/api/python/quant/rolling-returns",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/quant/rolling-returns",
			"rolling-returns",
			{ rollingStats: [] },
		);
	},
...
router.post("/api/python/quant/mvo", requireAuth, async (req, res) => {
	return proxyToPython(req, res, "/api/quant/mvo", "mvo", {
		frontier: [],
		optimalWeights: [],
	});
});
...
router.post(
	"/api/python/quant/black-litterman",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/quant/black-litterman",
			"black-litterman",
		);
	},
);
...
router.post(
	"/api/python/quant/drift-predict",
	requireAuth,
	async (req, res) => {
...
router.post(
	"/api/python/mf/cross-sectional-rank",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/mf/cross-sectional-rank",
...
router.post(
	"/api/python/mf/risk-from-monthly",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/mf/risk-from-monthly",
...
router.post(
	"/api/python/mf/monthly-pipeline",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/mf/monthly-pipeline",
			"mf-monthly-pipeline",
		);
	},
);
...
router.post(
	"/api/python/forecasting/return-forecast",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/forecasting/return-forecast",
			"return-forecast",
			{
				baseCase: null,
				bearCase: null,
...
router.post(
	"/api/python/forecasting/sip-simulate",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
...
router.post(
	"/api/python/portfolio/overlap-analysis",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
...
router.post(
	"/api/python/portfolio/rebalance",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
...
router.post(
	"/api/python/quant/asset-allocation",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
...
router.post(
	"/api/python/analytics/batch-metrics",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/analytics/batch-metrics",
			"batch-metrics",
		);
	},
);
...
router.post(
	"/api/python/fixed-income/bond-analytics",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
...
router.post(
	"/api/python/fixed-income/batch-bond-analytics",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/fixed-income/batch-bond-analytics",
...
router.post(
	"/api/python/fixed-income/yield-curve",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/fixed-income/yield-curve",
			"yield-curve",
		);
	},
);
...
router.post(
	"/api/python/fixed-income/treasury-optimize",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/fixed-income/treasury-optimize",
			"treasury-optimize",
		);
	},
);
...
router.post(
	"/api/python/factor/fund-factors",
	requireAuth,
	async (req, res) => {
...
router.post(
	"/api/python/factor/batch-fund-factors",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/factor/batch-fund-factors",
			"batch-fund-factors",
		);
	},
);
...
router.get(
	"/api/python/factor/market-factors",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/factor/market-factors",
			"market-factors",
		);
	},
);
...
router.post(
	"/api/python/regime/detect-batch",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/regime/detect-batch",
			"regime-detect-batch",
		);
	},
);
...
//
router.post(
	"/api/python/price-returns/compute",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/price-returns/compute",
			"price-returns-compute",
		);
	},
);

router.post(
	"/api/python/price-returns/batch",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/price-returns/batch",
			"price-returns-batch",
		);
	},
);
...
router.post(
	"/api/python/price-returns/daily-run",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			...
			"price-returns-daily-run",
		);
	},
);

router.get(
	"/api/python/price-returns/:isin/history",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			`/api/price-returns/${req.params.isin}/history`,
...
router.get("/api/python/price-returns/:isin", requireAuth, async (req, res) => {
	return proxyToPython(
		req,
		res,
		`/api/price-returns/${req.params.isin}`,
		"price-returns",
	);
});
...
// ── Corporate Actions ────────────────────────────────────────────────────────
router.post(
	"/api/python/corporate-actions/sync",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
...
router.get(
	"/api/python/corporate-actions/pending",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/corporate-actions/pending",
...
router.post(
	"/api/python/corporate-actions/apply-adjustments",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/corporate-actions/apply-adjustments",
...
router.get(
	"/api/python/corporate-actions/list",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/corporate-actions/list",
...
router.get(
	"/api/python/corporate-actions/history/:isin",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			`/api/corporate-actions/history/${req.params.isin}`,
...
// ── Data Lake ─────────────────────────────────────────────────────────────
router.post(
	"/api/python/data-lake/store-bhavcopy",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/data-lake/store-bhavcopy",
			"data-lake-bhavcopy",
		);
	},
);
...
router.post(
	"/api/python/data-lake/store-amfi-nav",
	requireAuth,
	async (req, res) => {
		return proxyToPython(
			req,
			res,
			"/api/data-lake/store-amfi-nav",
			"data-lake-amfi-nav",
		);
	},
);
