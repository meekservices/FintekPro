...
const ENGINE_REGISTRY: EngineRegistryEntry[] = [
  ...
  },
  {
    ...
    currentImpl: "TypeScript (Monte Carlo simulation)",
    upgradeStatus: "available",
    upgradeTypes: ["python_migration", "algorithm_upgrade"],
    pythonMigrated: false,
    currentVersion: "ts-v1",
    targetVersion: "py-numpy-v1",
    upgradeNote: "Monte Carlo with numpy random number generation is ~100× faster than TypeScript loops. Can add antithetic variates and quasi-random sequences for variance reduction.",
    priority: "high",
  },
  {
    ...
    currentImpl: "TypeScript (compound growth projections)",
    upgradeStatus: "available",
    upgradeTypes: ["python_migration"],
    pythonMigrated: false,
    currentVersion: "ts-v1",
    targetVersion: "py-numpy-v1",
    upgradeNote: "Vectorised numpy for multi-scenario SIP projections. Can extend to stochastic return modelling using historical NAV distributions.",
    priority: "medium",
  },
  {
  ...
  // ── Portfolio Engines ───────────────────────────────────────────────────
  {
    ...
    currentImpl: "TypeScript (stock-level overlap, sector concentration)",
    upgradeStatus: "available",
    upgradeTypes: ["python_migration", "algorithm_upgrade"],
    pythonMigrated: false,
    currentVersion: "ts-v1",
    targetVersion: "py-numpy-v1",
    upgradeNote: "Cosine similarity and portfolio overlap matrices via numpy. Add Principal Component Analysis (PCA) for factor exposure decomposition.",
    priority: "high",
  },
  {
    ...
    currentImpl: "TypeScript (drift detection + tax-optimised trades)",
    upgradeStatus: "available",
    upgradeTypes: ["python_migration", "algorithm_upgrade"],
    pythonMigrated: false,
    currentVersion: "ts-v1",
    targetVersion: "py-scipy-v1",
    upgradeNote: "Tax-loss harvesting FIFO lot selection can use pandas for lot ledger manipulation. Rebalancing trade optimisation can use scipy LP for minimum-turnover tax-aware trades.",
    priority: "high",
  },
  {
  ...
  },
  {
    ...
    category: "Python Sidecar",
    subcategory: "Fund Analytics",
    currentImpl: "Python pandas/scipy (full scheme analytics from mf_nav_history)",
    upgradeStatus: "completed",
    upgradeTypes: ["python_migration", "algorithm_upgrade"],
    pythonMigrated: true,
    currentVersion: "py-mf-analytics-v1",
    upgradeNote: "4 endpoints: compute-metrics (any NAV input), scheme-analytics (DB-native), monthly-series (bulk upsert mf_monthly_returns), bulk-compute-db (upserts mutual_fund_metrics with Sharpe/Sortino/MaxDD/Calmar/Beta/Alpha/TrackingError/SIP-XIRR). New DB columns: volatility, tracking_error, calmar_ratio added to mutual_fund_metrics.",
    priority: "critical",
  },
  {
