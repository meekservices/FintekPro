...
const ENGINE_REGISTRY: EngineRegistryEntry[] = [
  ...
  },
  {
    ...
    currentImpl: "TypeScript (fund comparison metrics)",
    upgradeStatus: "available",
    upgradeTypes: ["python_migration", "formula_fix"],
    pythonMigrated: false,
    currentVersion: "ts-v1",
    targetVersion: "py-pandas-v1",
    upgradeNote: "Relative ranking (alpha, beta, tracking error, info ratio) can use pandas groupby for category-level percentile computation. Risk-free rate updated to 7.15%.",
    priority: "high",
  },
  // ── Portfolio Engines ───────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    category: "Python Sidecar",
    subcategory: "Return Metrics",
    currentImpl: "Python pandas (CAGR from NAV history)",
    upgradeStatus: "completed",
    upgradeTypes: ["python_migration"],
    pythonMigrated: true,
    currentVersion: "py-rolling-v1",
    upgradeNote: "1Y/3Y/5Y/10Y CAGR from mutual_fund_nav_history via pandas. Replaces Yahoo Finance API calls for historical returns.",
    priority: "high",
  },
  {
