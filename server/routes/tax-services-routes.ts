...
router.get("/pricing/:id", async (req, res) => {
	try {
		...
		if (!config) {
			return res
				.status(404)
				.json({ success: false, error: "Pricing config not found" });
		}
		...
		const defaultConfigs = [
			{
				...
				description:
					"Salary, One House Property, Other Sources (up to ₹50L income)",
				selfFileFee: "499",
				selfFileGst: "90",
				caAssistedFee: "1499",
				caAssistedGst: "270",
			...
			},
			{
				...
				displayName: "ITR-2",
				description:
					"Salary, Capital Gains, Multiple Properties, Foreign Assets",
				selfFileFee: "999",
				selfFileGst: "180",
				caAssistedFee: "2999",
				caAssistedGst: "540",
			...
			},
			{
				...
				displayName: "ITR-7",
				description:
					"Trusts, Political Parties, Scientific Research Institutions",
				selfFileFee: "0",
				selfFileGst: "0",
				caAssistedFee: "9999",
				caAssistedGst: "1800",
