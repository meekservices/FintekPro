...
modelPortfoliosRouter.post("/admin/seed-holdings", async (_req: Request, res: Response) => {
  ...
  const SEED: Record<string, HoldingEntry[]> = {
    ...
    "reit-invit-income": [
      { rank: 1, name: "Embassy Office Parks REIT",      symbol: "EMBASSY",   isin: "INE041007019", weight: 22, type: "REIT" },
      { rank: 2, name: "Mindspace Business Parks REIT",  symbol: "MINDSPACE", isin: "INE936Y07019", weight: 18, type: "REIT" },
      { rank: 3, name: "Brookfield India REIT",          symbol: "BIRET",     isin: "INE0B8G01014", weight: 15, type: "REIT" },
