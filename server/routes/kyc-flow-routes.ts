...
const kycFlowConfig: KycStep[] = [
	{
		...
		description:
			"Permanent Account Number verification against NSDL/UTI database for identity and tax compliance",
		regulatoryBasis:
			"SEBI KYC Regulations 2011, Income Tax Act Section 139A, PMLA 2002",
		requiredFor: [
		...
		providers: [
			{
				providerId: "sandbox",
				providerName: "Sandbox.co.in PAN API",
				priority: 1,
				isConfigured: false,
				pricePerCall: 1.8,
				features: [
			...
			},
			{
				...
				providerName: "TruthScreen PAN",
				priority: 2,
				isConfigured: false,
				pricePerCall: 3.0,
				features: ["NSDL Direct", "Fraud Detection", "Enterprise SLA"],
			},
			{
				providerId: "cashfree",
				providerName: "Cashfree PAN Verification",
				priority: 3,
				isConfigured: false,
				pricePerCall: 2.5,
				features: [
	...
	},
	{
		...
		description:
			"UIDAI-compliant Aadhaar identity verification via OTP-based eKYC or Offline XML",
		regulatoryBasis:
			"Aadhaar Act 2016, SEBI Circular SEBI/HO/MIRSD/DOP/CIR/P/2019/42, RBI Master Direction KYC",
		requiredFor: [
			"Mutual Funds",
			"Demat Account",
			"Bank Account",
		...
		providers: [
			{
				providerId: "cashfree",
				providerName: "Cashfree Aadhaar OKYC",
				priority: 1,
				isConfigured: false,
				pricePerCall: 4.0,
				features: ["Aadhaar OTP", "eKYC Data", "Photo Retrieval"],
			},
			{
				providerId: "truthscreen",
				providerName: "TruthScreen Aadhaar eKYC",
				priority: 2,
				isConfigured: false,
				pricePerCall: 3.0,
				features: ["Aadhaar OTP", "PAN-Aadhaar Linkage", "Aadhaar Validation"],
			},
			{
				providerId: "sandbox",
				providerName: "Sandbox.co.in Aadhaar API",
				priority: 3,
				isConfigured: false,
				pricePerCall: 2.5,
				features: ["Government Source", "Bulk Verification"],
			},
			{
				providerId: "offline_xml",
				providerName: "Aadhaar Offline XML",
				priority: 4,
				isConfigured: true,
				pricePerCall: 0.0,
				features: ["No API Cost", "Offline Processing", "UIDAI Compliant"],
			},
		],
	},
	{
		...
		description:
			"Current and permanent address verification via utility bills, Aadhaar, or physical verification",
		regulatoryBasis:
			"RBI Master Direction KYC, SEBI KYC Regulations 2011, PMLA 2002 Rule 9",
		requiredFor: ["Bank Account", "Demat Account", "Loans", "Insurance"],
		providers: [
			{
				providerId: "aadhaar_address",
				providerName: "Aadhaar Address (via eKYC)",
				priority: 1,
				isConfigured: false,
				pricePerCall: 0.0,
				features: ["Auto from Aadhaar eKYC", "No Extra Cost", "UIDAI Verified"],
			},
			{
				providerId: "digilocker",
				providerName: "DigiLocker Address Proof",
				priority: 2,
				isConfigured: false,
				pricePerCall: 0.0,
				features: ["Government Issued", "Digital Documents", "Free API"],
			},
			{
				providerId: "manual_upload",
				providerName: "Manual Document Upload",
				priority: 3,
				isConfigured: true,
				pricePerCall: 0.0,
				features: ["Utility Bills", "Bank Statement", "Passport"],
			},
		],
	},
	{
		...
		description:
			"Bank account ownership verification via penny drop or IFSC validation",
		regulatoryBasis:
			"RBI Account Aggregator Framework, SEBI Circular for Direct Plan MF, NPCI Guidelines",
		requiredFor: ["Mutual Funds", "Insurance", "Loans", "Direct Equity"],
		providers: [
			{
				providerId: "cashfree_bank",
				providerName: "Cashfree Bank Verification",
				priority: 1,
				isConfigured: false,
				pricePerCall: 1.5,
				features: ["Penny Drop", "IFSC Validation", "Real-time"],
			},
			{
				providerId: "sandbox_bank",
				providerName: "Sandbox.co.in Bank API",
				priority: 2,
				isConfigured: false,
				pricePerCall: 1.2,
				features: ["Account Validation", "IFSC Lookup", "Bulk Support"],
			},
			{
				providerId: "manual_cheque",
				providerName: "Cancelled Cheque Upload",
				priority: 3,
				isConfigured: true,
				pricePerCall: 0.0,
				features: ["Manual Verification", "No API Cost"],
			},
		],
	},
	{
		...
		description:
			"Central KYC Registry lookup via CERSAI for regulated financial products - mandatory for MF/PMS/AIF per SEBI",
		regulatoryBasis:
			"SEBI Circular CIR/MIRSD/66/2016, CERSAI CKYC Guidelines, KRA Regulations",
		requiredFor: ["Mutual Funds", "PMS", "AIF", "Demat Account"],
		providers: [
			{
				providerId: "truthscreen_ckyc",
				providerName: "TruthScreen CKYC API",
				priority: 1,
				isConfigured: false,
				pricePerCall: 5.0,
				features: [
					"Real-time KRA Lookup",
					"All KRAs Supported",
					"CKYC Number Fetch",
				],
			},
			{
				providerId: "cersai_reference",
				providerName: "CERSAI Reference CKYC",
				priority: 2,
				isConfigured: false,
				pricePerCall: 0.0,
				features: ["Direct CERSAI", "CKYC Number Required", "Free Lookup"],
			},
			{
				providerId: "manual_ckyc",
				providerName: "Manual CKYC Submission",
				priority: 3,
				isConfigured: true,
				pricePerCall: 0.0,
				features: ["Admin Assisted", "Form Submission", "Offline Process"],
			},
		],
	},
	{
		...
		description:
			"Foreign Account Tax Compliance Act self-declaration for international tax reporting",
		regulatoryBasis:
			"FATCA IGA India-US, CRS (Common Reporting Standard), SEBI Circular CIR/MIRSD/2/2015",
		requiredFor: ["Mutual Funds", "PMS", "AIF", "Demat Account"],
		providers: [
			{
				providerId: "self_declaration",
				providerName: "Self-Declaration Form",
				priority: 1,
				isConfigured: true,
				pricePerCall: 0.0,
				features: ["Digital Form", "Auto-populated", "No API Cost"],
			},
		],
	},
	{
		...
		description:
			"SEBI-mandated risk assessment questionnaire for investment suitability",
		regulatoryBasis:
			"SEBI Circular SEBI/HO/IMD/DF2/CIR/P/2019/155, AMFI Best Practices Guidelines",
		requiredFor: ["Mutual Funds", "PMS", "AIF", "Direct Equity"],
		providers: [
			{
				providerId: "internal_engine",
				providerName: "FintekPro Risk Engine",
				priority: 1,
				isConfigured: true,
				pricePerCall: 0.0,
				features: ["SEBI Compliant", "20+ Questions", "Risk Score"],
			},
		],
	},
];
...
type OverrideMap = Record<
	string,
	Record<string, { priority?: number; pricePerCall?: number }>
>;
	...
	try {
		await db
			...
			.values({
				key: SETTINGS_KEY,
				value: overrides,
				description: "KYC flow provider priority and pricing overrides",
			})
			.onConflictDoUpdate({
...
function applyOverrides(overrides: OverrideMap): void {
	for (const step of kycFlowConfig) {
		...
		for (const provider of step.providers) {
			...
			if (typeof providerOverride.priority === "number")
				provider.priority = providerOverride.priority;
			if (typeof providerOverride.pricePerCall === "number")
				provider.pricePerCall = providerOverride.pricePerCall;
		}
	...
	try {
		...
		res.json({
			...
			meta: {
				...
				totalProviders: kycFlowConfig.reduce(
					(sum, s) => sum + s.providers.length,
					0,
				),
				configuredProviders: kycFlowConfig.reduce(
					(sum, s) => sum + s.providers.filter((p) => p.isConfigured).length,
					0,
				),
			},
		});
		...
		res
			...
			.json({
				success: false,
				error: "Failed to fetch KYC flow configuration",
			});
	}
});
		...
		try {
			...
			if (!Array.isArray(providers)) {
				return res
					...
					.json({
						success: false,
						error: "providers must be an array of { providerId, priority }",
					});
			}
			...
			if (!step) {
				return res
					.status(404)
					.json({ success: false, error: `Step ${stepId} not found` });
			}

			for (const { providerId, priority } of providers) {
				const provider = step.providers.find(
			...
			for (const p of step.providers) {
				if (!overrides[stepId][p.providerId])
					overrides[stepId][p.providerId] = {};
	...
	async (req: Request, res: Response) => {
		try {
			...
			if (!step)
				return res
					.status(404)
					.json({ success: false, error: "Step not found" });
