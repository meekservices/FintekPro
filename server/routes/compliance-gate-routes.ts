...
import { runComplianceChecks, type TransactionType } from '../middleware/transactionComplianceGate';
  ...
  app.get(
    ...
    async (req: Request, res: Response) => {
      ...
      try {
        ...
        logger.error('[ComplianceGate] Readiness check error', { user_id: userId, err });
