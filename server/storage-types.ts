...
export interface IStorage {
	...
	getExternalHoldingsBySource(
		userId: string,
		source: string,
	): Promise<ExternalHolding[]>;
	createExternalHolding(
		holding: InsertExternalHolding,
	): Promise<ExternalHolding>;
	deleteExternalHoldingsBySource(
		userId: string,
		source: string,
	): Promise<number>;
	...
	populatePortfolioFromCams(
		userId: string,
		panNumber: string,
		date: string,
	): Promise<any[]>;
	populatePortfolioFromKfintech(
		userId: string,
		panNumber: string,
		date: string,
	): Promise<any[]>;
	populatePortfolioFromNsdl(
		userId: string,
		accountNumber: string,
		date: string,
	): Promise<any[]>;
	populatePortfolioFromCdsl(
		userId: string,
		boId: string,
		date: string,
	): Promise<any[]>;
	populateGovernmentSchemeHoldings(
		userId: string,
		date: string,
	): Promise<any[]>;
	...
	getTransactionRecordsByUser(
		userId: string,
		financialYear?: string,
	): Promise<TransactionRecord[]>;

	// Customer Care Agent methods
	createCustomerCareAgent(
	...
	createAgentPartnerMapping(
		mapping: InsertAgentPartnerMapping,
	): Promise<AgentPartnerMapping>;
	getAgentPartnerMappings(
		agentId?: string,
		partnerId?: string,
	): Promise<AgentPartnerMapping[]>;
	updateAgentPartnerMapping(
		id: string,
	...
	updateIBAccountConnectionStatus(
		id: string,
		status: string,
		lastConnected?: Date,
	): Promise<IBAccount | undefined>;
	...
	getLoanApplicationsMarketplace(
		userId?: string,
	): Promise<LoanApplicationMarketplace[]>;
	getLoanApplicationMarketplace(
		id: string,
	): Promise<LoanApplicationMarketplace | undefined>;
	createLoanApplicationMarketplace(
		application: InsertLoanApplicationMarketplace,
	): Promise<LoanApplicationMarketplace>;
	updateLoanApplicationMarketplace(
		id: string,
	...
	getProviderIntegrationsByProvider(
		providerId: string,
	...
	generatePortfolioRebalanceRecommendations(
		portfolioId: string,
		goals: FinancialGoal[],
	): Promise<any[]>;
	...
	createICICILoanApplication(
		application: InsertICICILoanApplication,
	): Promise<ICICILoanApplication>;
	getICICILoanApplicationsByUser(
		userId: string,
	): Promise<ICICILoanApplication[]>;
	getICICILoanApplication(
		id: string,
	): Promise<ICICILoanApplication | undefined>;
	getICICILoanApplicationByApplicationId(
		applicationId: string,
	): Promise<ICICILoanApplication | undefined>;
	updateICICILoanApplicationStatus(
		applicationId: string,
		updates: Partial<ICICILoanApplication>,
	): Promise<ICICILoanApplication | undefined>;

	// ICICI Credit Score methods
	createICICICreditScore(
	...
	getAiOptimizationSuggestion(
		id: string,
	): Promise<AiOptimizationSuggestion | undefined>;
	createAiOptimizationSuggestion(
		suggestion: InsertAiOptimizationSuggestion,
	): Promise<AiOptimizationSuggestion>;
	updateAiOptimizationSuggestion(
		id: string,
	...
	getCashfreeTransactionByOrderId(
		orderId: string,
	): Promise<CashfreeTransaction | undefined>;
	updateCashfreeTransaction(
		id: string,
		updates: Partial<CashfreeTransaction>,
	): Promise<CashfreeTransaction | undefined>;
	getCashfreeTransactionsByUserId(
		userId: string,
	): Promise<CashfreeTransaction[]>;
	getCashfreeTransactionsByStatus(
		status: string,
	): Promise<CashfreeTransaction[]>;
	...
	getPhonePeTransactionByOrderId(
		orderId: string,
	): Promise<PhonePeTransaction | undefined>;
	getPhonePeTransactionByMerchantId(
		merchantTransactionId: string,
	): Promise<PhonePeTransaction | undefined>;
	updatePhonePeTransaction(
		id: string,
	...
	updateBudgetSpendById(
		budgetId: string,
		amount: number,
	): Promise<FamilyBudget>;

	grantPortfolioPermission(
	...
	updateKycVerificationSession(
		id: string,
		updates: Partial<KycVerificationSession>,
	): Promise<KycVerificationSession | undefined>;
	updateKycSessionStepStatus(
		sessionId: string,
		stepKey: string,
		stepData: any,
	): Promise<KycVerificationSession | undefined>;
	...
	getAllManualKycSubmissions(filters?: {
		status?: string;
		applicantType?: string;
		limit?: number;
		offset?: number;
	}): Promise<ManualKycSubmission[]>;
	updateManualKycSubmission(
		id: string,
		updates: Partial<ManualKycSubmission>,
	): Promise<ManualKycSubmission | undefined>;
	reviewManualKycSubmission(
		id: string,
		reviewerId: string,
		status: string,
		notes?: string,
	...
	bulkApproveKycSubmissions(
		submissionIds: string[],
		approverId: string,
		notes?: string,
	): Promise<{ success: number; failed: number }>;

	bulkRejectKycSubmissions(
		submissionIds: string[],
		rejectorId: string,
		reason: string,
	): Promise<{ success: number; failed: number }>;

	bulkAssignKycSubmissions(
		submissionIds: string[],
		reviewerId: string,
		assignedBy: string,
	): Promise<{ success: number; failed: number }>;
	...
	getAgentDocumentByType(
		agentId: string,
		documentType: string,
	): Promise<AgentDocument | undefined>;
	updateAgentDocumentVerification(
		documentId: string,
		status: string,
		verifiedBy: string,
		rejectionReason?: string,
	...
	createAmfiVerificationLog(
		log: InsertAmfiVerificationLog,
	): Promise<AmfiVerificationLog>;
	getAmfiVerificationLogs(
		agentId?: string,
	...
	createCommissionSplit(
		split: InsertAgentCommissionSplit,
	): Promise<AgentCommissionSplit>;
	getCommissionSplits(
		subAgentId?: string,
		masterAgentId?: string,
	): Promise<AgentCommissionSplit[]>;
	getActiveCommissionSplit(
		subAgentId: string,
		productType?: string,
	): Promise<AgentCommissionSplit | undefined>;
	...
	createAgentCommission(
		commission: InsertAgentCommission,
	...
	updateCommissionSettlementStatus(
		...
		status: string,
	): Promise<AgentCommission | undefined>;
	getCommissionSummary(
		agentId: string,
		month?: string,
	): Promise<{ totalEarned: number; settled: number; pending: number }>;
	...
	updateLoanOfferApplicationStatus(
		offerId: string,
		status: string,
		applicationData?: any,
	): Promise<any | undefined>;
	...
	getStoreProductBySourceCompanyId(
	...
	getStoreProductInquiries(filters?: {
		status?: string;
		productId?: string;
		categoryId?: string;
	}): Promise<any[]>;
	...
	toggleCategoryWithCascade(
		categoryId: string,
		isActive: boolean,
		adminId: string,
		adminEmail: string,
	): Promise<{ category: any; subcategories: any[]; products: any[] }>;
	toggleSubcategoryWithCascade(
	...
	getAllUnifiedCartItemsForAdmin(filters?: {
		userId?: string;
		category?: string;
		source?: string;
		status?: string;
