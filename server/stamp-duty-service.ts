...
export const STAMP_DUTY_RATES = {
	unlisted_shares: {
		...
		statuteSection:
			"Article 56A - Transfer of shares in companies other than through Stock Exchange",
	},
	corporate_bond: {
		rate: 0.01, // 0.0001%
	...
	infrastructure_bond: {
		...
		regulatorReference: "Indian Stamp Act 1899, Schedule IA, Article 27",
		statuteSection:
			"Article 27 - Transfer of debentures (Infrastructure Bonds)",
	},
	g_sec: {
		rate: 0,
		...
		isExempt: true,
		exemptionReason:
			"Government Securities exempt under Section 9 of Indian Stamp Act",
	...
	t_bill: {
		...
		isExempt: true,
		exemptionReason:
			"Treasury Bills exempt as Government Securities under Section 9",
		regulatorReference: "Indian Stamp Act 1899, Section 9",
		statuteSection:
			"Section 9 - Exemption of instruments relating to Government Securities",
	},
	sdl: {
		...
		isExempt: true,
		exemptionReason:
			"State Development Loans exempt as Government Securities under Section 9",
		regulatorReference: "Indian Stamp Act 1899, Section 9",
		statuteSection:
			"Section 9 - Exemption of instruments relating to Government Securities",
	},
	sgb: {
		...
		isExempt: true,
		exemptionReason:
			"Sovereign Gold Bonds exempt as Government Securities issued by RBI",
		regulatorReference: "Indian Stamp Act 1899, Section 9",
		statuteSection:
			"Section 9 - Exemption of instruments relating to Government Securities",
	},
...
class StampDutyService {
	...
	async logAudit(
		...
		try {
			...
			console.log(
				`[StampDutyService] Audit logged for ${transactionType} ${transactionId}: ₹${calculation.stampDutyAmount}`,
			);
		} catch (error) {
