...
export function computeRating(params: {
	...
	if (debtToEquity !== null)
		fundamentalsScore += debtToEquity < 0.5 ? 15 : debtToEquity < 1.5 ? 5 : -10;
	if (revenueGrowth !== null)
		fundamentalsScore +=
			revenueGrowth > 0.2 ? 15 : revenueGrowth > 0.05 ? 8 : -5;
	if (earningsGrowth !== null)
		fundamentalsScore +=
			earningsGrowth > 0.2 ? 10 : earningsGrowth > 0 ? 5 : -10;
	fundamentalsScore = Math.min(100, Math.max(0, fundamentalsScore));

	let valuationScore = 50;
	if (pe !== null)
		valuationScore += pe < 15 ? 25 : pe < 25 ? 10 : pe < 40 ? -5 : -20;
