...
export function requirePermission(permissions: string[], requireAll = false) {
	return (req: Request, res: Response, next: NextFunction) => {
		...
		const userRoles = getUserRoles(req.user);
		const result = roleService.checkPermissionAccess(
			userRoles,
			permissions,
			requireAll,
		);
 ...
 */
export function requirePartnerPortal(
	req: Request,
	res: Response,
	next: NextFunction,
) {
 ...
 */
export function requireAgentPortal(
	req: Request,
	res: Response,
	next: NextFunction,
) {
 ...
 */
export function requireMasterAgent(
	req: Request,
	res: Response,
	next: NextFunction,
) {
 ...
 */
export function requireInternalStaff(
	req: Request,
	res: Response,
	next: NextFunction,
) {
 ...
 */
export function requireComplianceVerified(
	req: Request,
	res: Response,
	next: NextFunction,
) {
 ...
 */
export function injectRoleInfo(
	req: Request,
	res: Response,
	next: NextFunction,
) {
