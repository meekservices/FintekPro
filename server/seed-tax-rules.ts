...
const initialTaxRules = [
	// Capital Gains Tax Rules - FY 2024-25
	{
		...
		metadata: {
			description:
				"Short Term Capital Gains Tax on equity and equity mutual funds",
			budgetYear: "2024-25",
			assetClass: "equity",
	...
	},
	{
		...
		metadata: {
			description:
				"Long Term Capital Gains Tax on equity and equity mutual funds above ₹1.25L",
			budgetYear: "2024-25",
			assetClass: "equity",
	...
	},
	{
		...
		metadata: {
			description:
				"Section 80D health insurance premium deduction (individual)",
			applicableRegime: "old",
			section: "80D",
	...
	},
	{
		...
		metadata: {
			description:
				"Section 80D health insurance premium deduction (senior citizen)",
			applicableRegime: "old",
			section: "80D",
