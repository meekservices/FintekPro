...
const RAW_HOLDINGS: Record<string, Array<{ rank: number; name: string; category: string; weight: number }>> = {
  ...
  "debt-long-duration": [
    ...
    // Fix: IDFC rebranded to Bandhan in Nov 2023 — old name fails AMFI/mfapi lookup
    {rank:6,name:"Bandhan CRISIL IBX Gilt Constant Maturity 10Y Index Fund",category:"Gilt 10Y Fund",weight:10.0},
    ...
    // Fix: category was "Liquid Buffer" — engine checks typeStr === "liquid mf", not "liquid buffer"
  ...
  "goal-home-downpayment": [
    // 5-year horizon: 90% debt-heavy + 10% equity for inflation buffer (standard for 5-yr goal)
    {rank:1,name:"HDFC Short Term Debt Fund",category:"Short Term MF",weight:20.0},  // was 22%
    {rank:2,name:"ICICI Pru Short Term Fund",category:"Short Term MF",weight:18.0},  // was 20%
    {rank:3,name:"Kotak Short Term Fund",category:"Short Term MF",weight:14.0},  // was 18%
    {rank:4,name:"SBI Magnum Income Fund",category:"Income MF",weight:14.0},  // was 15%
    {rank:5,name:"HDFC Corporate Bond Fund",category:"Corp Bond MF",weight:10.0},  // was 12%
    {rank:6,name:"Nippon India Gold Savings Fund",category:"Gold ETF",weight:7.0},  // hedge retained
    // 10% equity for 5-yr horizon — index fund minimizes active risk; reduces real-return drag
    {rank:7,name:"UTI NIFTY 50 Index Fund",category:"Index MF",weight:10.0},
    {rank:8,name:"Axis Liquid Fund",category:"Liquid MF",weight:4.0},  // was 3%
    {rank:9,name:"HDFC Liquid Fund",category:"Liquid MF",weight:3.0},
  ],
  "goal-emergency-corpus": [
    ...
    // Fix: "1-Month Bank FD" has no AMFI schemeCode and breaks enrichHolding (no enrichment path).
    // Replaced with DSP Overnight Fund (Overnight MF) — same liquidity, zero lock-in, properly enrichable.
    {rank:4,name:"DSP Overnight Fund",category:"Overnight MF",weight:15.0},
  ],
  "goal-senior-citizen": [
  ...
  "goal-starter-sip": [
    // 10+ yr horizon: reduced corp bond from 15%→8%, freed 7% into Nifty Next 50 Index
    // Rationale: first-time investors with 10+ yr horizon should maximize equity compound growth
    ...
    {rank:4,name:"HDFC Corporate Bond Fund",category:"Corp Bond MF",weight:8.0},  // was 15% — -7%
    {rank:5,name:"UTI NIFTY Next 50 Index Fund",category:"Index MF",weight:7.0},  // new: 10-yr horizon equity boost
    {rank:6,name:"Nippon India Gold Savings Fund",category:"Gold ETF",weight:7.0},
    {rank:7,name:"HDFC Liquid Fund",category:"Liquid MF",weight:3.0},
  ],
  "thematic-bfsi": [
  ...
  "thematic-consumption": [
    ...
    {rank:11,name:"DSP India T.I.G.E.R. Fund",category:"Infra MF",weight:4.0},  // was 5%; category fixed: "Infrastructure"→"Infra MF"
    // Liquid buffer reduced from 31% to 5% — thematic portfolios should maximize thematic exposure
    {rank:12,name:"HDFC Liquid Fund",category:"Liquid MF",weight:3.0},  // was 5%
    {rank:13,name:"ICICI Pru Liquid Fund",category:"Liquid MF",weight:1.0},  // was 4%
    // Removed: ranks 14-21 (SBI/Nippon/Axis/Kotak/DSP/AB/Mirae/Tata Liquid — excess 23% liquid)
  ],
  "debt-target-maturity-2028": [
    ...
    // Fix: IDFC rebranded to Bandhan in Nov 2023
    {rank:3,name:"Bandhan CRISIL IBX Triple A Financial Services Jun 2028 Index Fund",category:"Target Maturity",weight:15.0},
