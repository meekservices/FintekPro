...
const RAW_HOLDINGS: Record<string, Array<{ rank: number; name: string; category: string; weight: number }>> = {
  ...
  "tax-saver-portfolio": [
    {rank:1,name:"Axis Long Term Equity Fund (ELSS)",category:"ELSS",weight:12.0},
    {rank:2,name:"Mirae Asset Tax Saver Fund (ELSS)",category:"ELSS",weight:11.0},
    {rank:3,name:"Canara Robeco Equity Tax Saver",category:"ELSS",weight:10.0},
    {rank:4,name:"HDFC Tax Saver (ELSS)",category:"ELSS",weight:10.0},
    {rank:5,name:"Quant Tax Plan Fund (ELSS)",category:"ELSS",weight:9.0},
    {rank:6,name:"SBI Long Term Equity (ELSS)",category:"ELSS",weight:9.0},
    {rank:7,name:"Kotak Tax Saver Fund (ELSS)",category:"ELSS",weight:8.0},
    {rank:8,name:"DSP Tax Saver Fund (ELSS)",category:"ELSS",weight:7.0},
  ...
  "nifty50-index-alpha": [
    ...
    {rank:2,name:"HDFC Index Fund NIFTY 50",category:"Index MF",weight:14.0},
    {rank:3,name:"ICICI Pru NIFTY 50 Index Fund",category:"Index MF",weight:12.0},
    {rank:4,name:"Kotak NIFTY 50 ETF",category:"Index ETF",weight:11.0},
    {rank:5,name:"Nippon India ETF Nifty BeES",category:"Index ETF",weight:10.0},
    {rank:6,name:"SBI NIFTY Index Fund",category:"Index MF",weight:7.0},
  ...
  "debt-short-duration": [
    ...
    {rank:2,name:"Kotak Short Term Fund",category:"Short Term MF",weight:9.0},
    {rank:3,name:"ICICI Pru Short Term Fund",category:"Short Term MF",weight:9.0},
    {rank:4,name:"Aditya Birla SL Short Term Fund",category:"Short Term MF",weight:9.0},
    {rank:5,name:"SBI Short Term Debt Fund",category:"Short Term MF",weight:8.0},
    {rank:6,name:"Nippon India Short Term Fund",category:"Short Term MF",weight:8.0},
    {rank:7,name:"Axis Short Term Fund",category:"Short Term MF",weight:7.0},
    {rank:8,name:"DSP Short Term Fund",category:"Short Term MF",weight:7.0},
    {rank:9,name:"Franklin India Short Term Income",category:"Short Term MF",weight:6.0},
    {rank:10,name:"Tata Short Term Bond Fund",category:"Short Term MF",weight:6.0},
  ...
  "goal-child-education": [
    {rank:1,name:"Axis Long Term Equity Fund (ELSS)",category:"ELSS MF",weight:11.0},
    {rank:2,name:"Mirae Asset Tax Saver Fund",category:"ELSS MF",weight:9.0},
    {rank:3,name:"Mirae Asset Large Cap Fund",category:"Large Cap MF",weight:8.0},
    {rank:4,name:"Parag Parikh Flexi Cap Fund",category:"Flexi Cap MF",weight:8.0},
    {rank:5,name:"HDFC Mid-Cap Opportunities Fund",category:"Mid Cap MF",weight:7.0},
    {rank:6,name:"SBI Small Cap Fund",category:"Small Cap MF",weight:7.0},
    {rank:7,name:"HDFC Corporate Bond Fund",category:"Corp Bond MF",weight:7.0},
    {rank:8,name:"Axis AAA Bond Plus SDL",category:"Bond MF",weight:7.0},
    {rank:9,name:"Nippon India Gold Savings Fund",category:"Gold ETF",weight:6.0},
    ...
    {rank:13,name:"HDFC Liquid Fund",category:"Liquid MF",weight:5.0},
    {rank:14,name:"UTI Children's Career Fund",category:"Children MF",weight:5.0},
    {rank:15,name:"Axis Liquid Fund",category:"Liquid MF",weight:5.0},
  ],
  "goal-retirement": [
