...
export class DatabaseStorage implements IStorage {
  ...
  async seedDefaultStoreCategories(): Promise<void> {
    ...
    const defaultCategories = [
      ...
      { id: 'cat-bonds-ncds', name: 'Bonds & NCDs', slug: 'bonds-ncds', icon: 'FileText', displayOrder: 4, isActive: true },
      { id: 'cat-stocks', name: 'Stocks & Equities', slug: 'stocks', icon: 'BarChart3', displayOrder: 5, isActive: true },
      { id: 'cat-ipo-preipo', name: 'IPO & Pre-IPO', slug: 'ipo-preipo', icon: 'Rocket', displayOrder: 6, isActive: true },
      { id: 'cat-unlisted', name: 'Unlisted Shares', slug: 'unlisted', icon: 'Building2', displayOrder: 7, isActive: true },
      { id: 'cat-aif', name: 'AIF', slug: 'aif', icon: 'Briefcase', displayOrder: 8, isActive: true },
      { id: 'cat-pms', name: 'PMS', slug: 'pms', icon: 'Wallet', displayOrder: 9, isActive: true },
      { id: 'cat-mlds', name: 'MLDs', slug: 'mlds', icon: 'Layers', displayOrder: 10, isActive: true },
      { id: 'cat-insurance', name: 'Insurance', slug: 'insurance', icon: 'Shield', displayOrder: 11, isActive: true },
      { id: 'cat-loans', name: 'Loans & Credit', slug: 'loans', icon: 'CreditCard', displayOrder: 12, isActive: false },
      { id: 'cat-tax', name: 'Tax Services', slug: 'tax', icon: 'Calculator', displayOrder: 13, isActive: true },
      { id: 'cat-gold', name: 'Gold & Commodities', slug: 'gold', icon: 'Coins', displayOrder: 14, isActive: true },
      { id: 'cat-global', name: 'Global Products', slug: 'global-products', icon: 'Globe', displayOrder: 15, isActive: true },
      { id: 'cat-banking', name: 'Banking Products', slug: 'banking-products', icon: 'Building', displayOrder: 16, isActive: true },
      { id: 'cat-professional', name: 'Professional Services', slug: 'professional-services', icon: 'Users', displayOrder: 17, isActive: true },
      { id: 'cat-subscriptions', name: 'Subscriptions', slug: 'subscriptions', icon: 'Star', displayOrder: 18, isActive: true },
      { id: 'cat-premium', name: 'PREMIUM', slug: 'premium', icon: 'Crown', displayOrder: 19, isActive: true },
      { id: 'cat-elite', name: 'ELITE', slug: 'elite', icon: 'Award', displayOrder: 20, isActive: true },
    ];
