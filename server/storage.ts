...
import { type SupplierProduct, type InsertSupplierProduct, type Product, type InsertProduct, type ProductPerformanceMetric, type InsertProductPerformanceMetric, type ApplicationDocument, type InsertApplicationDocument, type ProductAccountPreference, type InsertProductAccountPreference, type ICICILoanApplication, type InsertICICILoanApplication, type ICICICreditScore, type InsertICICICreditScore, type PortfolioComparison, type InsertPortfolioComparison, type ChatSession, type InsertChatSession, type ChatMessage, type InsertChatMessage, type ChatAction, type InsertChatAction, type ChatFunction, type CurrencyRate, type CkycNotificationTrigger, type InsertCkycNotificationTrigger } from "@shared/schema";
