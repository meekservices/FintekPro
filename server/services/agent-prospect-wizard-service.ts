...
import {
	...
	getAllActiveRecommendations,
} from "./recommendation-products-service";
...
import {
	...
	proposalVersions,
	signalResolutionLog,
	rebalanceGovernanceConfig,
	rebalanceDecisionLog,
	dailyPicks,
} from "@shared/schema";
...
const FUND_RECOMMENDATIONS_BY_CATEGORY = {
	equity: {
		conservative: [
			{
				name: "Mirae Asset Large Cap Fund - Regular (G)",
				amc: "Mirae Asset",
		...
		aggressive: [
			{
				name: "Quant Small Cap Fund - Regular (G)",
				amc: "Quant",
			...
			{
				name: "Nippon India Small Cap Fund - Regular (G)",
				amc: "Nippon India",
				category: "Equity - Small Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "HDFC Small Cap Fund - Regular (G)",
				amc: "HDFC",
				category: "Equity - Small Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "Kotak Small Cap Fund - Regular (G)",
				amc: "Kotak",
				category: "Equity - Small Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "Axis Midcap Fund - Regular (G)",
				amc: "Axis",
				category: "Equity - Mid Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "HDFC Flexi Cap Fund - Regular (G)",
				amc: "HDFC",
				category: "Equity - Flexi Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		very_aggressive: [
			{
				name: "Quant Multi Cap Fund - Regular (G)",
				amc: "Quant",
			...
			{
				name: "Tata Small Cap Fund - Regular (G)",
				amc: "Tata",
				category: "Equity - Small Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "SBI Small Cap Fund - Regular (G)",
				amc: "SBI",
				category: "Equity - Small Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "Motilal Oswal Midcap Fund - Regular (G)",
				amc: "Motilal Oswal",
				category: "Equity - Mid Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "ICICI Pru Technology Fund - Regular (G)",
	...
	debt: {
		conservative: [
			{
				name: "ICICI Pru Corporate Bond Fund - Regular (G)",
				amc: "ICICI Prudential",
			...
			{
				name: "SBI Magnum Medium Duration Fund - Regular (G)",
				amc: "SBI",
			...
			{
				name: "Axis Banking & PSU Debt Fund - Regular (G)",
				amc: "Axis",
		...
		moderate: [
			{
				name: "SBI Corporate Bond Fund - Regular (G)",
				amc: "SBI",
				category: "Debt - Corporate Bond",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "HDFC Short Term Debt Fund - Regular (G)",
				amc: "HDFC",
		...
		aggressive: [
			{
				name: "ICICI Pru Credit Risk Fund - Regular (G)",
				amc: "ICICI Prudential",
		...
		very_aggressive: [
			{
				name: "SBI Dynamic Bond Fund - Regular (G)",
				amc: "SBI",
	...
	hybrid: {
		conservative: [
			{
				name: "HDFC Balanced Advantage Fund - Regular (G)",
				amc: "HDFC",
			...
			{
				name: "ICICI Pru Equity & Debt Fund - Regular (G)",
				amc: "ICICI Prudential",
		...
		moderate: [
			{
				name: "HDFC Hybrid Equity Fund - Regular (G)",
				amc: "HDFC",
				category: "Hybrid - Aggressive",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "Kotak Equity Hybrid Fund - Regular (G)",
				amc: "Kotak",
				category: "Hybrid - Aggressive",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		aggressive: [
			{
				name: "ICICI Pru Multi Asset Fund - Regular (G)",
				amc: "ICICI Prudential",
		...
		very_aggressive: [
			{
				name: "Quant Multi Asset Fund - Regular (G)",
				amc: "Quant",
				category: "Hybrid - Multi Asset",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
	...
	gold_fof: {
		...
		moderate: [
			{
				name: "Nippon India Gold Savings Fund - Regular (G)",
				amc: "Nippon India",
				category: "FOF - Gold",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		aggressive: [
			{
				name: "Kotak Gold Fund - Regular (G)",
				amc: "Kotak",
				category: "FOF - Gold",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		very_aggressive: [
			{
				name: "ICICI Pru Regular Gold Savings Fund - Regular (G)",
				amc: "ICICI Prudential",
				category: "FOF - Gold",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
	...
	silver_fof: {
		conservative: [
			{
				name: "ICICI Pru Silver ETF FOF - Regular (G)",
				amc: "ICICI Prudential",
				category: "FOF - Silver",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		moderate: [
			{
				name: "Nippon India Silver ETF FOF - Regular (G)",
				amc: "Nippon India",
				category: "FOF - Silver",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		aggressive: [
			{
				name: "Aditya Birla Sun Life Silver ETF FOF - Regular (G)",
				amc: "Aditya Birla",
				category: "FOF - Silver",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		very_aggressive: [
			{
				name: "Kotak Silver ETF FOF - Regular (G)",
				amc: "Kotak",
				category: "FOF - Silver",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
	...
	index_fund: {
		conservative: [
			{
				name: "UTI Nifty 50 Index Fund - Regular (G)",
				amc: "UTI",
		...
		moderate: [
			{
				name: "HDFC Index Fund - Nifty 50 Plan - Regular (G)",
				amc: "HDFC",
				category: "Index Fund - Large Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "UTI Nifty Next 50 Index Fund - Regular (G)",
				amc: "UTI",
				category: "Index Fund - Large & Mid Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		aggressive: [
			{
				name: "Motilal Oswal Nifty Midcap 150 Index Fund - Regular (G)",
				amc: "Motilal Oswal",
		...
		very_aggressive: [
			{
				name: "Nippon India Nifty Smallcap 250 Index Fund - Regular (G)",
				amc: "Nippon India",
				category: "Index Fund - Small Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
	...
	etf: {
		...
		very_aggressive: [
			...
			{
				name: "ICICI Pru Nifty Pharma ETF",
				amc: "ICICI Prudential",
				category: "ETF - Sectoral Pharma",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
	...
	international: {
		conservative: [
			{
				name: "Motilal Oswal Nasdaq 100 FOF - Regular (G)",
				amc: "Motilal Oswal",
			...
			{
				name: "PGIM India Global Equity Opp Fund - Regular (G)",
				amc: "PGIM India",
				category: "FOF - International",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		moderate: [
			{
				name: "Franklin India Feeder - Franklin US Opp Fund - Regular (G)",
				amc: "Franklin",
				category: "FOF - US Markets",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "Kotak International REIT FOF - Regular (G)",
				amc: "Kotak",
				category: "FOF - Global REIT",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
			...
			{
				name: "Nippon India Japan Equity Fund - Regular (G)",
				amc: "Nippon India",
				category: "FOF - Japan",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		aggressive: [
			{
				name: "Nippon India US Equity Opp Fund - Regular (G)",
				amc: "Nippon India",
				category: "FOF - US Markets",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "Kotak Nasdaq 100 FOF - Regular (G)",
				amc: "Kotak",
				category: "FOF - US Tech",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "Edelweiss Europe Dynamic Equity Fund - Regular (G)",
				amc: "Edelweiss",
				category: "FOF - Europe",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		very_aggressive: [
			{
				name: "Edelweiss Greater China Equity Off-shore Fund - Regular (G)",
				amc: "Edelweiss",
				category: "FOF - China",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "DSP Global Innovation FOF - Regular (G)",
				amc: "DSP",
				category: "FOF - Global Tech",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
			...
			{
				name: "ICICI Pru Global Advantage Fund - Regular (G)",
				amc: "ICICI Prudential",
				category: "FOF - Global Multi-Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
	...
	us_markets: {
		conservative: [
			{
				name: "Motilal Oswal S&P 500 Index Fund - Regular (G)",
				amc: "Motilal Oswal",
				category: "Index - S&P 500",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
				productType: "international_etf",
				region: "US",
				expenseRatio: "0.49%",
			},
			{
				name: "Franklin India Feeder - Franklin US Opp Fund - Regular (G)",
				amc: "Franklin",
				category: "FOF - US Equity",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
				productType: "international_fund",
				region: "US",
			},
		],
		moderate: [
			...
			{
				name: "Mirae Asset NYSE FANG+ ETF FOF - Regular (G)",
				amc: "Mirae Asset",
				category: "ETF - US Tech Giants",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		aggressive: [
			...
			{
				name: "ICICI Pru US Bluechip Equity Fund - Regular (G)",
				amc: "ICICI Prudential",
				category: "FOF - US Blue Chip",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "DSP US Flexible Equity Fund - Regular (G)",
				amc: "DSP",
				category: "FOF - US Multi-Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		very_aggressive: [
			{
				name: "Motilal Oswal Nasdaq Q50 ETF - Regular (G)",
				amc: "Motilal Oswal",
				category: "ETF - US Tech Growth",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
			...
			{
				name: "Axis Global Innovation FOF - Regular (G)",
				amc: "Axis",
				category: "FOF - US Innovation",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
	...
	europe_markets: {
		conservative: [
			{
				name: "ICICI Pru European Markets Fund - Regular (G)",
				amc: "ICICI Prudential",
				category: "FOF - Europe Diversified",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
			...
			{
				name: "Edelweiss Europe Fund - Regular (G)",
				amc: "Edelweiss",
				category: "FOF - Pan-European",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
		...
		moderate: [
			{
				name: "Franklin European Growth Fund - Regular (G)",
				amc: "Franklin",
				category: "FOF - Europe Growth",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "Kotak Global Emerging Market Fund - Regular (G)",
				amc: "Kotak",
				category: "FOF - Europe & EM",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "SBI European Equity Fund - Regular (G)",
				amc: "SBI",
				category: "FOF - Eurozone",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
		...
		aggressive: [
			...
			{
				name: "DSP European Opportunities Fund - Regular (G)",
				amc: "DSP",
				category: "FOF - European Mid-Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		very_aggressive: [
			{
				name: "Mirae Asset European Small Cap Fund - Regular (G)",
				amc: "Mirae Asset",
				category: "FOF - Europe Small Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
			...
			{
				name: "HDFC European Tech Fund - Regular (G)",
				amc: "HDFC",
				category: "FOF - Europe Tech",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
	...
	asia_pacific_markets: {
		conservative: [
			...
			{
				name: "ICICI Pru Asia Pacific Fund - Regular (G)",
				amc: "ICICI Prudential",
				category: "FOF - Asia-Pacific Diversified",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
		...
		moderate: [
			{
				name: "Kotak Pacific Fund - Regular (G)",
				amc: "Kotak",
				category: "FOF - Pacific Rim",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "Franklin Asian Equity Fund - Regular (G)",
				amc: "Franklin",
				category: "FOF - Asian Equity",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "Mirae Asset ASEAN Fund - Regular (G)",
				amc: "Mirae Asset",
				category: "FOF - ASEAN Markets",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		aggressive: [
			...
			{
				name: "SBI South Korea Fund - Regular (G)",
				amc: "SBI",
				category: "FOF - South Korea",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "Axis Taiwan Semiconductor Fund - Regular (G)",
				amc: "Axis",
				category: "FOF - Taiwan Tech",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		very_aggressive: [
			{
				name: "DSP China Growth Fund - Regular (G)",
				amc: "DSP",
				category: "FOF - China Growth",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
			...
			{
				name: "HDFC Asian Dragon Fund - Regular (G)",
				amc: "HDFC",
				category: "FOF - China & Hong Kong",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
			...
			{
				name: "Nippon India Vietnam Opp Fund - Regular (G)",
				amc: "Nippon India",
				category: "FOF - Vietnam",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
	...
	emerging_markets: {
		conservative: [
			{
				name: "PGIM India Emerging Markets Fund - Regular (G)",
				amc: "PGIM India",
				category: "FOF - EM Diversified",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "ICICI Pru Emerging Markets Fund - Regular (G)",
				amc: "ICICI Prudential",
				category: "FOF - EM Index",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
		...
		moderate: [
			{
				name: "Kotak BRICS Nations Fund - Regular (G)",
				amc: "Kotak",
				category: "FOF - BRICS",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "Franklin BRIC Fund - Regular (G)",
				amc: "Franklin",
				category: "FOF - BRIC Markets",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "SBI Emerging Markets Fund - Regular (G)",
				amc: "SBI",
				category: "FOF - EM Growth",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		aggressive: [
			{
				name: "Edelweiss Latin America Fund - Regular (G)",
				amc: "Edelweiss",
				category: "FOF - Latin America",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "DSP Africa Opportunities Fund - Regular (G)",
				amc: "DSP",
				category: "FOF - Africa",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "Mirae Asset EM Consumer Fund - Regular (G)",
				amc: "Mirae Asset",
				category: "FOF - EM Consumer",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		very_aggressive: [
			{
				name: "HDFC Emerging Markets Alpha Fund - Regular (G)",
				amc: "HDFC",
				category: "FOF - EM High Growth",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
			...
			{
				name: "Axis Frontier Markets Fund - Regular (G)",
				amc: "Axis",
				category: "FOF - Frontier Markets",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
			...
			{
				name: "Nippon India EM Small Cap Fund - Regular (G)",
				amc: "Nippon India",
				category: "FOF - EM Small Cap",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
	...
	invit: {
		conservative: [
			{
				name: "IndiGrid InvIT",
				amc: "IndiGrid",
				category: "InvIT - Power Transmission",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Low",
		...
		aggressive: [
			{
				name: "IRB InvIT Fund",
				amc: "IRB Infrastructure",
				category: "InvIT - Roads",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
	...
	bonds: {
		conservative: [
			{
				name: "REC Limited NCD - 7.5% 2028",
				amc: "REC",
				category: "Corporate Bond - PSU",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Low",
		...
		moderate: [
			{
				name: "PFC Limited NCD - 7.75% 2029",
				amc: "PFC",
				category: "Corporate Bond - PSU",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "HDFC Ltd NCD - 8.0% 2027",
				amc: "HDFC",
				category: "Corporate Bond - NBFC",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Low",
		...
		aggressive: [
			{
				name: "Tata Capital NCD - 8.25% 2028",
				amc: "Tata Capital",
				category: "Corporate Bond - NBFC",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		very_aggressive: [
			{
				name: "Shriram Transport Finance NCD - 9.0% 2027",
				amc: "Shriram Transport",
				category: "Corporate Bond - NBFC",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
	...
	mld: {
		conservative: [
			{
				name: "HDFC MLD - Principal Protected Nifty Linked",
				amc: "HDFC",
				category: "MLD - Principal Protected",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Low",
		...
		moderate: [
			{
				name: "ICICI Securities MLD - Equity Linked",
				amc: "ICICI Securities",
				category: "MLD - Equity Linked",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
			...
			{
				name: "Kotak Mahindra MLD - Multi Asset",
				amc: "Kotak",
				category: "MLD - Multi Asset",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
		...
		aggressive: [
			{
				name: "JM Financial MLD - Nifty Booster",
				amc: "JM Financial",
				category: "MLD - Nifty Linked",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderately High",
		...
		very_aggressive: [
			{
				name: "Axis Securities MLD - Aggressive Growth",
				amc: "Axis Securities",
				category: "MLD - Equity Linked",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
	...
	pms: {
		conservative: [
			{
				name: "HDFC AMC PMS - Balanced",
				amc: "HDFC AMC",
				category: "PMS - Balanced",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
		...
		moderate: [
			{
				name: "Motilal Oswal PMS - Value Strategy",
				amc: "Motilal Oswal",
				category: "PMS - Value",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
			...
			{
				name: "Kotak PMS - Special Situations",
				amc: "Kotak",
				category: "PMS - Special Situations",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		aggressive: [
			{
				name: "ASK Investment PMS - Growth Portfolio",
				amc: "ASK Investment",
				category: "PMS - Growth",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		very_aggressive: [
			{
				name: "Marcellus PMS - Consistent Compounders",
				amc: "Marcellus",
				category: "PMS - Quality",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "Alchemy Capital PMS - High Growth",
				amc: "Alchemy Capital",
				category: "PMS - High Growth",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
	...
	aif: {
		conservative: [
			{
				name: "ICICI Prudential Credit AIF - Category II",
				amc: "ICICI Prudential",
				category: "AIF - Credit",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		moderate: [
			{
				name: "Kotak Special Situations AIF - Category II",
				amc: "Kotak",
				category: "AIF - Special Situations",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderately High",
			...
			{
				name: "HDFC Ventures AIF - Category II",
				amc: "HDFC",
				category: "AIF - Growth",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
		...
		aggressive: [
			{
				name: "Edelweiss Pre-IPO AIF - Category I",
				amc: "Edelweiss",
				category: "AIF - Pre-IPO",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		very_aggressive: [
			{
				name: "True North AIF - Category II",
				amc: "True North",
				category: "AIF - Private Equity",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
			...
			{
				name: "Multiples PE AIF - Category II",
				amc: "Multiples",
				category: "AIF - Growth Equity",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
	...
	listed_stocks: {
		conservative: [
			...
			},
			{
				name: "HDFC Bank Ltd",
				amc: "NSE/BSE",
				category: "Stock - Large Cap Banking",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderate",
		...
		moderate: [
			...
			},
			{
				...
				amc: "NSE/BSE",
				category: "Stock - Large Cap Telecom",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderately High",
			...
			},
			{
				...
				amc: "NSE/BSE",
				category: "Stock - Large Cap Infrastructure",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Moderately High",
		...
		aggressive: [
			...
			},
			{
				name: "SBI Cards Ltd",
				amc: "NSE/BSE",
				category: "Stock - Mid Cap Financial",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		very_aggressive: [
			...
			},
			{
				name: "Tata Elxsi Ltd",
				amc: "NSE/BSE",
				category: "Stock - Mid Cap IT Services",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
			...
			},
			{
				...
				amc: "NSE/BSE",
				category: "Stock - Mid Cap Electronics",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
	...
	unlisted_stocks: {
		...
		aggressive: [
			...
			{
				name: "PhonePe (PhonePe Pvt Ltd)",
				amc: "Unlisted",
				category: "Unlisted - Fintech",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
			...
			{
				name: "Lenskart Solutions Pvt Ltd",
				amc: "Unlisted",
				category: "Unlisted - E-commerce",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "High",
		...
		very_aggressive: [
			{
				name: "OfBusiness (OFB Tech Pvt Ltd)",
				amc: "Unlisted",
				category: "Unlisted - B2B Commerce",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
			...
			},
			{
				...
				amc: "Unlisted",
				category: "Unlisted - Payment Tech",
				returns1Y: "PENDING",
				returns3Y: "PENDING",
				returns5Y: "PENDING",
				risk: "Very High",
...
export const LEGACY_PURCHASE_RESTRICTED_FUNDS: Array<{
...
}> = [
	{
		...
		reason:
			"AMC has temporarily suspended lumpsum investments due to fund size management",
	...
	},
	{
		...
		restrictionType: "lumpsum",
		reason:
			"AMC has restricted lumpsum investments to protect existing investors",
...
export function isLumpsumRestricted(fundName: string): {
	restricted: boolean;
	reason?: string;
	alternative?: string;
} {
	const match = LEGACY_PURCHASE_RESTRICTED_FUNDS.find(
		(r) =>
			fundName.toLowerCase().includes(r.fundNamePattern.toLowerCase()) &&
	...
	if (match) {
		return {
			restricted: true,
			reason: match.reason,
			alternative: match.alternativeFund,
		};
	}
	return { restricted: false };
}

export function isSipRestricted(fundName: string): {
	restricted: boolean;
	reason?: string;
	alternative?: string;
} {
...
function findFundInCatalog(fundName: string): any | null {
	...
	for (const category of Object.values(FUND_RECOMMENDATIONS_BY_CATEGORY)) {
		for (const riskFunds of Object.values(category)) {
			const found = (riskFunds as any[]).find(
...
async function checkFundLumpsumEligibility(fundName: string): Promise<{
	...
	try {
		const eligibility = await schemeGovernanceService.checkEligibility(
			fundName,
			"name",
		);
		if (!eligibility.lumpsumAllowed) {
			return {
				...
				reason:
					...
					"Lumpsum not allowed per subscription rules",
		...
		console.warn(
			`[SubscriptionSync] DB lookup failed for "${fundName}" — using legacy hardcoded fallback. Fix DB connectivity.`,
		);
	}
	...
	try {
		...
		if (!eligibility.sipAllowed) {
			return {
				...
				reason:
					eligibility.restrictionReason ||
					"SIP not allowed per subscription rules",
				alternativeName: eligibility.alternativeSchemeName || undefined,
			};
		}
		return { restricted: false };
 ...
 */
async function selectEligibleFundsForLumpsum(
	candidateFunds: any[],
	maxFunds: number = 2,
): Promise<any[]> {
	const eligible: any[] = [];
	...
	for (const fund of candidateFunds) {
		...
		if (fund.sebiBlocked === true) {
			console.log(
				`[SEBICompliance] Excluding ${fund.name}: status=${fund.sebiComplianceStatus}${fund.sebiBlockReason ? ` — ${fund.sebiBlockReason}` : ""}`,
			);
			continue;
		}
		if (fund.namingFailed === true) {
			console.log(
				`[SEBICompliance] Excluding ${fund.name}: naming_validation_status=FAILED`,
			);
			continue;
		}
		...
		if (restriction.restricted) {
			console.log(
				`[FundRestriction] Excluding ${fund.name} from lumpsum: ${restriction.reason}`,
			);
	...
	for (const altName of alternatives) {
		...
		if (catalogEntry) {
			const altRestriction = await checkFundLumpsumEligibility(
				catalogEntry.name,
			);
			if (!altRestriction.restricted) {
				...
				console.log(
					`[FundRestriction] Resolved alternative from catalog: ${catalogEntry.name} (${catalogEntry.amc})`,
				);
			}
		} else {
			console.log(
				`[FundRestriction] Alternative ${altName} not found in catalog, skipping`,
			);
		}
	}
...
async function enrichFundWithLiveReturns(fund: {
	...
	try {
		...
		const searchTerm = fund.name
			.replace(/- Regular \(G\)|- Growth|- Direct.*$/gi, "")
			.trim();
		...
		if (bestMatch?.schemeCode) {
			// Check if we have returns in DB
			if (bestMatch.returns1y || bestMatch.returns3y) {
				console.log(
					`[LiveReturns] Found DB returns for ${fund.name}: 1Y=${bestMatch.returns1y}, 3Y=${bestMatch.returns3y}`,
				);
				return {
					...fund,
					returns1Y: bestMatch.returns1y
						? Number.parseFloat(bestMatch.returns1y as string).toFixed(1)
						: fund.returns1Y,
					returns3Y: bestMatch.returns3y
						? Number.parseFloat(bestMatch.returns3y as string).toFixed(1)
						: fund.returns3Y,
					returns5Y: bestMatch.returns5y
						? Number.parseFloat(bestMatch.returns5y as string).toFixed(1)
						: fund.returns5Y,
			...
			const liveReturns = await mfReturnsSyncService.getReturnsForFund(
				bestMatch.schemeCode,
			);
			if (liveReturns && liveReturns.dataQuality !== "insufficient") {
				console.log(
					`[LiveReturns] Fetched MFAPI returns for ${fund.name}: 1Y=${liveReturns.returns1y?.toFixed(1)}, 3Y=${liveReturns.returns3y?.toFixed(1)}`,
				);
				return {
					...fund,
					returns1Y: liveReturns.returns1y
						? liveReturns.returns1y.toFixed(1)
						: fund.returns1Y,
					returns3Y: liveReturns.returns3y
						? liveReturns.returns3y.toFixed(1)
						: fund.returns3Y,
					returns5Y: liveReturns.returns5y
						? liveReturns.returns5y.toFixed(1)
						: fund.returns5Y,
					schemeCode: bestMatch.schemeCode,
					dataSource: "mfapi",
				};
 ...
 */
async function enrichCategoryFundsWithLiveReturns(
	funds: Array<{
		name: string;
		amc: string;
		category: string;
 ...
 */
const liveReturnsCache = new Map<
	string,
	{
		returns1Y: string;
		returns3Y: string;
...
const sebiComplianceCache = new Map<
	string,
	{
 ...
 */
export function updateLiveReturnsCache(
	fundName: string,
	returns: {
...
function getCachedLiveReturns(fundName: string): {
	...
	for (const normalizedName of nameVariations) {
		...
		if (cached) {
			...
			const hoursSinceSynced =
				(Date.now() - cached.syncedAt.getTime()) / (1000 * 60 * 60);
		...
		for (const [cacheKey, value] of liveReturnsCache.entries()) {
			if (
				...
				const hoursSinceSynced =
					(Date.now() - value.syncedAt.getTime()) / (1000 * 60 * 60);
				if (hoursSinceSynced < 24) {
					return value;
				}
			}
...
async function sanitizeFundForDisplayAsync(fund: any): Promise<any> {
	...
	try {
		const dbResult = await db
			...
			.from(mutualFunds)
			.where(
				sql`LOWER(${mutualFunds.schemeName}) LIKE LOWER(${"%" + fund.name.split(" ").slice(0, 3).join(" ") + "%"})`,
			)
			.limit(1);
		...
		if (dbResult[0]) {
			...
			const normalizedFundName = fund.name
				.toLowerCase()
				.replace(/\s+/g, " ")
				.trim();
			...
			if (row.returns1y || row.returns3y) {
				sanitized.returns1Y = row.returns1y
					? Number.parseFloat(row.returns1y as string).toFixed(1)
					: "N/A";
				sanitized.returns3Y = row.returns3y
					? Number.parseFloat(row.returns3y as string).toFixed(1)
					: "N/A";
				sanitized.returns5Y = row.returns5y
					? Number.parseFloat(row.returns5y as string).toFixed(1)
					: "N/A";
				sanitized.dataSource = "live";

				updateLiveReturnsCache(fund.name, {
					returns1Y: row.returns1y
						? Number.parseFloat(row.returns1y as string)
						: null,
					returns3Y: row.returns3y
						? Number.parseFloat(row.returns3y as string)
						: null,
					returns5Y: row.returns5y
						? Number.parseFloat(row.returns5y as string)
						: null,
					dataSource: "live",
				});
 ...
 */
function getfundsFromCategorySanitized(
	category: string,
	riskProfile: string,
): any[] {
	const rawFunds =
		(FUND_RECOMMENDATIONS_BY_CATEGORY as any)[category]?.[riskProfile] ||
 ...
 */
async function getFundsFromCategorySanitizedAsync(
	category: string,
	riskProfile: string,
): Promise<any[]> {
	const rawFunds =
	...
	const sanitizedFunds = await Promise.all(
		rawFunds.map(sanitizeFundForDisplayAsync),
	);
 ...
 */
async function getFundsWithLiveReturns(
	category: string,
	riskProfile: string,
): Promise<any[]> {
	const rawFunds =
...
export const PRODUCT_CATEGORIES = [
	{
		...
		description: "Large cap, mid cap, small cap, flexi cap funds",
	},
	{
		id: "debt",
		label: "Debt Mutual Funds",
		description: "Corporate bonds, government securities, short duration",
	},
	{
		id: "hybrid",
		label: "Hybrid Funds",
		description: "Balanced advantage, aggressive hybrid, multi-asset",
	},
	{
		id: "gold_fof",
		label: "Gold FOF",
		description: "Gold Fund of Funds for portfolio hedging",
	},
	{
		id: "silver_fof",
		label: "Silver FOF",
		description: "Silver ETF Fund of Funds",
	},
	{
		id: "index_fund",
		label: "Index Funds",
		description: "Passive funds tracking Nifty, Sensex indices",
	},
	{
		id: "etf",
		label: "ETFs",
		description:
			"Exchange Traded Funds on NSE/BSE (Nifty Bees, Bank Bees, etc.)",
	},
	{
		id: "international",
		label: "International FOF",
		description: "US equity, global tech, emerging markets funds",
	},
	{
		id: "reit",
		label: "REITs",
		description: "Embassy, Mindspace, Brookfield real estate trusts",
	},
	{
		id: "invit",
		label: "InvITs",
		description: "IndiGrid, IRB, PowerGrid infrastructure trusts",
	},
	{
		id: "bonds",
		label: "Corporate Bonds/NCDs",
		description: "Direct corporate bonds, NCDs, G-Secs",
	},
	{
		id: "mld",
		label: "MLDs",
		description: "Market Linked Debentures for tax-efficient returns",
	},
	{
		id: "listed_stocks",
		label: "Listed Stocks",
		description: "Direct equity in NSE/BSE listed companies",
	},
	{
		id: "unlisted_stocks",
		label: "Unlisted Stocks",
		description: "Pre-IPO & private company shares (Enhanced KYC required)",
		requiresEnhancedKYC: true,
	},
	{
		id: "pms",
		label: "PMS",
		description: "Portfolio Management Services (Min ₹50L)",
		minInvestment: 5000000,
	},
	{
		id: "aif",
		label: "AIF",
		description: "Alternative Investment Funds (Min ₹1Cr)",
		minInvestment: 10000000,
	},
];
...
async function getRecommendationsForCategory(
	...
	if (productType) {
		try {
			const dbRecommendations = await getRecommendationsByCategory(
				productType,
				riskProfile,
			);
			if (dbRecommendations.length > 0) {
				console.log(
					`[Recommendations] Using ${dbRecommendations.length} ${category} recommendations from database for ${riskProfile}`,
				);
				return dbRecommendations;
			}
		} catch (error) {
			console.error(
				`[Recommendations] Error fetching ${category} from database:`,
				error,
			);
		}
	}
...
async function initializeRecommendationsFromDatabase(): Promise<void> {
	try {
		...
		for (const [productType, riskProfiles] of Object.entries(dbProducts)) {
			...
			for (const [riskProfile, products] of Object.entries(
				riskProfiles as Record<string, any[]>,
			)) {
		...
		if (mergedCount > 0) {
			console.log(
				`[Recommendations] Loaded ${mergedCount} products from database into recommendation catalog`,
			);
		}
	} catch (error) {
		console.error(
			"[Recommendations] Failed to load from database, using hardcoded data:",
			error,
		);
	}
}
...
export async function getListedStocksBySector(
	...
	try {
		...
		console.error(
			`[ListedStocks] Error fetching stocks for sector ${broadSector}:`,
			error,
		);
		return [];
	}
...
export async function getAvailableBroadSectors(): Promise<
...
export async function getListedStockRecommendations(
	...
	try {
		...
		const sectors =
			preferredSectors && preferredSectors.length > 0
				? preferredSectors
		...
		return allStocks
			.sort((a, b) => {
				...
				return (
					(capOrder[b.marketCap || ""] || 0) -
					(capOrder[a.marketCap || ""] || 0)
				);
			})
			.slice(0, limit);
	} catch (error) {
...
function mapUnlistedToBroadSector(sector?: string | null): string {
	...
	if (
		...
		sectorLower.includes("fintech") ||
		sectorLower.includes("saas") ||
		sectorLower.includes("ai") ||
		sectorLower.includes("edtech") ||
	...
	if (
		...
		sectorLower.includes("nbfc") ||
		sectorLower.includes("insurance") ||
		sectorLower.includes("lending") ||
		sectorLower.includes("payment")
	) {
	...
	if (
		...
		sectorLower.includes("hospital") ||
		sectorLower.includes("biotech") ||
		sectorLower.includes("diagnostic")
	) {
	...
	if (
		...
		sectorLower.includes("fmcg") ||
		sectorLower.includes("food") ||
		sectorLower.includes("beverage") ||
		sectorLower.includes("ecommerce") ||
		sectorLower.includes("e-commerce") ||
		sectorLower.includes("d2c")
	) {
	...
	if (
		...
		sectorLower.includes("road") ||
		sectorLower.includes("cement") ||
		sectorLower.includes("logistics") ||
		sectorLower.includes("transport")
	) {
	...
	if (
		...
		sectorLower.includes("property") ||
		sectorLower.includes("housing") ||
		sectorLower.includes("realty")
	) {
		return "Real Estate";
	}
	...
	// Metals & Mining
	if (
		sectorLower.includes("metal") ||
		sectorLower.includes("mining") ||
		sectorLower.includes("steel") ||
		sectorLower.includes("alumin")
	) {
	...
	// Services
	if (
		sectorLower.includes("service") ||
		sectorLower.includes("consult") ||
		sectorLower.includes("bpo") ||
		sectorLower.includes("staffing") ||
		sectorLower.includes("hr") ||
		sectorLower.includes("media") ||
		sectorLower.includes("entertainment") ||
		sectorLower.includes("travel")
	) {
		return "Services";
	}
...
export async function getUnlistedStocksBySector(
	...
	try {
		...
		return companies.map((company) => ({
			...
			riskLevel: determineUnlistedRiskLevel(
				company.riskRating,
				company.investmentTier,
			),
			requiresEnhancedKyc: true,
		})) as any[];
	} catch (error) {
		console.error(
			`[UnlistedStocks] Error fetching companies for sector ${broadSector}:`,
			error,
		);
		return [];
	}
...
function determineUnlistedRiskLevel(
...
export async function getAvailableUnlistedSectors(): Promise<
	{ sector: string; count: number }[]
> {
	try {
		const sectors = await db
...
export async function getUnlistedStockRecommendations(
	...
	try {
		...
		if (riskProfile === "conservative") {
			console.log(
				"[UnlistedStocks] Conservative profile - unlisted stocks not recommended",
			);
			return [];
		}
		...
		return allCompanies
			.sort((a, b) => {
				...
				return (
					(tierOrder[b.investmentTier || ""] || 0) -
					(tierOrder[a.investmentTier || ""] || 0)
				);
			})
			.slice(0, limit);
	} catch (error) {
...
export async function populateUnlistedBroadSectors(): Promise<{
	updated: number;
	errors: number;
}> {
	...
	for (const company of companiesWithoutBroadSector) {
		try {
			...
			errors++;
			console.error(
				`[UnlistedStocks] Error updating broad sector for ${company.id}:`,
				error,
			);
		}
	}
	...
	console.log(
		`[UnlistedStocks] Broad sector population complete: ${updated} updated, ${errors} errors`,
	);
...
function normalizeHolding(raw: any): ProspectPortfolioHolding {
	...
	if (!purchaseDate && raw.lots && raw.lots.length > 0) {
		...
		const lotDates = raw.lots
			.map((lot: any) => {
				const dateStr =
					lot.transactionDateStr || lot.purchaseDate || lot.transactionDate;
...
const FUND_ALPHA_METRICS: Record<
	string,
	{ sharpe: number; aumCr: number; directName?: string }
> = {
	"Parag Parikh Flexi Cap Fund - Regular (G)": {
		sharpe: 1.85,
		aumCr: 87000,
		directName: "Parag Parikh Flexi Cap Fund - Direct (G)",
	},
	"Mirae Asset Large Cap Fund - Regular (G)": {
		sharpe: 1.12,
		aumCr: 38000,
		directName: "Mirae Asset Large Cap Fund - Direct (G)",
	},
	"Kotak Emerging Equity Fund - Regular (G)": {
		sharpe: 1.05,
		aumCr: 49000,
		directName: "Kotak Emerging Equity Fund - Direct (G)",
	},
	"Quant Small Cap Fund - Regular (G)": {
		sharpe: 1.42,
		aumCr: 23000,
		directName: "Quant Small Cap Fund - Direct (G)",
	},
	"Nippon India Small Cap Fund - Regular (G)": {
		sharpe: 1.28,
		aumCr: 60000,
		directName: "Nippon India Small Cap Fund - Direct (G)",
	},
	"HDFC Small Cap Fund - Regular (G)": {
		sharpe: 1.1,
		aumCr: 33000,
		directName: "HDFC Small Cap Fund - Direct (G)",
	},
	"Kotak Small Cap Fund - Regular (G)": {
		sharpe: 0.98,
		aumCr: 15000,
		directName: "Kotak Small Cap Fund - Direct (G)",
	},
	"Axis Midcap Fund - Regular (G)": {
		sharpe: 1.15,
		aumCr: 25000,
		directName: "Axis Midcap Fund - Direct (G)",
	},
	"HDFC Flexi Cap Fund - Regular (G)": {
		sharpe: 1.22,
		aumCr: 60000,
		directName: "HDFC Flexi Cap Fund - Direct (G)",
	},
	"Quant Multi Cap Fund - Regular (G)": {
		sharpe: 1.38,
		aumCr: 10000,
		directName: "Quant Multi Cap Fund - Direct (G)",
	},
	"Tata Small Cap Fund - Regular (G)": {
		sharpe: 1.05,
		aumCr: 10000,
		directName: "Tata Small Cap Fund - Direct (G)",
	},
	"SBI Small Cap Fund - Regular (G)": {
		sharpe: 1.18,
		aumCr: 35000,
		directName: "SBI Small Cap Fund - Direct (G)",
	},
	"Motilal Oswal Midcap Fund - Regular (G)": {
		sharpe: 1.35,
		aumCr: 22000,
		directName: "Motilal Oswal Midcap Fund - Direct (G)",
	},
	"ICICI Pru Technology Fund - Regular (G)": {
		sharpe: 0.92,
		aumCr: 12000,
		directName: "ICICI Pru Technology Fund - Direct (G)",
	},
	"ICICI Pru Corporate Bond Fund - Regular (G)": {
		sharpe: 1.45,
		aumCr: 28000,
		directName: "ICICI Pru Corporate Bond Fund - Direct (G)",
	},
	"SBI Magnum Medium Duration Fund - Regular (G)": {
		sharpe: 1.2,
		aumCr: 10000,
		directName: "SBI Magnum Medium Duration Fund - Direct (G)",
	},
	"Axis Banking & PSU Debt Fund - Regular (G)": {
		sharpe: 1.38,
		aumCr: 18000,
		directName: "Axis Banking & PSU Debt Fund - Direct (G)",
	},
	"SBI Corporate Bond Fund - Regular (G)": {
		sharpe: 1.32,
		aumCr: 21000,
		directName: "SBI Corporate Bond Fund - Direct (G)",
	},
	"HDFC Short Term Debt Fund - Regular (G)": {
		sharpe: 1.28,
		aumCr: 16000,
		directName: "HDFC Short Term Debt Fund - Direct (G)",
	},
	"HDFC Balanced Advantage Fund - Regular (G)": {
		sharpe: 1.18,
		aumCr: 88000,
		directName: "HDFC Balanced Advantage Fund - Direct (G)",
	},
	"ICICI Pru Equity & Debt Fund - Regular (G)": {
		sharpe: 1.25,
		aumCr: 38000,
		directName: "ICICI Pru Equity & Debt Fund - Direct (G)",
	},
	"HDFC Hybrid Equity Fund - Regular (G)": {
		sharpe: 1.15,
		aumCr: 22000,
		directName: "HDFC Hybrid Equity Fund - Direct (G)",
	},
	"Kotak Equity Hybrid Fund - Regular (G)": {
		sharpe: 1.08,
		aumCr: 16000,
		directName: "Kotak Equity Hybrid Fund - Direct (G)",
	},
	"ICICI Pru Multi Asset Fund - Regular (G)": {
		sharpe: 1.35,
		aumCr: 48000,
		directName: "ICICI Pru Multi Asset Fund - Direct (G)",
	},
	"Quant Multi Asset Fund - Regular (G)": {
		sharpe: 1.28,
		aumCr: 3000,
		directName: "Quant Multi Asset Fund - Direct (G)",
	},
	"SBI Gold Fund - Regular (G)": {
		sharpe: 0.85,
		aumCr: 3000,
		directName: "SBI Gold Fund - Direct (G)",
	},
	"HDFC Gold Fund - Regular (G)": {
		sharpe: 0.82,
		aumCr: 2000,
		directName: "HDFC Gold Fund - Direct (G)",
	},
	"UTI Nifty 50 Index Fund - Regular (G)": {
		sharpe: 1.05,
		aumCr: 22000,
		directName: "UTI Nifty 50 Index Fund - Direct (G)",
	},
	"HDFC Index Fund - Nifty 50 Plan - Regular (G)": {
		sharpe: 1.06,
		aumCr: 18000,
		directName: "HDFC Index Fund - Nifty 50 Plan - Direct (G)",
	},
	"Nippon India Index Fund - Nifty 50 Plan - Regular (G)": {
		sharpe: 1.03,
		aumCr: 10000,
		directName: "Nippon India Index Fund - Nifty 50 Plan - Direct (G)",
	},
	"Motilal Oswal S&P 500 Index Fund - Regular (G)": {
		sharpe: 0.8,
		aumCr: 4500,
		directName: "Motilal Oswal S&P 500 Index Fund - Direct (G)",
	},
	"Motilal Oswal Nasdaq 100 FOF - Regular (G)": {
		sharpe: 0.76,
		aumCr: 6000,
		directName: "Motilal Oswal Nasdaq 100 FOF - Direct (G)",
	},
	"Kotak Nasdaq 100 FOF - Regular (G)": {
		sharpe: 0.75,
		aumCr: 3000,
		directName: "Kotak Nasdaq 100 FOF - Direct (G)",
	},
	"SBI Dynamic Bond Fund - Regular (G)": {
		sharpe: 1.1,
		aumCr: 3500,
		directName: "SBI Dynamic Bond Fund - Direct (G)",
	},
	"ICICI Pru Credit Risk Fund - Regular (G)": {
		sharpe: 0.95,
		aumCr: 8000,
		directName: "ICICI Pru Credit Risk Fund - Direct (G)",
	},
};
...
const SEBI_CATEGORY_MAP: Record<string, Record<string, string[]>> = {
	...
	gold_fof: {
		...
		moderate: ["Gold"],
		aggressive: ["Gold"],
		very_aggressive: ["Gold"],
	},
	silver_fof: {
		conservative: ["Silver"],
		moderate: ["Silver"],
		aggressive: ["Silver"],
		very_aggressive: ["Silver"],
	},
	index_fund: {
		conservative: ["Index Funds"],
		moderate: ["Index Funds"],
		aggressive: ["Index Funds"],
		very_aggressive: ["Index Funds"],
	},
	etf: {
		conservative: ["Other  ETFs"],
		moderate: ["Other  ETFs"],
		aggressive: ["Other  ETFs"],
		very_aggressive: ["Other  ETFs"],
	},
	international: {
		conservative: ["FoF Overseas"],
		moderate: ["FoF Overseas"],
		aggressive: ["FoF Overseas"],
		very_aggressive: ["FoF Overseas"],
	},
	us_markets: {
		conservative: ["FoF Overseas"],
		moderate: ["FoF Overseas"],
...
async function getDbFundsForCategory(
	wizardCategory: string,
	riskProfile: string,
): Promise<any[]> {
	let keywords =
		SEBI_CATEGORY_MAP[wizardCategory]?.[riskProfile] ||
	...
	if (wizardCategory === "debt" && keywords.length > 0) {
		const LONG_DUR_KEYWORDS = [
			"Gilt",
			"Dynamic Bond",
			"Medium to Long Duration",
			"Long Duration",
		];
		const SHORT_DUR_KEYWORDS = [
			"Short Duration",
			"Banking and PSU",
			"Liquid",
			"Overnight",
		...
		if (MARKET_SIGNALS.rateCycleDirection === "cut") {
			...
			keywords = [
				...keywords.filter((k) =>
					LONG_DUR_KEYWORDS.some((ld) => k.includes(ld)),
				),
				...keywords.filter(
					(k) =>
						!LONG_DUR_KEYWORDS.some((ld) => k.includes(ld)) &&
						!SHORT_DUR_KEYWORDS.some((sd) => k.includes(sd)),
				),
				...keywords.filter((k) =>
					SHORT_DUR_KEYWORDS.some((sd) => k.includes(sd)),
				),
	...
	try {
		...
		return unique.slice(0, 20).map((f) => ({
			...
			returns1Y:
				f.returns1y !== null ? Number.parseFloat(String(f.returns1y)) : null,
			returns3Y:
				f.returns3y !== null ? Number.parseFloat(String(f.returns3y)) : null,
			returns5Y:
				f.returns5y !== null ? Number.parseFloat(String(f.returns5y)) : null,
			expenseRatio:
				f.expenseRatio !== null
					? `${Number.parseFloat(String(f.expenseRatio)).toFixed(2)}%`
					: "1.5%",
			risk: f.riskLevel || "Moderate",
			productType: "mutual_fund",
			_dbCrisilScore:
				f.crisilScore !== null
					? Number.parseFloat(String(f.crisilScore))
					: null,
			_fromDb: true,
		}));
	} catch (err) {
		console.warn(
			`[AlphaEngine] DB fund fetch failed for ${wizardCategory}/${riskProfile}:`,
...
async function getDailyPicksForCategory(
	wizardCategory: string,
	riskProfile: string,
): Promise<any[]> {
	...
	try {
		...
		return picks.map((p) => ({
			...
			returns1Y:
				p.returnPct !== null ? Number.parseFloat(String(p.returnPct)) : null,
			returns3Y: null,
			returns5Y: null,
			...
			currentPrice:
				p.currentPrice !== null
					? Number.parseFloat(String(p.currentPrice))
					: undefined,
			targetPrice:
				p.targetPrice !== null
					? Number.parseFloat(String(p.targetPrice))
					: undefined,
			stopLoss:
				p.stoplossPrice !== null
					? Number.parseFloat(String(p.stoplossPrice))
					: undefined,
		...
		console.warn(
			`[AlphaEngine] daily_picks fetch failed for ${wizardCategory}:`,
			(err as Error).message,
		);
		return [];
	}
...
function computeFundCompositeScore(fund: any): number {
	...
	if (sharpe == null) {
		const crisil =
			typeof fund._dbCrisilScore === "number" ? fund._dbCrisilScore : null;
		sharpe = crisil != null ? 0.3 + (crisil / 5) * 1.2 : 1.0; // crisil 5→1.5, crisil 1→0.54
	}

	const aumCr =
		staticMetrics?.aumCr ??
		(typeof fund._aumCr === "number" ? fund._aumCr : 10000);
	const expRatioStr = fund.expenseRatio || "1.5%";
	const expRatioNum = Number.parseFloat(expRatioStr.replace("%", "")) || 1.5;

	// Weighted composite: 3Y returns 40% + 5Y returns 25% + sharpe*12 − expRatio*8
	let score = r3 * 0.4 + r5 * 0.25 + sharpe * 12 - expRatioNum * 8;
...
function calculateRequiredSIP(
	...
	const fvCurrentSavings = currentSavings * (1 + r) ** n;
	...
	const sip = (remainingFV * r) / (((1 + r) ** n - 1) * (1 + r));
...
function calculateFlatSIPCorpus(
	monthlySIP: number,
	years: number,
	expectedReturnPct: number,
): number {
	...
	return Math.round(monthlySIP * (((1 + r) ** n - 1) / r) * (1 + r));
}
...
class AgentProspectWizardService {
		...
		if (existingUser) {
			...
			if (existingUser.agentId) {
				const [agent] = await db
					...
					.limit(1);
				if (agent) {
					currentAgentName = [agent.firstName, agent.lastName]
						.filter(Boolean)
						.join(" ");
				}
			}
	...
	async checkForExistingProspect(
		agentId: string,
		pan?: string,
		email?: string,
		mobile?: string,
		...
		if (existingProspect) {
			return {
				...
				message:
					"You already have this person as a prospect. Please use the existing record.",
	...
	async requestClientMapping(
		...
		const [request] = await db
			.insert(agentClientMappingRequests)
			.values({
				agentId,
				agentName,
		...
		return {
			...
			message:
				"Your request has been submitted to admin for approval. You will be notified once it is processed.",
		};
	}
	...
	async processMappingRequest(
		...
		await db
			.update(agentClientMappingRequests)
			.set({
	...
	async createProspect(
		agentId: string,
		data: Omit<InsertProspectClient, "agentId">,
	): Promise<string | DuplicateCheckResult> {
		// Step 1: Check for existing client in the system
		const clientCheck = await this.checkForExistingClient(
			data.pan || undefined,
		...
		const prospectCheck = await this.checkForExistingProspect(
			agentId,
			data.pan || undefined,
			data.email || undefined,
			data.mobile || undefined,
	...
	async updateProspectRiskProfile(
		prospectId: string,
	...
	async updateProspectTaxProfile(
		prospectId: string,
		taxProfile: {
	...
	analyzePortfolio(
		...
		Object.keys(assetAllocation).forEach((key) => {
			assetAllocation[key].percentage =
				totalValue > 0
		...
		let riskScore = 50;
		const equityWeight =
			(assetAllocation.equity?.percentage || 0) +
		...
		if (numAssetClasses < 3) {
			recommendations.push({
				type: "warning",
				message:
					"Portfolio is under-diversified. Consider adding more asset classes.",
				action: "Diversify",
			});
		}
		...
		const sortedByValue = [...normalizedHoldings].sort(
	...
	private calculateVolatility(
		...
		holdings.forEach((h) => {
			...
			else if (category.includes("small") || category.includes("micro"))
				assetVolatility = 28;
			else if (category.includes("mid")) assetVolatility = 22;
			else if (category.includes("large") || category.includes("blue"))
				assetVolatility = 16;
			else if (category.includes("debt") || category.includes("bond"))
				assetVolatility = 5;
			else if (category.includes("gold") || category.includes("silver"))
				assetVolatility = 18;
			else if (category.includes("hybrid")) assetVolatility = 12;
			else if (category.includes("liquid") || category.includes("money"))
				assetVolatility = 2;
	...
	private calculateBeta(holdings: ProspectPortfolioHolding[]): number | null {
		...
		holdings.forEach((h) => {
			...
			if (productType === "pms" || productType === "aif") assetBeta = 1.2;
				...
				assetBeta = 0.0; // Gold has near-zero correlation
	...
	private calculateAssetAllocationBreakdown(
		holdings: ProspectPortfolioHolding[],
	...
	calculatePortfolioMetrics(
		...
		const assetAllocation =
			this.calculateAssetAllocationBreakdown(normalizedHoldings);

		const numAssetClasses = Object.values(assetAllocation).filter(
			(v) => v > 5,
		).length;
		const diversificationScore = Math.min(
			100,
			numAssetClasses * 15 + normalizedHoldings.length * 3 + 20,
		);
	...
	calculateProposedPortfolioMetrics(
		...
		const pseudoHoldings: ProspectPortfolioHolding[] = freshInvestments.map(
			(inv) => ({
		...
		const totalAmount = freshInvestments.reduce(
			(sum, inv) => sum + inv.suggestedAmount,
			0,
		);
		let weightedReturn = 0;
		freshInvestments.forEach((inv) => {
			const returnVal =
				Number.parseFloat(inv.expectedReturn.replace("%", "")) || 12;
	...
	async calculatePortfolioMetricsWithRealData(
		...
		const metricsPromises = normalizedHoldings.map(async (holding) => {
			...
			if (category.includes("small")) {
				...
				estVolatility = 20;
				estMaxDrawdown = 35;
			} else if (category.includes("large") || category.includes("equity")) {
				estVolatility = 15;
				estMaxDrawdown = 25;
			} else if (category.includes("debt") || category.includes("bond")) {
				estVolatility = 5;
		...
		const dataSource =
			useRealData && realDataCount >= normalizedHoldings.length / 2
				? "historical"
				: "estimated";

		// If we have real data, use it; otherwise fall back to estimation
		const baseMetrics = this.calculatePortfolioMetrics(
			normalizedHoldings,
			expectedReturn,
		);
		...
		if (useRealData) {
			...
			const effectiveSharpe =
				realVolatility > 0
					? (effectiveReturn - riskFreeRate) / realVolatility
					: null;
	...
	async generatePortfolioComparisonWithRealData(
		...
		normalizedHoldings.forEach((h) => {
			...
			currentExpectedReturn =
				currentExpectedReturn * (1 - weight) + assetReturn * weight;
		});

		// Use real historical data for current portfolio metrics
		const currentMetricsResult =
			await this.calculatePortfolioMetricsWithRealData(
				normalizedHoldings,
				currentExpectedReturn,
			);
		const proposedMetrics = this.calculateProposedPortfolioMetrics(
			freshInvestments,
			riskProfile,
		);

		const comparison = this.buildComparisonFromMetrics(
	...
	generatePortfolioComparison(
		...
		const addImprovement = (
			...
			const change =
				current !== null && proposed !== null ? proposed - current : null;
			const isImprovement =
				change !== null ? (higherIsBetter ? change > 0 : change < 0) : false;
			improvements.push({
				metric,
				current,
				proposed,
		...
		addImprovement(
			...
			proposedMetrics.expectedReturn,
			true,
		...
		addImprovement(
			...
			proposedMetrics.sharpeRatio,
			true,
			"Higher Sharpe means better risk-adjusted returns",
		);
		addImprovement(
			"Treynor Ratio",
			currentMetrics.treynorRatio,
			proposedMetrics.treynorRatio,
			true,
			"Higher Treynor means better return per unit of market risk",
		);
		addImprovement(
			"Sortino Ratio",
			currentMetrics.sortinoRatio,
			proposedMetrics.sortinoRatio,
			true,
			"Higher Sortino means better return for downside risk taken",
		);
		addImprovement(
			"Information Ratio",
			currentMetrics.informationRatio,
			proposedMetrics.informationRatio,
			true,
		...
		addImprovement(
			...
			proposedMetrics.diversificationScore,
			true,
	...
	async generateRebalancingRecommendations(
		...
		| {
				...
				taxSummary: any;
				effectiveFreshInvestment: number;
		  }
	> {
		// Normalize holdings to canonical format at entry point
		const normalizedHoldings = normalizeHoldings(holdings);
		...
		const totalValue =
			normalizedHoldings.reduce((sum, h) => sum + h.currentValue, 0) ||
			analysis.totalValue;
		...
		const fundNames = normalizedHoldings
			.filter((h) =>
				new Set([
					...
					"gold_fof",
					"silver_fof",
				]).has((h.productType || h.assetType || "").toLowerCase()),
			)
			.map((h) => (h.name || h.productName || "").trim())
			.filter(Boolean);

		const complianceResults =
			await complianceService.checkFundsCompliance(fundNames);
		...
		for (const holding of normalizedHoldings) {
			...
			if (compRes && !compRes.isCompliant) {
				console.log(
					`[SEBICompliance] Rebalancing: marking ${holdingName} for SELL — compliance_status=${compRes.status}`,
				);
				...
				recommendations.push({
					action: "SELL",
					productType:
						holding.productType || holding.assetType || "mutual_fund",
		...
		const defaultAllocations: Record<
			string,
			{
				equity: number;
				debt: number;
		...
		let targetAllocations =
			...
			Object.values(customAllocations).some((v) => (v as number) > 0)
				...
				: defaultAllocations[riskProfile.riskTolerance] ||
		...
		if (selectedCategories && selectedCategories.length > 0) {
			...
			if (totalSelectedAllocation === 0) {
				...
				console.log(
					"[Rebalancing] No allocations for selected categories, distributed equally",
				);
				...
				console.warn(
					`[Rebalancing] ⚠️ Agent allocations summed to ${totalSelectedAllocation}% (expected 100%). ` +
						...
						selectedCategories
							.map(
								(c) =>
									`${c}=${(newAllocations as any)[categoryToAllocationKey[c] || c]}%`,
							)
							.join(", "),
				);
				const scaleFactor = 100 / totalSelectedAllocation;
				let assigned = 0;
				const selectedKeys = selectedCategories.map(
					(cat) => categoryToAllocationKey[cat] || cat,
				);
				selectedKeys.forEach((key, idx) => {
					if (idx === selectedKeys.length - 1) {
						...
						const scaled = Math.round(
							((newAllocations as any)[key] || 0) * scaleFactor,
						);
			...
			console.log(
				"[Rebalancing] Filtered to selected categories:",
				selectedCategories
					.map(
						(c) =>
							`${c}: ${(targetAllocations as any)[categoryToAllocationKey[c] || c]}%`,
					)
					.join(", "),
			);
		}
		...
		console.log(
			"[Rebalancing] Target allocations:",
			JSON.stringify(targetAllocations),
		);
		...
		const categorizeHolding = (h: ProspectPortfolioHolding): string => {
			...
			if (type === "reit" || name.includes("reit") || category.includes("reit"))
				return "reit";
			if (
				type === "invit" ||
				name.includes("invit") ||
				name.includes("infra trust")
			)
				return "invit";
			...
			if (
				type === "ncd" ||
				name.includes("ncd") ||
				(type === "bond" && !category.includes("fund"))
			)
				return "bonds";
			...
			if (name.includes("silver") || category.includes("silver"))
				return "silver";
			...
			if (type === "stock" || type === "equity" || type === "share")
			...
			if (
				...
				name.includes("pre-ipo") ||
				category.includes("unlisted")
			)
			...
			if (type === "mutual_fund" || type === "mf") {
				...
				if (category.includes("equity") || name.includes("equity"))
					return "equity";
		...
		const currentByCategory: Record<
			string,
			{ value: number; holdings: ProspectPortfolioHolding[] }
		> = {
		...
		console.log(
			"[Rebalancing] Current by category:",
		...
		const governanceConfig = await db
			.select()
			.from(rebalanceGovernanceConfig)
			.where(
				eq(rebalanceGovernanceConfig.riskProfile, riskProfile.riskTolerance),
			)
			.limit(1);
		const policy = governanceConfig[0] || {
			toleranceBandPct: 5,
			minTradeValueInr: 5000,
			brokerageRatePct: 0.03,
			maxTacticalWeightPct: 10,
			targetVolatilityPct: 15,
			riskToleranceBandPct: 3,
			maxCategoriesInBuy: 3,
		};
		console.log(
			"[Rebalancing] Governance policy loaded:",
			JSON.stringify({
				toleranceBandPct: policy.toleranceBandPct,
				minTradeValueInr: policy.minTradeValueInr,
				brokerageRatePct: policy.brokerageRatePct,
				targetVolatilityPct: policy.targetVolatilityPct,
			}),
		);
		...
		const existingHoldingNames = new Set(
			normalizedHoldings
				.map((h) => (h.name || h.productName || "").toLowerCase().trim())
				.filter(Boolean),
		);
		const existingHoldingIsins = new Set(
			normalizedHoldings
				.map((h) => (h.isin || "").toUpperCase().trim())
				.filter(Boolean),
		);
		...
		for (const dm of driftMetrics) {
			...
			const holdingsToReduce = [...dm.holdings].sort(
				(a, b) => b.currentValue - a.currentValue,
			);
			...
			for (const holding of holdingsToReduce) {
				...
				const isExistingHolding =
					(holdingName && existingHoldingNames.has(holdingName)) ||
				...
				if (isExistingHolding) {
					const alreadyRecommended = recommendations.find(
						(r) =>
							r.productName ===
							(holding.name || holding.productName || "Unknown"),
					);
					...
					if (!alreadyRecommended) {
						if (needsPartialReduce) {
							recommendations.push({
								action: "HOLD",
								productType:
									holding.productType || holding.assetType || "other",
					...
					console.log(
						`[Rebalancing] Existing holding: ${holding.name || holding.productName} — ${needsPartialReduce ? `HOLD with partial reduce ₹${reduceAmount}` : reduceAmount >= 1000 ? `Full REDUCE ₹${holding.currentValue}` : "HOLD (reduce too small)"}`,
					);
					continue;
				}
				...
				const taxInfo =
					await proposalCapitalGainsService.calculateHoldingTaxAsync({
						...
						investedAmount:
							(holding as any).investedAmount || reduceAmount * 0.85,
						purchaseDate:
							holding.purchaseDate || (holding as any).firstPurchaseDate,
						quantity: holding.quantity,
					});

				const reducePurchaseDate =
					holding.purchaseDate || (holding as any).firstPurchaseDate || null;
				recommendations.push({
					action: "REDUCE",
					...
					investedAmount:
						(holding as any).investedAmount || reduceAmount * 0.85,
					suggestedValue: isPartialReduce
						? holding.currentValue - reduceAmount
						: 0,
					changeAmount: -reduceAmount,
		...
		for (const dm of driftMetrics) {
			if (
				dm.finalAction !== "HOLD" &&
				dm.finalAction !== "HOLD_COST_FILTER" &&
				dm.finalAction !== "HOLD_RISK_LIMIT"
			)
				continue;
			if (dm.currentValue === 0 || dm.targetPercent === 0) continue;

			const alreadyHasRec = recommendations.some((r) => {
				return dm.holdings.some(
					(h) => r.productName === (h.name || h.productName),
				);
			});
			...
			for (const holding of dm.holdings) {
				...
				const holdAction: "HOLD" | "HOLD_COST_FILTER" | "HOLD_RISK_LIMIT" =
					dm.finalAction as any;
		...
		for (const h of normalizedHoldings) {
			...
			if (
				...
				const existing = recommendations.find(
					(r) => r.productName === (h.name || h.productName),
				);
		...
		if (analysis.underperformers && analysis.underperformers.length > 0) {
			const normalizedUnderperformers = normalizeHoldings(
			...
			if (selectedCategories && selectedCategories.length > 0) {
				...
				console.log(
					"[Rebalancing] Filtering SWITCH recs to categories:",
					Array.from(allowedSwitchCategories),
				);
			}
			...
			for (const underperformer of normalizedUnderperformers.slice(0, 3)) {
				...
				if (!existing && underperformer.currentValue > 5000) {
					...
					if (
						...
						!allowedSwitchCategories.has(category)
					) {
						console.log(
							`[Rebalancing] Skipping SWITCH for ${upName} - category ${category} not in selected categories`,
						);
						continue;
					}

					const targetFunds = await getFundsFromCategorySanitizedAsync(
						category,
						riskProfile.riskTolerance,
					);
					const eligibleTargets = await selectEligibleFundsForLumpsum(
						targetFunds,
						1,
					);
					...
					const taxInfo =
						await proposalCapitalGainsService.calculateHoldingTaxAsync({
							name:
								underperformer.name || underperformer.productName || "Unknown",
							productType:
								underperformer.productType ||
								underperformer.assetType ||
								"mutual_fund",
							...
							investedAmount:
								(underperformer as any).investedAmount ||
								underperformer.currentValue * 0.85,
							purchaseDate:
								underperformer.purchaseDate ||
								(underperformer as any).firstPurchaseDate,
							quantity: underperformer.quantity,
						});

					const switchPurchaseDate =
						underperformer.purchaseDate ||
						(underperformer as any).firstPurchaseDate ||
						null;
					recommendations.push({
						action: "SWITCH",
						productType:
							underperformer.productType || underperformer.assetType || "other",
						productName:
							underperformer.name || underperformer.productName || "Unknown",
						isin: underperformer.isin,
						category: underperformer.category,
		...
		if (
			...
			categories.forEach((category) => {
				...
				const targetPercent =
					targetAllocations[category as keyof typeof targetAllocations] || 0;
				...
				if (gap > 2 && targetPercent > 0) {
					...
					suggestedAmounts.push({
						category,
						amount: Math.max(suggestedForCategory, 5000),
					});
				}
			});
			if (suggestedAmounts.length > 0) {
				effectiveFreshInvestment = suggestedAmounts.reduce(
					(sum, s) => sum + s.amount,
					0,
				);
				// Minimum ₹10,000 total, maximum 30% of portfolio value
				effectiveFreshInvestment = Math.max(effectiveFreshInvestment, 10000);
				effectiveFreshInvestment = Math.min(
					effectiveFreshInvestment,
					totalValue * 0.3,
				);
				console.log(
					"[Rebalancing] Auto-calculated fresh investment for selected categories:",
					effectiveFreshInvestment,
					"from gaps:",
		...
		console.log(
			"[Rebalancing] Trade Netting: totalReduceAmount=",
			totalReduceAmount,
			", totalSellAmount=",
			totalSellAmount,
			...
			effectiveFreshInvestment,
			", totalDeployable=",
			totalDeployableBudget,
		);

		const increaseMetrics = driftMetrics.filter(
			(dm) => dm.finalAction === "INCREASE",
		);
		const totalIncreaseGap = increaseMetrics.reduce(
			(sum, dm) => sum + Math.abs(dm.drift),
			0,
		);

		for (const dm of increaseMetrics) {
			const proportion =
				totalIncreaseGap > 0 ? Math.abs(dm.drift) / totalIncreaseGap : 0;
			netFlows[dm.category] = totalReduceAmount * proportion;
		}

		console.log(
			"[Rebalancing] Net flows by category:",
			JSON.stringify(netFlows),
		);
		...
		if (totalDeployableBudget > 2000) {
			...
			if (selectedCategories && selectedCategories.length > 0) {
				...
				console.log(
					"[Rebalancing] Filtering BUY recs to selected categories:",
			...
			const numCategoriesToFund = Math.min(
				underweightCategories.length,
				policy.maxCategoriesInBuy ?? 3,
			);
			const categoriesToFund = underweightCategories.slice(
				0,
				numCategoriesToFund,
			);
			...
			for (const { category, gap, targetPercent } of categoriesToFund) {
				...
				const proportion =
					totalGap > 0 ? gap / totalGap : 1 / numCategoriesToFund;
				...
				const actualAmount = Math.min(
					Math.max(buyAmount, nettedAmount),
					remainingToAllocate,
				);

				if (actualAmount < 2000) continue;

				const categoryFunds = await getFundsFromCategorySanitizedAsync(
					category,
					riskProfile.riskTolerance,
				);
				// Fetch up to 3 candidates so the concentration filter below has alternatives to pick from
				const eligibleForLumpsum = await selectEligibleFundsForLumpsum(
					categoryFunds,
					3,
				);
				...
				const normalizeForConcentrationCheck = (name: string): string =>
					(name || "")
						.toLowerCase()
						.replace(
							/\s+(ltd\.?|limited|inc\.?|corporation|corp\.?|pvt\.?|private|llp|llc|co\.)$/i,
							"",
						)
						.replace(/[.\-,&]/g, "")
						.replace(/\s+/g, "")
				...
				const safeForIncrease = eligibleForLumpsum.filter((fund) => {
					...
					const alreadyConcentrated = normalizedHoldings.some((h) => {
						const holdNorm = normalizeForConcentrationCheck(
							h.name || (h as any).productName || "",
						);
						const holdValue = h.currentValue || 0;
						const matchesName = holdNorm && fundNorm && holdNorm === fundNorm;
						const matchesIsin =
							fund.isin && (h as any).isin && fund.isin === (h as any).isin;
						return (
							(matchesName || matchesIsin) &&
							totalValue > 0 &&
							holdValue / totalValue > 0.25
						);
					});
					if (alreadyConcentrated) {
						console.log(
							`[INCREASE] Skipping "${fund.name}" — already at >25% concentration in portfolio`,
						);
					}
				...
				if (fundToRecommend) {
					const isAutoCalculated =
						freshInvestmentAmount === 0 && effectiveFreshInvestment > 0;
					const fundingSource =
						totalSellAmount > 0 ? "sell_proceeds" : "fresh_investment";
					const fundingDescription =
						totalSellAmount > 0 && effectiveFreshInvestment > 0
		...
		//   3. High-Gain Alert        — >50% unrealized gain on sizeable position
		{
			...
			for (const holding of normalizedHoldings) {
				...
				try {
						...
						await proposalCapitalGainsService.calculateHoldingTaxAsync({
							...
							purchaseDate:
								...
								(holding.transactionDate
									? String(holding.transactionDate)
									: "") ||
								"",
							investedAmount:
								holding.investedValue || holding.purchaseValue || 0,
					...
					if (
						taxInfo.taxType === "LTCG" &&
						unrealizedGain > LTCG_EXEMPTION_LIMIT
					) {
					...
					// Trigger 2: Concentration Risk (> 25% of portfolio)
						...
						bookAmount = Math.round(currentValue * 0.2); // trim 20% to reduce concentration
					...
					const isLTCGExemptBucket =
						taxInfo.taxType === "LTCG" && bookedGain <= LTCG_EXEMPTION_LIMIT;
					...
					const passiveHoldActions = new Set([
						"HOLD",
						"HOLD_RISK_LIMIT",
						"HOLD_COST_FILTER",
					]);
					const existingPassiveIdx = recommendations.findIndex(
						(r) =>
							r.productName === holdingName &&
							passiveHoldActions.has(r.action as string),
					);
					if (existingPassiveIdx !== -1) {
						...
						console.log(
							`[ProfitBook] Replaced passive ${replacedAction} with PROFIT_BOOK for ${holdingName}`,
						);
					}

					const pbPurchaseDate =
						holding.purchaseDate || (holding as any).firstPurchaseDate || null;
					recommendations.push({
						action: "PROFIT_BOOK",
						productType: holding.productType || holding.assetType || "other",
						...
						investedAmount:
							(holding as any).investedAmount || currentValue * 0.85,
						currentValue,
						...
						taxImplications: {
							...
							taxRate: isLTCGExemptBucket
								? "0% (within ₹1.25L exemption)"
								: `${((taxInfo.applicableTaxRate || 0) * 100).toFixed(1)}%`,
							purchaseDate: pbPurchaseDate,
							taxRateSource: "LOCAL_FALLBACK",
							grandfatheringApplied: taxInfo.grandfatheringApplied,
					...
					console.log(
						`[ProfitBook] ${profitBookLabel} suggested for ${holdingName}: redeem ₹${formatAmount(bookAmount)}, gain ₹${formatAmount(bookedGain)}, tax ₹${formatAmount(taxOnBooking)}`,
					);
				} catch (e: any) {
		...
		try {
			if (auditEntries.length > 0) {
				...
				console.log(
					"[Rebalancing] Audit log: persisted",
					auditEntries.length,
					"decision entries",
				);
			}
		...
		console.log(
			...
			"recommendations:",
			recommendations
				.map((r) => `${r.action}: ${r.productName} (${r.changeAmount})`)
				.join(", "),
		);
		...
		console.log(
			"[Signal Orchestrator] POTD cross-reference skipped — POTD excluded from rebalancing proposals",
		);
		...
		if (planUpgrades.length > 0) {
			console.log(
				`[AlphaEngine] Plan upgrades found: ${planUpgrades.length} (Regular→Direct or Dividend→Growth)`,
			);
		...
		const harvestOpportunities = await this.scanTaxLossHarvestingOpportunities(
			holdings,
			recommendations,
		);
		if (harvestOpportunities.length > 0) {
			console.log(
				`[TaxHarvest] Adding ${harvestOpportunities.length} harvesting recommendations`,
			);
		...
		// vs "ETERNAL LIMITED".
		{
			...
			if (profitBookNames.size > 0) {
				const conflictingIncreases = recommendations.filter(
					(r) =>
						r.action === "INCREASE" &&
						profitBookNames.has(normalizeHoldingName(r.productName)),
				);
				if (conflictingIncreases.length > 0) {
					conflictingIncreases.forEach((r) => {
						...
						console.log(
							`[Dedup] Removed contradictory INCREASE for "${r.productName}" — same holding has PROFIT_BOOK recommendation`,
						);
					});
				}
			}
		...
		const sellSwitchRecs = recommendations.filter(
			(r) =>
				r.action === "SELL" ||
				r.action === "SWITCH" ||
				r.action === "REDUCE" ||
				r.action === "PROFIT_BOOK",
		);
		const harvestRecs = recommendations.filter(
			(r) => r.action === "TAX_LOSS_HARVEST",
		);
	 ...
	 */
	private scanPlanUpgradeOpportunities(
		holdings: ProspectPortfolioHolding[],
	): RebalanceRecommendation[] {
		...
		for (const holding of holdings) {
			...
			if (isRegularPlan && !isDividendPlan) {
				...
				const annualSaving = Math.round(
					(currentVal * REGULAR_EXPENSE_PREMIUM) / 100,
				);
				...
				results.push({
					action: "SWITCH",
					productType:
						(holding as any).productType || holding.assetType || "mutual_fund",
					productName: name,
			...
			if (isDividendPlan) {
				const growthName = name
					.replace(/\b(dividend|idcw|div)\b/gi, "Growth")
					.trim();
				const currentVal = holding.currentValue || 0;
	...
	private async scanTaxLossHarvestingOpportunities(
		...
		const alreadyActioned = new Set(
			existingRecs
				.filter((r) =>
					["SELL", "REDUCE", "SWITCH", "PROFIT_BOOK"].includes(r.action),
				)
		...
		for (const holding of holdings) {
			...
			const purchaseDateStr =
				holding.purchaseDate || holding.firstPurchaseDate || "";
			let holdingDays = 0;
			if (purchaseDateStr) {
				try {
					...
					if (!Number.isNaN(pDate.getTime())) {
						holdingDays = Math.floor(
							(now.getTime() - pDate.getTime()) / 86400000,
						);
					}
				} catch {
					/* ignore */
			...
			const isMutualFund =
				["mutual_fund", "mf", "sip"].includes(assetType) ||
			...
			const exitLoadPct =
				isMutualFund && isEquity && holdingDays < 365 ? 0.01 : 0;
			...
			const rationale = [
				...
				exitLoadAmount > 0
					? `Exit load: ₹${Math.round(exitLoadAmount).toLocaleString("en-IN")}.`
					: null,
			...
			results.push({
				...
				rationale,
				priority:
					netHarvestBenefit > 50000
						? "high"
						: netHarvestBenefit > 20000
							? "medium"
							: "low",
		...
		console.log(
			`[TaxHarvest] Identified ${results.length} harvesting opportunities from ${holdings.length} holdings`,
		);
		return results;
	}
	 ...
	 */
	private async calculateTaxSummary(
		recommendations: any[],
		harvestRecs: any[] = [],
	): Promise<any> {
		...
		const taxResults = await Promise.allSettled(
			recommendations.map(async (rec) => {
				const sellAmount =
					Math.abs(rec.changeAmount || 0) || Math.abs(rec.currentValue || 0);
				...
				if (
					existingTax?.taxType &&
					(existingTax.taxRateSource != null ||
						existingTax.holdingPeriodDays != null)
				) {
					console.log(
						`[TaxSummary] Re-using pre-computed tax for ${rec.productName}: ${existingTax.taxType} (${existingTax.holdingPeriodDays ?? "?"} days, source: ${existingTax.taxRateSource || "pre-computed"})`,
					);
					return {
						rec,
						tax: {
							...
							estimatedTaxWithCess:
								existingTax.estimatedTaxWithCess ??
								existingTax.estimatedTax ??
								0,
							unrealizedGain:
								existingTax.unrealizedGain ?? existingTax.estimatedGain ?? 0,
						},
					};
				}
				...
				try {
					const result =
						await proposalCapitalGainsService.calculateHoldingTaxWithSandboxAPI(
							{
								name: rec.productName || "Unknown",
								productType:
									(rec as any).productType ||
									(rec as any).category ||
									"mutual_fund",
					...
					console.log(
						`[TaxSummary] ${rec.productName}: ${result.taxType} tax ₹${Math.round(result.estimatedTaxWithCess)} [${result.taxRateSource}]`,
					);
					return { rec, tax: result };
				} catch (err: any) {
					console.warn(
						`[TaxSummary] Tax calc failed for ${rec.productName}: ${err.message}`,
					);
		...
		for (const outcome of taxResults) {
			...
			if (taxSource === "SANDBOX_API") sandboxCount++;
			else localCount++;
		...
		const netRebalancingCostAfterHarvest = Math.max(
			0,
			netRebalancingCost - totalHarvestBenefit,
		);
		...
		return {
			...
			netRebalancingCostAfterHarvest: Math.round(
				netRebalancingCostAfterHarvest,
			),
			taxLossHarvestingOpportunity: Math.round(
				taxLossHarvestingOpportunity + harvestedLosses,
			),
	...
	async generateFreshInvestmentSuggestions(
		...
		const existingPortfolioValue = existingHoldings.reduce(
		...
		const hasValidCustomAllocations =
			customAllocations &&
			Object.values(customAllocations).some((v) => (v as number) > 0);
		...
		if (totalPortfolioValue < MIN_PMS && allocations.pms > 0) {
			console.log(
				`[Agent Wizard] PMS allocation removed - portfolio value ${totalPortfolioValue} < min ${MIN_PMS}`,
			);
			allocations.pms = 0;
		}
		if (totalPortfolioValue < MIN_AIF && allocations.aif > 0) {
			console.log(
				`[Agent Wizard] AIF allocation removed - portfolio value ${totalPortfolioValue} < min ${MIN_AIF}`,
			);
			allocations.aif = 0;
		}
		...
		if (!hasValidCustomAllocations && isPythonServiceConfigured()) {
			try {
				const horizonYears =
					riskProfile.investmentHorizon === "long_term"
						? 10
						: riskProfile.investmentHorizon === "medium_term"
							? 5
							: 3;
				const taxBracketStr =
					(riskProfile.taxBracket ?? 20) >= 30
						? "high"
						: (riskProfile.taxBracket ?? 20) >= 20
							? "medium"
							: "low";
				const pyAlloc = await callPython<any>(
				...
				if (pyAlloc?.allocations?.length) {
					...
					let eq = 0,
						...
						alt = 0,
						corp = 0;
					for (const a of pyAlloc.allocations as Array<{
						assetClass: string;
						weight: number;
					}>) {
						...
						switch (a.assetClass) {
							...
							case "mid_cap_equity":
							case "small_cap_equity":
								eq += w;
								break;
							case "international_equity":
								intl += w;
								break;
					...
					// Real assets
					allocations.reit = Math.round(re * 0.6);
					allocations.invit = Math.round(re * 0.4);
					// Alternatives (still subject to PMS/AIF eligibility above)
					allocations.aif = Math.round(alt * 0.5);
					allocations.pms = Math.round(alt * 0.5);
					// Commodities
					allocations.gold = gold;
					allocations.silver = (allocations as any).silver ?? 0;
					console.log(
						"[AlphaEngine] Python MVO allocations applied:",
						JSON.stringify({
							equity: allocations.equity,
							index: allocations.index,
							hybrid: allocations.hybrid,
							debt: allocations.debt,
							bonds: allocations.bonds,
							gold: allocations.gold,
							reit: allocations.reit,
							invit: allocations.invit,
							us: allocations.us_markets,
							sharpe: pyAlloc.sharpeRatio,
						}),
					);
				}
			} catch (e: any) {
				console.warn(
					"[AlphaEngine] Python MVO unavailable, using TS defaults:",
					e?.message,
				);
			}
		}
		...
		console.log(
			"[Agent Wizard] Using allocations:",
			JSON.stringify(allocations),
			"Custom:",
			hasValidCustomAllocations,
		);
		console.log(
			"[Agent Wizard] Total portfolio value:",
			totalPortfolioValue,
			"PMS eligible:",
			totalPortfolioValue >= MIN_PMS,
			"AIF eligible:",
			totalPortfolioValue >= MIN_AIF,
		);
		...
		if (totalAllocation === 0 && filteredAllocations.length > 0) {
			...
			filteredAllocations = filteredAllocations.map((a, idx) => ({
				...
				allocation:
					idx === 0
						? equalAllocation + (100 % filteredAllocations.length)
						: equalAllocation,
			}));
			totalAllocation = 100;
			console.log(
				"[Agent Wizard] No allocations set for selected categories, distributing equally:",
				filteredAllocations
					.map((a) => `${a.category}: ${a.allocation}%`)
					.join(", "),
			);
		}
		...
		if (riskProfile.liquidityNeeds === "high") {
			...
			const removed = filteredAllocations.filter((a) =>
				illiquidCategories.has(a.category),
			);
			if (removed.length > 0) {
				console.log(
					`[AlphaEngine] Illiquidity mismatch: removing ${removed.map((r) => r.category).join(", ")} due to liquidityNeeds=high`,
				);
				filteredAllocations = filteredAllocations.filter(
					(a) => !illiquidCategories.has(a.category),
				);
				...
				if (sum > 0 && sum !== 100) {
					...
					filteredAllocations = filteredAllocations.map((a) => ({
						...a,
						allocation: Math.round(a.allocation * sf),
					}));
				}
			}
		}
		...
		const MAX_TOTAL_INSTRUMENTS =
			investmentAmount <= 500000 ? 6 : investmentAmount <= 2500000 ? 8 : 10;
		console.log(
			`[AlphaEngine] Max instruments cap: ${MAX_TOTAL_INSTRUMENTS} for ₹${investmentAmount} portfolio`,
		);
		...
		for (const h of existingHoldings) {
			...
			for (const kw of subCatKeywords) {
				if (name.includes(kw) || cat.includes(kw))
					existingSubcategoryKeywords.add(kw);
			}
		}
		if (existingSubcategoryKeywords.size > 0) {
			console.log(
				`[AlphaEngine] Overlap guard active. Existing subcategories: ${[...existingSubcategoryKeywords].join(", ")}`,
			);
		}
		...
		for (const { category, allocation } of filteredAllocations) {
			...
			if (suggestions.length >= MAX_TOTAL_INSTRUMENTS) {
				console.log(
					`[AlphaEngine] Cap reached (${MAX_TOTAL_INSTRUMENTS} instruments). Skipping remaining categories.`,
				);
				break;
			}
			...
			if (isNonMFCategory) {
				...
				const picks = await getDailyPicksForCategory(
					category,
					riskProfile.riskTolerance,
				);
				if (picks.length > 0) {
					console.log(
						`[AlphaEngine] ${category}: ${picks.length} AI daily_picks loaded (primary)`,
					);
					categoryFunds = picks;
				}
				// Step 2: Fallback to hardcoded catalog if no live picks
				if (categoryFunds.length === 0) {
					categoryFunds = await getFundsFromCategorySanitizedAsync(
						category,
						riskProfile.riskTolerance,
					);
					console.log(
						`[AlphaEngine] ${category}: ${categoryFunds.length} catalog funds loaded (fallback)`,
					);
				}
			} else {
				// Step 1: Query mutual_funds DB directly (15K+ real schemes, sorted by 3Y returns)
				const dbFunds = await getDbFundsForCategory(
					category,
					riskProfile.riskTolerance,
				);
				if (dbFunds.length >= 3) {
					console.log(
						`[AlphaEngine] ${category}: ${dbFunds.length} DB funds loaded (primary)`,
					);
					categoryFunds = dbFunds;
				} else {
					// Step 2: Fallback to hardcoded catalog (enriched with live returns from mfapi)
					const catalogFunds = await getFundsFromCategorySanitizedAsync(
						category,
						riskProfile.riskTolerance,
					);
					categoryFunds = [
					...
					console.log(
						`[AlphaEngine] ${category}: ${dbFunds.length} DB + ${catalogFunds.length} catalog funds (hybrid)`,
					);
				}
			}
				...
				try {
					...
					if (mlResult?.results?.length) {
						...
						categoryFunds = categoryFunds.map((f: any, i: number) => ({
							...f,
							_mlScore: scoreMap.get(i) ?? 0,
						}));
						// Sort by ML predicted return (descending) — overrides composite sort
						categoryFunds.sort(
							(a: any, b: any) => (b._mlScore ?? 0) - (a._mlScore ?? 0),
						);
						console.log(
							`[AlphaEngine] ML scoring applied for ${category}: top fund = ${categoryFunds[0]?.name}`,
						);
					}
				} catch (e: any) {
					console.warn(
						`[AlphaEngine] ML scoring skipped for ${category}:`,
						e?.message,
					);
				}
			}
			...
			const scoredFunds = categoryFunds
				.map((f: any) => ({
					...f,
					_compositeScore: computeFundCompositeScore(f),
				}))
				.sort((a: any, b: any) =>
					b._mlScore !== undefined || a._mlScore !== undefined
						? (b._mlScore ?? 0) - (a._mlScore ?? 0) ||
			...
			const taxFilteredFunds = highTaxClient
				? scoredFunds.filter(
						(f: any) => !/\b(dividend|idcw|div)\b/i.test(f.name || ""),
					)
				: scoredFunds;
			...
			const fundsToUse = await selectEligibleFundsForLumpsum(
				taxFilteredFunds,
				2,
			);
			...
			const amcFiltered = fundsToUse.filter((f: any) => {
				...
				if (count >= MAX_FUNDS_PER_AMC) {
					console.log(
						`[AlphaEngine] AMC cap: skipping ${f.name} (${amc} already has ${count} funds)`,
					);
					return false;
				}
				return true;
			...
			finalFunds.forEach((fund: any, index: number) => {
				...
				if (seenProductNames.has(nameKey)) {
					console.log(
						`[AlphaEngine] Dedup: skipping duplicate "${fund.name}" in category ${category}`,
					);
					return;
				}
				...
				if (existingSubcategoryKeywords.size > 0) {
					...
					const overlapping = Array.from(existingSubcategoryKeywords).some(
						(kw) => fundNameLower.includes(kw) || fundCatLower.includes(kw),
					);
					if (overlapping) {
						console.log(
							`[AlphaEngine] Overlap guard: skipping "${fund.name}" — subcategory already in existing holdings`,
						);
						return;
					}
				}
				...
				const alphaMetrics = FUND_ALPHA_METRICS[fund.name] || {
					sharpe: null,
					aumCr: null,
				};
				...
				const realReturn3Y =
					r3 !== null
						? Number.parseFloat((r3 - INFLATION_RATE).toFixed(2))
						: null;
				const compositeScore =
					fund._compositeScore !== undefined
						? Number.parseFloat(fund._compositeScore.toFixed(1))
						: null;
				const isElss =
					(fund.category || "").toLowerCase().includes("elss") ||
					(fund.name || "").toLowerCase().includes("elss");
				const taxNote =
					highTaxClient && isElss
						? ` ELSS: ₹1.5L/year 80C deduction benefit for 30% slab.`
						: "";

				const sharpeStr = alphaMetrics.sharpe
					? `Sharpe: ${alphaMetrics.sharpe} | `
					: "";
				const aumStr = alphaMetrics.aumCr
					? `AUM: ₹${alphaMetrics.aumCr.toLocaleString("en-IN")}Cr | `
					: "";
				const realReturnStr =
					realReturn3Y !== null
						? `Real Return (inflation-adj): ${realReturn3Y}% | `
						: "";
				...
				const targetPriceStr = fund.targetPrice
					? ` Target: ₹${fund.targetPrice.toLocaleString("en-IN")}.`
					: "";
				const stopLossStr = fund.stopLoss
					? ` Stop-loss: ₹${fund.stopLoss.toLocaleString("en-IN")}.`
					: "";
				const confidenceStr = fund.confidence
				...
				suggestions.push({
					...
					highlights: isFromPicks
						? [
								...
								...(fund.currentPrice
									? [
											`Current Price: ₹${fund.currentPrice.toLocaleString("en-IN")}`,
										]
									: []),
								...(fund.targetPrice
									? [
											`Target: ₹${fund.targetPrice.toLocaleString("en-IN")} (${fund.currentPrice ? Math.round(((fund.targetPrice - fund.currentPrice) / fund.currentPrice) * 100) : "?"}% upside)`,
										]
									: []),
								...(fund.stopLoss
									? [`Stop-loss: ₹${fund.stopLoss.toLocaleString("en-IN")}`]
						...
						: [
								...
								`Risk: ${fund.risk}`,
								...(alphaMetrics.sharpe
									? [`Sharpe Ratio: ${alphaMetrics.sharpe}`]
									: []),
								...(realReturn3Y !== null
									? [
											`Real Return: ${realReturn3Y}% (after ${INFLATION_RATE}% inflation)`,
										]
									: []),
							],
					fundMetrics: {
						...
						aum:
							fund.aum ||
							`₹${alphaMetrics.aumCr ? alphaMetrics.aumCr.toLocaleString("en-IN") + "Cr" : "N/A"}`,
					...
					allocationPercentage: Math.round(
						(fundAmount / investmentAmount) * 100,
					),
		...
		if (suggestions.length === 0 && categories.length > 0) {
			console.log(
				"[Agent Wizard] No primary suggestions, trying fallback for categories:",
				categories,
			);
			...
			for (let i = 0; i < categories.length; i++) {
				...
				const allocation =
					i === 0
						? equalAllocationFallback + (100 % categories.length)
						: equalAllocationFallback;
				const categoryAmount = Math.round(
					(allocation / 100) * investmentAmount,
				);
				...
				for (const risk of riskLevels) {
					...
					const eligible = await selectEligibleFundsForLumpsum(
						categoryFunds,
						2,
					);
			...
			console.log(
				"[Agent Wizard] Fallback generated",
				suggestions.length,
				"suggestions",
			);
		}
		...
		if (suggestions.length === 0) {
			console.log(
				"[Agent Wizard] Warning: No suggestions generated for categories:",
				categories,
			);
		}
		...
		const stpRecommended =
			investmentAmount >= STP_TRIGGER_LUMPSUM &&
		...
		if (stpRecommended) {
			...
			console.log(
				`[AlphaEngine] STP recommended: ₹${investmentAmount} lumpsum → ₹${monthlyInstalment}/month × ${stpMonths}M (Nifty PE: ${MARKET_SIGNALS.niftyPE}, equity allocation: ${totalEquityAllocation}%)`,
			);
			// Tag all equity suggestions with stpRecommended flag
			suggestions.forEach((s: any) => {
				if (
					["equity", "index_fund", "etf"].includes(
						(s.category || "").toLowerCase(),
					) ||
					["equity", "index", "etf"].includes(
	...
	private calculateWeightedReturn(
		freshInvestments: FreshInvestmentSuggestion[],
		riskProfile: ProspectRiskProfile,
	): number {
		...
		freshInvestments.forEach((inv: any) => {
			...
			const returnVal = Number.parseFloat(returnStr.replace("%", "")) || 12;
	...
	async createCombinedProposal(
		...
		const rebalancing: RebalanceRecommendation[] = (
			Array.isArray(rebalancingResult)
				? rebalancingResult
				: (rebalancingResult as any).recommendations
		) as RebalanceRecommendation[];
		const taxSummary = Array.isArray(rebalancingResult)
			? null
			: (rebalancingResult as any).taxSummary;
		// Use auto-calculated fresh investment if engine determined one (e.g. when all holdings are HOLD)
		const effectiveFresh =
			!Array.isArray(rebalancingResult) &&
			(rebalancingResult as any).effectiveFreshInvestment
				? (rebalancingResult as any).effectiveFreshInvestment
				: freshInvestmentAmount;
		...
		const remainingSellProceeds = Math.max(
			0,
			sellProceeds - buyAllocatedFromSellProceeds,
		);
		const remainingFreshInvestment = Math.max(
			0,
			effectiveFresh - increaseAllocatedFromFresh,
		);
		const totalDeployableAmount =
			remainingFreshInvestment + remainingSellProceeds;

		console.log(
			`[Proposal] Fresh: ${freshInvestmentAmount}, EffectiveFresh: ${effectiveFresh}, Sell proceeds: ${sellProceeds}, BUY from sells: ${buyAllocatedFromSellProceeds}, INCREASE from fresh: ${increaseAllocatedFromFresh}, Remaining fresh: ${remainingFreshInvestment}, Remaining sells: ${remainingSellProceeds}, Total deployable for fresh suggestions: ${totalDeployableAmount}`,
		);

		// Create funding summary for PDF
		const rebalancingBuyAllocated =
			buyAllocatedFromSellProceeds + increaseAllocatedFromFresh;
		...
		try {
			const mfSuggestions = freshInvestments.filter(
				(f) =>
					["mutual_fund", "mf", "equity", "debt", "hybrid"].includes(
						(f.productType || "").toLowerCase(),
					) && (f as any).schemeCode,
			);
			for (let i = 0; i < mfSuggestions.length; i++) {
				for (let j = i + 1; j < mfSuggestions.length; j++) {
					...
					const overlapPct = await mfSebiOverlapService.computeOverlap(
						codeA,
						codeB,
					);
					...
					const isThematicOrSectoral =
						catA.includes("thematic") ||
						catA.includes("sectoral") ||
						catB.includes("thematic") ||
						catB.includes("sectoral");
			...
			if (sebiOverlapWarnings.length > 0) {
				console.log(
					`[SEBICompliance] ${sebiOverlapWarnings.length} proposal-level overlap warning(s) generated`,
				);
			}
		} catch (overlapErr) {
			console.error(
				"[SEBICompliance] Overlap check failed (non-fatal):",
				overlapErr,
			);
		}
		...
		const avgReturn = this.calculateWeightedReturn(
			freshInvestments,
			riskProfile,
		);
		const years =
			riskProfile.investmentHorizon === "short_term"
				? 3
				: riskProfile.investmentHorizon === "medium_term"
					? 5
					: 10;
		const projectedValue =
			(analysis.totalValue + netInvestmentRequired) *
			(1 + avgReturn / 100) ** years;
		...
		const hasCustomAlloc =
			customAllocations && Object.values(customAllocations).some((v) => v > 0);
		if (hasCustomAlloc && customAllocations) {
			...
			console.log(
				"[ProposalGen] Using agent custom targetAllocation:",
				JSON.stringify(cleanAlloc),
			);
		} else {
			targetAllocation =
				TARGET_ALLOCATIONS[riskProfile.riskTolerance] ||
				TARGET_ALLOCATIONS.moderate;
			console.log(
				"[ProposalGen] Using risk-profile default targetAllocation:",
				riskProfile.riskTolerance,
			);
		}
		...
		if (holdings.length > 0 && freshInvestments.length > 0) {
			try {
				const comparisonWithData =
					await this.generatePortfolioComparisonWithRealData(
						holdings,
						freshInvestments,
						riskProfile,
					);
				...
				console.log(
					`[ProposalGen] Portfolio metrics calculated using ${metricsDataSource} data`,
				);
			} catch (error) {
				// Fallback to estimation-based comparison if real data fails
				console.log(
					"[ProposalGen] Using estimation-based metrics (real data unavailable)",
				);
				portfolioComparison = this.generatePortfolioComparison(
					holdings,
					freshInvestments,
					riskProfile,
				);
		...
		const allocationPolicy = allocationPolicyService.getDefaultPolicy(
			riskProfile.riskTolerance,
		);
		...
		const [proposal] = await db
			...
			.values({
				...
				riskProfile: riskProfile.riskTolerance,
				investmentGoals:
					investmentGoalsInput && investmentGoalsInput.length > 0
						? {
								goals: investmentGoalsInput,
								totalMonthlySIP: investmentGoalsInput.reduce(
			...
			for (const fund of allFunds) {
				try {
					...
					const investmentType =
						fund.type === "BUY" ? "lumpsum" : fund.type.toLowerCase();
					const isAllowed =
					...
					await db.insert(proposalAuditLog).values({
						...
						validationMessage:
							eligibility.restrictionReason || "Fund eligible for inclusion",
						metadata: {
					...
					await db.insert(proposalAuditLog).values({
						...
						validationMessage:
							"Eligibility check unavailable; using hardcoded fallback",
					});
				}
			}
		} catch (auditError) {
			console.error(
				"[ProposalAudit] Non-critical: Failed to write audit/version records:",
				auditError,
			);
		}
		...
		const liquidHoldings =
			analysis.assetAllocation?.Liquid?.value ||
			analysis.assetAllocation?.Cash?.value ||
			analysis.assetAllocation?.liquid?.value ||
			0;
		const emergencyFundMonths =
			monthlyExpenses > 0 ? liquidHoldings / monthlyExpenses : null;
		const emergencyFundAdequate =
			emergencyFundMonths !== null ? emergencyFundMonths >= 6 : null;
		const emergencyFundAlert =
			...
			investmentGoalsInput && investmentGoalsInput.length > 0
				? investmentGoalsInput.map((goal: any) => {
						...
						const currentProgress =
							goal.currentProgress || goal.currentSavings || 0;
						...
						const flatCorpus = calculateFlatSIPCorpus(
							actualMonthlySIP,
							timelineYears,
							expectedReturn,
						);
						const stepUpRate = riskProfile.annualIncomeStepUp || 10;
						const stepUpCorpus = calculateStepUpSIPCorpus(
							actualMonthlySIP,
							stepUpRate,
							timelineYears,
							expectedReturn,
						);
						const realExpectedReturn = Number.parseFloat(
							(expectedReturn - INFLATION_RATE).toFixed(2),
						);
						return {
							goalId: goal.id,
		...
		const totalActualSIP = goalCorpusGap.reduce(
			(s: number, g: any) => s + g.actualMonthlySIP,
			0,
		);
		const totalRequiredSIP = goalCorpusGap.reduce(
			(s: number, g: any) => s + g.requiredSIP,
			0,
		);
		const totalStepUpBonus = goalCorpusGap.reduce(
			(s: number, g: any) => s + g.stepUpBonus,
			0,
		);
	...
	private generateExecutiveSummary(
		...
		const buyCount = rebalancing.filter(
			(r) => r.action === "BUY" || r.action === "INCREASE",
		).length;
		const totalOpportunities = freshInvestments.length + buyCount;

		let summary =
			`Based on your ${riskProfile.riskTolerance} risk profile and ${riskProfile.investmentHorizon.replace("_", " ")} investment horizon, ` +
		...
		if (
			globalAdvisorySelections &&
			Object.keys(globalAdvisorySelections).length > 0
		) {
			const marketLabels: Record<string, string> = {
				...
				japan: "Japan",
				other_asia: "Other Asian Markets",
			};
			const markets = Object.keys(globalAdvisorySelections)
				.map((m) => marketLabels[m] || m)
				.join(", ");
			const instrumentCount = Object.values(globalAdvisorySelections).flat()
				.length;
	...
	async shareProposal(
		...
		const [proposal] = await db
			...
			.where(
				and(
					eq(prospectProposals.id, proposalId),
