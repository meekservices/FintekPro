...
export function buildPrompt(
	...
	metadata: Pick<
		PromptTemplate,
		"model" | "maxTokens" | "temperature" | "version" | "regulatoryDisclaimer"
	>;
} {
 ...
 */
export function listPrompts(): Omit<
	PromptTemplate,
	"systemPrompt" | "userPromptTemplate"
>[] {
	return Object.values(PROMPTS).map(
		({ systemPrompt: _s, userPromptTemplate: _u, ...rest }) => rest,
	);
}
