...
export class CashfreeAadhaarService {
	...
	static async generateOTP(
		...
		try {
			...
			const response = await axios.post(
				`${CashfreeAadhaarService.getBaseUrl()}/offline-aadhaar/otp`,
				{ aadhaar_number: aadhaarNumber },
				{ headers: CashfreeAadhaarService.getHeaders() },
			);
			...
			console.error(
				"Cashfree Aadhaar OTP generation error:",
	...
	static async verifyOTP(
		...
		try {
			...
			const response = await axios.post(
				`${CashfreeAadhaarService.getBaseUrl()}/offline-aadhaar/verify`,
				{
					otp: otp,
					ref_id: refId,
				},
			...
			console.error(
				"Cashfree Aadhaar OTP verification error:",
				error.response?.data || error.message,
			);
