...
const SEBI_2017_RULES: CategoryRule[] = [
	{
		...
		sebiCircularRef: "SEBI/HO/IMD/DF3/CIR/P/2017/114",
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 80% in large cap stocks (top 100 by market cap)",
			minEquityPercent: 80,
			notes: "Large cap = 1st-100th company by full market cap",
		},
	},
	{
		category: "Equity",
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 35% in large cap, min 35% in mid cap",
			minEquityPercent: 70,
			notes: "Large cap >= 35%, Mid cap >= 35%",
		},
	},
	{
		category: "Equity",
		...
		rules: {
			...
			minEquityPercent: 65,
			notes: "Mid cap = 101st-250th company",
		},
	},
	{
		category: "Equity",
		...
		rules: {
			...
			minEquityPercent: 65,
			notes: "Small cap = 251st onwards",
		},
	},
	{
		category: "Equity",
		subCategory: "Multi Cap",
		sebiCircularRef: "SEBI/HO/IMD/DF2/CIR/P/2020/174",
		effectiveDate: "2020-09-11",
		rules: {
			description: "Min 75% equity: min 25% each in large, mid, small cap",
			minEquityPercent: 75,
			notes: "Min 25% in each cap segment",
		},
	},
	{
		category: "Equity",
		subCategory: "Flexi Cap",
		sebiCircularRef: "SEBI/HO/IMD/DF3/CIR/P/2020/228",
	...
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 65% equity, max 30 stocks",
			minEquityPercent: 65,
			maxStocks: 30,
		},
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 65% equity following value/contrarian strategy",
			minEquityPercent: 65,
		},
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 80% equity, 3-year lock-in for tax benefits",
			minEquityPercent: 80,
			lockInPeriod: 1095,
		},
	},
	...
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 80% in stocks of a particular sector/theme",
			minEquityPercent: 80,
		},
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Investment in overnight securities with maturity of 1 day",
			notes: "Maturity = 1 day",
		},
	},
	{
		category: "Debt",
		...
		rules: {
			description:
				"Investment in debt/money market securities with maturity up to 91 days",
			notes: "Macaulay duration ≤ 91 days",
		},
	},
	{
		category: "Debt",
		...
		rules: {
			...
			notes: "Macaulay duration 3-6 months",
		},
	},
	{
		category: "Debt",
		...
		rules: {
			...
			notes: "Macaulay duration 6-12 months",
		},
	},
	{
		category: "Debt",
		...
		rules: {
			description:
				"Investment in money market instruments with maturity up to 1 year",
	...
	},
	{
		...
		rules: {
			...
			notes: "Macaulay duration 1-3 years",
		},
	},
	{
		category: "Debt",
		...
		rules: {
			...
			notes: "Macaulay duration 3-4 years",
		},
	},
	{
		category: "Debt",
		...
		rules: {
			...
			notes: "Macaulay duration 4-7 years",
		},
	},
	{
		category: "Debt",
		...
		rules: {
			...
			notes: "Macaulay duration > 7 years",
		},
	},
	{
		category: "Debt",
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Investment across duration, dynamic management",
			notes: "Dynamic duration management",
		},
	},
	{
		category: "Debt",
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 80% in AA+ and above rated corporate bonds",
			minDebtPercent: 80,
			notes: "AA+ and above",
		},
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 65% in AA and below rated corporate bonds",
			minDebtPercent: 65,
			notes: "AA and below rated",
		},
	},
	{
		category: "Debt",
	...
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 80% in G-Secs across duration",
			minDebtPercent: 80,
		},
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 65% in floating rate instruments",
			minDebtPercent: 65,
		},
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Equity 10-25%, Debt 75-90%",
			minEquityPercent: 10,
			maxEquityPercent: 25,
			minDebtPercent: 75,
			maxDebtPercent: 90,
	...
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Equity 65-80%, Debt 20-35%",
			minEquityPercent: 65,
			maxEquityPercent: 80,
			minDebtPercent: 20,
			maxDebtPercent: 35,
	...
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Dynamic equity allocation 0-100%",
			minEquityPercent: 0,
			maxEquityPercent: 100,
		},
	},
	{
		category: "Hybrid",
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 3 asset classes, each min 10%",
			notes: "Min 10% in each of at least 3 asset classes",
		},
	},
	{
		category: "Hybrid",
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 65% in equity with arbitrage strategy",
			minEquityPercent: 65,
		},
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Equity min 65% (hedged + unhedged), debt min 10%",
			minEquityPercent: 65,
			minDebtPercent: 10,
		},
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Retirement benefit with 5-year lock-in or till retirement",
			lockInPeriod: 1825,
		},
	},
	{
		...
		rules: {
			description:
				"For children fund with 5-year lock-in or till child turns 18",
			lockInPeriod: 1825,
		},
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 95% in securities of index being replicated",
			minEquityPercent: 95,
		},
	},
	{
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Min 95% in underlying funds",
			notes: "Min 95% invested in underlying MF schemes",
		},
	},
	{
		category: "Other",
		...
		effectiveDate: "2017-10-06",
		rules: {
			description: "Exchange traded fund tracking an index",
			minEquityPercent: 95,
...
const SEBI_2026_CATEGORIES = [
	{
		groupCode: "EQUITY",
		groupName: "Equity Schemes",
		description:
			"Schemes predominantly investing in equity and equity-related instruments",
	},
	{
		groupCode: "DEBT",
		groupName: "Debt Schemes",
		description: "Schemes predominantly investing in debt instruments",
	},
	{
		groupCode: "HYBRID",
		groupName: "Hybrid Schemes",
		description: "Schemes investing in both equity and debt instruments",
	},
	{
		groupCode: "LIFECYCLE",
		groupName: "Life Cycle Schemes",
		description:
			"Target-date schemes with a glide path reducing equity allocation towards maturity — new in SEBI 2026 circular",
	},
	{
		groupCode: "OTHER",
...
const SEBI_2026_SUBCATEGORIES: SubcategoryDef[] = [
	...
	{
		groupCode: "EQUITY",
		subcategoryCode: "EQ_LARGE_CAP",
		subcategoryName: "Large Cap Fund",
		minEquityPct: 80,
		notes: "Min 80% in top 100 large cap stocks by market cap",
	},
	{
		groupCode: "EQUITY",
		subcategoryCode: "EQ_LARGE_MID",
		subcategoryName: "Large & Mid Cap Fund",
		minEquityPct: 70,
		notes: "Min 35% in large cap + min 35% in mid cap",
	},
	{
		groupCode: "EQUITY",
		subcategoryCode: "EQ_MID_CAP",
		subcategoryName: "Mid Cap Fund",
		minEquityPct: 65,
		notes: "Min 65% in mid cap stocks (101st-250th by market cap)",
	},
	{
		groupCode: "EQUITY",
		subcategoryCode: "EQ_SMALL_CAP",
		subcategoryName: "Small Cap Fund",
		minEquityPct: 65,
		notes: "Min 65% in small cap stocks (251st onwards)",
	},
	{
		groupCode: "EQUITY",
		subcategoryCode: "EQ_MULTI_CAP",
		subcategoryName: "Multi Cap Fund",
		minEquityPct: 75,
		notes: "Min 25% each in large, mid, small cap",
	},
	{
		groupCode: "EQUITY",
		subcategoryCode: "EQ_FLEXI_CAP",
		subcategoryName: "Flexi Cap Fund",
		minEquityPct: 65,
		notes: "Flexible allocation across market caps, min 65% equity",
	},
	{
		groupCode: "EQUITY",
		subcategoryCode: "EQ_FOCUSED",
		subcategoryName: "Focused Fund",
		minEquityPct: 65,
		maxStocks: 30,
		notes: "Max 30 stocks, min 65% equity",
	},
	{
		groupCode: "EQUITY",
		subcategoryCode: "EQ_VALUE_CONTRA",
		subcategoryName: "Value/Contra Fund",
		minEquityPct: 65,
		notes: "Value or contrarian investment strategy",
	},
	{
		groupCode: "EQUITY",
		subcategoryCode: "EQ_ELSS",
		subcategoryName: "ELSS (Tax Saving)",
		minEquityPct: 80,
		lockInDays: 1095,
		notes: "Min 80% equity, 3-year lock-in, Section 80C benefit",
	},
	{
		groupCode: "EQUITY",
		subcategoryCode: "EQ_DIVIDEND_YIELD",
		subcategoryName: "Dividend Yield Fund",
		minEquityPct: 65,
		notes: "Min 65% in dividend yielding stocks",
	},
	{
		groupCode: "EQUITY",
		subcategoryCode: "EQ_SECTORAL_THEMATIC",
		subcategoryName: "Sectoral/Thematic Fund",
		minEquityPct: 80,
		overlapThresholdPct: 50,
		notes:
			"Min 80% in a specific sector/theme. Strict overlap rule: >50% = breach",
	},
	// DEBT — 16 subcategories
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_OVERNIGHT",
		subcategoryName: "Overnight Fund",
		notes: "Maturity of 1 day",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_LIQUID",
		subcategoryName: "Liquid Fund",
		notes: "Macaulay duration ≤ 91 days",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_ULTRA_SHORT",
		subcategoryName: "Ultra Short Duration Fund",
		notes: "Macaulay duration 3-6 months",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_LOW_DURATION",
		subcategoryName: "Low Duration Fund",
		notes: "Macaulay duration 6-12 months",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_MONEY_MARKET",
		subcategoryName: "Money Market Fund",
		notes: "Maturity ≤ 1 year",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_SHORT_DURATION",
		subcategoryName: "Short Duration Fund",
		notes: "Macaulay duration 1-3 years",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_MEDIUM_DURATION",
		subcategoryName: "Medium Duration Fund",
		notes: "Macaulay duration 3-4 years",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_MEDIUM_LONG",
		subcategoryName: "Medium to Long Duration Fund",
		notes: "Macaulay duration 4-7 years",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_LONG_DURATION",
		subcategoryName: "Long Duration Fund",
		notes: "Macaulay duration > 7 years",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_DYNAMIC_BOND",
		subcategoryName: "Dynamic Bond Fund",
		notes: "Dynamic duration management",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_CORPORATE_BOND",
		subcategoryName: "Corporate Bond Fund",
		minDebtPct: 80,
		notes: "Min 80% in AA+ and above rated corporate bonds",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_CREDIT_RISK",
		subcategoryName: "Credit Risk Fund",
		minDebtPct: 65,
		notes: "Min 65% in AA and below rated corporate bonds",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_BANKING_PSU",
		subcategoryName: "Banking and PSU Fund",
		minDebtPct: 80,
		notes: "Min 80% in debt of banks, PSUs, PFIs",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_GILT",
		subcategoryName: "Gilt Fund",
		minDebtPct: 80,
		notes: "Min 80% in government securities",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_GILT_10Y_CONSTANT",
		subcategoryName: "Gilt Fund with 10 Year Constant Duration",
		minDebtPct: 80,
		notes: "G-Secs with Macaulay duration = 10 years",
	},
	{
		groupCode: "DEBT",
		subcategoryCode: "DEBT_FLOATER",
		subcategoryName: "Floater Fund",
		minDebtPct: 65,
		notes: "Min 65% in floating rate instruments",
	},
	// HYBRID — 6 subcategories
	{
		groupCode: "HYBRID",
		subcategoryCode: "HY_CONSERVATIVE",
		subcategoryName: "Conservative Hybrid Fund",
		minEquityPct: 10,
		maxEquityPct: 25,
		minDebtPct: 75,
		maxDebtPct: 90,
	...
	{
		groupCode: "HYBRID",
		subcategoryCode: "HY_AGGRESSIVE",
		subcategoryName: "Aggressive Hybrid Fund",
		minEquityPct: 65,
		maxEquityPct: 80,
		minDebtPct: 20,
		maxDebtPct: 35,
	...
	{
		groupCode: "HYBRID",
		subcategoryCode: "HY_BALANCED_ADVANTAGE",
		subcategoryName: "Balanced Advantage Fund",
		minEquityPct: 0,
		maxEquityPct: 100,
		notes: "Dynamic equity allocation 0-100%",
	},
	{
		groupCode: "HYBRID",
		subcategoryCode: "HY_MULTI_ASSET",
		subcategoryName: "Multi Asset Allocation Fund",
		notes: "Min 3 asset classes, each min 10%",
	},
	{
		groupCode: "HYBRID",
		subcategoryCode: "HY_ARBITRAGE",
		subcategoryName: "Arbitrage Fund",
		minEquityPct: 65,
		notes: "Min 65% in equity with arbitrage strategy",
	},
	{
		groupCode: "HYBRID",
		subcategoryCode: "HY_EQUITY_SAVINGS",
		subcategoryName: "Equity Savings Fund",
		minEquityPct: 65,
		minDebtPct: 10,
		notes: "Min 65% equity (hedged+unhedged), min 10% debt",
	},
	// LIFECYCLE — NEW in SEBI 2026 circular
	{
		groupCode: "LIFECYCLE",
		subcategoryCode: "LC_LIFECYCLE_FUND",
		subcategoryName: "Life Cycle Fund",
		minEquityPct: 20,
		maxEquityPct: 80,
		notes:
			"Equity starts high (~80%) and glides to low (~20%) by maturity. Maturity year must appear in scheme name. Glide path monotonically decreasing equity required.",
	},
	// OTHER — 4 subcategories
	{
		groupCode: "OTHER",
		subcategoryCode: "OTH_INDEX",
		subcategoryName: "Index Fund",
		minEquityPct: 95,
		notes: "Min 95% in index securities",
	},
	{
		groupCode: "OTHER",
		subcategoryCode: "OTH_ETF",
		subcategoryName: "Exchange Traded Fund (ETF)",
		minEquityPct: 95,
		notes: "Listed on exchange, tracks an index",
	},
	{
		groupCode: "OTHER",
		subcategoryCode: "OTH_FOF_DOMESTIC",
		subcategoryName: "Fund of Funds (Domestic)",
		notes: "Min 95% in domestic MF schemes",
	},
	{
		groupCode: "OTHER",
		subcategoryCode: "OTH_FOF_OVERSEAS",
...
class SEBICategoryEngine {
	...
	static getInstance(): SEBICategoryEngine {
		if (!SEBICategoryEngine.instance) {
			SEBICategoryEngine.instance = new SEBICategoryEngine();
		}
		return SEBICategoryEngine.instance;
	}

	// ── Legacy 2017 rule seeding (existing mf_category_rules table) ──────────
	async seedCategoryRules(): Promise<{
		seeded: number;
		skipped: number;
		errors: string[];
	}> {
		...
		console.log(
			`[SEBICategoryEngine] Seeded ${seeded} 2017 rules, ${skipped} skipped, ${errors.length} errors`,
		);
		return { seeded, skipped, errors };
	}

	// ── SEBI 2026 taxonomy seeding — idempotent ───────────────────────────────
	async seedSEBI2026Taxonomy(): Promise<{
      ...
      `);
        ...
        `);
				...
				console.error(
					`[SEBICategoryEngine] Category seed error ${cat.groupCode}:`,
					e.message,
				);
			}
		}
        ...
        `);
				...
				console.error(
					`[SEBICategoryEngine] Subcategory seed error ${sub.subcategoryCode}:`,
					e.message,
				);
			}
		}
		...
		console.log(
			`[SEBICategoryEngine] SEBI 2026 taxonomy seeded: ${versionsSeeded} versions, ${categoriesSeeded} categories, ${subcategoriesSeeded} subcategories`,
		);
	...
	async logCategorizationChange(
		...
		try {
			...
			console.error(
				`[SEBICategoryEngine] Audit log error for ${schemeCode}:`,
				e.message,
			);
		}
	}
	...
	async validateSchemeCategory(schemeCode: string): Promise<{
		...
		if (fund.category && fund.schemeSubCategory) {
			rule = await this.getRuleForCategory(
				fund.category,
				fund.schemeSubCategory,
			);
			if (!rule) {
				issues.push(
					`No SEBI rule found for category: ${fund.category}/${fund.schemeSubCategory}`,
				);
			}
		}
        ...
        `);
				...
				console.warn(
					"[SEBICategoryEngine] Failed to update compliance status:",
					statusErr?.message,
				);
			}
		}
	...
	async validateAllSchemes(limit = 1000): Promise<{
		...
		for (const fund of funds) {
			...
			if (this.isLifecycleFund(fund)) {
				lifecycleCount++;
				if (fund.category !== "Lifecycle")
					fundIssues.push(
						"Lifecycle fund not classified under Lifecycle category",
					);
			}
	...
	async getCategoryStats(): Promise<
		Record<string, { count: number; withSubCategory: number }>
	> {
