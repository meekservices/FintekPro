...
const DEFAULT_PROVIDERS: ProviderPricing[] = [
	...
	{
		providerName: "sandbox-pan",
		displayName: "Sandbox — PAN Verification",
		description: "PAN card identity verification",
		costPerCall: 2,
	},
	{
		providerName: "sandbox-mca",
		displayName: "Sandbox — MCA Data",
		description: "Ministry of Corporate Affairs company data",
		costPerCall: 3,
	},
	{
		providerName: "sandbox-gstin",
		displayName: "Sandbox — GSTIN Verification",
		description: "GST identification number verification",
		costPerCall: 1.5,
	},

	// TruthScreen (formerly AuthBridge — same company) — separate services
	{
		providerName: "truthscreen-aadhaar",
		displayName: "TruthScreen — Aadhaar Verification",
		description: "Aadhaar identity verification (OTP/offline)",
		costPerCall: 3,
	},
	{
		providerName: "truthscreen-ckyc",
		displayName: "TruthScreen — CKYC Search",
		description: "Central KYC registry lookup",
		costPerCall: 5,
	},
	{
		providerName: "truthscreen-esign",
		displayName: "TruthScreen — eSign",
		description: "Aadhaar-based electronic signature",
		costPerCall: 10,
	},
	...
	// Cashfree — separate services
	{
		...
		displayName: "Cashfree — Payment Gateway",
		description: "Online payment collection (UPI, cards, netbanking)",
		costPerCall: 0,
	},
	{
		providerName: "cashfree-payouts",
		displayName: "Cashfree — Payouts",
		description: "Bank transfer payouts to beneficiaries",
		costPerCall: 5,
	},
	{
		providerName: "cashfree-pan",
		displayName: "Cashfree — PAN Verification",
		description: "PAN card verification via Cashfree",
		costPerCall: 2,
	},
	{
		providerName: "cashfree-bank",
		displayName: "Cashfree — Bank Verification",
	...
	// Twilio — separate services
	{
		...
		description: "SMS OTP & notifications",
		costPerCall: 0.5,
	},
	{
	...
	{
		providerName: "credhive-details",
		displayName: "CredHive — Company Details",
		description: "Company master data & directors",
		costPerCall: 5,
	},
	{
		providerName: "credhive-financials",
		displayName: "CredHive — Company Financials",
		description: "Balance sheet, P&L, cash flow",
		costPerCall: 8,
	},
	{
		providerName: "credhive-ratios",
		displayName: "CredHive — Company Ratios",
		description: "Financial ratios & analytics",
		costPerCall: 5,
	},
	...
	// Google Gemini — single service
	{
		...
		description: "AI features (fallback)",
		costPerCall: 0.01,
	},
	...
	// Zoho — separate services
	{
		...
		description: "Lead & contact management, deal pipeline",
		costPerCall: 0,
	},
	{
	...
	{
		providerName: "zoho-campaigns",
		displayName: "Zoho — Campaigns",
		description: "Email marketing campaigns",
		costPerCall: 0,
	},
	{
		providerName: "zoho-meeting",
	...
	},
	{
		...
		description: "Document digital signing",
		costPerCall: 0,
	},
	...
	// OpenAI — single service
	{
		providerName: "openai",
		displayName: "OpenAI",
		description: "Primary AI engine (recommendations, analysis)",
		costPerCall: 0.03,
	},
	...
	// Financial data providers — single service each
	{
		...
		description: "Stock financials, ETF data, batch quotes",
		costPerCall: 0.01,
	},
	{
		providerName: "finnhub",
		displayName: "Finnhub",
		description: "Stock metrics, real-time market data",
		costPerCall: 0,
	},
	{
		providerName: "yahoo",
		displayName: "Yahoo Finance",
		description: "Stock prices, fallback provider",
		costPerCall: 0,
	},
	{
		providerName: "nse",
		displayName: "NSE India",
		description: "Market movers, stock exchange data",
		costPerCall: 0,
	},
	{
		providerName: "bse",
		displayName: "BSE India",
		description: "Market movers, bond catalog",
		costPerCall: 0,
	},
	{
		providerName: "amfi",
		displayName: "AMFI",
		description: "Mutual fund NAV, scheme data",
		costPerCall: 0,
	},
	{
		providerName: "polygon",
		displayName: "Polygon.io",
		description: "US market data, flat files",
		costPerCall: 0.01,
	},
	{
		providerName: "alphavantage",
		displayName: "Alpha Vantage",
		description: "Financial data, technical indicators",
		costPerCall: 0.01,
	},

	// Turtlefin — separate services
	{
		providerName: "turtlefin-life",
		displayName: "Turtlefin — Life Insurance",
		description: "Life insurance quotes & issuance",
		costPerCall: 1,
	},
	{
		providerName: "turtlefin-health",
		displayName: "Turtlefin — Health Insurance",
		description: "Health insurance quotes & issuance",
		costPerCall: 1,
	},
	{
		providerName: "turtlefin-general",
		displayName: "Turtlefin — General Insurance",
		description: "Motor, travel, property insurance",
		costPerCall: 1,
	},

	// Protean (NSDL) — separate services
	{
		providerName: "protean-esign",
		displayName: "Protean — Aadhaar eSign",
		description: "NSDL Aadhaar-based electronic signature",
		costPerCall: 4,
	},
	{
		providerName: "protean-kra",
		displayName: "Protean — KRA Verification",
		description: "KYC Registration Agency verification",
		costPerCall: 2,
	},

	// CIBIL — separate services
	{
		providerName: "cibil-score",
		displayName: "CIBIL — Credit Score",
		description: "TransUnion CIBIL score fetch",
		costPerCall: 12,
	},
	{
		providerName: "cibil-report",
		displayName: "CIBIL — Credit Report",
		description: "Detailed credit report with history",
		costPerCall: 25,
	},

	// Utility providers — single service each
	{
		providerName: "exchangerate",
...
class ApiUsageTrackingService {
	...
	async initialize() {
		...
		try {
			...
			const existingNames = new Set(
				existingPricing.map((p) => p.providerName.toLowerCase()),
			);
			...
			existingPricing.forEach((p) => {
				this.providerPricing.set(p.providerName.toLowerCase(), {
					...
					costPerCall: Number.parseFloat(p.costPerCall || "0"),
			...
			if (isProduction) {
				for (const provider of DEFAULT_PROVIDERS) {
					if (!existingNames.has(provider.providerName.toLowerCase())) {
						await db
							.insert(schema.apiProviderPricing)
							.values({
			...
			if (newCount > 0) {
				console.log(
					`✅ API provider pricing loaded (${existingPricing.length} existing + ${newCount} new providers)`,
				);
			} else {
				console.log(
					`✅ API provider pricing loaded (${existingPricing.length} providers)`,
				);
			}
			...
			console.warn(
				"⚠️ Could not load API provider pricing from database, using defaults",
			);
			this.initialized = true;
		}
	}
	...
	private resolveProviderKey(provider: string, endpoint?: string): string {
		...
		const LEGACY_MAP: Record<string, (ep: string) => string> = {
			...
			truthscreen: (ep) =>
				ep.includes("ckyc")
					? "truthscreen-ckyc"
					: ep.includes("esign") || ep.includes("sign")
						? "truthscreen-esign"
						: "truthscreen-aadhaar",
			cashfree: (ep) =>
				ep.includes("payout")
					...
					: ep.includes("pan")
						? "cashfree-pan"
						: ep.includes("bank") || ep.includes("penny")
							? "cashfree-bank"
							: "cashfree-payments",
			twilio: (ep) =>
				ep.includes("whatsapp") ? "twilio-whatsapp" : "twilio-sms",
			credhive: (ep) =>
				ep.includes("financial")
					? "credhive-financials"
					: ep.includes("ratio")
						? "credhive-ratios"
						: "credhive-details",
			...
			turtlefin: (ep) =>
				ep.includes("health")
					? "turtlefin-health"
					: ep.includes("general") || ep.includes("motor")
						? "turtlefin-general"
						: "turtlefin-life",
	...
	async logApiCall(params: ApiCallLogParams): Promise<void> {
		try {
			const resolvedProvider = this.resolveProviderKey(
				params.provider,
				params.endpoint,
			);
	...
	async updateProviderPricing(
		...
		try {
			const existing = await db
				...
				.where(
					eq(
						schema.apiProviderPricing.providerName,
			...
			await db
				.update(schema.apiProviderPricing)
				.set({
			...
			console.log(
				`[API Usage] Admin ${adminId} updated ${providerName} pricing to ₹${costPerCall}/call`,
			);

			return {
				success: true,
				message: `Updated ${providerName} cost to ₹${costPerCall} per call`,
			};
		} catch (error) {
	...
	async addProvider(
		...
		try {
			...
			console.log(
				`[API Usage] Admin ${adminId} added provider ${provider.providerName}`,
			);
			return {
				success: true,
				message: `Added provider ${provider.displayName}`,
			};
		} catch (error: any) {
	...
	async getUsageStats(startDate?: Date, endDate?: Date): Promise<UsageStats[]> {
		try {
			...
			usageLogs.forEach((log) => {
				...
				if (!statsByProvider.has(providerLower)) {
					statsByProvider.set(providerLower, {
						...
						costPerCall:
							pricing?.costPerCall ||
							Number.parseFloat(log.estimatedCost || "0"),
						totalCost: 0,
			...
			return Array.from(statsByProvider.values()).sort(
	...
	async getDailyUsage(
		days: number = 30,
	): Promise<{ date: string; calls: number; cost: number }[]> {
		try {
			const now = new Date();
			...
			const dailyStats: Map<string, { calls: number; cost: number }> =
				new Map();
			...
			logs.forEach((log) => {
				...
				stats.calls++;
				stats.cost += Number.parseFloat(log.estimatedCost || "0");
			});
