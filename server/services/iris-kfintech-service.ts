...
class IrisKfintechService {
	...
	async login(): Promise<{
		...
		if (!username || !password) {
			return {
				success: false,
				message:
					"IRIS_USERNAME/IRIS_PASSWORD (or KFINTECH_ counterparts) not set",
			};
		}
		try {
	...
	// ─── Dashboard ────────────────────────────────────────────────────────────────
	async getAumSummary() {
		return this.call("/user/dashboard/aum-summary");
	}
	async getFundEarnings() {
		return this.call("/user/dashboard/fund-earnings");
	}
	async getSipSummary() {
		return this.call("/user/dashboard/sip-summary");
	}
	async getUniqueInvestors() {
		return this.call("/user/dashboard/unique-investors");
	}
	async getInflowOutflow(params?: any) {
		return this.call(
			`/user/dashboard/inflow-outflow${params ? "?" + new URLSearchParams(params).toString() : ""}`,
		);
	}
	async getEuins() {
		return this.call("/user/dashboard/euins");
	}

	// ─── Empanelment ──────────────────────────────────────────────────────────────
	async getEmpanelmentAmcList() {
		return this.call("/empanelment/amc-list");
	}
	async getAmcEmpanelmentStatus(amcCode?: string) {
		return this.call(
			`/empanelment/amc-status${amcCode ? "?amcCode=" + amcCode : ""}`,
		);
	}
	async getFdEmpanelmentStatus() {
		return this.call("/empanelment/fd-status");
	}
	async getNpsEmpanelmentStatus() {
		return this.call("/empanelment/nps-status");
	}
	async resendEsignLink(empanelmentId: string) {
		return this.call("/empanelment/resend-esign", "POST", { empanelmentId });
	}
	...
	async getInvestorDetails(pan: string) {
		return this.call(`/user/investors/${pan}`);
	}
	async getInvestorKycDetails(pan: string) {
		return this.call(`/user/investors/${pan}/kyc`);
	}
	async getPortfolioSummary(pan: string) {
		return this.call(`/user/investors/${pan}/portfolio-summary`);
	}
	async getInvestmentDetails(pan: string) {
		return this.call(`/user/investors/${pan}/investments`);
	}
	async getTransactionDetails(pan: string, params?: any) {
		const qs = params ? "?" + new URLSearchParams(params).toString() : "";
		return this.call(`/user/investors/${pan}/transactions${qs}`);
	}
	async getSystematicPlanDetails(pan: string) {
		return this.call(`/user/investors/${pan}/systematic-plans`);
	}
	async getFamilyPortfolio(pan: string) {
		return this.call(`/user/investors/${pan}/family-portfolio`);
	}
	async getPortfolioInsights(pan: string) {
		return this.call(`/user/investors/${pan}/portfolio-insights`);
	}
	async getKraStatus(pan: string) {
		return this.call(`/user/investors/${pan}/kra-status`);
	}
	async getSipHealth(pan: string) {
		return this.call(`/user/investors/${pan}/sip-health`);
	}
	async sendEkycMail(pan: string) {
		return this.call(`/user/investors/${pan}/send-ekyc-mail`, "POST");
	}
	async sendReminderMail(pan: string, body?: any) {
		return this.call(`/user/investors/${pan}/send-reminder`, "POST", body);
	}

	// ─── Transactions ─────────────────────────────────────────────────────────────
	async getAllFunds() {
		return this.call("/sif/funds");
	}
	async getSchemesByFund(fundCode: string) {
		return this.call(`/sif/funds/${fundCode}/schemes`);
	}
	async getSchemeDetails(schemeCode: string) {
		return this.call(`/sif/schemes/${schemeCode}`);
	}
	...
	async getNfoData() {
		return this.call("/sif/nfo");
	}
	async getAvailablePaymentModes(pan: string, schemeCode: string) {
		return this.call(
			`/sif/transactions/payment-modes?pan=${pan}&schemeCode=${schemeCode}`,
		);
	}
	...
	async getDirectPayStatus(pan: string, bankAccountNo: string) {
		return this.call(
			`/sif/transactions/direct-pay-status?pan=${pan}&accountNo=${bankAccountNo}`,
		);
	}
	async validateInvestment(body: any) {
		return this.call("/sif/transactions/validate", "POST", body);
	}
	...
	async placeRedemption(body: any) {
		return this.call("/sif/transactions/redemption", "POST", body);
	}
	async cancelSip(body: any) {
		return this.call("/sif/transactions/sip/cancel", "POST", body);
	}
	async pauseSip(body: any) {
		return this.call("/sif/transactions/sip/pause", "POST", body);
	}
	async cancelOrder(orderId: string) {
		return this.call(`/sif/transactions/${orderId}/cancel`, "POST");
	}
	async reinitiateOrder(orderId: string) {
		return this.call(`/sif/transactions/${orderId}/reinitiate`, "POST");
	}
	async getMandates(pan: string) {
		return this.call(`/sif/mandates?pan=${pan}`);
	}
	...
	async getFixedDepositProducts() {
		return this.call("/user/fixed-deposit/products");
	}
	async getFdBrochure(productId: string) {
		return this.call(`/user/fixed-deposit/products/${productId}/brochure`);
	}
	async getNpsInvestmentLinks() {
		return this.call("/user/nps/links");
	}
	...
	async registerStp(body: any) {
		return this.call("/sif/transactions/stp/register", "POST", body);
	}
	async cancelStp(body: any) {
		return this.call("/sif/transactions/stp/cancel", "POST", body);
	}
	async pauseStp(body: any) {
		return this.call("/sif/transactions/stp/pause", "POST", body);
	}

	// SWP (Systematic Withdrawal Plan)
	async registerSwp(body: any) {
		return this.call("/sif/transactions/swp/register", "POST", body);
	}
	async cancelSwp(body: any) {
		return this.call("/sif/transactions/swp/cancel", "POST", body);
	}
	async pauseSwp(body: any) {
		return this.call("/sif/transactions/swp/pause", "POST", body);
	}

	// Additional Purchase (existing folio)
	async placeAdditionalPurchase(body: any) {
		return this.call("/sif/transactions/additional-purchase", "POST", body);
	}

	// eNACH / Mandate Creation
	async createMandate(body: any) {
		return this.call("/sif/mandates", "POST", body);
	}
	async getMandateStatus(mandateId: string) {
		return this.call(`/sif/mandates/${mandateId}`);
	}
	...
	async listActiveMandatesByBank(pan: string, bankAccountNo: string) {
		return this.call(
			`/sif/mandates/active?pan=${pan}&accountNo=${bankAccountNo}`,
		);
	}

	// Fixed Deposit Orders
	async placeFdOrder(body: any) {
		return this.call("/user/fixed-deposit/order", "POST", body);
	}
	async getFdOrders(pan: string) {
		return this.call(
			`/user/fixed-deposit/orders?pan=${encodeURIComponent(pan)}`,
		);
	}
	async getFdOrderDetails(orderId: string) {
		return this.call(`/user/fixed-deposit/orders/${orderId}`);
	}
	async prematureCloseFd(orderId: string, body: any) {
		return this.call(
			`/user/fixed-deposit/orders/${orderId}/premature-closure`,
			"POST",
			body,
		);
	}
	...
	async getNpsSubscriberDetails(pran: string) {
		return this.call(`/nps/subscriber/${pran}`);
	}
	async initiateNpsOnboarding(body: any) {
		return this.call("/nps/subscriber/onboarding", "POST", {
			...body,
			partnerCode: "FINTEKPRO",
		});
	}
	async placeNpsContribution(body: any) {
		return this.call("/nps/transactions/contribution", "POST", body);
	}
	async getNpsPortfolio(pran: string) {
		return this.call(`/nps/subscriber/${pran}/portfolio`);
	}
	async getNpsFundValues(pran: string) {
		return this.call(`/nps/subscriber/${pran}/fund-values`);
	}
	async getNpsTransactions(pran: string, params?: any) {
		const qs = params ? "?" + new URLSearchParams(params).toString() : "";
		return this.call(`/nps/subscriber/${pran}/transactions${qs}`);
	}
	async changeNpsScheme(pran: string, body: any) {
		return this.call(`/nps/subscriber/${pran}/scheme-change`, "POST", body);
	}
	async npsPartialWithdrawal(pran: string, body: any) {
		return this.call(
			`/nps/subscriber/${pran}/partial-withdrawal`,
			"POST",
			body,
		);
	}
	...
	async getNomineeDetails(pan: string) {
		return this.call(`/sif/non-financial/${pan}/nominee`);
	}
	async getBankDetails(pan: string) {
		return this.call(`/sif/non-financial/${pan}/bank`);
	}
	async getFatcaDetails(pan: string) {
		return this.call(`/sif/non-financial/${pan}/fatca`);
	}
	async getDividendHistory(pan: string, params?: any) {
		const qs = params ? "?" + new URLSearchParams(params).toString() : "";
		return this.call(`/user/investors/${pan}/dividend-history${qs}`);
	}
	async getEkycStatus(pan: string) {
		return this.call(`/user/investors/${pan}/ekyc-status`);
	}
	async getDematAccounts(pan: string) {
		return this.call(`/user/investors/${pan}/demat-accounts`);
	}
	async linkDematAccount(pan: string, body: any) {
		return this.call(`/user/investors/${pan}/demat-accounts`, "POST", body);
	}
	async getInvestorDocuments(pan: string) {
		return this.call(`/user/investors/${pan}/documents`);
	}
	async uploadInvestorDocument(pan: string, body: any) {
		return this.call(`/user/investors/${pan}/documents`, "POST", body);
	}

	// Financial Goals (per investor)
	async getGoals(pan: string) {
		return this.call(`/user/investors/${pan}/goals`);
	}
	async createGoal(pan: string, body: any) {
		return this.call(`/user/investors/${pan}/goals`, "POST", body);
	}
	async updateGoal(pan: string, goalId: string, body: any) {
		return this.call(`/user/investors/${pan}/goals/${goalId}`, "PUT", body);
	}
	async deleteGoal(pan: string, goalId: string) {
		return this.call(`/user/investors/${pan}/goals/${goalId}`, "DELETE");
	}

	// Non-Financial Transactions — POST (write)
	async updateNominee(pan: string, body: any) {
		return this.call(`/sif/non-financial/${pan}/nominee`, "POST", body);
	}
	async updateEmail(pan: string, body: any) {
		return this.call(`/sif/non-financial/${pan}/email`, "POST", body);
	}
	async updateMobile(pan: string, body: any) {
		return this.call(`/sif/non-financial/${pan}/mobile`, "POST", body);
	}
	async updateFatca(pan: string, body: any) {
		return this.call(`/sif/non-financial/${pan}/fatca`, "POST", body);
	}
	async updateIdcw(pan: string, body: any) {
		return this.call(`/sif/non-financial/${pan}/idcw`, "POST", body);
	}
	async updateBankDetails(pan: string, body: any) {
		return this.call(`/sif/non-financial/${pan}/bank`, "POST", body);
	}
	async manageBankMandate(pan: string, body: any) {
	...
	async getSubBrokerDetails(euinCode: string) {
		return this.call(`/user/hierarchy/sub-brokers/${euinCode}`);
	}
	...
	async registerSip(body: any) {
		return this.call("/sif/transactions/sip/register", "POST", {
			...body,
			partnerCode: "FINTEKPRO",
		});
	}
	async modifySip(sipId: string, body: any) {
		return this.call(`/sif/transactions/sip/${sipId}`, "PATCH", body);
	}
	async getSipDetails(sipId: string) {
		return this.call(`/sif/transactions/sip/${sipId}`);
	}
	...
	async listOrdersByPan(pan: string, params?: any) {
		const qs = params ? "?" + new URLSearchParams(params).toString() : "";
		return this.call(
			`/sif/transactions/orders?pan=${encodeURIComponent(pan)}${qs ? "&" + qs.slice(1) : ""}`,
		);
	}
	async getOrderDetails(orderId: string) {
		return this.call(`/sif/transactions/orders/${orderId}`);
	}
	async getSwitchStatus(orderId: string) {
		return this.call(`/sif/transactions/switch/${orderId}/status`);
	}

	// ─── STP Status ───────────────────────────────────────────────────────────────
	async listStpsByPan(pan: string) {
		return this.call(`/sif/transactions/stp?pan=${encodeURIComponent(pan)}`);
	}
	async getStpDetails(stpId: string) {
		return this.call(`/sif/transactions/stp/${stpId}`);
	}

	// ─── SWP Status ───────────────────────────────────────────────────────────────
	async listSwpsByPan(pan: string) {
		return this.call(`/sif/transactions/swp?pan=${encodeURIComponent(pan)}`);
	}
	async getSwpDetails(swpId: string) {
		return this.call(`/sif/transactions/swp/${swpId}`);
	}

	// ─── Failed Transactions ──────────────────────────────────────────────────────
	async listFailedTransactions(pan: string) {
		return this.call(
			`/sif/transactions/orders?pan=${encodeURIComponent(pan)}&status=FAILED,REJECTED`,
		);
	}

	// ─── Phase 1: Switch ─────────────────────────────────────────────────────────
	async placeSwitch(body: any) {
		return this.call("/sif/transactions/switch", "POST", body);
	}
	async cancelSwitch(body: any) {
		return this.call("/sif/transactions/switch/cancel", "POST", body);
	}
	async reinitiateSwitch(orderId: string) {
		return this.call(`/sif/transactions/switch/${orderId}/reinitiate`, "POST");
	}

	// ─── Phase 1: eNACH ──────────────────────────────────────────────────────────
	async createEnach(body: any) {
		return this.call("/sif/enach/create", "POST", body);
	}
	async getEnachStatus(mandateId: string) {
		return this.call(`/sif/enach/${mandateId}/status`);
	}
	async cancelEnach(mandateId: string) {
		return this.call(`/sif/enach/${mandateId}/cancel`, "POST");
	}
	async listEnach(pan: string) {
		return this.call(`/sif/enach?pan=${encodeURIComponent(pan)}`);
	}
	async regenerateEnachLink(mandateId: string) {
		return this.call(`/sif/enach/${mandateId}/regenerate-link`, "POST");
	}

	// ─── Phase 1: UPI Autopay Mandate ────────────────────────────────────────────
	async createUpiMandate(body: any) {
		return this.call("/sif/mandates/upi", "POST", body);
	}
	async getUpiMandateStatus(umrn: string) {
		return this.call(`/sif/mandates/upi/${umrn}`);
	}
	async cancelUpiMandate(umrn: string) {
		return this.call(`/sif/mandates/upi/${umrn}/cancel`, "POST");
	}
	async listUpiMandates(pan: string) {
		return this.call(`/sif/mandates/upi?pan=${encodeURIComponent(pan)}`);
	}

	// ─── Physical NACH Mandate ────────────────────────────────────────────────────
	async uploadPhysicalMandate(body: any) {
		return this.call("/sif/mandates/physical", "POST", body);
	}
	async listPhysicalMandates(pan: string) {
		return this.call(`/sif/mandates/physical?pan=${encodeURIComponent(pan)}`);
	}

	// ─── Phase 1: Folio Management ───────────────────────────────────────────────
	async listFolios(pan: string) {
		return this.call(`/user/investors/${pan}/folios`);
	}
	async getFolioDetails(pan: string, folioNo: string) {
		return this.call(`/user/investors/${pan}/folios/${folioNo}`);
	}
	async getFolioTransactions(pan: string, folioNo: string, params?: any) {
		const qs = params ? "?" + new URLSearchParams(params).toString() : "";
		return this.call(
			`/user/investors/${pan}/folios/${folioNo}/transactions${qs}`,
		);
	}

	// ─── Phase 1: Investor Portal Link ───────────────────────────────────────────
	async getInvestorPortalLink(pan: string) {
		return this.call(`/user/investors/${pan}/portal-link`);
	}
	async sendPortalLinkToInvestor(pan: string, body?: any) {
		return this.call(`/user/investors/${pan}/portal-link/send`, "POST", body);
	}
	...
	async getOnboardingStatus(applicationId: string) {
		return this.call(`/user/onboarding/${applicationId}/status`);
	}
	async verifyOnboardingKyc(applicationId: string, body: any) {
		return this.call(
			`/user/onboarding/${applicationId}/kyc-verify`,
			"POST",
			body,
		);
	}
	...
	async resendOnboardingLink(applicationId: string) {
		return this.call(`/user/onboarding/${applicationId}/resend-link`, "POST");
	}
	...
	async generateCasStatement(body: any) {
		return this.call("/reports/cas/generate", "POST", body);
	}
	...
	async getSchemeReturns(schemeCode: string) {
		return this.call(`/sif/schemes/${schemeCode}/returns`);
	}
	async getPortfolioXirr(pan: string) {
		return this.call(`/analytics/portfolio-xirr/${pan}`);
	}
	...
	async getSchemeLatestNav(schemeCode: string) {
		return this.call(`/sif/schemes/${schemeCode}/nav`);
	}

	// ─── Phase 3: Scheme Performance ─────────────────────────────────────────────
	async getSchemePerformance(schemeCode: string) {
		return this.call(`/sif/schemes/${schemeCode}/performance`);
	}
	...
	async getSchemeHoldings(schemeCode: string) {
		return this.call(`/sif/schemes/${schemeCode}/portfolio-holdings`);
	}
	async getSchemeFactSheet(schemeCode: string) {
		return this.call(`/sif/schemes/${schemeCode}/factsheet`);
	}

	// ─── Phase 3: Scheme Comparison ──────────────────────────────────────────────
	async compareSchemes(body: { schemeCodes: string[] }) {
		return this.call("/sif/schemes/compare", "POST", body);
	}

	// ─── Phase 3: Scheme Categories ──────────────────────────────────────────────
	async getSchemeCategories() {
		return this.call("/sif/categories");
	}
	async getSchemeSubcategories(category?: string) {
		return this.call(
			`/sif/subcategories${category ? "?category=" + encodeURIComponent(category) : ""}`,
		);
	}
	async getSchemesByCategory(category: string, params?: any) {
		const qs = params ? "&" + new URLSearchParams(params).toString() : "";
		return this.call(
			`/sif/schemes?category=${encodeURIComponent(category)}${qs}`,
		);
	}

	// ─── Phase 3: Investor Risk Profiling ────────────────────────────────────────
	async getRiskQuestionnaire() {
		return this.call("/user/risk-profile/questionnaire");
	}
	async submitRiskProfile(pan: string, body: any) {
		return this.call(`/user/investors/${pan}/risk-profile`, "POST", body);
	}
	async getInvestorRiskProfile(pan: string) {
		return this.call(`/user/investors/${pan}/risk-profile`);
	}
	async getSchemesForRiskProfile(riskProfile: string) {
		return this.call(
			`/sif/schemes/recommended?riskProfile=${encodeURIComponent(riskProfile)}`,
		);
	}
	...
	async getApplicationStatus(applicationId: string) {
		return this.call(`/user/applications/${applicationId}/status`);
	}
	async getOrderTracking(orderId: string) {
		return this.call(`/sif/transactions/${orderId}/tracking`);
	}

	// ─── Phase 3: Alert Management ───────────────────────────────────────────────
	async createAlert(body: any) {
		return this.call("/user/alerts", "POST", body);
	}
	async listAlerts(pan: string) {
		return this.call(`/user/alerts?pan=${encodeURIComponent(pan)}`);
	}
	async deleteAlert(alertId: string) {
		return this.call(`/user/alerts/${alertId}`, "DELETE");
	}
	async updateAlert(alertId: string, body: any) {
		return this.call(`/user/alerts/${alertId}`, "PUT", body);
	}
	...
	async sendWhatsappNotification(body: any) {
		return this.call("/notifications/whatsapp/send", "POST", body);
	}
	...
	async getNotificationTemplates() {
		return this.call("/notifications/templates");
	}
	 ...
	 */
	async getNotificationHistory(pan: string) {
		return this.call(`/notifications/history?pan=${encodeURIComponent(pan)}`);
	}
	...
	async sendWhatsAppMessage(opts: {
		...
		try {
			...
			const messageId =
				resp?.messageId ?? resp?.data?.messageId ?? resp?.id ?? undefined;
			...
			return {
				success: false,
				errorCode:
					errBody?.errorCode ?? (status ? `HTTP_${status}` : "NETWORK_ERROR"),
				retryable,
			};
		}
	}
	...
	// ─── Phase 3: NFO ─────────────────────────────────────────────────────────────
	async getNfoSchemes() {
		return this.call("/sif/nfo/active");
	}
	async getNfoSchemeDetails(schemeCode: string) {
		return this.call(`/sif/nfo/${schemeCode}`);
	}
	async applyNfo(body: any) {
		return this.call("/sif/nfo/apply", "POST", body);
	}
	async getNfoApplications(pan: string) {
		return this.call(`/sif/nfo/applications?pan=${encodeURIComponent(pan)}`);
	}
	async cancelNfoApplication(applicationId: string) {
		return this.call(`/sif/nfo/applications/${applicationId}/cancel`, "POST");
	}
	...
	async getSchemeFundManager(schemeCode: string) {
		return this.call(
			`/sif/schemes/${encodeURIComponent(schemeCode)}/fund-manager`,
		);
	}
	...
	async getSchemeBenchmarkComparison(schemeCode: string, params?: any) {
		const qs = params ? "?" + new URLSearchParams(params).toString() : "";
		return this.call(
			`/sif/schemes/${encodeURIComponent(schemeCode)}/benchmark${qs}`,
		);
	}
	...
	async importExternalPortfolio(body: any) {
		return this.call("/portfolio/import", "POST", body);
	}
	// Returns all externally linked / imported holdings for a PAN.
	async getExternalPortfolio(pan: string) {
		return this.call(`/portfolio/external/${encodeURIComponent(pan)}`);
	}
	// Links a single external folio (cross-registrar — CAMS or KFintech) to the investor.
	async linkExternalFolio(body: any) {
		return this.call("/portfolio/external/link", "POST", body);
	}
	// Unlinks / removes an external folio from IRIS tracking.
	async unlinkExternalFolio(folioNo: string) {
		return this.call(
			`/portfolio/external/${encodeURIComponent(folioNo)}`,
			"DELETE",
		);
	}
	// Triggers a live refresh of all external portfolio data for a PAN.
	async refreshExternalPortfolio(pan: string) {
		return this.call(
			`/portfolio/external/${encodeURIComponent(pan)}/refresh`,
			"POST",
		);
	}
	...
	async checkSecuritiesEligibility(pan: string, dpId?: string): Promise<any> {
		...
		return this.call(
			`/las/securities/eligibility/${encodeURIComponent(pan)}${qs}`,
		);
	}
	...
	async initiateMfPledge(body: {
		...
		return this.call("/las/mf/pledge/initiate", "POST", {
			...body,
			partnerCode: "FINTEKPRO",
		});
	}
	...
	async initiateSecuritiesPledge(body: {
		...
		return this.call("/las/securities/pledge/initiate", "POST", {
			...body,
			partnerCode: "FINTEKPRO",
		});
	}
	...
	async applyForLoan(body: {
		...
		return this.call("/las/loan/apply", "POST", {
			...body,
			partnerCode: "FINTEKPRO",
		});
	}
	...
	async releasePledge(
		...
		return this.call(
			`/las/pledge/${encodeURIComponent(pledgeId)}/release`,
			"POST",
			{ reason },
		);
	}
