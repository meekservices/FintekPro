...
const REPORT_LABELS: Record<string, LabelEntry> = {
	...
	client_profile: {
		...
		description: "Client information and investment objectives",
	},
	risk_assessment: {
		key: "risk_assessment",
		label: "Risk Assessment",
		description: "Risk profiling and tolerance analysis",
	},
	current_portfolio: {
		key: "current_portfolio",
		label: "Current Portfolio Analysis",
		description: "Analysis of existing investments",
	},
	recommended_allocation: {
		key: "recommended_allocation",
		label: "Recommended Asset Allocation",
		description: "Suggested portfolio distribution",
	},
	exit_load: {
		key: "exit_load",
		label: "Exit Load Analysis",
		description: "Exit load impact on redemptions",
	},
	capital_gains: {
		key: "capital_gains",
		label: "Capital Gains Summary",
		description: "Tax implications of transactions",
	},
	tax_impact: {
		key: "tax_impact",
		label: "Tax Impact Analysis",
		description: "Comprehensive tax analysis",
	},
	sip_projection: {
		key: "sip_projection",
		label: "SIP Projection",
		description: "Systematic investment projections",
	},
	what_if_scenarios: {
		key: "what_if_scenarios",
		label: "What-If Scenarios",
		description: "Market scenario analysis",
	},
	fee_disclosure: {
		key: "fee_disclosure",
		label: "Fee Disclosure",
		description: "Fees and charges disclosure",
	},
	terms_conditions: {
	...
	expense_ratio: {
		key: "expense_ratio",
		label: "Expense Ratio",
		description: "Fund management cost percentage",
	},
	risk_heat_map: {
		key: "risk_heat_map",
		label: "Risk Heat Map",
		description: "Visual risk distribution",
	},
	...
	buy_verdict: {
		key: "buy_verdict",
		label: "BUY",
		description: "Recommend purchasing",
	},
	hold_verdict: {
		key: "hold_verdict",
		label: "HOLD",
		description: "Recommend maintaining position",
	},
	sell_verdict: {
		key: "sell_verdict",
		label: "SELL",
		description: "Recommend selling",
	},

	// SIP Source Labels
	sip_rebalancing: {
		key: "sip_rebalancing",
		label: "Rebalancing SIP",
		description: "SIP from existing holdings rebalancing",
	},
	sip_fresh: {
		key: "sip_fresh",
		label: "Fresh Investment SIP",
		description: "SIP from new investment",
	},
	sip_hybrid: {
		key: "sip_hybrid",
		label: "Hybrid SIP",
		description: "SIP combining rebalancing and fresh investment",
	},
	...
	goal_wealth_creation: {
		key: "goal_wealth_creation",
		label: "Wealth Creation",
		description: "Capital appreciation focused",
	},
	goal_income_generation: {
		key: "goal_income_generation",
		label: "Income Generation",
		description: "Regular income focused",
	},
	goal_capital_preservation: {
		key: "goal_capital_preservation",
		label: "Capital Preservation",
		description: "Safety-focused investing",
	},
	goal_education: {
		key: "goal_education",
		label: "Education Funding",
		description: "Children education planning",
	},
	goal_home_purchase: {
		key: "goal_home_purchase",
		label: "Home Purchase",
		description: "Property down payment",
	},
	goal_emergency_fund: {
		key: "goal_emergency_fund",
		label: "Emergency Fund",
		description: "Liquid safety net",
	},

	// Risk Profile Labels
	risk_conservative: {
		key: "risk_conservative",
		label: "Conservative",
	...
	risk_moderate: {
		key: "risk_moderate",
		label: "Moderate",
		description: "Balanced risk tolerance",
	},
	risk_aggressive: {
		key: "risk_aggressive",
		label: "Aggressive",
	...
	risk_very_aggressive: {
		key: "risk_very_aggressive",
		label: "Very Aggressive",
		description: "Very high risk tolerance",
	},
	...
	// Phase Labels
	phase_risk_profile: {
		key: "phase_risk_profile",
		label: "Risk Profile",
		description: "Client risk assessment",
	},
	phase_investment_horizon: {
		key: "phase_investment_horizon",
		label: "Investment Horizon",
		description: "Time frame selection",
	},
	phase_goal: {
		key: "phase_goal",
	...
	phase_portfolio_input: {
		key: "phase_portfolio_input",
		label: "Portfolio Input",
		description: "Current holdings entry",
	},
	phase_analysis: {
		key: "phase_analysis",
		label: "Portfolio Analysis",
		description: "Holdings analysis",
	},
	phase_recommendation: {
		key: "phase_recommendation",
		label: "AI Recommendations",
		description: "Investment suggestions",
	},
	phase_rebalancing: {
		key: "phase_rebalancing",
		label: "Rebalancing",
	...
	phase_verdict: {
		...
		description: "Buy/Hold/Sell decisions",
	},
	phase_report: {
		key: "phase_report",
		label: "Report Generation",
		description: "Final proposal report",
	},
	...
	scenario_bear_10: {
		key: "scenario_bear_10",
		label: "Bear Case (-10%)",
		description: "Mild market correction",
	},
	scenario_bear_20: {
		key: "scenario_bear_20",
		label: "Bear Case (-20%)",
...
export class ReportLabelRegistry {
	static getLabel(key: string): string {
		const normalizedKey = ReportLabelRegistry.normalizeKey(key);
	...
	static getSectionLabels(): LabelEntry[] {
		return ReportLabelRegistry.getLabelsForCategory("");
	}
	...
	static getGoalLabels(): LabelEntry[] {
		return ReportLabelRegistry.getLabelsForCategory("goal_");
	}

	static getRiskProfileLabels(): LabelEntry[] {
		return ReportLabelRegistry.getLabelsForCategory("risk_");
	}

	static getPhaseLabels(): LabelEntry[] {
		return ReportLabelRegistry.getLabelsForCategory("phase_");
	}

	static getScenarioLabels(): LabelEntry[] {
		return ReportLabelRegistry.getLabelsForCategory("scenario_");
	}
}
