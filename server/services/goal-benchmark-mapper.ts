...
import { db } from "../db";
import {
	goalBenchmarkMapping,
	InsertGoalBenchmarkMapping,
} from "@shared/schema";
...
const DEFAULT_BENCHMARKS: InsertGoalBenchmarkMapping[] = [
	// Retirement - Long term horizons
	{
		...
		benchmarkRationale: "Large cap stability for long-term retirement goals",
		isDefault: true,
	},
	{
		goalType: "retirement",
		...
		benchmarkRationale:
			"Broad market exposure for moderate risk retirement planning",
		isDefault: true,
	},
	{
		goalType: "retirement",
		...
		benchmarkRationale:
			"Higher growth potential for aggressive retirement portfolios",
		isDefault: true,
	},
	...
	// Wealth Creation
	{
		...
		horizonYearsMin: 5,
		horizonYearsMax: 99,
		benchmarkCode: "NIFTYLARGECAP",
		benchmarkName: "NIFTY Large Cap 100 TRI",
		benchmarkRationale: "Blue chip focus for conservative wealth building",
		isDefault: true,
	},
	{
		goalType: "wealth_creation",
		...
		benchmarkCode: "NIFTY50",
		benchmarkName: "NIFTY 50 TRI",
		benchmarkRationale: "Market benchmark for balanced wealth creation",
		isDefault: true,
	},
	{
		goalType: "wealth_creation",
		...
		benchmarkRationale:
			"High growth small cap exposure for aggressive wealth building",
		isDefault: true,
	},

	// Income Generation
	{
		goalType: "income_generation",
		riskProfile: "conservative",
		horizonYearsMin: 1,
		horizonYearsMax: 99,
		benchmarkCode: "CRISIL_COMPOSITE",
		benchmarkName: "CRISIL Composite Bond Index",
		benchmarkRationale: "Fixed income benchmark for regular income generation",
		isDefault: true,
	},
	{
		goalType: "income_generation",
		...
		horizonYearsMin: 1,
		horizonYearsMax: 99,
		benchmarkCode: "NIFTY_DIV_OPP",
		benchmarkName: "NIFTY Dividend Opportunities 50 TRI",
		benchmarkRationale: "Dividend-focused equity for moderate income needs",
		isDefault: true,
	},
	...
	// Capital Preservation
	{
		...
		horizonYearsMin: 0,
		horizonYearsMax: 99,
		benchmarkCode: "CRISIL_LIQUID",
		benchmarkName: "CRISIL Liquid Fund Index",
		benchmarkRationale: "Capital safety with minimal volatility",
		isDefault: true,
	},
	{
		goalType: "capital_preservation",
		...
		horizonYearsMin: 0,
		horizonYearsMax: 99,
		benchmarkCode: "CRISIL_SHORT_TERM",
		benchmarkName: "CRISIL Short Term Bond Index",
		benchmarkRationale: "Short duration bonds for capital stability",
		isDefault: true,
	},
	...
	// Education
	{
		...
		horizonYearsMin: 3,
		horizonYearsMax: 10,
		benchmarkCode: "CRISIL_HYBRID",
		benchmarkName: "CRISIL Hybrid 35+65 Index",
		benchmarkRationale: "Balanced approach for medium-term education goals",
		isDefault: true,
	},
	{
		goalType: "education",
		...
		benchmarkCode: "NIFTY50",
		benchmarkName: "NIFTY 50 TRI",
		benchmarkRationale: "Growth-focused for longer education planning",
		isDefault: true,
	},
	{
		goalType: "education",
		...
		benchmarkCode: "NIFTYMIDCAP150",
		benchmarkName: "NIFTY Midcap 150 TRI",
		benchmarkRationale: "Higher growth for very long-term education funding",
		isDefault: true,
	},
	...
	// Home Purchase
	{
		...
		benchmarkCode: "CRISIL_SHORT_TERM",
		benchmarkName: "CRISIL Short Term Bond Index",
		benchmarkRationale: "Capital protection for near-term home purchase",
		isDefault: true,
	},
	{
		goalType: "home_purchase",
		...
		benchmarkCode: "NIFTYLARGECAP",
		benchmarkName: "NIFTY Large Cap 100 TRI",
		benchmarkRationale: "Balanced growth for medium-term property goals",
		isDefault: true,
	},
	...
	// Emergency Fund
	{
		...
		benchmarkCode: "CRISIL_LIQUID",
		benchmarkName: "CRISIL Liquid Fund Index",
		benchmarkRationale: "Immediate liquidity with capital safety",
		isDefault: true,
	},
];
...
export class GoalBenchmarkMapper {
	...
	static async selectBenchmark(
		...
		return GoalBenchmarkMapper.getFallbackBenchmark(riskProfile);
	}

	private static getFallbackBenchmark(
		riskProfile: RiskProfile,
	): BenchmarkSelection {
