...
const itrForms: ITRForm[] = [
  ...
  },
  {
    id: "itr2",
    name: "ITR-2",
    description: "For individuals with income from capital gains, multiple properties, foreign assets",
  ...
  },
  {
    id: "itr7",
    name: "ITR-7",
    description: "For trusts, political parties, institutions, and other entities",
...
const taxServices: TaxService[] = [
  // Tax Filing Services
  {
    ...
    isPopular: true,
    icon: FileText,
    benefits: ["Hassle-free filing", "Maximum refund", "Expert review", "Income tax notice support"],
    documents: ["Form 16", "Bank Statement", "Investment Proofs", "PAN Card"]
  },
  {
    id: "comprehensive-filing",
    title: "Comprehensive Tax Filing",
    description: "Complete tax filing for complex income sources and investments",
    category: "Filing",
    features: ["All ITR Forms", "Capital Gains", "Multiple Incomes", "Dedicated CA"],
    price: 2999,
    processingTime: "2-3 business days",
    rating: 4.8,
    isPremium: true,
    icon: Receipt,
    benefits: ["Complete tax optimization", "All income sources", "Capital gains planning", "Year-round support"],
    documents: ["All Income Documents", "Investment Statements", "Property Documents", "Foreign Asset Details"]
  },
  ...
  // Tax Planning Services
  {
    ...
    description: "Comprehensive tax planning to minimize your tax liability legally",
    category: "Planning",
    features: ["Investment Planning", "Tax-saving Instruments", "Retirement Planning", "Regular Reviews"],
    price: 4999,
    processingTime: "5-7 business days",
    rating: 4.9,
    isPremium: true,
    icon: Calculator,
    benefits: ["30-40% tax savings", "Customized strategy", "Regular monitoring", "Investment guidance"],
    documents: ["Salary Slips", "Investment Portfolio", "Insurance Policies", "Previous ITRs"]
  },
  {
    id: "ca-consultation",
    title: "CA Consultation",
    description: "One-on-one consultation with experienced Chartered Accountants",
    category: "Consultation",
    features: ["Personal Meeting", "Expert Advice", "Document Review", "Follow-up Support"],
    price: 1999,
    processingTime: "Same day",
    rating: 4.7,
    isPopular: true,
    icon: Users,
    benefits: ["Expert guidance", "Personalized advice", "Complex queries resolution", "Ongoing support"],
  ...
  // Compliance Services
  {
    ...
    category: "Compliance",
    features: ["Quarterly Filing", "TDS Reconciliation", "Form 16A Generation", "Correction Returns"],
    price: 2499,
    processingTime: "3-5 business days",
    rating: 4.5,
    icon: Building2,
    benefits: ["Compliance assurance", "Penalty avoidance", "Timely filing", "Expert handling"],
  ...
  },
  {
    ...
    category: "Compliance",
    features: ["Monthly Filing", "ITC Optimization", "Reconciliation", "Notice Handling"],
    price: 1999,
    processingTime: "5-7 business days",
    rating: 4.4,
    icon: Receipt,
    benefits: ["GST compliance", "ITC maximization", "Penalty protection", "Regular updates"],
    documents: ["Sales Invoices", "Purchase Bills", "Bank Statements", "GSTR-2A"]
  },
  ...
  // Advisory Services
  {
    ...
    description: "Statutory tax audit for businesses exceeding prescribed limits",
    category: "Audit",
    features: ["Statutory Audit", "Tax Audit Report", "Compliance Check", "Audit Defense"],
    price: 15999,
  ...
  },
  {
    ...
    isPopular: true,
    icon: AlertTriangle,
    benefits: ["Expert representation", "Penalty minimization", "Quick resolution", "Legal protection"],
...
const taxPlanningStrategies: TaxPlanning[] = [
  {
    ...
    description: "Maximize deductions up to ₹1.5 lakh through ELSS, PPF, and life insurance",
    potentialSavings: "₹46,800",
    category: "Deductions",
    icon: PieChart,
    details: ["ELSS Mutual Funds - ₹1.5L", "PPF Contribution - ₹1.5L", "Life Insurance Premium", "Home Loan Principal"]
  },
  {
  ...
  },
  {
    ...
    description: "Dual benefits from home loan interest and principal repayment",
    potentialSavings: "₹4,68,000",
    category: "Property",
    icon: Building2,
    details: ["Interest Deduction - ₹2L", "Principal Deduction - ₹1.5L", "First Home Buyer - ₹3.5L Interest"]
  },
  {
    id: "nps-contribution",
    ...
    category: "Retirement",
    icon: TrendingUp,
    details: ["Employee Contribution - 10% of Salary", "Additional NPS - ₹50,000", "Employer Contribution - 14%"]
  },
  {
    id: "education-loan",
    title: "Education Loan Interest",
    description: "Deduction for interest on education loan without any upper limit",
    potentialSavings: "Unlimited",
    category: "Education",
    icon: BookOpen,
    details: ["No Upper Limit", "For Self/Spouse/Children", "Higher Education Only", "8 Years Maximum"]
  },
  {
    ...
    category: "Donations",
    icon: Award,
    details: ["80G Donations - 50% to 100%", "PM CARES - 100%", "Electoral Bonds", "Scientific Research"]
  }
];
...
export default function ITRTaxServices() {
  ...
  const categories = ["All", "Filing", "Planning", "Consultation", "Compliance", "Audit", "Advisory"];
  ...
  const calculateTaxSavings = () => {
    const total = taxPlanningStrategies.reduce((sum, strategy) => {
      if (strategy.potentialSavings.includes('₹')) {
        const amount = parseInt(strategy.potentialSavings.replace(/[₹,]/g, ''));
        return sum + amount;
      }
      return sum;
    }, 0);
      ...
      <div className="relative bg-gradient-to-br from-green-600 via-blue-600 to-purple-600 rounded-3xl p-8 md:p-12 text-foreground overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl mb-8 text-blue-100 max-w-3xl leading-relaxed">
            Expert tax filing, planning, and compliance services with CA consultation. Maximize your savings and ensure complete compliance.
          </p>
                  ...
                  <Card key={form.id} className="relative border-2 hover:border-green-200 transition-colors cursor-pointer">
                    <CardHeader className="pb-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge 
                          variant={form.complexity === "Simple" ? "secondary" : form.complexity === "Moderate" ? "outline" : "destructive"}
                          className="text-xs"
                        >
                          {form.complexity}
                        </Badge>
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        <h5 className="font-semibold text-sm mb-2">Applicable For:</h5>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <Input placeholder="Enter your annual income" data-testid="input-annual-income" />
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Investments (80C)</label>
                    <Input placeholder="Enter 80C investments" data-testid="input-80c-investments" />
                  </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg p-6">
                  <h3 className="font-semibold mb-4">Your Tax Savings Breakdown</h3>
                ...
                <div className="space-y-3">
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-green-600 font-semibold">Filed</span>
                    </div>
