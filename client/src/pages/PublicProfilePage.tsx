					...
					<div className="md:col-span-2 space-y-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Visualizing performance without exposing private values.
								</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="h-48 bg-muted rounded-lg flex items-center justify-center border border-dashed">
									<p className="text-sm text-muted-foreground italic text-center px-8">
										"I believe in long-term wealth creation through diversified
										US equities and automated SIPs."
									</p>
								</div>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent className="flex flex-wrap gap-3">
								<Badge variant="outline" className="py-1 px-3 gap-2">
									🌱 First Deposit
								</Badge>
								<Badge variant="outline" className="py-1 px-3 gap-2">
									🇺🇸 Global Explorer
