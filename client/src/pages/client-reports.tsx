    ...
    reports: [
      {
        ...
        description: 'Complete overview of all your current investments across asset classes',
      ...
      },
      {
        ...
        description: 'Breakdown of your portfolio by asset class, sector, and geography',
      ...
      },
      {
        ...
        description: 'Current market value of all holdings with cost basis comparison',
    ...
    reports: [
      {
        ...
        description: 'Month-over-month returns analysis with benchmark comparison',
      ...
      },
      {
        ...
        description: 'Comprehensive Q4 2024 performance analysis with market insights',
  ...
  },
  {
    ...
    reports: [
      ...
      },
      {
        ...
        description: 'Identified opportunities to optimize tax liability through loss harvesting',
      ...
      },
      {
        ...
        description: 'Consolidated Form 16 information from all dividend and interest income',
    ...
    reports: [
      {
        ...
        description: 'Complete account activity including deposits, withdrawals, and transfers',
        lastGenerated: '2024-12-20',
        status: 'ready',
        size: '1.8 MB'
      },
      ...
      },
      {
        ...
        description: 'Summary of all dividend payments received across your portfolio',
        lastGenerated: '2024-12-01',
        status: 'ready',
        size: '280 KB'
      }
...
export default function ClientReports() {
  ...
  const handleDownload = (report: Report) => {
    ...
    if (report.status === 'scheduled') {
      toast({
        ...
        description: "This report is scheduled for generation. Check back soon.",
        variant: "default"
      });
      return;
    }
  ...
  const getReportIcon = (reportId: string) => {
    switch (reportId) {
      case 'holdings_summary': return Wallet;
      case 'asset_allocation': return PieChart;
      case 'portfolio_valuation': return IndianRupee;
      case 'monthly_performance': return BarChart3;
      case 'quarterly_review': return TrendingUp;
      case 'annual_summary': return FileCheck;
      case 'capital_gains': return Receipt;
      case 'tax_harvesting': return Banknote;
      case 'form16_summary': return FileText;
      case 'account_statement': return FileSpreadsheet;
      case 'transaction_history': return History;
      case 'dividend_income': return IndianRupee;
      default: return FileText;
    }
  };
  ...
  const readyReports = REPORT_CATEGORIES.reduce(
    (acc, cat) => acc + cat.reports.filter(r => r.status === 'ready').length, 0
  );
            ...
            <TabsContent key={category.id} value={category.id} className="mt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {category.reports.map((report) => {
                  const statusConfig = getStatusConfig(report.status, report.id);
                  const StatusIcon = statusConfig.icon;
                  const ReportIcon = getReportIcon(report.id);
                  const isGenerating = generatingReports.has(report.id) || report.status === 'generating';
