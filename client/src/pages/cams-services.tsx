...
export default function CamsServices() {
  ...
  // API hooks
  const { data: portfolioData, isLoading: portfolioLoading, error: portfolioError } = useCamsPortfolio(selectedPan);
  const { data: transactionData, isLoading: transactionLoading } = useCamsTransactions(selectedPan);
  ...
  const { data: investorValidation, isLoading: validationLoading } = useCamsInvestorValidation(selectedPan);
          ...
          <TabsContent value="schemes" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Browse mutual fund schemes available through CAMS</CardDescription>
              </CardHeader>
              <CardContent>
                {schemesLoading ? (
                  <div className="flex items-center justify-center py-8">
