...
const reportCategories: ReportCategory[] = [
	{
		...
		description:
			"Holdings, transactions, SIP summary, and capital gains from BSE STAR MF",
		icon: TrendingUp,
		color: "blue",
		reports: [
			{
				id: "mf-holdings",
				name: "MF Portfolio Holdings",
				description: "Complete mutual fund holdings with current NAV",
				apiSource: "BSE STAR MF - GetHoldingReport",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			...
			{
				id: "mf-transactions",
				name: "MF Transaction Report",
				description: "All purchase, redemption, and switch transactions",
				apiSource: "BSE STAR MF - GetTransactionReport",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			},
			{
				id: "sip-summary",
				name: "SIP Summary",
				description: "Active SIPs with installment status",
				apiSource: "BSE STAR MF - SIPReport",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			},
			{
				...
				apiSource: "BSE STAR MF - GetCapitalGainReport",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			},
			{
				...
				description: "Dividend payouts and reinvestments",
				apiSource: "BSE STAR MF - DividendReport",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
		...
		externalSources: [
			{
				...
				description: "CAS + MF Holdings",
			},
			{
				name: "KFinTech",
				url: "https://mfs.kfintech.com/investor/",
				description: "MF Portfolio & SIP Summary",
			},
			{
				name: "BSE STAR MF",
				url: "https://www.bsestarmf.in/",
				description: "Orders placed under ARN",
			},
		],
	},
	{
		...
		description:
			"Portfolio snapshot, transaction ledger, and valuations from NSDL/CDSL",
		icon: BarChart3,
		color: "green",
		reports: [
			{
				id: "demat-snapshot",
				name: "NSDL/CDSL Portfolio Snapshot",
				description: "Complete demat holdings with current prices",
				apiSource: "Account Aggregator - Demat Statement API",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			...
			{
				id: "isin-ledger",
				name: "ISIN-wise Transaction Ledger",
				description: "All buy/sell transactions by ISIN",
				apiSource: "Account Aggregator - NSDL/CDSL CA API",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			},
			{
				...
				description: "Mark-to-market valuation of holdings",
				apiSource: "DP Partner API",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
		...
		externalSources: [
			{
				...
				description: "Consolidated Demat Statement",
			},
			{
				name: "CDSL",
				url: "https://www.cdslindia.com/",
				description: "Account Statement & Portfolio Snapshot",
			},
			{
				name: "Your Broker",
				url: "#",
				description: "Contract Notes, Ledger, Holdings",
			},
		],
	},
	{
		...
		description:
			"Holdings, certificates, and fair value for unlisted company shares",
		icon: Building2,
		color: "purple",
		reports: [
			{
				id: "unlisted-holdings",
				name: "Holdings & Certificates",
				description: "Unlisted shares with share certificates",
				apiSource: "NSDL/CDSL (AA) + Registrar APIs",
				requiresKYC: true,
				kycLevel: 2,
				formats: ["PDF", "XLSX"],
				status: "available",
			},
			{
				...
				description: "Lock-in status and transfer restrictions",
				apiSource: "Registrar API",
				requiresKYC: true,
				kycLevel: 2,
				formats: ["PDF"],
				status: "available",
			...
			{
				id: "historical-deals",
				name: "Historical Deals & Fair Value",
				description: "Past transactions and current fair value",
				apiSource: "FintekPro Valuation Engine",
				requiresKYC: true,
				kycLevel: 2,
				formats: ["PDF", "XLSX"],
				status: "available",
		...
		externalSources: [
			{
				...
				description: "PMS Holdings",
			},
			{
				name: "LinkIntime",
				url: "https://linkintime.co.in/",
				description: "Share Registry",
			},
			{
				name: "KFintech Private",
				url: "https://kfintech.com/",
				description: "Private Market Holdings",
			},
		],
	},
	{
		...
		reports: [
			{
				id: "bond-holdings",
				name: "Bond/NCD Holdings",
				description: "All fixed income securities in demat",
				apiSource: "Demat data via AA",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			...
			{
				id: "coupon-calendar",
				name: "Coupon Calendar",
				description: "Upcoming interest payment dates",
				apiSource: "Trustees / Registrars",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			...
			{
				id: "redemption-schedule",
				name: "Redemption Schedule",
				description: "Maturity dates and redemption amounts",
				apiSource: "Exchange allotment records",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
		...
		externalSources: [
			{
				name: "NSE",
				url: "https://www.nseindia.com/market-data/bonds-traded-in-cm",
				description: "NSE Bond Listings",
			},
			{
				name: "BSE",
				url: "https://www.bseindia.com/markets/debt/debt_corp_702.aspx",
				description: "BSE Debt Market",
			},
			{
				name: "RBI Retail Direct",
				url: "https://rbiretaildirect.org.in/",
				description: "G-Sec Holdings",
			},
		],
	},
	{
		...
		reports: [
			{
				id: "epf-passbook",
				name: "EPF Passbook",
				description: "Employee Provident Fund balance and contributions",
				apiSource: "EPFO Passbook API + Aadhaar OTP",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			},
			{
				id: "vpf-ppf-ledger",
				name: "VPF & PPF Ledger",
				description: "Voluntary and Public Provident Fund statements",
				apiSource: "EPFO + Bank API via AA",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			...
			{
				id: "nps-statement",
				name: "NPS Statement (Tier I/II)",
				description: "National Pension System holdings and performance",
				apiSource: "Protean CRA API / KFin NPS CRA",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			...
			{
				id: "apy-log",
				name: "APY Contribution Log",
				description: "Atal Pension Yojana contributions",
				apiSource: "Bank feed via AA",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
		...
		externalSources: [
			{
				...
				description: "EPF Passbook",
			},
			{
				name: "NPS CRA",
				url: "https://npscra.nsdl.co.in/",
				description: "Tier I & II Statements",
			},
		...
		reports: [
			{
				id: "ais-summary",
				name: "AIS Summary",
				description: "Annual Information Statement from Income Tax",
				apiSource: "Income Tax Portal API",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
				status: "available",
			...
			{
				id: "form-26as",
				name: "Form 26AS Insights",
				description: "TDS/TCS credits and tax payments",
				apiSource: "Income Tax Portal API",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF", "XLSX"],
			...
			{
				id: "consolidated-tax",
				name: "Consolidated Tax Report",
				description: "Year-end comprehensive tax summary",
				apiSource: "FintekPro Tax Engine",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF"],
				status: "available",
	...
	},
	{
		...
		title: "Order History",
		description:
			"All mutual fund buy/sell orders, SIPs, switches, and settlement status",
		icon: Receipt,
		color: "purple",
		reports: [
			{
				id: "mf-orders",
				name: "MF Order History",
				description: "All mutual fund transactions with settlement status",
				apiSource: "FintekPro Order Management",
				requiresKYC: false,
				kycLevel: 0,
				formats: ["PDF", "XLSX"],
				status: "available",
			...
			{
				id: "sip-orders",
				name: "SIP Order History",
				description: "Systematic Investment Plan orders and installments",
				apiSource: "FintekPro SIP Module",
				requiresKYC: false,
				kycLevel: 0,
				formats: ["PDF", "XLSX"],
				status: "available",
			},
			{
				id: "contract-notes",
				name: "Contract Notes",
				description: "Digital contract notes for executed orders",
				apiSource: "BSE STAR MF",
				requiresKYC: true,
				kycLevel: 1,
				formats: ["PDF"],
				status: "available",
		...
		externalSources: [
			{
				name: "BSE STAR MF",
				url: "https://www.bsestarmf.in/",
				description: "Order Status & Contract Notes",
			},
		],
	},
];
...
export default function ReportsHub() {
	...
	const userKYCLevel = Number.parseInt(kycData?.kycLevel) || 0;
	...
	const syncMFMutation = useMutation({
		...
		onSuccess: (data: any) => {
			...
			toast({
				...
				description:
					data.message ||
					`Synced ${data.syncedCount} mutual fund holdings to your portfolio.`,
			});
			setIsSyncing(null);
		},
		onError: (error: any) => {
	...
	const syncDematMutation = useMutation({
		mutationFn: async () => {
			const response = await apiRequest(
				"/api/reports/sync-demat-to-portfolio",
				{
					method: "POST",
					body: JSON.stringify({
						userId: user?.id,
		...
		onSuccess: (data: any) => {
			...
			toast({
				...
				description:
					data.message ||
					`Synced ${data.syncedCount} demat holdings to your portfolio.`,
			});
			setIsSyncing(null);
		},
		onError: (error: any) => {
	...
	const handleSyncToPortfolio = (type: "mf" | "demat") => {
		if (!isPanVerified) {
			toast({
				...
				description:
					"Please verify your PAN card to sync holdings from external sources.",
				variant: "destructive",
			});
			return;
		}
			...
			<div className="max-w-7xl mx-auto space-y-6">
				<div className="text-center space-y-2">
					...
					<p className="text-xl text-muted-foreground">
						Access all your financial reports in one place - auto-fetched from
						official sources
					</p>
				</div>
				...
				<Alert className="border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/30">
					...
					<AlertDescription className="text-blue-800 dark:text-blue-200">
						<span className="font-semibold">SEBI & PMLA Compliant:</span> All
						reports are encrypted, audit-logged, and stored securely for 7 years
						...
						<div className="flex items-center justify-between">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										View all FintekPro orders and payment transactions
									</p>
								</div>
							</div>
							<Link href="/transaction-reports">
								<Button
									...
									data-testid="link-transaction-reports"
								>
					...
					<CardHeader className="pb-2">
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<CardDescription>
									Complete audit trail of all store transactions - maintained
									for 7 years per SEBI/RBI regulations
								</CardDescription>
							</div>
						</div>
					</CardHeader>
				...
				<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
					{reportCategories.map((category) => {
						...
						return (
							...
							>
								<div
									className={`w-10 h-10 mx-auto rounded-full ${catColors.iconBg} flex items-center justify-center mb-2`}
								>
									<Icon className={`w-5 h-5 ${catColors.text}`} />
								</div>
								<p
									className={`text-sm font-medium ${isActive ? catColors.text : "text-muted-foreground"}`}
								>
												...
												<div className="flex items-start justify-between gap-4">
													<div className="flex-1">
														<div className="flex items-center gap-2 mb-1">
															...
															<h4
																className={`font-semibold ${isLocked ? "text-muted-foreground" : "text-foreground"}`}
															>
																{report.name}
															</h4>
															{isLocked && (
														...
														<p
															className={`text-sm ${isLocked ? "text-muted-foreground" : "text-muted-foreground"} mb-2`}
														>
															{report.description}
														</p>
													...
													{!isLocked && (
														<div className="flex items-center gap-2">
															<Button
																...
																variant="outline"
																onClick={() =>
																	handleGenerateReport(report.id, report.name)
																}
																disabled={isLoading}
															...
															{report.formats.map((format) => (
																<Button
																	...
																	variant="outline"
																	onClick={() =>
																		handleDownload(report.id, format)
																	}
											...
											{isLoadingOrders ? (
																	...
																	<div className="flex-1">
																		<div className="flex items-center gap-2 mb-1">
																			<Badge
																				variant={
																					order.orderType === "buy" ||
																					order.orderType === "lumpsum"
																						? "default"
																						: order.orderType === "sell" ||
																								order.orderType === "redemption"
																							? "destructive"
																							: order.orderType === "sip"
																								? "secondary"
																								: "outline"
																		...
																		<p className="font-medium text-foreground text-sm">
																			{order.schemeName || "Mutual Fund Order"}
																		</p>
																	...
																	<div className="text-right">
																		...
																		{order.units && (
																			<p className="text-xs text-muted-foreground">
																				{Number.parseFloat(order.units).toFixed(
																					3,
																				)}{" "}
																				units
																			</p>
												...
												<div className="text-center py-8 text-muted-foreground">
													...
													<p className="text-sm mt-1">
														Your mutual fund orders will appear here
													</p>
												</div>
											)}
										</div>
							...
							<Card className="bg-gradient-to-br from-green-50 dark:from-green-950/30 to-emerald-50 dark:to-emerald-950/30 border-green-200 dark:border-green-800">
								<CardHeader>
									...
									<CardDescription className="text-green-700 dark:text-green-300">
										Auto-populate your portfolio with holdings from external
										sources
									</CardDescription>
								</CardHeader>
								<CardContent className="space-y-3">
							...
							<Card>
								...
								<CardContent>
									<div className="text-center py-4 text-muted-foreground">
										...
										<p className="text-xs">
											Generate a report to see activity here
										</p>
									</div>
								</CardContent>
							</Card>
