...
export default function BondCategoryPage() {
  ...
  const filteredBonds = bonds
    ...
    .sort((a: any, b: any) => {
      ...
      switch (sortBy) {
        case "yield":
          aVal = parseFloat(a.yieldToMaturity || a.ytm || a.currentYield || a.indicativeYield || 0);
          bVal = parseFloat(b.yieldToMaturity || b.ytm || b.currentYield || b.indicativeYield || 0);
          break;
        case "coupon":
          aVal = parseFloat(a.couponRate || 0);
          bVal = parseFloat(b.couponRate || 0);
          break;
        case "maturity":
          ...
          break;
        case "price":
          aVal = parseFloat(a.currentPrice || a.lastPrice || a.lastTradedPrice || 0);
          bVal = parseFloat(b.currentPrice || b.lastPrice || b.lastTradedPrice || 0);
          break;
        default:
        ...
        {isLoading ? (
          ...
          <Card>
            <CardContent className="p-8 text-center">
              <p className="text-red-500">Failed to load bonds. Please try again.</p>
          ...
          <div className="grid gap-4">
            {filteredBonds.map((bond: any) => (
              <Card 
                ...
                onClick={() => navigate(`/bonds/detail/${bond.isin || bond.id}`)}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {bond.bondType && (
                          <Badge variant="outline">{bond.bondType || bond.type}</Badge>
                        )}
                      </div>
