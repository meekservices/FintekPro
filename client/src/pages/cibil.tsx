...
export default function Cibil() {
  ...
  const handleCardEligibilityCheck = () => {
    checkCardEligibility({
      ...
      monthlyIncome: parseInt(formData.monthlyIncome),
      employmentType: formData.employmentType,
      existingCards: parseInt(formData.existingCards) || 0
    });
  };
  ...
  return (
    <div className="min-h-screen bg-finance-light" data-testid="cibil-page">
      ...
      <main className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-16 lg:pt-0 ${isNavCollapsed ? 'ml-16 lg:ml-0' : 'ml-64 lg:ml-0'}`}>
        ...
        {/* Page Header */}
        <div className="mb-8" data-testid="cibil-header">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">CIBIL Credit Services</h1>
          <p className="text-gray-600 text-lg">
            Check your credit score, get detailed reports, and improve your creditworthiness
          </p>
        </div>
        ...
        <Tabs defaultValue="score-check" className="space-y-8">
                  ...
                  {creditData?.success ? (
                    <div className="space-y-6">
                      <div className="text-center">
                        ...
                        />
                        <Badge 
                          variant={creditData.data.creditScore >= 750 ? "default" : "secondary"}
                          className="text-sm"
                        >
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button 
                          onClick={() => setupMonitoring({ reportId: creditData.data.reportId })}
                          variant="outline"
                          size="sm"
          ...
          <TabsContent value="detailed-report" className="space-y-6" data-testid="detailed-report-tab">
            {detailedReport?.success ? (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {detailedReport.data.creditAccounts.slice(0, 5).map((account: any, idx: number) => (
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {detailedReport.data.enquiryHistory.slice(0, 5).map((enquiry: any, idx: number) => (
                        <div key={idx} className="p-3 border rounded-lg">
          ...
          <TabsContent value="loan-eligibility" className="space-y-6" data-testid="loan-eligibility-tab">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <TabsContent value="card-eligibility" className="space-y-6" data-testid="card-eligibility-tab">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <CreditCard className="h-5 w-5 text-finance-blue" />
                              ...
                              <CardContent className="p-4">
                                ...
                                <div className="text-sm mb-3">
                                  ...
                                  <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">₹{card.minIncome.toLocaleString()}</span>
                                  </div>
                                </div>
          ...
          <TabsContent value="monitoring" className="space-y-6" data-testid="monitoring-tab">
            {monitoringSetup?.success ? (
              ...
              <Card className="border-dashed border-2 border-gray-300">
                <CardContent className="flex flex-col items-center justify-center py-12">
                  ...
                  <Button 
                    onClick={() => setupMonitoring({ reportId: creditData?.data?.reportId || 'demo' })}
