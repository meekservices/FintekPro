				...
				<div className="max-w-4xl mx-auto">
					<div className="text-center mb-12">
						...
						<p className="text-lg text-muted-foreground">
							Legal terms governing your use of FintekPro's financial services
							platform.
						</p>
					...
					<div className="space-y-8">
						<Card>
							...
							<CardContent className="space-y-4">
								<p className="text-muted-foreground">
									By accessing and using FintekPro's services, you acknowledge
								...
								<p className="text-muted-foreground">
									...
									between you and FintekPro Financial Services LLP.
								</p>
							</CardContent>
						</Card>
							...
							<CardContent className="space-y-4">
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Must be 18 years or older (21 for certain products as per
											SEBI guidelines)
										</li>
										<li>
											Must be a legal resident of India, eligible NRI, or Global
											Advisory client in supported jurisdictions
										</li>
										<li>
											Must have valid KYC documentation (PAN mandatory, Aadhaar
											for eKYC)
										</li>
										<li>
											Must complete appropriate KYC tier for intended services
											(Basic/Enhanced/Accredited)
										</li>
										<li>
											For PMS/AIF: Must qualify as Accredited Investor per SEBI
						...
						<Card>
							...
							<CardContent className="space-y-4">
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Domestic stocks trading on NSE/BSE through registered
											brokers
										</li>
										<li>
											US stocks and international markets through authorized
											channels
										</li>
										<li>IPO applications via ASBA mechanism</li>
										<li>
											Pre-IPO and unlisted securities (Enhanced KYC required)
										</li>
									</ul>
								</div>
								<div>
								...
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										...
										<li>
											Market Linked Debentures (MLDs) - Accredited Investors
											only
										</li>
									</ul>
								</div>
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Portfolio Management Services (PMS) - Minimum ₹50 lakhs
										</li>
										<li>
											Alternative Investment Funds (AIF) - Minimum ₹1 crore
										</li>
										<li>REITs and InvITs listed on exchanges</li>
										<li>
											Unlisted securities marketplace (Enhanced KYC required)
										</li>
									</ul>
								</div>
							</CardContent>
						...
						<Card>
							...
							<CardContent className="space-y-4">
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Personal loans, home loans, and LAP through partner
											lenders
										</li>
										<li>
											Loan against securities (LAS) and loan against mutual
											funds
										</li>
										<li>Business loans and working capital facilities</li>
										<li>
											Credit assessment facilitated through authorized bureaus
											(CIBIL)
										</li>
									</ul>
								</div>
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Life and health insurance through IRDAI-registered
											partners
										</li>
						...
						<Card>
							...
							<CardContent className="space-y-4">
								...
								<div>
									<h4 className="font-semibold mb-2">
										Global Advisory (Analytics Mode)
									</h4>
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Portfolio analytics and tracking for non-India markets
										</li>
										<li>
											Read-only mode for jurisdictions where execution is not
											permitted
										</li>
							...
							<CardContent className="space-y-4">
								<div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg border border-orange-200 dark:border-orange-800">
									...
									<p className="text-orange-700 dark:text-orange-300 text-sm">
										...
										returns. Registration granted by SEBI and certification from
										NISM in no way guarantee performance of the intermediary or
										provide any assurance of returns to investors.
									</p>
								</div>
								<p className="text-muted-foreground">
									For detailed product-wise risk disclosures, please refer to
									our{" "}
									<Link href="/disclaimer" className="text-blue-600 underline">
										Investment Risk Disclaimer
									</Link>
							...
							<CardContent className="space-y-4">
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										...
										<li>
											Transaction charges as per applicable product schedules
										</li>
						...
						<Card>
							...
							<CardContent>
								<p className="text-muted-foreground mb-4">
									Your privacy and data security are paramount. By using our
									services, you consent to:
								</p>
								<ul className="list-disc list-inside text-muted-foreground space-y-1">
									<li>
										Collection and processing of financial data as described in
										our{" "}
										<Link href="/privacy" className="text-blue-600 underline">
											Privacy Policy
										</Link>
									...
									<li>
										Mandatory sharing with regulatory authorities (SEBI, RBI,
										Income Tax)
									</li>
									<li>
										7-year data retention as per SEBI/RBI compliance
										requirements
									</li>
									<li>
										Consent-based auto-population from external data sources
									</li>
								</ul>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent className="space-y-4">
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Securities and Exchange Board of India (SEBI) - Investment
											Advisory
										</li>
										<li>Reserve Bank of India (RBI) - Payment Aggregation</li>
										<li>
											Association of Mutual Funds in India (AMFI) - Mutual Fund
											Distribution
										</li>
										<li>
								...
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Provide accurate KYC information and valid documentation
										</li>
										<li>
											Report material changes in financial status or PEP status
										</li>
										<li>
											Comply with FEMA regulations for cross-border transactions
										</li>
										<li>
											Fulfill tax reporting obligations on investment income
										</li>
									</ul>
								</div>
							</CardContent>
						...
						<Card>
							...
							<CardContent>
								<ul className="list-disc list-inside text-muted-foreground space-y-1">
									<li>
										Market manipulation, insider trading, or front-running
									</li>
						...
						<Card>
							...
							<CardContent>
								<p className="text-muted-foreground mb-4">
									To the maximum extent permitted by law, FintekPro shall not be
									liable for:
								</p>
								<ul className="list-disc list-inside text-muted-foreground space-y-1">
									<li>
										Investment losses arising from market conditions or user
										decisions
									</li>
									<li>
										Losses from technical issues, system downtime, or
										connectivity failures
									</li>
									<li>
										Third-party service provider failures (exchanges,
										depositories, payment gateways)
									</li>
									<li>
								...
								<p className="text-muted-foreground mt-4">
									Maximum aggregate liability is limited to fees paid by you in
								...
								<div>
									...
									<div className="space-y-3 text-muted-foreground">
										<div className="bg-muted p-3 rounded">
											...
											<p className="text-sm">
												Email support@fintekpro.com - Response within 48 hours,
						...
						<Card>
							...
							<CardContent>
								...
								<ul className="list-disc list-inside text-muted-foreground space-y-1">
									<li>
										You retain ownership of all investments held in your name
									</li>
									<li>
										We will assist in transferring your portfolio to another
										service provider
									</li>
									<li>Outstanding fees and charges must be settled</li>
									<li>
										Data retention continues as per regulatory requirements (7
										years)
									</li>
						...
						<Card>
							...
							<CardContent>
								...
								<div className="space-y-2 text-muted-foreground">
									<p>
										<strong>Legal & Compliance:</strong> support@fintekpro.com
									</p>
									<p>
									...
									<p>
										<strong>Registered Office:</strong> FintekPro Financial
										Services LLP, Mumbai, Maharashtra, India
									</p>
									<p>
								...
								<div className="mt-4 pt-4 border-t text-muted-foreground">
									<p>
										<strong>Grievance Officer:</strong> support@fintekpro.com
									</p>
									<p className="text-sm">
										Response within 48 hours as per SEBI guidelines
									</p>
								</div>
							</CardContent>
						</Card>
					...
					<div className="mt-12 text-center space-y-4">
						<p className="text-sm text-muted-foreground">
							These terms are effective as of January 3, 2026. We reserve the
							right to update these terms with 30 days notice to registered
							users via email.
						</p>
