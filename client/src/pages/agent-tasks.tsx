										...
										<div>
											...
											<Popover>
												<PopoverTrigger asChild>
													<Button
														variant="outline"
														className="w-full mt-1 justify-start border-border bg-card text-left"
													>
											...
											>
												...
												<div className="flex-1 min-w-0">
													<div className="flex items-start justify-between gap-4">
														<div>
															<p
																className={`font-medium ${task.status === "completed" ? "text-muted-foreground line-through" : "text-foreground"}`}
															>
																{task.title}
															</p>
													...
													<div className="flex items-center gap-4 mt-2 text-sm">
														...
														<span
															className={`flex items-center gap-1 ${getDueDateColor(task.dueDate, task.status)}`}
														>
														...
														{task.recurring && task.recurring !== "none" && (
															<span className="flex items-center gap-1 text-muted-foreground">
																...
																{task.recurring.charAt(0).toUpperCase() +
																	task.recurring.slice(1)}
															</span>
														)}
													</div>
												</div>
							...
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-muted-foreground text-sm">
										3 clients have KYC expiring in 30 days
									</p>
								</div>
						...
						<CardContent className="p-4">
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-muted-foreground text-sm">
										5 stocks require action based on exit signals
									</p>
								</div>
								<Button size="sm" variant="outline" className="border-border">
									<ChevronRight className="h-4 w-4" />
