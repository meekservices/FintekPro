...
export default function BajajFinance() {
	...
	// Get Interest Rates
	const { data: interestRates, isLoading: ratesLoading } =
		useQuery<InterestRatesData>({
	...
	const calculateBusinessLoan = async () => {
		if (
			!businessLoanForm.amount ||
			!businessLoanForm.tenure ||
			!businessLoanForm.businessType
		)
			return;
	...
	const checkEligibility = async () => {
		if (
			!eligibilityForm.salary ||
			!eligibilityForm.age ||
			!eligibilityForm.loanType
		)
			return;
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="text-center mb-8">
					...
					<p className="text-xl text-muted-foreground max-w-3xl mx-auto">
						Comprehensive financial solutions including loans, fixed deposits,
							...
							<div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
								...
								<div className="bg-orange-50 dark:bg-orange-950/30 p-4 rounded-lg">
									...
									<p className="text-orange-700 dark:text-orange-300">
										{interestRates.data.fixedDeposit.regular}% -{" "}
										{interestRates.data.fixedDeposit.seniorCitizen}%
									</p>
								</div>
								<div className="bg-red-50 dark:bg-red-950/30 p-4 rounded-lg">
									...
									<p className="text-red-700 dark:text-red-300">
										{interestRates.data.autoLoan.min}% -{" "}
										{interestRates.data.autoLoan.max}%
									</p>
								</div>
							</div>
						) : (
				...
				<Tabs defaultValue="emi" className="space-y-6">
					<div className="overflow-x-auto pb-2">
						<ScrollableTabsList className="inline-flex w-auto min-w-full">
							<TabsTrigger value="emi" className="flex-shrink-0">
								EMI Calculator
							</TabsTrigger>
							<TabsTrigger value="personal-loan" className="flex-shrink-0">
								Personal Loan
							</TabsTrigger>
							<TabsTrigger value="business-loan" className="flex-shrink-0">
								Business Loan
							</TabsTrigger>
							<TabsTrigger value="fixed-deposit" className="flex-shrink-0">
								Fixed Deposit
							</TabsTrigger>
							<TabsTrigger value="eligibility" className="flex-shrink-0">
								Eligibility
							</TabsTrigger>
						</ScrollableTabsList>
					</div>
								...
								<CardContent className="space-y-4">
									<div>
										...
										<Input
											...
											onChange={(e) =>
												setEmiForm({ ...emiForm, principal: e.target.value })
											}
										/>
									</div>
									<div>
										...
										<Input
											...
											onChange={(e) =>
												setEmiForm({ ...emiForm, interestRate: e.target.value })
											}
										/>
									</div>
									<div>
										...
										<Input
											...
											onChange={(e) =>
												setEmiForm({ ...emiForm, tenure: e.target.value })
											}
										/>
									</div>
								...
								<CardContent className="space-y-4">
									<div>
										...
										<Input
											...
											value={fdForm.amount}
											onChange={(e) =>
												setFdForm({ ...fdForm, amount: e.target.value })
											}
										/>
									</div>
									<div>
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
							...
							{eligibilityResult && (
								<Card>
									...
									<CardContent className="space-y-4">
										<div
											className={`p-4 rounded-lg ${eligibilityResult.eligible ? "bg-green-50 dark:bg-green-950/30" : "bg-red-50 dark:bg-red-950/30"}`}
										>
											<h4
												className={`font-semibold ${eligibilityResult.eligible ? "text-green-900 dark:text-green-100" : "text-red-900 dark:text-red-100"}`}
											>
