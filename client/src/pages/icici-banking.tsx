...
import { CreditCard, DollarSign, Send, CheckCircle, AlertCircle, Clock, Eye, Download, RefreshCw, Building2, Banknote, Receipt, History, Shield, Users, TrendingUp } from "lucide-react";
                ...
                {userAccounts.map((account) => (
                  <Card 
                    ...
                    className={`cursor-pointer transition-all hover:shadow-md ${
                      selectedAccount === account.accountNumber ? 'ring-2 ring-blue-500 bg-blue-50 dark:bg-blue-900/20' : ''
                    }`}
              ...
              <TabsContent value="payments">
                <Card data-testid="payments-card">
                  <CardHeader>
                    ...
                    <CardDescription>Send instant payments to any bank account</CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setPaymentForm({ ...paymentForm, beneficiaryAccountNumber: e.target.value })}
                            placeholder="Enter beneficiary account number"
                          />
                        </div>
                        <div>
                          <Label htmlFor="beneficiary-ifsc">Beneficiary IFSC Code</Label>
                          <Input
                            id="beneficiary-ifsc"
                            data-testid="input-beneficiary-ifsc"
                            value={paymentForm.beneficiaryIFSC}
                            onChange={(e) => setPaymentForm({ ...paymentForm, beneficiaryIFSC: e.target.value })}
                    ...
                    <div className="mt-6">
                      <Button
                        ...
                        disabled={paymentMutation.isPending || !paymentForm.beneficiaryAccountNumber || !paymentForm.amount}
                        className="w-full"
              ...
              <TabsContent value="transactions">
                <Card data-testid="transactions-card">
                  <CardHeader>
                    ...
                    <CardDescription>View your account transaction history</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                          ...
                          <Select onValueChange={(value) => setStatementForm({ ...statementForm, format: value })}>
              ...
              <TabsContent value="validation">
                <Card data-testid="validation-card">
                  <CardHeader>
                    ...
                    <CardDescription>Validate account number and IFSC code</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-600 dark:text-green-400">
                    Account Management • Payments • Transaction History • Validation
                  </p>
                </div>
              </div>
