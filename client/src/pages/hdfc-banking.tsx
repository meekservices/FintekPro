...
export default function HDFCBanking() {
	...
	const paymentMutation = useMutation({
		mutationFn: async (
			data: typeof paymentForm & { debitAccountNumber: string },
		) => {
	...
	const { data: transactions, isLoading: transactionsLoading } = useQuery<any>({
		queryKey: [
			"/api/hdfc/accounts/transactions",
			selectedAccount,
			transactionForm,
		],
		enabled:
	...
	return (
		<div
			className="min-h-screen bg-gradient-to-br from-red-50 to-orange-100 dark:from-background dark:to-card p-4"
			data-testid="hdfc-banking-page"
		>
			<div className="container mx-auto max-w-7xl space-y-6">
				...
				<div className="text-center space-y-4">
					...
					<p className="text-muted-foreground max-w-2xl mx-auto">
						Access comprehensive banking services with OAuth-secured API
						integration including payments, account management, and transaction
						history
					</p>
				</div>
											...
											<div className="space-y-2">
												...
												<div>
													...
													<p className="text-sm text-muted-foreground">
														****{account.accountNumber.slice(-4)} • Branch:{" "}
														{account.branchCode}
													</p>
												</div>
											</div>
									...
									<div className="grid grid-cols-1 md:grid-cols-4 gap-4">
										...
										<div className="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
											...
											>
												<Badge
													variant={
														accountBalance.data?.accountStatus === "ACTIVE"
															? "default"
															: "destructive"
													}
												>
							...
							<TabsContent value="payments">
								<Card data-testid="payments-card">
									<CardHeader>
										...
										<CardDescription>
											Send payments via IMPS, NEFT, or RTGS with OAuth security
										</CardDescription>
									</CardHeader>
									<CardContent>
												...
												<div>
													...
													<Input
														...
														onChange={(e) =>
															setPaymentForm({
																...paymentForm,
																creditAccountNumber: e.target.value,
															})
														}
										...
										<div className="mt-6">
											<Button
												...
												disabled={
													...
													!paymentForm.creditAccountNumber ||
													!paymentForm.amount
												}
							...
							<TabsContent value="transactions">
								<Card data-testid="transactions-card">
									<CardHeader>
										...
										<CardDescription>
											View your HDFC account transaction history
										</CardDescription>
									</CardHeader>
									<CardContent>
										<div className="space-y-4">
							...
							<TabsContent value="statements">
								<Card data-testid="statements-card">
									<CardHeader>
										...
										<CardDescription>
											Generate and download HDFC account statements
										</CardDescription>
									</CardHeader>
									<CardContent>
										<div className="space-y-4">
							...
							<TabsContent value="validation">
								<Card data-testid="validation-card">
									<CardHeader>
										...
										<CardDescription>
											Validate HDFC Bank account number and IFSC code
										</CardDescription>
									</CardHeader>
									<CardContent>
										<div className="space-y-4">
				...
				<Card data-testid="api-status-card">
					<CardHeader>
						...
						<CardDescription>
							OAuth-secured API health monitoring
						</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-sm text-green-600 dark:text-green-400">
										OAuth Authentication • Account Management • Payments
										(IMPS/NEFT/RTGS) • Transaction History • Account Validation
									</p>
								</div>
							</div>
							<Badge
