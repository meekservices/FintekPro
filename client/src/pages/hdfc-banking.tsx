...
import { CreditCard, DollarSign, Send, CheckCircle, AlertCircle, Clock, Eye, Download, RefreshCw, Building2, Banknote, Receipt, History, Shield, Users, TrendingUp, ArrowUpDown } from "lucide-react";
import { apiRequest, queryClient } from "@/lib/queryClient";
import { useToast } from "@/hooks/use-toast";
import { format } from "date-fns";

export default function HDFCBanking() {
  ...
  const userAccounts = [
    { 
      ...
      accountName: "HDFC Savings Plus",
      currency: "INR",
      branchCode: "001"
    },
    { 
      accountNumber: "00501234567890", 
      accountType: "Current Account",
      accountName: "HDFC Business Current",
      currency: "INR",
      branchCode: "001"
    },
    { 
      accountNumber: "15671234567891", 
                ...
                {userAccounts.map((account) => (
                  <Card 
                    ...
                    className={`cursor-pointer transition-all hover:shadow-md ${
                      selectedAccount === account.accountNumber ? 'ring-2 ring-red-500 bg-red-50 dark:bg-red-900/20' : ''
                    }`}
                      ...
                      <div className="space-y-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            ****{account.accountNumber.slice(-4)} • Branch: {account.branchCode}
                          </p>
                        </div>
                      </div>
                    </CardContent>
                ...
                {balanceLoading ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-green-700 dark:text-green-300" data-testid="available-balance">
                        ₹{accountBalance.data?.availableBalance?.toLocaleString()}
                      </p>
                    </div>
                    <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                      <p className="text-sm text-blue-600 dark:text-blue-400">Ledger Balance</p>
                      <p className="text-2xl font-bold text-blue-700 dark:text-blue-300" data-testid="ledger-balance">
                    ...
                    <div className="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                      ...
                      <p className="text-lg font-medium" data-testid="account-status">
                        <Badge variant={accountBalance.data?.accountStatus === 'ACTIVE' ? 'default' : 'destructive'}>
                          {accountBalance.data?.accountStatus}
                        </Badge>
                      </p>
                    </div>
            ...
            <Tabs defaultValue="payments" className="space-y-6">
              ...
              <TabsContent value="payments">
                <Card data-testid="payments-card">
                  <CardHeader>
                    <CardTitle>HDFC Bank Transfer</CardTitle>
                    <CardDescription>Send payments via IMPS, NEFT, or RTGS with OAuth security</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div>
                          <Label htmlFor="credit-account">Beneficiary Account Number</Label>
                          <Input
                            id="credit-account"
                            data-testid="input-credit-account"
                            value={paymentForm.creditAccountNumber}
                            onChange={(e) => setPaymentForm({ ...paymentForm, creditAccountNumber: e.target.value })}
                            placeholder="Enter beneficiary account number"
                          />
                        </div>
                        <div>
                          <Label htmlFor="credit-ifsc">Beneficiary IFSC Code</Label>
                          <Input
                            id="credit-ifsc"
                            data-testid="input-credit-ifsc"
                            value={paymentForm.creditIFSC}
                            onChange={(e) => setPaymentForm({ ...paymentForm, creditIFSC: e.target.value })}
                        ...
                        <div>
                          ...
                          <Select value={paymentForm.paymentMode} onValueChange={(value) => setPaymentForm({ ...paymentForm, paymentMode: value })}>
                            ...
                            <SelectContent>
                              <SelectItem value="IMPS">IMPS - Instant (24/7)</SelectItem>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <Select onValueChange={(value) => setPaymentForm({ ...paymentForm, purpose: value })}>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="education">Education Fee</SelectItem>
                    ...
                    <div className="mt-6">
                      <Button
                        ...
                        disabled={paymentMutation.isPending || !paymentForm.creditAccountNumber || !paymentForm.amount}
              ...
              <TabsContent value="transactions">
                <Card data-testid="transactions-card">
                  <CardHeader>
                    ...
                    <CardDescription>View your HDFC account transaction history</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setTransactionForm({ ...transactionForm, fromDate: e.target.value })}
                          />
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setTransactionForm({ ...transactionForm, toDate: e.target.value })}
                          />
                        </div>
                        <div>
                          <Label htmlFor="limit">Limit</Label>
                          <Select onValueChange={(value) => setTransactionForm({ ...transactionForm, limit: value })}>
                          ...
                          <Table>
                            ...
                            <TableBody>
                              {transactions.data.map((transaction: any) => (
                                <TableRow key={transaction.transactionId} data-testid={`transaction-row-${transaction.transactionId}`}>
                                  ...
                                  <TableCell className="text-sm text-muted-foreground">{transaction.narration || '-'}</TableCell>
                                </TableRow>
                              ))}
                            </TableBody>
                          </Table>
              ...
              <TabsContent value="statements">
                <Card data-testid="statements-card">
                  <CardHeader>
                    ...
                    <CardDescription>Generate and download HDFC account statements</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <Select value={statementForm.format} onValueChange={(value) => setStatementForm({ ...statementForm, format: value })}>
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            value={statementForm.emailId}
                            onChange={(e) => setStatementForm({ ...statementForm, emailId: e.target.value })}
                            placeholder="Enter email for statement delivery"
                          />
                        </div>
                      </div>
                      <Button
                        onClick={handleStatementGeneration}
                        disabled={statementMutation.isPending || !statementForm.fromDate || !statementForm.toDate}
              ...
              <TabsContent value="validation">
                <Card data-testid="validation-card">
                  <CardHeader>
                    ...
                    <CardDescription>Validate HDFC Bank account number and IFSC code</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <Label htmlFor="validation-account">Account Number</Label>
                          <Input
                            id="validation-account"
                            data-testid="input-validation-account"
                            value={validationForm.accountNumber}
                            onChange={(e) => setValidationForm({ ...validationForm, accountNumber: e.target.value })}
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setValidationForm({ ...validationForm, ifscCode: e.target.value })}
                      ...
                      <Button
                        ...
                        disabled={validateAccountMutation.isPending || !validationForm.accountNumber || !validationForm.ifscCode}
                        className="bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700"
        ...
        <Card data-testid="api-status-card">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              HDFC Bank API Status
            </CardTitle>
            <CardDescription>OAuth-secured API health monitoring</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-600 dark:text-green-400">
                    OAuth Authentication • Account Management • Payments (IMPS/NEFT/RTGS) • Transaction History • Account Validation
                  </p>
                </div>
              </div>
