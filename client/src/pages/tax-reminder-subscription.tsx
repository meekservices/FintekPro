...
export default function TaxReminderSubscription() {
	...
	const { data: hasExpertFiling, isLoading: expertFilingLoading } = useQuery<{
		hasExpertFiling: boolean;
	}>({
	...
	useEffect(() => {
		...
		if (success === "true") {
			toast({
				...
				description:
					"Your tax reminder subscription has been activated. Quarterly reminders have been generated.",
				duration: 5000,
			});
			queryClient.invalidateQueries({
				queryKey: ["/api/tax/reminder-subscription"],
			});
	...
	const subscriptionMutation = useMutation({
		mutationFn: (data: {
			...
			apiRequest("/api/tax/reminder-subscription", {
				method: "POST",
	...
	return (
		<div
			...
			data-testid="tax-reminder-subscription-page"
		>
			<div className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-950 dark:to-indigo-900 rounded-2xl p-8 mb-8">
				<div className="max-w-4xl mx-auto text-center">
					<Badge
						className="mb-4 bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-100"
					...
					<p className="text-lg text-muted-foreground mb-6">
						Stay compliant with advance tax payments. Get timely reminders for
						STCG (20%) and LTCG (12.5% above ₹1.25L)
					</p>

					{hasExpertFiling?.hasExpertFiling && (
						<Alert
							className="bg-yellow-50 border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-800 mb-6"
							data-testid="alert-free-tier"
						>
							<Sparkles className="h-4 w-4 text-yellow-600" />
							<AlertDescription className="text-yellow-800 dark:text-yellow-200 font-medium">
								🎉 FREE for Expert ITR Filing Subscribers - Enjoy complimentary
			...
			{subscription ? (
				<Card
					className="mb-8 border-green-200 dark:border-green-800"
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
				<Card data-testid="feature-card-reminders">
					...
					<CardContent>
						<p className="text-muted-foreground">
							Receive timely alerts before each advance tax deadline - June 15,
							Sept 15, Dec 15, and March 15
						</p>
					</CardContent>
				</Card>
				...
				<Card data-testid="feature-card-calculation">
					...
					<CardContent>
						<p className="text-muted-foreground">
							Automatic capital gains calculation based on your portfolio
				...
				<Card data-testid="feature-card-channels">
					...
					<CardContent>
						<p className="text-muted-foreground">
							Get notifications via Email, SMS, and WhatsApp to ensure you never
							miss a deadline
						</p>
					</CardContent>
				</Card>
				...
				<Card data-testid="feature-card-breakdown">
					...
					<CardContent>
						<p className="text-muted-foreground">
							Detailed breakdown of STCG and LTCG liabilities with section-wise
							calculations
						</p>
					</CardContent>
				</Card>
				...
				<Card data-testid="feature-card-challan">
					...
					<CardContent>
						<p className="text-muted-foreground">
							Step-by-step guidance for challan generation and online payment of
							advance tax
						</p>
					</CardContent>
				</Card>
				...
				<Card data-testid="feature-card-compliance">
					...
					<CardContent>
						<p className="text-muted-foreground">
							Avoid interest penalties under section 234B and 234C by paying
							advance tax on time
						</p>
					</CardContent>
				</Card>
			...
			{selectedTier && !hasExpertFiling?.hasExpertFiling && (
				<Card
					...
					data-testid="card-payment-checkout"
				>
						...
						<div className="space-y-4">
							<Alert data-testid="alert-payment-info">
								...
								<AlertDescription>
									...
									successful payment. You will start receiving quarterly
								...
								>
									<div className="flex items-center space-x-2 p-3 border rounded-lg hover:bg-muted cursor-pointer">
										<RadioGroupItem
											value="cashfree"
											id="cashfree-tax"
											data-testid="radio-cashfree-tax"
										/>
										<Label
											htmlFor="cashfree-tax"
							...
							<div className="flex gap-4">
								<Button
									...
									disabled={
										isProcessingPayment || subscriptionMutation.isPending
									}
									className="flex-1"
