...
export default function IPO() {
	...
	const { data: rawListed, isLoading: listedLoading } = useQuery({
		queryKey: ["/api/ipos?status=listed"],
	});
			...
			<CardHeader>
				<div className="flex justify-between items-start">
					<div className="flex items-start space-x-3">
						...
						<div>
							<CardTitle className="text-lg" data-testid="ipo-company-name">
								{ipo.companyName}
							</CardTitle>
							<p
								className="text-sm text-muted-foreground"
								data-testid="ipo-sector"
							>
								{ipo.sector}
							</p>
						</div>
				...
				<div className="grid grid-cols-2 gap-4 text-sm">
					...
					<div>
						...
						<p className="font-semibold" data-testid="ipo-issue-size">
							{ipo.issueSize
								? `₹${Number(ipo.issueSize).toLocaleString()} Cr`
								: "Not Issued"}
						</p>
					</div>
					<div>
						<p className="text-muted-foreground">
							{showPerformance ? "Listing Date" : "Open Date"}
						</p>
					...
					<div>
						<p className="text-muted-foreground">
							{showPerformance ? "Issue Type" : "Close Date"}
						</p>
						<p className="font-semibold" data-testid="ipo-close-date">
							{showPerformance
								? ipo.issueType || "Book Built"
			...
			<div className="space-y-6">
				...
				<Tabs defaultValue="upcoming" className="space-y-8">
					<ScrollableTabsList className="grid w-full grid-cols-5">
						...
						<TabsTrigger value="sme" data-testid="tab-sme">
							SME IPOs
						</TabsTrigger>
							...
							<Card className="border-dashed border-2 border-border">
								<CardContent className="flex flex-col items-center justify-center py-12">
									...
									<p className="text-muted-foreground text-center">
										IPO data will be displayed here when available from
										authorized sources
									</p>
								</CardContent>
							</Card>
						...
						{ongoingLoading ? (
							...
							<div className="space-y-6">
								<div
									...
									data-testid="live-ipo-notice"
								>
									<div className="flex items-center space-x-2">
										<Clock className="h-5 w-5 text-green-600" />
										<h3 className="font-semibold text-green-800 dark:text-green-200">
											Live IPO Applications
										</h3>
									</div>
									<p className="text-green-700 dark:text-green-300 text-sm mt-1">
										These IPOs are currently accepting applications. Apply
											...
											<div className="flex items-center space-x-3">
												...
												<div>
													<CardTitle className="text-blue-900 dark:text-blue-100">
														Amanta Healthcare IPO Analysis
													</CardTitle>
													<p className="text-blue-700 dark:text-blue-300 text-sm">
														Price Band: ₹120 - ₹126 | Issue Size: ₹126 Cr
													</p>
												</div>
											</div>
											...
											<div className="bg-card p-4 rounded-lg">
												...
												<div className="space-y-2 text-sm">
													<div>
														...
														<p className="text-muted-foreground">
															Strong market position, experienced management
														</p>
													</div>
													<div>
									...
									<Card className="hover:shadow-md transition-shadow">
										<CardContent className="p-4">
											...
											<Button
												...
												data-testid="view-anlon-analysis"
											>
												View Analysis
											</Button>
										</CardContent>
									...
									<Card className="hover:shadow-md transition-shadow">
										<CardContent className="p-4">
											...
											<Button
												...
												size="sm"
												className="w-full mt-3"
												data-testid="view-fractal-analysis"
											>
												View Analysis
											</Button>
										</CardContent>
									...
									<CardContent className="p-4">
										...
										<div className="flex flex-wrap gap-2">
											<Button
												variant="outline"
												size="sm"
												data-testid="valuation-calculator"
											>
											...
											<Button
												variant="outline"
												size="sm"
												data-testid="subscription-tracker"
											>
						...
						<CardContent className="p-8 text-center">
							<div className="max-w-2xl mx-auto">
								<h2 className="text-2xl font-bold text-foreground mb-4">
									Ready to Apply for IPOs?
								</h2>
								<p className="text-muted-foreground mb-6">
									Open your Demat account now to apply for your favorite IPOs.
									Get access to detailed analysis, application tracking, and
								...
								<div className="flex flex-col sm:flex-row gap-4 justify-center">
									<Button
										...
										data-testid="open-demat-account"
									>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						...
						<Card>
							<CardContent className="p-6">
								...
								<p className="text-muted-foreground text-sm">
									Quick and easy online application process with instant
									confirmation
								</p>
							</CardContent>
						</Card>
