  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-8">
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="text-center p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Personal Loan</p>
                ...
                <div className="text-center p-3 rounded-lg bg-green-50 dark:bg-green-900/20">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Home Loan</p>
                ...
                <div className="text-center p-3 rounded-lg bg-purple-50 dark:bg-purple-900/20">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Business Loan</p>
                ...
                <div className="text-center p-3 rounded-lg bg-orange-50 dark:bg-orange-900/20">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Used Car Loan</p>
                ...
                <div className="text-center p-3 rounded-lg bg-red-50 dark:bg-red-900/20">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Loan Against Property</p>
                ...
                <div className="text-center p-3 rounded-lg bg-indigo-50 dark:bg-indigo-900/20">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Loan Against Securities</p>
              ...
              <CardContent className="space-y-6 pt-6">
                ...
                {personalLoanResult && (
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    ...
                    <div className="text-center">
                      <p className="text-sm text-gray-600 dark:text-gray-300">Processing Fee</p>
              ...
              <CardContent className="space-y-6 pt-6">
                ...
                {homeLoanResult && (
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    ...
                    <div className="text-center">
                      <p className="text-sm text-gray-600 dark:text-gray-300">Max Loan Amount</p>
                ...
                {carLoanResult && (
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                      ...
                      <div className="text-center">
                        <p className="text-sm text-gray-600 dark:text-gray-300">Vehicle Valuation</p>
                      ...
                      <div className="text-center">
                        <p className="text-sm text-gray-600 dark:text-gray-300">LTV Ratio</p>
        ...
        <Card className="mt-8">
          <CardHeader>
            <CardTitle className="text-center text-gray-800 dark:text-gray-200">Tata Capital API Integration</CardTitle>
