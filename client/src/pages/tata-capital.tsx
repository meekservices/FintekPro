...
export default function TataCapital() {
	...
	const [personalLoanResult, setPersonalLoanResult] =
		useState<PersonalLoanResult | null>(null);
	...
	const [homeLoanResult, setHomeLoanResult] = useState<HomeLoanResult | null>(
		null,
	);
	...
	const [businessLoanResult, setBusinessLoanResult] =
		useState<BusinessLoanResult | null>(null);
	...
	const [carLoanResult, setCarLoanResult] = useState<UsedCarLoanResult | null>(
		null,
	);
	...
	const [lapResult, setLapResult] = useState<LoanAgainstPropertyResult | null>(
		null,
	);
	...
	const calculatePersonalLoan = async () => {
		if (
			!personalLoanData.principal ||
			!personalLoanData.tenure ||
			!personalLoanData.employmentType
		)
			return;
		...
		try {
			const response = await apiRequest(
				"POST",
				"/api/tata-capital/personal-loan",
				{
					principal: Number.parseInt(personalLoanData.principal),
					tenure: Number.parseInt(personalLoanData.tenure),
	...
	const calculateHomeLoan = async () => {
		if (
			!homeLoanData.principal ||
			!homeLoanData.tenure ||
			!homeLoanData.propertyType
		)
			return;
		...
		try {
			const response = await apiRequest("POST", "/api/tata-capital/home-loan", {
				principal: Number.parseInt(homeLoanData.principal),
				tenure: Number.parseInt(homeLoanData.tenure),
	...
	const calculateBusinessLoan = async () => {
		if (
			!businessLoanData.principal ||
			!businessLoanData.tenure ||
			!businessLoanData.businessVintage ||
			!businessLoanData.turnover
		)
			return;
		...
		try {
			const response = await apiRequest(
				"POST",
				"/api/tata-capital/business-loan",
				{
					principal: Number.parseInt(businessLoanData.principal),
					tenure: Number.parseInt(businessLoanData.tenure),
					businessVintage: Number.parseInt(businessLoanData.businessVintage),
					turnover: Number.parseInt(businessLoanData.turnover),
				},
			);
			const result = await response.json();
	...
	const calculateCarLoan = async () => {
		if (
			!carLoanData.vehiclePrice ||
			!carLoanData.vehicleAge ||
			!carLoanData.downPayment ||
			!carLoanData.tenure
		)
			return;
		...
		try {
			const response = await apiRequest(
				"POST",
				"/api/tata-capital/used-car-loan",
				{
					vehiclePrice: Number.parseInt(carLoanData.vehiclePrice),
					vehicleAge: Number.parseInt(carLoanData.vehicleAge),
					downPayment: Number.parseInt(carLoanData.downPayment),
					tenure: Number.parseInt(carLoanData.tenure),
				},
			);
			const result = await response.json();
	...
	const calculateLAP = async () => {
		if (
			!lapData.propertyValue ||
			!lapData.loanAmount ||
			!lapData.tenure ||
			!lapData.propertyType
		)
			return;
		...
		try {
			const response = await apiRequest(
				"POST",
				"/api/tata-capital/loan-against-property",
				{
					propertyValue: Number.parseInt(lapData.propertyValue),
					loanAmount: Number.parseInt(lapData.loanAmount),
					tenure: Number.parseInt(lapData.tenure),
			...
			<div className="container mx-auto px-4 py-8">
				<div className="text-center mb-8">
					...
					<p className="text-muted-foreground text-lg max-w-2xl mx-auto">
						Comprehensive financial services with advanced loan calculators,
						credit analysis, and digital banking solutions
					</p>
				</div>
				...
				{interestRates?.data && (
					<Card className="mb-8 border-blue-200 dark:border-blue-800">
						<CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20">
							...
							<CardDescription>
								Latest interest rates across all loan products
							</CardDescription>
						</CardHeader>
							...
							<div className="grid grid-cols-2 md:grid-cols-3 gap-4">
								<div className="text-center p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20">
									...
									<p className="text-lg font-bold text-blue-600">
										{interestRates.data.personalLoan.min}% -{" "}
										{interestRates.data.personalLoan.max}%
									</p>
								</div>
								<div className="text-center p-3 rounded-lg bg-green-50 dark:bg-green-900/20">
									...
									<p className="text-lg font-bold text-green-600">
										{interestRates.data.homeLoan.min}% -{" "}
										{interestRates.data.homeLoan.max}%
									</p>
								</div>
								<div className="text-center p-3 rounded-lg bg-purple-50 dark:bg-purple-900/20">
									...
									<p className="text-lg font-bold text-purple-600">
										{interestRates.data.businessLoan.min}% -{" "}
										{interestRates.data.businessLoan.max}%
									</p>
								</div>
								<div className="text-center p-3 rounded-lg bg-orange-50 dark:bg-orange-900/20">
									...
									<p className="text-lg font-bold text-orange-600">
										{interestRates.data.usedCarLoan.min}% -{" "}
										{interestRates.data.usedCarLoan.max}%
									</p>
								</div>
								<div className="text-center p-3 rounded-lg bg-red-50 dark:bg-red-900/20">
									...
									<p className="text-lg font-bold text-red-600">
										{interestRates.data.loanAgainstProperty.min}% -{" "}
										{interestRates.data.loanAgainstProperty.max}%
									</p>
								</div>
								<div className="text-center p-3 rounded-lg bg-indigo-50 dark:bg-indigo-900/20">
									...
									<p className="text-lg font-bold text-indigo-600">
										{interestRates.data.loanAgainstSecurities.min}% -{" "}
										{interestRates.data.loanAgainstSecurities.max}%
									</p>
								</div>
							</div>
						</CardContent>
				...
				<Tabs defaultValue="personal-loan" className="space-y-6">
					<ScrollableTabsList className="grid w-full grid-cols-5 bg-card border border-border">
						<TabsTrigger
							value="personal-loan"
							className="data-[state=active]:bg-blue-100 dark:bg-blue-900/30 data-[state=active]:text-blue-800 dark:text-blue-200"
						>
						...
						<TabsTrigger
							value="home-loan"
							className="data-[state=active]:bg-green-100 dark:bg-green-900/30 data-[state=active]:text-green-800 dark:text-green-200"
						>
						...
						<TabsTrigger
							value="business-loan"
							className="data-[state=active]:bg-purple-100 dark:bg-purple-900/30 data-[state=active]:text-purple-800 dark:text-purple-200"
						>
						...
						<TabsTrigger
							value="car-loan"
							className="data-[state=active]:bg-orange-100 dark:bg-orange-900/30 data-[state=active]:text-orange-800 dark:text-orange-200"
						>
						...
						<TabsTrigger
							value="property-loan"
							className="data-[state=active]:bg-red-100 dark:bg-red-900/30 data-[state=active]:text-red-800 dark:text-red-200"
						>
					...
					<TabsContent value="personal-loan">
						<Card className="border-blue-200 dark:border-blue-800">
							<CardHeader className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20">
								...
								<CardDescription>
									Calculate EMI for personal loans with competitive interest
									rates
								</CardDescription>
							</CardHeader>
							<CardContent className="space-y-6 pt-6">
								<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
									...
									<div className="space-y-2">
										...
										<Select
											value={personalLoanData.employmentType}
											onValueChange={(value) =>
												setPersonalLoanData((prev) => ({
													...prev,
									...
									<div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
										<div className="text-center">
											...
											<p
												...
												data-testid="text-personal-loan-emi"
											>
												{formatCurrency(personalLoanResult.emi)}
											</p>
										</div>
										<div className="text-center">
											<p className="text-sm text-muted-foreground">
											...
											<p
												className="text-xl font-bold text-blue-600"
												data-testid="text-personal-loan-rate"
											>
												{personalLoanResult.interestRate}%
											</p>
										</div>
										<div className="text-center">
											<p className="text-sm text-muted-foreground">
											...
											<p
												className="text-xl font-bold text-blue-600"
												data-testid="text-personal-loan-fee"
											>
												{formatCurrency(personalLoanResult.processingFee)}
											</p>
										</div>
										<div className="text-center">
											<p className="text-sm text-muted-foreground">
											...
											<p
												className="text-xl font-bold text-blue-600"
												data-testid="text-personal-loan-total"
											>
												{formatCurrency(personalLoanResult.totalAmount)}
											</p>
										</div>
					...
					<TabsContent value="home-loan">
						<Card className="border-green-200 dark:border-green-800">
							<CardHeader className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20">
								...
								<CardDescription>
									Calculate EMI for home loans with attractive interest rates
								</CardDescription>
							</CardHeader>
							<CardContent className="space-y-6 pt-6">
								<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
									...
									<div className="grid grid-cols-2 md:grid-cols-5 gap-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
										<div className="text-center">
											...
											<p
												...
												data-testid="text-home-loan-emi"
											>
												{formatCurrency(homeLoanResult.emi)}
											</p>
										</div>
										<div className="text-center">
											<p className="text-sm text-muted-foreground">
											...
											<p
												className="text-xl font-bold text-green-600"
												data-testid="text-home-loan-rate"
											>
												{homeLoanResult.interestRate}%
											</p>
										</div>
										<div className="text-center">
											<p className="text-sm text-muted-foreground">
											...
											<p
												className="text-xl font-bold text-green-600"
												data-testid="text-home-loan-fee"
											>
												{formatCurrency(homeLoanResult.processingFee)}
											</p>
										</div>
										<div className="text-center">
											<p className="text-sm text-muted-foreground">
											...
											<p
												className="text-xl font-bold text-green-600"
												data-testid="text-home-loan-total"
											>
												{formatCurrency(homeLoanResult.totalAmount)}
											</p>
										</div>
										<div className="text-center">
											<p className="text-sm text-muted-foreground">
											...
											<p
												className="text-xl font-bold text-green-600"
												data-testid="text-home-loan-max"
											>
												{formatCurrency(homeLoanResult.maxLoanAmount)}
											</p>
										</div>
									</div>
								)}
					...
					<TabsContent value="business-loan">
						<Card className="border-purple-200 dark:border-purple-800">
							<CardHeader className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20">
								...
								<CardDescription>
									Calculate EMI for business loans based on business profile
								</CardDescription>
							</CardHeader>
							<CardContent className="space-y-6 pt-6">
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									...
									<div className="space-y-2">
										<Label htmlFor="business-vintage">
										...
										<Input
											...
											onChange={(e) =>
												setBusinessLoanData((prev) => ({
													...prev,
													businessVintage: e.target.value,
												}))
											}
									...
									<div className="space-y-2">
										<Label htmlFor="business-turnover">
											Annual Turnover (₹)
										</Label>
										<Input
										...
										<div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
											<div className="text-center">
												...
												<p
													...
													data-testid="text-business-loan-emi"
												>
													{formatCurrency(businessLoanResult.emi)}
												</p>
											</div>
											<div className="text-center">
												<p className="text-sm text-muted-foreground">
												...
												<p
													className="text-xl font-bold text-purple-600"
													data-testid="text-business-loan-rate"
												>
													{businessLoanResult.interestRate}%
												</p>
											</div>
											<div className="text-center">
												<p className="text-sm text-muted-foreground">
												...
												<p
													className="text-xl font-bold text-purple-600"
													data-testid="text-business-loan-fee"
												>
													{formatCurrency(businessLoanResult.processingFee)}
												</p>
											</div>
										</div>
					...
					<TabsContent value="car-loan">
						<Card className="border-orange-200 dark:border-orange-800">
							<CardHeader className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20">
								...
								<CardDescription>
									Calculate EMI for used car loans with VAHAN integration
								</CardDescription>
							</CardHeader>
							<CardContent className="space-y-6 pt-6">
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
										...
										<div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
											<div className="text-center">
												...
												<p
													...
													data-testid="text-car-loan-emi"
												>
													{formatCurrency(carLoanResult.emi)}
												</p>
											</div>
											<div className="text-center">
												<p className="text-sm text-muted-foreground">
												...
												<p
													className="text-xl font-bold text-orange-600"
													data-testid="text-car-loan-rate"
												>
													{carLoanResult.interestRate}%
												</p>
											</div>
											<div className="text-center">
												<p className="text-sm text-muted-foreground">
												...
												<p
													className="text-xl font-bold text-orange-600"
													data-testid="text-car-loan-amount"
												>
													{formatCurrency(carLoanResult.loanAmount)}
												</p>
											</div>
											<div className="text-center">
												<p className="text-sm text-muted-foreground">
												...
												<p
													className="text-xl font-bold text-orange-600"
													data-testid="text-car-loan-valuation"
												>
													{formatCurrency(carLoanResult.vehicleValuation)}
												</p>
											</div>
											<div className="text-center">
												<p className="text-sm text-muted-foreground">
												...
												<p
													className="text-xl font-bold text-orange-600"
													data-testid="text-car-loan-ltv"
												>
													{carLoanResult.maxLoanToValue}%
												</p>
											</div>
											<div className="text-center">
												<p className="text-sm text-muted-foreground">
												...
												<p
													className="text-xl font-bold text-orange-600"
													data-testid="text-car-loan-fee"
												>
													{formatCurrency(carLoanResult.processingFee)}
												</p>
											</div>
										</div>
									</div>
					...
					<TabsContent value="property-loan">
						<Card className="border-red-200 dark:border-red-800">
							<CardHeader className="bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20">
								...
								<CardDescription>
									Calculate EMI for loans against residential and commercial
									property
								</CardDescription>
							</CardHeader>
							<CardContent className="space-y-6 pt-6">
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									<div className="space-y-2">
										<Label htmlFor="lap-property-value">
											Property Value (₹)
										</Label>
										<Input
									...
									<div className="space-y-2">
										...
										<Select
											value={lapData.propertyType}
											onValueChange={(value) =>
												setLapData((prev) => ({ ...prev, propertyType: value }))
											}
										>
									...
									<div className="grid grid-cols-2 md:grid-cols-5 gap-4 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
										<div className="text-center">
											...
											<p
												...
												data-testid="text-lap-emi"
											>
												{formatCurrency(lapResult.emi)}
											</p>
										</div>
										<div className="text-center">
											<p className="text-sm text-muted-foreground">
											...
											<p
												className="text-xl font-bold text-red-600"
												data-testid="text-lap-rate"
											>
												{lapResult.interestRate}%
											</p>
										</div>
										<div className="text-center">
											<p className="text-sm text-muted-foreground">
											...
											<p
												className="text-xl font-bold text-red-600"
												data-testid="text-lap-max-amount"
											>
												{formatCurrency(lapResult.maxLoanAmount)}
											</p>
										</div>
										<div className="text-center">
											...
											<p
												className="text-xl font-bold text-red-600"
												data-testid="text-lap-ltv"
											>
												{lapResult.loanToValue}%
											</p>
										</div>
										<div className="text-center">
											<p className="text-sm text-muted-foreground">
											...
											<p
												className="text-xl font-bold text-red-600"
												data-testid="text-lap-fee"
											>
												{formatCurrency(lapResult.processingFee)}
											</p>
										</div>
									</div>
								)}
				...
				<Card className="mt-8">
					<CardHeader>
						...
						<CardDescription className="text-center">
							Comprehensive financial services API with real-time data
