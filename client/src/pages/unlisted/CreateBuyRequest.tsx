...
export default function CreateBuyRequest() {
	...
	const createRequestMutation = useMutation({
		...
		onSuccess: () => {
			...
			queryClient.invalidateQueries({
				queryKey: ["/api/unlisted/buy-requests"],
			});
	...
	return (
		<div
			...
			data-testid="create-buy-request"
		>
						...
						{!isKycEligible && (
							<Alert className="mb-6 border-yellow-500 dark:border-yellow-700">
								...
								<AlertDescription>
									...
									Investor KYC. Please upgrade your KYC to place buy requests.
								</AlertDescription>
							</Alert>
						)}
														...
														<TableCell>
															<Button
																...
																onClick={() => {
																	...
																	form.setValue(
																		"maxPrice",
																		listing.landingPrice.toString(),
																	);
																	form.setValue(
																		"targetPrice",
																		listing.floorPrice.toString(),
																	);
																	setActiveTab("create");
																}}
									...
									>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormDescription>Request expiry date</FormDescription>
													<FormMessage />
												</FormItem>
											)}
										/>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormDescription>
														Preferred number of shares per transaction
														(optional)
													</FormDescription>
													<FormMessage />
												</FormItem>
										...
										<div className="flex gap-3">
											<Button
												type="submit"
												disabled={
													!isKycEligible || createRequestMutation.isPending
												}
												className="flex-1"
