...
export default function NSDLServices() {
	...
	const accountOpeningMutation = useMutation({
		...
		onSuccess: (data) => {
			toast({
				title: "Success",
				description: "Demat account opened successfully!",
			});
		...
		onError: () => {
			toast({
				title: "Error",
				description: "Failed to open demat account",
				variant: "destructive",
			});
		},
	});
	...
	const edisMutation = useMutation({
		...
		onSuccess: () => {
			toast({
				title: "Success",
				description: "eDIS instruction submitted successfully!",
			});
	...
	const pledgeMutation = useMutation({
		...
		onSuccess: () => {
			toast({
				title: "Success",
				description: "Margin pledge created successfully!",
			});
	...
	return (
		<div
			...
			data-testid="nsdl-services-page"
		>
				...
				<div className="space-y-8">
					...
					<div>
						<h1 className="text-3xl font-bold text-foreground">
							NSDL Securities Services
						</h1>
						<p className="text-muted-foreground mt-2">
							Complete depository services including demat accounts, electronic
							trading, margin pledges, and loan facilities
						</p>
					</div>
					...
					<Tabs defaultValue="holdings" className="w-full">
						...
						<TabsContent value="holdings" className="space-y-6">
							<Card data-testid="holdings-card">
								...
								<CardContent>
									{holdingsLoading ? (
										<div data-testid="holdings-loading">
											Loading holdings...
										</div>
									) : holdings ? (
															...
															<div className="flex justify-between items-start">
																<div className="flex-1">
																	...
																	<div className="flex space-x-4 mt-2">
																		...
																		<Badge variant="outline">
																			Free: {holding.freeQuantity}
																		</Badge>
																		{holding.pledgedQuantity > 0 && (
																			<Badge variant="secondary">
																				Pledged: {holding.pledgedQuantity}
																			</Badge>
																		)}
																	</div>
																</div>
						...
						<TabsContent value="account" className="space-y-6">
							<Card data-testid="account-opening-card">
								...
								<CardContent>
									...
									>
										{accountOpeningMutation.isPending
											? "Processing..."
											: "Open Demat Account"}
									</Button>
								</CardContent>
								...
								<CardContent className="space-y-4">
									<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
										...
										<div>
											...
											<Input
												...
												onChange={(e) =>
													setEdisForm({ ...edisForm, quantity: e.target.value })
												}
									...
									<div className="flex space-x-4">
										<Button
											onClick={() =>
												otpMutation.mutate({
													accountNumber: edisForm.accountNumber,
													mobile: "9876543210",
												})
											}
									...
									{otpRequests[edisForm.accountNumber] && (
										<div>
											...
											<Input
												...
												value={edisForm.otp}
												onChange={(e) =>
													setEdisForm({ ...edisForm, otp: e.target.value })
												}
												placeholder="123456"
												maxLength={6}
											...
											>
												{edisMutation.isPending
													? "Processing..."
													: "Submit eDIS Instruction"}
											</Button>
										</div>
									)}
								</CardContent>
								...
								<CardContent className="space-y-4">
									...
									<div className="flex space-x-4">
										<Button
											onClick={() =>
												otpMutation.mutate({
													accountNumber: pledgeForm.accountNumber,
													mobile: "9876543210",
												})
											}
											disabled={otpMutation.isPending}
									...
									{otpRequests[pledgeForm.accountNumber] && (
										<div>
											...
											<Input
												...
												onChange={(e) =>
													setPledgeForm({ ...pledgeForm, otp: e.target.value })
												}
												placeholder="123456"
												maxLength={6}
									...
									<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
										...
										<div>
											...
											<Input
												...
												onChange={(e) =>
													setLoanForm({ ...loanForm, bankCode: e.target.value })
												}
