...
export default function AgentTrainingPage() {
	...
	const submitQuizMutation = useMutation({
		mutationFn: (data: {
			...
			apiRequest("/api/agent/training/submit-quiz", {
				method: "POST",
				...
				<TabsContent value="certifications" className="mt-6">
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
						<Card
							className={
								(certifications as any)?.isCertified
									? "border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-950/30/50"
									: ""
							}
						>
							<CardHeader>
								<div className="flex items-center gap-4">
									...
									<div>
										...
										<CardDescription>
											Advanced recommendation certification
										</CardDescription>
									</div>
								</div>
							</CardHeader>
								...
								{(certifications as any)?.isCertified ? (
									...
									<div className="text-center py-4">
										...
										<p className="text-sm text-muted-foreground">
											Complete the Growth-Optimized training to unlock this
											certification
										</p>
									</div>
								)}
			...
			<Dialog open={showQuiz} onOpenChange={setShowQuiz}>
				<DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
					<DialogHeader>
						...
						<DialogDescription>
							Answer all questions correctly to earn your certification. You
							...
							{quizResult.passed ? (
								<>
									...
									<p className="text-muted-foreground mb-4">
										You scored {quizResult.score}% and earned your
										certification.
									</p>
									<Badge className="bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 px-4 py-2">
										<Award className="h-4 w-4 mr-2" />
								...
								<>
									...
									<p className="text-muted-foreground mb-4">
										You scored {quizResult.score}%. You need 80% or higher to
										pass. Please review the training material and try again.
									</p>
								</>
							)}
						</div>
