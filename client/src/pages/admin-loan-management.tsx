...
export default function AdminLoanManagement() {
	...
	const createStaffMutation = useMutation({
		mutationFn: async (data: StaffFormData) => {
			const response = await apiRequest(
				"POST",
				`/api/admin/loan-marketplace/providers/${selectedProvider}/staff`,
				{
					...data,
	...
	const updatePayoutConfigMutation = useMutation({
		mutationFn: async (config: CommissionConfig) => {
			const response = await apiRequest(
				"PUT",
				"/api/admin/loan-marketplace/payout-config",
				config,
			);
			return response.json();
		},
		onSuccess: () => {
			toast({
				...
				description: "Payout configuration has been updated.",
			});
			queryClient.invalidateQueries({
				queryKey: ["/api/admin/loan-marketplace/payout-config"],
			});
		...
		<div className="space-y-6" data-testid="admin-loan-management">
			<div className="flex justify-between items-center">
				<div>
					<h1 className="text-3xl font-bold text-foreground">
						Loan Marketplace Management
					</h1>
					<p className="text-muted-foreground">
						Manage partner lenders, staff, commissions, and revenue
					</p>
				</div>
				<Button
					variant="outline"
			...
			<Tabs value={activeTab} onValueChange={setActiveTab}>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
							{providers.map((provider: LoanProvider) => (
								<Card
									...
									data-testid={`lender-${provider.providerKey}`}
								>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
							{products.map((product: any) => (
								<Card
									key={product.key}
									className="hover:shadow-md transition-shadow"
									data-testid={`product-admin-${product.key}`}
								>
									<CardContent className="p-6">
										<div className="flex items-start justify-between mb-4">
										...
										<div className="space-y-2 text-sm">
											...
											<div className="flex justify-between">
												...
												<span className="font-semibold">
													{product.minTenure} - {product.maxTenure} years
												</span>
											</div>
											<div className="flex justify-between">
												<span className="text-muted-foreground">
								...
								<>
														...
														render={({ field }) => (
															<FormItem>
																...
																>
																	...
																	<SelectContent>
																		<SelectItem value="relationship_manager">
																			Relationship Manager
																		</SelectItem>
																		<SelectItem value="branch_manager">
																			Branch Manager
																		</SelectItem>
																		<SelectItem value="credit_officer">
																			Credit Officer
																		</SelectItem>
																		<SelectItem value="zonal_head">
																			Zonal Head
																		</SelectItem>
																		<SelectItem value="regional_head">
																			Regional Head
																		</SelectItem>
																...
																<FormItem>
																	...
																	<FormControl>
																		<Input
																			...
																			data-testid="staff-branch-input"
																		/>
																	</FormControl>
																	<FormMessage />
																</FormItem>
																...
																<FormItem>
																	...
																	<FormControl>
																		<Input
																			{...field}
																			placeholder="Region"
																			data-testid="staff-region-input"
																		/>
																	</FormControl>
																	<FormMessage />
																</FormItem>
									...
									>
										<DialogContent className="max-w-md">
											...
											<Form {...staffForm}>
												<form
													onSubmit={staffForm.handleSubmit(handleUpdateStaff)}
													className="space-y-4"
												>
													<FormField
														control={staffForm.control}
																...
																<FormItem>
																	...
																	<FormControl>
																		<Input
																			...
																			data-testid="edit-staff-email-input"
																		/>
																	</FormControl>
																	<FormMessage />
																</FormItem>
																...
																<FormItem>
																	...
																	<FormControl>
																		<Input
																			{...field}
																			placeholder="Branch name"
																			data-testid="edit-staff-branch-input"
																		/>
																	</FormControl>
																	<FormMessage />
																</FormItem>
																...
																<FormItem>
																	...
																	<FormControl>
																		<Input
																			{...field}
																			placeholder="Region"
																			data-testid="edit-staff-region-input"
																		/>
																	</FormControl>
																	<FormMessage />
																</FormItem>
					...
					{!selectedProvider ? (
						<Card className="border-dashed">
							<CardContent className="flex flex-col items-center justify-center py-12">
								...
								<p className="text-muted-foreground">
									Choose a partner lender to view and manage their staff
								</p>
							</CardContent>
						</Card>
					) : staffLoading ? (
						...
						<Card className="border-dashed">
							<CardContent className="flex flex-col items-center justify-center py-12">
								...
								<p className="text-muted-foreground mb-4">
									Add staff members for this lender
								</p>
								<Button
									onClick={() => setIsAddStaffOpen(true)}
									data-testid="add-first-staff-btn"
								>
									<UserPlus className="h-4 w-4 mr-2" />
										...
										>
											...
											<td className="py-3 px-4">
												<Badge variant="outline">
													{(member.designation || "staff").replace(/_/g, " ")}
												</Badge>
											</td>
											<td className="py-3 px-4">
				...
				<TabsContent
					value="commissions"
					className="space-y-6"
					data-testid="commissions-content"
				>
						...
						<Card>
							...
							<CardContent className="space-y-6">
								<p className="text-sm text-muted-foreground">
									Configure how commission revenue is split between FintekPro,
									partners, and agents.
								</p>
									...
									<div>
										<div className="flex justify-between mb-2">
											...
											<span className="text-sm font-bold text-blue-600">
												{payoutConfig?.data?.fintekProShare || 40}%
											</span>
										</div>
										<div className="h-2 bg-muted rounded-full overflow-hidden">
											<div
												...
												style={{
													width: `${payoutConfig?.data?.fintekProShare || 40}%`,
												}}
											/>
										</div>
									</div>
									<div>
										<div className="flex justify-between mb-2">
											...
											<span className="text-sm font-bold text-green-600">
												{payoutConfig?.data?.partnerShare || 30}%
											</span>
										</div>
										<div className="h-2 bg-muted rounded-full overflow-hidden">
											<div
												...
												style={{
													width: `${payoutConfig?.data?.partnerShare || 30}%`,
												}}
											/>
										</div>
									</div>
									<div>
										<div className="flex justify-between mb-2">
											...
											<span className="text-sm font-bold text-purple-600">
												{payoutConfig?.data?.agentShare || 30}%
											</span>
										</div>
										<div className="h-2 bg-muted rounded-full overflow-hidden">
											<div
												...
												style={{
													width: `${payoutConfig?.data?.agentShare || 30}%`,
												}}
											/>
										</div>
									</div>
								...
								<div className="pt-4 border-t">
									<p className="text-xs text-muted-foreground mb-4">
										Total must equal 100%. Changes will affect all new
										commission calculations.
									</p>
									<Button
										variant="outline"
										className="w-full"
										data-testid="edit-split-btn"
									>
										...
										<div className="flex items-center justify-between">
											<div>
												...
												<p className="text-2xl font-bold text-green-600">
													{formatCurrency(
														revenueDashboard?.data?.totalCommissions || 0,
													)}
												</p>
											</div>
										...
										<div className="flex items-center justify-between">
											<div>
												...
												<p className="text-2xl font-bold text-blue-600">
													{formatCurrency(
														revenueDashboard?.data?.partnerPayouts || 0,
													)}
												</p>
											</div>
										...
										<div className="flex items-center justify-between">
											<div>
												...
												<p className="text-2xl font-bold text-purple-600">
													{formatCurrency(
														revenueDashboard?.data?.agentPayouts || 0,
													)}
												</p>
											</div>
										...
										<div className="flex items-center justify-between">
											<div>
												...
												<p className="text-2xl font-bold text-orange-600">
													{formatCurrency(
														revenueDashboard?.data?.netRevenue || 0,
													)}
												</p>
											</div>
										...
										<div className="space-y-4">
											<div className="flex items-center justify-between p-3 bg-muted rounded-lg">
												...
												<span className="font-bold">
													{revenueDashboard?.data?.leadAnalytics?.totalLeads ||
														0}
												</span>
											</div>
											<div className="flex items-center justify-between p-3 bg-muted rounded-lg">
												...
												<span className="font-bold">
													{revenueDashboard?.data?.leadAnalytics?.processing ||
														0}
												</span>
											</div>
											<div className="flex items-center justify-between p-3 bg-muted rounded-lg">
												...
												<span className="font-bold">
													{revenueDashboard?.data?.leadAnalytics?.sanctioned ||
														0}
												</span>
											</div>
											<div className="flex items-center justify-between p-3 bg-muted rounded-lg">
												...
												<span className="font-bold">
													{revenueDashboard?.data?.leadAnalytics?.disbursed ||
														0}
												</span>
											</div>
											<div className="flex items-center justify-between p-3 bg-muted rounded-lg">
												...
												<span className="font-bold">
													{revenueDashboard?.data?.leadAnalytics?.rejected || 0}
												</span>
											</div>
										</div>
									</CardContent>
