...
const TIME_HORIZONS = [
  { id: 'intraday', label: 'Intraday', description: 'Same day trades', icon: Zap, color: 'text-red-500', duration: 'Minutes to hours' },
  { id: 'ultra_short', label: 'Ultra Short', description: '1-5 trading days', icon: Timer, color: 'text-orange-500', duration: '1-5 days' },
  { id: 'short_term', label: 'Short Term', description: '1-4 weeks', icon: Clock, color: 'text-yellow-500', duration: '1-4 weeks' },
  { id: 'medium_term', label: 'Medium Term', description: '1-6 months', icon: Calendar, color: 'text-green-500', duration: '1-6 months' },
  { id: 'long_term', label: 'Long Term', description: '6+ months', icon: TrendingUp, color: 'text-blue-500', duration: '6+ months' }
];

const DERIVATIVE_TYPES = [
  { id: 'futures', label: 'Futures', description: 'Index & Stock Futures' },
  { id: 'options_call', label: 'Call Options', description: 'Bullish option strategies' },
  { id: 'options_put', label: 'Put Options', description: 'Bearish option strategies' },
  { id: 'spreads', label: 'Spreads', description: 'Multi-leg strategies' }
];

const SECTORS = [
  'Banking', 'IT', 'Pharma', 'Auto', 'FMCG', 'Energy', 'Metals', 'Realty', 'Infra', 'Media'
];
...
export default function AgentStockAI() {
  ...
  const [derivativeTimeHorizon, setDerivativeTimeHorizon] = useState("intraday");
  ...
  const getActionColor = (action: string) => {
    if (action === 'BUY') return 'bg-green-500/10 text-green-500 border-green-500/30';
    if (action === 'SELL') return 'bg-red-500/10 text-red-500 border-red-500/30';
          ...
          <TabsContent value="stocks" className="space-y-6">
            <Card className="bg-background/50 border-border">
              <CardHeader>
                ...
                <CardDescription>Select the time frame for stock recommendations</CardDescription>
              </CardHeader>
              <CardContent>
                        ...
                        <div className="flex">
                          ...
                          <div className="flex-1 p-4">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <Button size="sm" className="bg-emerald-600 hover:bg-emerald-700" data-testid={`button-add-${stock.symbol}`}>
                                Add to Proposal
                              </Button>
                            </div>
                          </div>
          ...
          <TabsContent value="derivatives" className="space-y-6">
            ...
            <Card className="bg-background/50 border-border">
              <CardHeader>
                ...
                <CardDescription>Select time frame for F&O recommendations</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-5 gap-3">
                  {TIME_HORIZONS.filter(h => ['intraday', 'ultra_short', 'short_term'].includes(h.id)).map((horizon) => {
                    const Icon = horizon.icon;
            ...
            <Alert className="bg-amber-500/10 border-amber-500/30">
              ...
              <AlertDescription className="text-amber-200">
                <strong>Risk Warning:</strong> Derivatives are complex instruments with high risk. 
                Only recommend to clients with appropriate experience and risk tolerance.
              </AlertDescription>
            </Alert>
