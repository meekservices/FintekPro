		...
		<div className="max-w-6xl mx-auto p-6 space-y-6">
			<div className="text-center space-y-2">
				...
				<p className="text-muted-foreground">
					File your Income Tax Return directly through our platform
				</p>
			</div>
							...
							{itrData ? (
									...
									<div className="flex items-center justify-between">
										<div>
											<h3 className="font-medium">
												{itrData.formType} for AY {itrData.assessmentYear}
											</h3>
											<p className="text-sm text-muted-foreground">
												Last updated:{" "}
												{new Date(itrData.lastUpdated).toLocaleDateString()}
											</p>
										</div>
										<Badge className={getStatusColor(itrData.status)}>
											{(itrData.status || "pending").charAt(0).toUpperCase() +
												(itrData.status || "pending").slice(1)}
										</Badge>
									</div>
									...
									<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
										<div className="text-center p-4 bg-green-50 dark:bg-green-950/30 rounded-lg">
											<div className="text-2xl font-bold text-green-600">
												₹{itrData.totalIncome.toLocaleString()}
											</div>
										...
										<div className="text-center p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
											<div className="text-2xl font-bold text-blue-600">
												₹{itrData.taxLiability.toLocaleString()}
											</div>
											<div className="text-sm text-muted-foreground">
												Tax Liability
											</div>
										...
										<div className="text-center p-4 bg-purple-50 dark:bg-purple-950/30 rounded-lg">
											<div className="text-2xl font-bold text-purple-600">
												₹{itrData.refundAmount.toLocaleString()}
											</div>
											<div className="text-sm text-muted-foreground">
												Refund Due
											</div>
								...
								<div className="text-center py-8">
									...
									<p className="text-muted-foreground mb-4">
										Start by auto-populating data from your tax sources
									</p>
									<Button
							...
							<TabsContent value="review" className="space-y-4">
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									<Card>
										<CardHeader>
											...
											<CardDescription>
												Review all income data before filing
											</CardDescription>
										</CardHeader>
										<CardContent>
								...
								<Card>
									<CardHeader>
										...
										<CardDescription>
											Information automatically populated from connected sources
										</CardDescription>
									</CardHeader>
									<CardContent>
									...
									<CardContent>
										<div className="space-y-4">
											<Alert>
												<AlertCircle className="h-4 w-4" />
												<AlertDescription>
													This will generate the final ITR-XML file for
													submission to the Income Tax Department portal.
												</AlertDescription>
											</Alert>
											...
											{itrData?.status === "generated" && (
												<div className="p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
													...
													<p className="text-sm text-blue-700 dark:text-blue-300">
														Your ITR-XML file is ready for submission. You can
														now proceed to file your return.
													</p>
												</div>
											)}
										</div>
											...
											{itrData?.status === "filed" ? (
												<div className="p-4 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-800">
													...
													<p className="text-sm text-green-700 dark:text-green-300 mb-3">
														Your ITR has been successfully submitted to the
													...
													<div className="space-y-2 text-sm">
														<div className="flex justify-between">
															...
															<span className="font-mono font-medium">
																ITR{new Date().getFullYear()}12345678
															</span>
														</div>
														<div className="flex justify-between">
												...
												<>
													<Alert>
														<AlertCircle className="h-4 w-4" />
														<AlertDescription>
															Final step: Submit your ITR to the Income Tax
															Department portal. This action cannot be undone.
														</AlertDescription>
													</Alert>
