	...
	const advisoryServices: Service[] = [
		{
			...
			description:
				"Personalized investment strategy and portfolio management for HNI clients",
			features: [
		...
		},
		{
			...
			category: "Planning",
			description:
				"Comprehensive financial planning covering goals, insurance, tax, and retirement",
			features: [
				"Goal-based planning",
				"Cash flow analysis",
				"Insurance review",
	...
	const researchServices: Service[] = [
		{
			...
			category: "Research",
			description:
				"In-depth equity research reports with buy/sell recommendations",
			features: [
		...
		},
		{
			...
			category: "Research",
			description:
				"Fund selection and portfolio construction for mutual fund investors",
			features: [
				"Fund comparison",
				"Portfolio analysis",
				"SIP recommendations",
	...
	const specializedServices: Service[] = [
		{
			...
			description:
				"Specialized advisory for Non-Resident Indians investing in India",
			features: [
		...
		},
		{
			...
			category: "Corporate",
			description:
				"Financial advisory for corporates, startups, and businesses",
			features: [
				"Fundraising support",
				...
				<div className="flex items-center gap-3 mb-2">
					...
					<div>
						<h1
							...
							data-testid="professional-services-title"
						>
							Professional Services
						</h1>
						<p className="text-muted-foreground">
							Expert advisory and research services for your financial goals
						</p>
					</div>
				</div>
			</div>
				...
				<TabsContent value="advisory" className="space-y-6">
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
						{advisoryServices.map((service) => (
							<Card
								key={service.id}
								className={service.popular ? "border-primary" : ""}
						...
						{researchServices.map((service) => (
							...
							>
								...
								<CardContent className="space-y-4">
									...
									<Button
										className="w-full"
										data-testid={`button-subscribe-research-${service.id}`}
									>
										Subscribe Now
									</Button>
								</CardContent>
				...
				<TabsContent value="team" className="space-y-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Meet our experienced financial advisors and research analysts
							</CardDescription>
						</CardHeader>
						<CardContent>
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Connect with our advisory team for personalized guidance
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-4">
