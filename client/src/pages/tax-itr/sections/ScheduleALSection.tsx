...
export const ScheduleALSection: React.FC = (): React.ReactElement => {
	...
	const computedTotalAssets =
		scheduleAL.immovableProperty +
		scheduleAL.movableAssets +
		scheduleAL.bankDeposits +
		scheduleAL.sharesAndSecurities +
		scheduleAL.insurancePolicies +
		scheduleAL.loansAndAdvancesGiven +
		scheduleAL.cashInHand +
		scheduleAL.jewelleryBullion +
		scheduleAL.archaeologicalCollections +
		scheduleAL.vehiclesYachtsBoats;
	const computedTotalLiabilities =
		scheduleAL.liabilitiesRelatedToImmovable +
		scheduleAL.liabilitiesRelatedToOther;
	const netWorth = computedTotalAssets - computedTotalLiabilities;

	return (
		<div className="space-y-6">
			<p className="text-muted-foreground text-sm">
				Schedule AL (Assets & Liabilities) is{" "}
				<strong>
					mandatory for ITR-2/3/4 when total income exceeds ₹50 lakhs
				</strong>
				. Disclose all assets and liabilities as on 31st March of the assessment
				year. This is a wealth disclosure requirement per Income Tax rules.
			</p>
					...
					<div className="space-y-2">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
							<div className="space-y-1.5">
								...
								<CurrencyInput
									id="al-immovable"
									value={scheduleAL.immovableProperty}
									onChange={(v: number): void =>
										setScheduleAL((prev: ScheduleALDetails) => ({
											...prev,
											immovableProperty: v,
										}))
									}
									data-testid="al-immovable"
								/>
							</div>
						</div>
					</div>
					...
					<div className="space-y-2">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
							<div className="space-y-1.5">
								...
								<CurrencyInput
									id="al-jewellery"
									value={scheduleAL.jewelleryBullion}
									onChange={(v: number): void =>
										setScheduleAL((prev: ScheduleALDetails) => ({
											...prev,
											jewelleryBullion: v,
							...
							<div className="space-y-1.5">
								...
								<CurrencyInput
									id="al-vehicles"
									value={scheduleAL.vehiclesYachtsBoats}
									onChange={(v: number): void =>
										setScheduleAL((prev: ScheduleALDetails) => ({
											...prev,
											vehiclesYachtsBoats: v,
										}))
									}
									data-testid="al-vehicles"
								/>
							</div>
							<div className="space-y-1.5">
								<Label className="text-xs">
								...
								<CurrencyInput
									id="al-archaeological"
									value={scheduleAL.archaeologicalCollections}
									onChange={(v: number): void =>
										setScheduleAL((prev: ScheduleALDetails) => ({
											...prev,
											archaeologicalCollections: v,
										}))
									}
									data-testid="al-archaeological"
								/>
							</div>
							<div className="space-y-1.5">
								<Label className="text-xs">
								...
								<CurrencyInput
									id="al-movable"
									value={scheduleAL.movableAssets}
									onChange={(v: number): void =>
										setScheduleAL((prev: ScheduleALDetails) => ({
											...prev,
											movableAssets: v,
					...
					<div className="space-y-2">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
							...
							<div className="space-y-1.5">
								...
								<CurrencyInput
									id="al-shares"
									value={scheduleAL.sharesAndSecurities}
									onChange={(v: number): void =>
										setScheduleAL((prev: ScheduleALDetails) => ({
											...prev,
											sharesAndSecurities: v,
										}))
									}
									data-testid="al-shares"
								/>
							</div>
							<div className="space-y-1.5">
								<Label className="text-xs">
								...
								<CurrencyInput
									id="al-insurance"
									value={scheduleAL.insurancePolicies}
									onChange={(v: number): void =>
										setScheduleAL((prev: ScheduleALDetails) => ({
											...prev,
											insurancePolicies: v,
							...
							<div className="space-y-1.5">
								...
								<CurrencyInput
									id="al-loans"
									value={scheduleAL.loansAndAdvancesGiven}
									onChange={(v: number): void =>
										setScheduleAL((prev: ScheduleALDetails) => ({
											...prev,
											loansAndAdvancesGiven: v,
										}))
									}
									data-testid="al-loans"
								/>
							</div>
							<div className="space-y-1.5">
								<Label className="text-xs">
			...
			<Card>
				<CardHeader className="pb-3">
					<CardTitle className="text-base flex items-center gap-2">
						<Receipt className="h-4 w-4" /> Part B — Liabilities (as on 31st
						March)
					</CardTitle>
				</CardHeader>
				<CardContent className="space-y-3">
					<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
						<div className="space-y-1.5">
							...
							<CurrencyInput
								id="al-liab-immovable"
								value={scheduleAL.liabilitiesRelatedToImmovable}
								onChange={(v: number): void =>
									setScheduleAL((prev: ScheduleALDetails) => ({
										...prev,
										liabilitiesRelatedToImmovable: v,
									}))
								}
								data-testid="al-liab-immovable"
							/>
						</div>
						<div className="space-y-1.5">
							<Label className="text-xs">
							...
							<CurrencyInput
								id="al-liab-other"
								value={scheduleAL.liabilitiesRelatedToOther}
								onChange={(v: number): void =>
									setScheduleAL((prev: ScheduleALDetails) => ({
										...prev,
										liabilitiesRelatedToOther: v,
									}))
								}
								data-testid="al-liab-other"
							/>
						</div>
					</div>
				</CardContent>
				...
				<CardContent className="p-4 space-y-2">
					<div className="flex justify-between items-center">
						...
						<span className="font-bold text-blue-600">
							{formatCurrency(computedTotalAssets)}
						</span>
					</div>
					<div className="flex justify-between items-center">
						<span className="text-sm">Total Liabilities</span>
						<span className="font-bold text-red-600">
							{formatCurrency(computedTotalLiabilities)}
						</span>
					</div>
					<Separator />
					<div className="flex justify-between items-center">
						...
						<span
							className={`font-bold text-lg ${netWorth >= 0 ? "text-green-600" : "text-red-600"}`}
						>
			...
			<Alert>
				...
				<AlertDescription className="text-xs">
					<strong>Important:</strong> Ensure all assets are disclosed at their
					value as on 31st March{" "}
					{assessmentYear ? Number.parseInt(assessmentYear) - 1 : "2025"}.
					Non-disclosure or under-reporting may attract penalty under Section
					271(1)(c) for concealment of income and assets.
				</AlertDescription>
			</Alert>
