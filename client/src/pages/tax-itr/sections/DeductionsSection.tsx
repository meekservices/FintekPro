		...
		<div className="space-y-6">
			{isNewRegime && (
				<Alert className="bg-amber-50 dark:bg-amber-950 border-amber-200 dark:border-amber-800">
					...
					<AlertDescription>
						<strong>New Tax Regime selected.</strong> Most Chapter VI-A
						deductions (80C, 80D, 80G, etc.) are <strong>not available</strong>.
						Only standard deduction of ₹75,000 and employer NPS (80CCD2) apply.
			...
			<p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
				Section 80C / 80CCC / 80CCD — Combined Limit ₹1.5 Lakh
			</p>
			<div className="grid grid-cols-1 md:grid-cols-2 gap-5">
				<div className="space-y-1.5">
					<Label
						htmlFor="section80C"
						className={isNewRegime ? "text-muted-foreground" : ""}
					>
					...
					<CurrencyInput
						...
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80C: v,
							}))
						}
						placeholder="PPF, ELSS, LIC, PF"
						max={150000}
				...
				<div className="space-y-1.5">
					...
					<CurrencyInput
						id="section80CCC"
						value={deductionDetails.section80CCC}
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80CCC: v,
						...
						max={150000}
						disabled={isNewRegime}
						data-testid="input-section-80ccc"
					/>
				</div>
				<div className="space-y-1.5">
					<Label
						htmlFor="section80CCD1"
						className={isNewRegime ? "text-muted-foreground" : ""}
					>
					...
					<CurrencyInput
						id="section80CCD1"
						value={deductionDetails.section80CCD1}
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80CCD1: v,
						...
						max={150000}
						disabled={isNewRegime}
						data-testid="input-section-80ccd1"
					/>
				</div>
				<div className="space-y-1.5">
					<Label
						htmlFor="section80CCD1B"
						className={isNewRegime ? "text-muted-foreground" : ""}
					>
					...
					<CurrencyInput
						id="section80CCD1B"
						value={deductionDetails.section80CCD1B}
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80CCD1B: v,
				...
				<div className="space-y-1.5">
					...
					<CurrencyInput
						id="section80CCD2"
						value={deductionDetails.section80CCD2}
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80CCD2: v,
						...
						placeholder="Employer NPS (check payslip)"
						data-testid="input-section-80ccd2"
					/>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-5">
				...
				<div className="space-y-1.5">
					...
					<CurrencyInput
						id="section80DD"
						value={deductionDetails.section80DD}
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80DD: v,
						...
						placeholder="₹75K or ₹1.25L"
						max={125000}
						disabled={isNewRegime}
						data-testid="input-section-80dd"
					/>
				</div>
				<div className="space-y-1.5">
					<Label
						htmlFor="section80DDB"
						className={isNewRegime ? "text-muted-foreground" : ""}
					>
					...
					<CurrencyInput
						id="section80DDB"
						value={deductionDetails.section80DDB}
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80DDB: v,
						...
						placeholder="Specified disease treatment"
						max={100000}
						disabled={isNewRegime}
						data-testid="input-section-80ddb"
					/>
				</div>
				<div className="space-y-1.5">
					<Label
					...
					<CurrencyInput
						id="section80U"
						value={deductionDetails.section80U}
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80U: v,
			...
			<Separator />
			<p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
				Housing, Donations & Savings Interest
			</p>
			<div className="grid grid-cols-1 md:grid-cols-2 gap-5">
				<div className="space-y-1.5">
					<Label
						htmlFor="section80EEA"
						className={isNewRegime ? "text-muted-foreground" : ""}
					>
					...
					<CurrencyInput
						id="section80EEA"
						value={deductionDetails.section80EEA}
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80EEA: v,
						...
						placeholder="Affordable housing loan"
						max={150000}
						disabled={isNewRegime}
						data-testid="input-section-80eea"
					/>
				</div>
				<div className="space-y-1.5">
					<Label
						htmlFor="section80EEB"
						className={isNewRegime ? "text-muted-foreground" : ""}
					>
					...
					<CurrencyInput
						id="section80EEB"
						value={deductionDetails.section80EEB}
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80EEB: v,
						...
						placeholder="Electric vehicle loan"
						max={150000}
						disabled={isNewRegime}
						data-testid="input-section-80eeb"
					/>
				</div>
				<div className="space-y-1.5">
					<Label
					...
					<CurrencyInput
						id="section80GG"
						value={deductionDetails.section80GG}
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80GG: v,
						...
						placeholder="Rent if no HRA"
						max={60000}
						disabled={isNewRegime}
						data-testid="input-section-80gg"
					/>
				</div>
				<div className="space-y-1.5">
					<Label
					...
					<div className="col-span-full space-y-3 border rounded-lg p-4 bg-muted/30">
						<div className="flex items-center justify-between">
							...
							<Button
								...
								size="sm"
								onClick={(): void =>
									setDonationEntries((prev: DonationEntry[]) => [
										...prev,
										{
											doneeName: "",
											doneePAN: "",
											...
											qualifyingLimit: "without_limit",
											donationDate: "",
											donationType: "cash",
											section80GCertificateNo: "",
											eligibleAmount: 0,
										},
									])
								}
						...
						<p className="text-xs text-muted-foreground">
							Add each donation separately for ITR Schedule 80G. The total
							eligible deduction is auto-calculated and applied to the 80G field
							above.
						</p>
							...
							<Card key={idx} className="border-dashed">
								<CardContent className="p-3 space-y-3">
									<div className="flex items-center justify-between">
										...
										<Button
											...
											onClick={(): void =>
												setDonationEntries((prev: DonationEntry[]) =>
													prev.filter(
														(_: DonationEntry, i: number): boolean => i !== idx,
													),
												)
											}
										>
									...
									<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
										<div className="space-y-1.5">
											<Label className="text-xs">
												Donee Name <span className="text-red-500">*</span>
											</Label>
											<Input
												value={d.doneeName}
												onChange={(
													...
													const n = [...donationEntries];
													n[idx] = { ...n[idx], doneeName: e.target.value };
													setDonationEntries(n);
												}}
												placeholder="e.g. PM National Relief Fund"
												data-testid={`donation-name-${idx}`}
											/>
										</div>
										<div className="space-y-1.5">
											...
											<Input
												...
												onChange={(
													...
													n[idx] = {
														...n[idx],
														doneePAN: e.target.value.toUpperCase(),
													};
													setDonationEntries(n);
												}}
												placeholder="AAAPN0000A"
												maxLength={10}
											/>
										</div>
										<div className="space-y-1.5">
											...
											<CurrencyInput
												...
												onChange={(v: number): void => {
													const n = [...donationEntries];
													const pct = n[idx].qualifyingPercentage;
													n[idx] = {
														...n[idx],
														donationAmount: v,
														eligibleAmount: (v * pct) / 100,
													};
													setDonationEntries(n);
												}}
												data-testid={`donation-amount-${idx}`}
											/>
										</div>
										<div className="space-y-1.5">
											...
											<Input
												type="date"
												value={d.donationDate}
												onChange={(
													e: React.ChangeEvent<HTMLInputElement>,
												): void => {
													const n = [...donationEntries];
													n[idx] = { ...n[idx], donationDate: e.target.value };
													setDonationEntries(n);
												}}
											/>
										</div>
										<div className="space-y-1.5">
											...
											<Select
												value={String(d.qualifyingPercentage)}
												onValueChange={(v: string): void => {
													const n = [...donationEntries];
													const pct = Number.parseInt(v) as 100 | 50;
													n[idx] = {
														...n[idx],
														qualifyingPercentage: pct,
														eligibleAmount: (n[idx].donationAmount * pct) / 100,
													};
													setDonationEntries(n);
												}}
											>
										...
										<div className="space-y-1.5">
											...
											<Select
												value={d.qualifyingLimit}
												onValueChange={(
													v: "with_limit" | "without_limit",
												): void => {
													const n = [...donationEntries];
													n[idx] = { ...n[idx], qualifyingLimit: v };
													setDonationEntries(n);
												}}
											>
												<SelectTrigger>
												...
												<SelectContent>
													<SelectItem value="with_limit">
														With Limit (10% of Adjusted GTI)
													</SelectItem>
													<SelectItem value="without_limit">
														Without Limit (e.g. PM Relief Fund)
													</SelectItem>
												</SelectContent>
											</Select>
										</div>
										<div className="space-y-1.5">
											...
											<Select
												...
												onValueChange={(v: "cash" | "kind" | "other"): void => {
													const n = [...donationEntries];
													n[idx] = { ...n[idx], donationType: v };
													setDonationEntries(n);
												}}
											>
												<SelectTrigger>
										...
										<div className="space-y-1.5">
											...
											<Input
												value={d.section80GCertificateNo}
												onChange={(
													e: React.ChangeEvent<HTMLInputElement>,
												): void => {
													const n = [...donationEntries];
													n[idx] = {
														...n[idx],
														section80GCertificateNo: e.target.value,
													};
													setDonationEntries(n);
												}}
									...
									<div className="flex items-center gap-2 text-xs bg-green-50 dark:bg-green-950/30 p-2 rounded">
										...
										<span>
											Eligible Deduction:{" "}
											<strong>{formatCurrency(d.eligibleAmount)}</strong> (
											{d.qualifyingPercentage}% of{" "}
						...
						{donationEntries.length > 0 && (
							<div className="flex justify-between items-center p-2 bg-green-100 dark:bg-green-950 rounded text-sm font-medium">
								...
								<span className="text-green-700 dark:text-green-400">
									{formatCurrency(
										donationEntries.reduce(
											(sum: number, d: DonationEntry) => sum + d.eligibleAmount,
											0,
										),
									)}
								</span>
				...
				<div className="space-y-1.5">
					...
					<CurrencyInput
						id="section80TTB"
						value={deductionDetails.section80TTB}
						onChange={(v: number): void =>
							setDeductionDetails((prev: DeductionDetails) => ({
								...prev,
								section80TTB: v,
						...
						placeholder="Senior citizen interest"
						max={50000}
						disabled={isNewRegime}
						data-testid="input-section-80ttb"
					/>
				</div>
			</div>
				...
				<CardContent className="p-4">
					<div className="flex justify-between items-center">
						...
						<span className="font-bold text-lg text-green-600">
							{isNewRegime
								? formatCurrency(deductionDetails.section80CCD2) +
									" (New Regime — only 80CCD2)"
