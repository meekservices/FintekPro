...
export const DeductionsSection: React.FC = () => {
  const {
    taxRegime,
    deductionDetails,
    setDeductionDetails,
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80C" value={deductionDetails.section80C} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80C: v }))} placeholder="PPF, ELSS, LIC, PF" max={150000} disabled={isNewRegime} data-testid="input-section-80c" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80CCC" value={deductionDetails.section80CCC} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80CCC: v }))} placeholder="Pension fund contributions" max={150000} disabled={isNewRegime} data-testid="input-section-80ccc" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80CCD1" value={deductionDetails.section80CCD1} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80CCD1: v }))} placeholder="NPS self-contribution" max={150000} disabled={isNewRegime} data-testid="input-section-80ccd1" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80CCD1B" value={deductionDetails.section80CCD1B} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80CCD1B: v }))} placeholder="Additional NPS ₹50K" max={50000} disabled={isNewRegime} data-testid="input-section-80ccd1b" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80CCD2" value={deductionDetails.section80CCD2} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80CCD2: v }))} placeholder="Employer NPS (check payslip)" data-testid="input-section-80ccd2" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80D" value={deductionDetails.section80D} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80D: v }))} placeholder="Self + family + parents" max={100000} disabled={isNewRegime} data-testid="input-section-80d" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80DD" value={deductionDetails.section80DD} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80DD: v }))} placeholder="₹75K or ₹1.25L" max={125000} disabled={isNewRegime} data-testid="input-section-80dd" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80DDB" value={deductionDetails.section80DDB} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80DDB: v }))} placeholder="Specified disease treatment" max={100000} disabled={isNewRegime} data-testid="input-section-80ddb" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80U" value={deductionDetails.section80U} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80U: v }))} placeholder="₹75K or ₹1.25L" max={125000} disabled={isNewRegime} data-testid="input-section-80u" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80E" value={deductionDetails.section80E} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80E: v }))} placeholder="No upper limit" disabled={isNewRegime} data-testid="input-section-80e" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80EEA" value={deductionDetails.section80EEA} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80EEA: v }))} placeholder="Affordable housing loan" max={150000} disabled={isNewRegime} data-testid="input-section-80eea" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80EEB" value={deductionDetails.section80EEB} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80EEB: v }))} placeholder="Electric vehicle loan" max={150000} disabled={isNewRegime} data-testid="input-section-80eeb" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80GG" value={deductionDetails.section80GG} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80GG: v }))} placeholder="Rent if no HRA" max={60000} disabled={isNewRegime} data-testid="input-section-80gg" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80G" value={deductionDetails.section80G} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80G: v }))} placeholder="Charitable donations" disabled={isNewRegime} data-testid="input-section-80g" />
        </div>
        ...
        {!isNewRegime && (
          <div className="col-span-full space-y-3 border rounded-lg p-4 bg-muted/30">
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => setDonationEntries((prev: DonationEntry[]) => [...prev, {
              ...
              <Card key={idx} className="border-dashed">
                <CardContent className="p-3 space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Button variant="ghost" size="sm" onClick={() => setDonationEntries((prev: DonationEntry[]) => prev.filter((_: DonationEntry, i: number) => i !== idx))}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      ...
                      <Input value={d.doneeName} onChange={(e: React.ChangeEvent<HTMLInputElement>) => { const n = [...donationEntries]; n[idx] = { ...n[idx], doneeName: e.target.value }; setDonationEntries(n); }} placeholder="e.g. PM National Relief Fund" data-testid={`donation-name-${idx}`} />
                    </div>
                    <div className="space-y-1.5">
                      <Label className="text-xs">Donee PAN</Label>
                      <Input value={d.doneePAN} onChange={(e: React.ChangeEvent<HTMLInputElement>) => { const n = [...donationEntries]; n[idx] = { ...n[idx], doneePAN: e.target.value.toUpperCase() }; setDonationEntries(n); }} placeholder="AAAPN0000A" maxLength={10} />
                    </div>
                    <div className="space-y-1.5">
                      <Label className="text-xs">Donation Amount <span className="text-red-500">*</span></Label>
                      <CurrencyInput id={`donation-amt-${idx}`} value={d.donationAmount} onChange={(v: number) => { const n = [...donationEntries]; const pct = n[idx].qualifyingPercentage; n[idx] = { ...n[idx], donationAmount: v, eligibleAmount: v * pct / 100 }; setDonationEntries(n); }} data-testid={`donation-amount-${idx}`} />
                    </div>
                    <div className="space-y-1.5">
                      <Label className="text-xs">Donation Date</Label>
                      <Input type="date" value={d.donationDate} onChange={(e: React.ChangeEvent<HTMLInputElement>) => { const n = [...donationEntries]; n[idx] = { ...n[idx], donationDate: e.target.value }; setDonationEntries(n); }} />
                    </div>
                    <div className="space-y-1.5">
                      <Label className="text-xs">Qualifying %</Label>
                      <Select value={String(d.qualifyingPercentage)} onValueChange={(v: string) => { const n = [...donationEntries]; const pct = parseInt(v) as 100 | 50; n[idx] = { ...n[idx], qualifyingPercentage: pct, eligibleAmount: n[idx].donationAmount * pct / 100 }; setDonationEntries(n); }}>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input value={d.section80GCertificateNo} onChange={(e: React.ChangeEvent<HTMLInputElement>) => { const n = [...donationEntries]; n[idx] = { ...n[idx], section80GCertificateNo: e.target.value }; setDonationEntries(n); }} placeholder="Certificate reference" />
                    </div>
                  </div>
        ...
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80TTA" value={deductionDetails.section80TTA} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80TTA: v }))} placeholder="Savings account interest" max={10000} disabled={isNewRegime} data-testid="input-section-80tta" />
        </div>
        <div className="space-y-1.5">
          ...
          <CurrencyInput id="section80TTB" value={deductionDetails.section80TTB} onChange={(v: number) => setDeductionDetails((prev: DeductionDetails) => ({ ...prev, section80TTB: v }))} placeholder="Senior citizen interest" max={50000} disabled={isNewRegime} data-testid="input-section-80ttb" />
        </div>
      </div>
