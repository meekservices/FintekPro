	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Explore other investment strategies managed by the same portfolio
					manager
				</CardDescription>
			</CardHeader>
			<CardContent>
						...
						<Card>
							...
							<CardContent className="space-y-3">
								...
								<div className="flex justify-between py-2 border-b">
									...
									<span className="font-medium">
										{formatCurrency(scheme.minSIPInvestment)}
									</span>
								</div>
								<div className="flex justify-between py-2 border-b">
					...
					{scheme.manager ? (
								...
								<CardContent>
									<div className="flex flex-col md:flex-row gap-6">
										<div className="flex-1">
											...
											<p className="text-muted-foreground mb-4">
												{scheme.manager.designation || "Portfolio Manager"}
											</p>
											{scheme.manager.bio && (
						...
						<Card className="p-8 text-center">
							...
							<h3 className="text-lg font-semibold text-foreground">
								Portfolio Manager Information Not Available
							</h3>
							<p className="text-muted-foreground">
								Contact the PMS provider for manager details.
							</p>
						</Card>
					)}
				</TabsContent>
