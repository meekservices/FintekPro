...
import { 
  ...
  Shield, Scale, Briefcase, Phone, FileWarning
} from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-4">
              ...
              <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Investment Risk Disclaimer</h1>
            </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                  ...
                  <ul className="list-disc list-inside text-muted-foreground dark:text-muted-foreground space-y-1 mt-3">
