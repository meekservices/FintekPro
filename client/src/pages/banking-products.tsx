			...
			<div className="space-y-6">
						...
						return (
							...
							>
								<CardContent className="p-6">
									...
									>
										<IconComponent
											className={`h-6 w-6 text-finance-${category.color}`}
										/>
									</div>
								...
								{bankingProducts && bankingProducts.length > 0 ? (
													...
													{product.annualFee !== undefined && (
														<div className="flex justify-between text-sm">
															...
															<span className="font-semibold">
																{product.annualFee === 0
																	? "FREE"
																	: `₹${product.annualFee.toLocaleString()}`}
															</span>
														</div>
													)}
													{product.rewards && (
									...
									<div className="col-span-full text-center py-12">
										...
										<p className="text-muted-foreground">
											No banking products available in this category.
										</p>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<Card className="bg-gradient-to-br from-blue-50 dark:from-blue-950/30 to-blue-100 dark:to-blue-900/30">
						...
						<CardContent className="space-y-3">
							<div className="flex items-start gap-2">
								<div className="w-1.5 h-1.5 rounded-full bg-finance-blue mt-2" />
								<p className="text-sm">
									Compare offers from 20+ leading banks in real-time
								</p>
							</div>
							<div className="flex items-start gap-2">
								<div className="w-1.5 h-1.5 rounded-full bg-finance-blue mt-2" />
								<p className="text-sm">
									Instant eligibility check without affecting credit score
								</p>
							</div>
							<div className="flex items-start gap-2">
								<div className="w-1.5 h-1.5 rounded-full bg-finance-blue mt-2" />
								<p className="text-sm">
									End-to-end digital application with minimal documentation
								</p>
							</div>
							<div className="flex items-start gap-2">
								<div className="w-1.5 h-1.5 rounded-full bg-finance-blue mt-2" />
					...
					<Card className="bg-gradient-to-br from-green-50 dark:from-green-950/30 to-green-100 dark:to-green-900/30">
						...
						<CardContent className="space-y-3">
							<p className="text-sm">
								We continuously monitor and negotiate with partner banks to
								ensure you get the best rates available in the market.
							</p>
							...
							<Button
								className="w-full"
								size="sm"
								data-testid="button-check-rates"
							>
								Check Latest Rates
							</Button>
						</CardContent>
