...
export default function TaxITRVerifyPage() {
  ...
  const [verificationMethod, setVerificationMethod] = useState<VerificationMethod>("evc-aadhaar");
  ...
  const verifyOtpMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      setAcknowledgementNumber(data?.acknowledgementNumber || `ACK${Date.now()}`);
      toast({
    ...
    onError: (error) => {
      ...
      toast({
        ...
        description: "Unable to verify your ITR. Please try again or contact support.",
        variant: "destructive"
      });
    }
  });
  ...
  const dscMutation = useMutation({
    ...
    onError: (error) => {
      ...
      toast({
        ...
        description: "Unable to verify with DSC. Please ensure your token is connected.",
        variant: "destructive"
      });
    }
  });
  ...
  const handleDSCVerify = () => {
    ...
    toast({
      ...
      description: "Please connect your DSC token and select the certificate..."
    });
  ...
  if (verificationComplete) {
    return (
      <div className="container mx-auto p-6 space-y-6" data-testid="page-itr-verify-success">
        <Card className="max-w-2xl mx-auto border-green-500 dark:border-green-400">
          <CardHeader className="text-center">
            <div className="mx-auto w-16 h-16 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mb-4">
              <CheckCircle2 className="w-8 h-8 text-green-600 dark:text-green-400" />
            </div>
            <CardTitle className="text-2xl text-green-600 dark:text-green-400">ITR Filed Successfully!</CardTitle>
          ...
          <CardContent className="space-y-6">
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 text-center space-y-4">
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Acknowledgement Number</p>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="text-gray-500 dark:text-gray-400">Assessment Year</p>
                ...
                <div>
                  <p className="text-gray-500 dark:text-gray-400">ITR Form</p>
                  <p className="font-medium text-gray-900 dark:text-white">{draftData?.itrForm || "ITR-1"}</p>
                </div>
                <div>
                  <p className="text-gray-500 dark:text-gray-400">Verification Method</p>
            ...
            <Alert>
              ...
              <AlertDescription>
                An acknowledgement receipt has been sent to your registered email address.
              </AlertDescription>
            </Alert>
              ...
              <Button 
                ...
                onClick={() => {
                  toast({
                    ...
                    description: "Your ITR-V acknowledgement is being downloaded."
                  });
                }}
  ...
  return (
    <div className="container mx-auto p-6 space-y-6" data-testid="page-itr-verify">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Complete verification to file your return</p>
        </div>
      </div>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500 dark:text-gray-400">Assessment Year</span>
                  <span className="font-medium text-gray-900 dark:text-white">2024-25</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500 dark:text-gray-400">ITR Form</span>
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500 dark:text-gray-400">Draft Status</span>
