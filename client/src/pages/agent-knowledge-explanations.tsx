...
export default function AgentKnowledgeExplanations() {
  ...
  const simplifyMutation = useMutation({
    mutationFn: async (text: string) => {
      const response = await apiRequest("POST", "/api/knowledge-hub/simplify", { text });
      return response.json();
    },
    onSuccess: (data) => {
  ...
  const usageTrackMutation = useMutation({
    mutationFn: async (templateId: string) => {
      await apiRequest("POST", `/api/knowledge-hub/explanations/${templateId}/use`);
    },
  });
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={() => copyToClipboard(template.simplifiedVersion, template.id)}
                    >
                  ...
                  <div>
                    ...
                    <div className="p-4 bg-card rounded-lg relative">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          copyToClipboard(selectedTemplate.simplifiedVersion, selectedTemplate.id)
                        }
                      >
                ...
                <div className="p-4 bg-card rounded-lg relative">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      toast({ title: "Copied!", description: "Simplified text copied" });
                    }}
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
