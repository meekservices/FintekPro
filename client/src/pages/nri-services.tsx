...
const nriServices: NRIService[] = [
	// Banking Services
	{
		...
		description:
			"Fully repatriable account for NRIs with tax-free interest and easy fund transfer",
		category: "Banking",
		features: [
			"Fully Repatriable",
			"Tax-free Interest",
	...
	},
	{
		...
		description:
			"Rupee account for managing income earned in India with partial repatriation",
		category: "Banking",
		features: [
			"Rupee Denominated",
			"Partial Repatriable",
		...
		benefits: [
			"Manage India income",
			"Current/Fixed deposit facility",
			"Repatriate up to USD 1 million per year",
	...
	},
	{
		...
		description:
			"Foreign currency term deposits with exchange rate protection and tax benefits",
		category: "Banking",
		features: [
	...
	// Investment Services
	{
		...
		description:
			"Invest in Indian stocks, mutual funds and securities with full regulatory compliance",
		category: "Investment",
		features: [
			"Stock Trading",
			"Mutual Funds",
		...
		icon: TrendingUp,
		benefits: [
			"Invest up to 5% stake in listed companies",
			"Full repatriation of proceeds",
	...
	},
	{
		...
		description:
			"Curated mutual fund portfolio designed specifically for Non-Resident Indians",
		category: "Investment",
		features: [
	...
	},
	{
		...
		description:
			"Expert guidance for property investment in India with legal and tax compliance",
		category: "Investment",
		features: [
			"Legal Compliance",
			"Market Research",
	...
	// Remittance Services
	{
		...
		description:
			"Send money to India with competitive exchange rates and multiple transfer options",
		category: "Remittance",
		features: [
			"Competitive Rates",
			"Multiple Options",
	...
	},
	{
		...
		description:
			"Specialized remittance services for education expenses with preferential rates",
		category: "Remittance",
		features: [
			"Education Focused",
			"Preferential Rates",
	...
	},
	{
		...
		description:
			"Quick remittance facility for medical emergencies with priority processing",
		category: "Remittance",
		features: [
			"Priority Processing",
			"Emergency Support",
	...
	// Tax & Compliance
	{
		...
		description:
			"Complete tax filing and compliance services for NRIs across multiple jurisdictions",
	...
	},
	{
		...
		description:
			"Expert assistance with Foreign Exchange Management Act compliance and reporting",
		category: "Tax & Compliance",
		features: [
			"FEMA Expertise",
	...
	},
	{
		...
		description:
			"CA-assisted international remittance compliance with DTAA benefits and digital signature",
		category: "Tax & Compliance",
		features: [
			"CA Assisted",
			"DTAA Optimization",
			"Digital Signature",
			"Rule 37BB Compliance",
		],
		processingTime: "2-3 business days",
		currency: "INR",
		rating: 4.9,
	...
	// Advisory Services
	{
		...
		description:
			"Comprehensive financial planning considering global assets and India-specific goals",
		category: "Advisory",
		features: [
			"Holistic Planning",
			"Global Assets",
	...
	},
	{
		...
		description:
			"Expert guidance on visa processes, citizenship matters and immigration compliance",
		category: "Advisory",
		features: [
			"Visa Guidance",
...
export default function NRIServices() {
	...
	const [selectedService, setSelectedService] = useState<NRIService | null>(
		null,
	);
	...
	const selectedCountryData = nriCountries.find(
		...
		<div className="container mx-auto px-4 py-8 space-y-8">
			...
			<div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 text-foreground overflow-hidden">
				...
				<div className="relative z-10">
					...
					<p className="text-xl mb-8 text-blue-100 max-w-3xl leading-relaxed">
						Banking, investments, remittances, and compliance services designed
						specifically for Non-Resident Indians across the globe.
					</p>

					<div className="flex flex-wrap gap-4">
						<Button
							size="lg"
							className="bg-card text-blue-600 hover:bg-blue-50 dark:bg-blue-950/30"
									...
									<div className="space-y-2">
										...
										{service.minimumAmount && (
											<div className="flex items-center gap-2 text-sm">
												...
												<span className="text-muted-foreground">
													Min: {service.currency}{" "}
													{service.minimumAmount.toLocaleString()}
												</span>
											</div>
										)}
									</div>
			...
			<Card>
				<CardHeader>
					...
					<p className="text-muted-foreground">
						Compare rates and fees for sending money to India
					</p>
				</CardHeader>
				<CardContent className="space-y-6">
					<div className="grid md:grid-cols-3 gap-4">
						...
						<div className="flex items-end">
							<Button
								className="w-full"
								data-testid="button-calculate-remittance"
							>
			...
			<div className="grid md:grid-cols-2 gap-6">
				...
				<Card>
					...
					<CardContent className="space-y-4">
						<p className="text-sm text-muted-foreground">
							Get personalized service from a dedicated NRI relationship manager
