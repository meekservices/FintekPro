...
export default function CDSLServices() {
  ...
  const accountSetupMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({ title: 'Error', description: error.error || 'Failed to setup account', variant: 'destructive' });
    }
  });
  ...
  const edisConsentMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({ title: 'Error', description: error.error || 'Failed to provide eDIS consent', variant: 'destructive' });
    }
  });
  ...
  const pledgeCreateMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({ title: 'Error', description: error.error || 'Failed to create pledge', variant: 'destructive' });
    }
  });
  ...
  const elasMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({ title: 'Error', description: error.error || 'Failed to create eLAS pledge', variant: 'destructive' });
    }
  });
  ...
  const tpinGenerateMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({ title: 'Error', description: error.error || 'Failed to generate TPIN', variant: 'destructive' });
    }
  });
  ...
  const handleElasCreate = (values: z.infer<typeof elasSchema>) => {
    const securitiesData = holdingsQuery.data?.data?.holdings?.slice(0, 2) || [];
    elasMutation.mutate({
      ...values,
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex space-x-4 items-end">
            ...
            >
              {tpinGenerateMutation.isPending && <Loader2 className="h-4 w-4 mr-2 animate-spin" />}
              Generate TPIN
            </Button>
          </div>
        </CardContent>
      ...
      <Tabs defaultValue="account" className="w-full">
            ...
            <CardContent>
              <Form {...accountForm}>
                <form onSubmit={accountForm.handleSubmit(handleAccountSetup)} className="space-y-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="email" placeholder="client@example.com" {...field} data-testid="input-email" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Nominee name (optional)" {...field} data-testid="input-nominee-name" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Relationship (optional)" {...field} data-testid="input-nominee-relation" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  >
                    {accountSetupMutation.isPending && <Loader2 className="h-4 w-4 mr-2 animate-spin" />}
                    Setup CDSL Account
                  </Button>
                </form>
              </Form>
              ...
              {holdingsQuery.isLoading ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {holdingsQuery.data.data.holdings.map((holding: any, index: number) => (
                      <Card key={index}>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    No holdings data available. Please check your BO ID or try again later.
                  </AlertDescription>
                </Alert>
              )}
            </CardContent>
        ...
        <TabsContent value="edis" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Provide electronic consent for delivery of shares without physical DIS
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...edisForm}>
                <form onSubmit={edisForm.handleSubmit(handleEdisConsent)} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="INE040A01034" {...field} data-testid="input-isin" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="CLIENT001" {...field} data-testid="input-client-code" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="password" maxLength={6} placeholder="6-digit TPIN" {...field} data-testid="input-tpin" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  >
                    {edisConsentMutation.isPending && <Loader2 className="h-4 w-4 mr-2 animate-spin" />}
        ...
        <TabsContent value="pledge" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <Form {...pledgeForm}>
                <form onSubmit={pledgeForm.handleSubmit(handlePledgeCreate)} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>BO ID *</FormLabel>
                          <FormControl>
                            <Input {...field} data-testid="input-pledge-bo-id" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>ISIN *</FormLabel>
                          <FormControl>
                            <Input placeholder="INE040A01034" {...field} data-testid="input-pledge-isin" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Quantity *</FormLabel>
                          <FormControl>
                            <Input type="number" placeholder="50" {...field} data-testid="input-pledge-quantity" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="BROKER001" {...field} data-testid="input-pledgee-code" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              <SelectItem value="TRADING_MARGIN">Trading Margin</SelectItem>
                              <SelectItem value="LOAN_AGAINST_SECURITIES">Loan Against Securities</SelectItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>TPIN *</FormLabel>
                          <FormControl>
                            <Input type="password" maxLength={6} placeholder="6-digit TPIN" {...field} data-testid="input-pledge-tpin" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  >
                    {pledgeCreateMutation.isPending && <Loader2 className="h-4 w-4 mr-2 animate-spin" />}
                    Create Pledge
                  </Button>
                </form>
              </Form>
        ...
        <TabsContent value="elas" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <Form {...elasForm}>
                <form onSubmit={elasForm.handleSubmit(handleElasCreate)} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="LENDER001" {...field} data-testid="input-lender-code" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="number" placeholder="100000" {...field} data-testid="input-loan-amount" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                        ...
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="TRADING_FINANCE">Trading Finance</SelectItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>TPIN *</FormLabel>
                            <FormControl>
                              <Input type="password" maxLength={6} placeholder="6-digit TPIN" {...field} data-testid="input-elas-tpin" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                  ...
                  <Alert>
                    <AlertTriangle className="h-4 w-4" />
                    <AlertDescription>
                      <strong>Note:</strong> Your securities will be pledged as collateral. 
                      Typical LTV (Loan to Value) ratio is 70-80% based on security type.
                  ...
                  >
                    {elasMutation.isPending && <Loader2 className="h-4 w-4 mr-2 animate-spin" />}
                    Apply for eLAS
                  </Button>
                </form>
              </Form>
        ...
        <TabsContent value="evoting" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Cast your votes on company resolutions through CDSL's e-voting platform
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                ...
                <Button 
                  onClick={() => window.open('https://www.evotingindia.com', '_blank')}
