	...
	return (
		<div className="min-h-screen bg-background p-6">
			<div className="max-w-7xl mx-auto space-y-6">
				<div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
					<div>
						...
						<p className="text-muted-foreground mt-1">
							Compete, achieve, and climb the ranks
						</p>
					</div>
				...
				{currentUserRank && (
					<Card
						className="bg-gradient-to-r from-emerald-900/50 via-emerald-800/30 to-teal-900/50 border-emerald-700/50"
							...
							<div className="flex flex-col md:flex-row items-start md:items-center gap-6">
								<div className="flex items-center gap-4">
									<div className="relative">
										...
										{getRankChange(
											currentUserRank.rank,
											currentUserRank.previousRank,
										)}
									</div>
									<div>
										<p
											className="text-xl font-bold text-foreground"
											data-testid="text-my-name"
										>
											{currentUserRank.name}
										</p>
										<p className="text-muted-foreground text-sm">
											Rank {currentUserRank.rank} of {totalAgents} agents
										</p>
									</div>
								</div>
								...
								<div className="flex-1 grid grid-cols-2 md:grid-cols-5 gap-4">
									<div className="text-center">
										...
										<p
											...
											data-testid="text-my-aum"
										>
											{formatCurrency(currentUserRank.totalAUM)}
										</p>
									</div>
									<div className="text-center">
										...
										<p
											className="text-foreground font-semibold"
											data-testid="text-my-commission-mtd"
										>
											{formatCurrency(currentUserRank.commissionMTD)}
										</p>
									</div>
									<div className="text-center">
										<p className="text-muted-foreground text-xs">
										...
										<p
											className="text-foreground font-semibold"
											data-testid="text-my-clients"
										>
											{currentUserRank.activeClients}
										</p>
									</div>
									<div className="text-center">
										<p className="text-muted-foreground text-xs">
										...
										<p
											className="text-foreground font-semibold"
											data-testid="text-my-deals"
										>
											{currentUserRank.dealsClosedThisMonth}
										</p>
									</div>
									<div className="text-center">
										<p className="text-muted-foreground text-xs">
										...
										<p
											className="text-foreground font-semibold"
											data-testid="text-my-conversion"
										>
											{currentUserRank.leadConversionRate}%
										</p>
									</div>
								</div>
								...
								{currentUserRank.streak > 0 && (
									<div className="flex items-center gap-2 bg-orange-500/20 px-3 py-2 rounded-lg">
										...
										<span className="text-orange-300 font-semibold">
											{currentUserRank.streak} week streak
										</span>
									</div>
								)}
					...
					<Card className="bg-background border-border">
						<CardContent className="py-12 text-center">
							...
							<p className="text-muted-foreground">
								Start closing deals to appear on the leaderboard!
							</p>
						</CardContent>
					</Card>
				)}
							...
							<CardContent className="pt-6">
								<div className="flex flex-col items-center text-center">
									...
									<h3
										...
										data-testid={`text-agent-name-${agent.rank}`}
									>
										{agent.name}
									</h3>
									...
									<div className="w-full mt-4 space-y-2">
										...
										<div className="flex justify-between text-sm">
											...
											<span className="text-emerald-400 font-medium">
												{formatCurrency(agent.commissionYTD)}
											</span>
										</div>
										<div className="flex justify-between text-sm">
											<span className="text-muted-foreground">Conversion</span>
											<span className="text-foreground font-medium">
												{agent.leadConversionRate}%
											</span>
										</div>
									</div>
