        ...
        <div className="bg-card py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Ready to accelerate your wealth journey? Our financial experts are here to help you transform your investment potential into real returns.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <Card>
                <CardHeader>
                  <CardTitle data-testid="contact-methods-title">Get in Touch</CardTitle>
                  <CardDescription>
                ...
                <CardContent className="space-y-6">
                  {contactMethods.map((method, index) => (
                    <div key={index} className="flex items-start gap-4 p-4 border rounded-lg" data-testid={`contact-method-${index}`}>
                      <div className="mt-1">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2" data-testid="business-hours-title">
          ...
          <div className="mt-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Visit us at any of our offices across India for personalized financial consultations.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {officeLocations.map((office, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow" data-testid={`office-${office.city.toLowerCase()}`}>
                  <CardHeader>
          ...
          <div className="mt-16 bg-gradient-to-r from-finance-blue to-blue-600 rounded-2xl text-foreground p-8">
            <div className="text-center">
              ...
              <p className="text-xl mb-8 text-blue-100">
                Our investment experts are ready to help you start building wealth today.
              </p>
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">How do I open an investment account?</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    You can start investing in just 10 minutes with our digital onboarding process. Simply complete your CKYC verification and fund your account.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">What's the minimum investment amount?</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Our minimum investment starts from ₹500 for mutual funds and ₹5,000 for direct equity investments, making wealth building accessible to everyone.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Are my investments safe with FintekPro?</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Yes, we're SEBI registered and use bank-grade security. Your investments are held with custodians and protected by investor insurance.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">How quickly can I access my money?</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Liquid funds and equity withdrawals are processed within T+1 days. Emergency withdrawals are available for certain investment products.
                  </p>
                </CardContent>
              </Card>
            </div>
