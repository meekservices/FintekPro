...
const eligibilityCheckSchema = z.object({
	...
	monthlyIncome: z
		.number()
		.min(15000, "Minimum monthly income should be ₹15,000"),
...
const loanApplicationSchema = z.object({
	...
	employmentDetails: z.object({
		...
		workExperience: z
			.number()
			.min(2, "Minimum 2 years work experience required"),
	}),
	cibilConsent: z
		.boolean()
		.refine((val) => val === true, "CIBIL consent is required"),
	termsAccepted: z
		.boolean()
...
export default function HDFCLoans() {
	...
	const eligibilityCheckMutation = useMutation({
		mutationFn: async (data: EligibilityForm) => {
			...
			const eligible =
				data.monthlyIncome >= 25000 &&
				data.loanAmount <= data.monthlyIncome * 60;
			return {
				success: true,
				data: {
					eligible,
					...
					message: eligible
						? "Congratulations! You are eligible for HDFC Bank loan."
					...
					<div className="flex items-center space-x-3">
						...
						<div>
							...
							<p className="text-muted-foreground">
								Trusted banking partner for all loan needs
							</p>
						</div>
					</div>
				</div>
					...
					<TabsContent value="eligibility" className="space-y-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Get pre-approval with HDFC Bank's advanced eligibility
									assessment
								</CardDescription>
							</CardHeader>
							<CardContent>
								<Form {...eligibilityForm}>
									<form
										onSubmit={eligibilityForm.handleSubmit(
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
							...
							<Card className="hover:shadow-lg transition-shadow border-t-4 border-t-red-600">
								<CardHeader>
									...
									<CardDescription>
										India's most trusted home loan
									</CardDescription>
								</CardHeader>
								<CardContent>
									<ul className="space-y-2 text-sm">
						...
						<Card>
							...
							<CardContent>
								<div className="text-center py-8">
									...
									<p className="text-muted-foreground">
										No HDFC loan applications found
									</p>
									<Button
