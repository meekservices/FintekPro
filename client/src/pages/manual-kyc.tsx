...
const ENTITY_DOCUMENT_REQUIREMENTS: Record<
	CorporateEntityType,
	DocumentRequirement[]
> = {
	private_limited: [
...
export default function ManualKYCPage() {
	...
	const [entityType, setEntityType] =
		useState<CorporateEntityType>("private_limited");
	...
	const submitKYCMutation = useMutation({
		...
		onSuccess: (data) => {
			toast({
				...
				description:
					"Your KYC application has been submitted for verification. You'll receive an update within 2-3 business days.",
			});
	...
	const handleSubmit = () => {
		...
		const missingFields = requiredFields.filter(
			(field) => !formData[field as keyof KYCFormData],
		);
			...
			<div className="mb-8">
				<div className="flex items-center gap-3 mb-4">
					...
					<div>
						...
						<p className="text-muted-foreground">{getKYCTypeDescription()}</p>
					</div>
				</div>
				...
				<Alert className="mb-6">
					...
					<AlertDescription>
						{kycType === "individual" ? (
							<>
								This path uses direct document upload with BSE Star MFD API
								verification.
								<strong className="block mt-1">
									...
									for a faster, AI-assisted experience with auto-fill.
								</strong>
							</>
						) : kycType === "corporate" ? (
							<>
								This path is designed for companies, trusts, and non-individual
								entities. Document verification through BSE Star API with
								Corporate PAN validation.
							</>
						) : (
							<>
								Specialized path for Non-Resident Indians requiring passport,
								visa, and overseas address verification through BSE Star API.
							</>
						)}
					</AlertDescription>
				</Alert>
				...
				<Card>
					...
					<CardContent className="space-y-6">
						<Alert>
							<Info className="h-4 w-4" />
							<AlertDescription>
								All information must match your identity documents exactly. Any
								mismatch may lead to rejection.
							</AlertDescription>
						</Alert>
									...
									<>
											...
											<Input
												...
												placeholder={
													entityType === "llp"
														...
														: "As per Certificate of Incorporation"
												}
										...
										<div>
											...
											<Input
												...
												placeholder={
													entityType === "llp" ? "LLPIN Number" : "CIN Number"
												}
									...
									<>
										<div className="md:col-span-2">
											...
											<Input
												...
												placeholder={
													entityType === "aop"
														? "Association of Persons name"
														: "Body of Individuals name"
												}
			...
			{currentStep === "documents" && (
				<div className="space-y-6">
					<Alert>
						...
						<AlertDescription>
							<strong>Document Guidelines:</strong> Upload clear, legible scans
							or photos. Ensure all text is readable and there's no glare or
							shadow on documents.
						</AlertDescription>
					</Alert>
								...
								<div className="space-y-3">
									<div className="text-sm text-muted-foreground">
										...
										<p>
											...
											{Math.round(doc.maxSize / 1024 / 1024)}MB
										</p>
									</div>
										...
										<div className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
											...
											<div className="flex-1">
												...
												<p className="text-xs text-muted-foreground">
													Uploaded on{" "}
													{new Date(
														uploadedDocs[doc.id].uploadedAt,
													).toLocaleString()}
												</p>
											</div>
											<Button
			...
			{currentStep === "review" && (
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Please review all information before submitting your KYC
							application
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-6">
						<Alert>
							<Info className="h-4 w-4" />
							<AlertDescription>
								Once submitted, your application will be processed through BSE
								Star MFD API. You'll receive verification updates via email and
								SMS.
							</AlertDescription>
						</Alert>
									...
									{kycType === "corporate" && (
										<>
											...
											<div>
												...
												<p className="font-medium">
													{formData.authorizedSignatoryName || "N/A"}
												</p>
											</div>
										</>
									)}
									{kycType === "nri" && (
										<>
											...
											<div>
												...
												<p className="font-medium">
													{formData.countryOfResidence || "N/A"}
												</p>
											</div>
										</>
									)}
								...
								<div className="space-y-2">
									{Object.values(uploadedDocs).map((doc) => (
										...
										>
											...
											<span>
												{requirements.find((r) => r.id === doc.id)?.name}
											</span>
										</div>
									))}
								</div>
