		...
		<div className="p-6 space-y-6">
			<div className="flex items-center gap-4">
				...
				<div>
					...
					<p className="text-muted-foreground mt-1">
						Track your knowledge certifications (optional)
					</p>
				</div>
			</div>
			...
			<Alert className="bg-blue-500/10 border-blue-500/30">
				...
				<AlertDescription className="text-blue-200/80 text-sm">
					Certifications are optional and for self-improvement. They do not
					restrict your access to any platform features. Complete them at your
					own pace to enhance your knowledge.
				</AlertDescription>
			</Alert>
						...
						<>
							<DialogHeader>
								...
								<DialogDescription className="text-muted-foreground">
									Answer all questions. You need {selectedQuiz.passingScore}% to
									pass.
								</DialogDescription>
							</DialogHeader>
