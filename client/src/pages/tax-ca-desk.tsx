...
const EXPERT_CAS = [
	{
		...
		specialization: "Individual Taxation",
		rating: 4.9,
		reviews: 234,
		experience: "12 years",
	},
		...
		<div className="container mx-auto p-6 space-y-6">
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">
						Get expert assistance from qualified Chartered Accountants
					</p>
				</div>
				<Button
					variant="outline"
					...
					<div className="flex items-center justify-between">
						<div className="space-y-4">
							...
							<p className="text-purple-100 max-w-lg">
								Our team of qualified CAs is here to help you with all your tax
								needs. From simple ITR filing to complex tax notices.
							</p>
			...
			<Card data-testid="card-how-it-works">
				<CardHeader>
					...
					<CardDescription>
						Simple 4-step process to get expert tax help
					</CardDescription>
				</CardHeader>
				<CardContent>
						...
						{[
							{
								...
								description: "Choose the tax service you need",
								icon: FileText,
							},
							{
								step: 2,
								title: "Upload Documents",
								description: "Share required documents securely",
								icon: LucideShield,
							},
							{
								step: 3,
								title: "CA Review",
								description: "Expert CA reviews and prepares filing",
								icon: Users,
							},
							{
								step: 4,
								title: "Submit & Pay",
								description: "Review, approve and complete payment",
								icon: CheckCircle,
							},
						].map((item) => {
					...
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-4">
							...
							<div>
								...
								<p className="text-muted-foreground">
									Speak to our tax experts for personalized guidance
								</p>
							</div>
						</div>
