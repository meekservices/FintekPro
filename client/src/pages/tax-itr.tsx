...
export default function TaxITRPage(): React.ReactElement {
	...
	const { data: eligibleFormsData, isLoading: formsLoading } =
		useQuery<EligibleFormsResponse>({
		...
		<div className="container mx-auto p-6 space-y-6">
							...
							<div>
								...
								<div className="flex items-center gap-2 text-sm text-muted-foreground">
									...
									<span className="capitalize">
										{panContext?.panType?.replace("_", " ") || "Individual"}
									</span>
								</div>
							</div>
						</div>
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">
						AY 2025-26 (FY 2024-25) | Due Date: July 31, 2025 &nbsp;·&nbsp; AY
						2026-27 (FY 2025-26) opens April 1, 2026
					</p>
				</div>
				<div className="flex items-center gap-2">
					<Badge
			...
			>
				...
				<TabsContent
					value="landing"
					className="space-y-6"
					data-testid="content-itr-landing"
				>
					{/* Filing Options */}
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						{/* Self File Option */}
						<Card
							className="relative overflow-hidden hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-blue-500"
						...
						>
							...
							<CardHeader>
								<div className="flex items-center gap-3">
									...
									<div>
										...
										<CardDescription>
											File your return yourself with guidance
										</CardDescription>
									</div>
								</div>
							</CardHeader>
							<CardContent className="space-y-4">
								...
								<div className="flex items-center justify-between pt-4 border-t">
									...
									<Button
										className="gap-2"
										data-testid="button-start-self-file"
									>
						...
						{/* Hire Expert Option */}
						<Card
							className="relative overflow-hidden hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-purple-500"
							...
							<CardContent className="space-y-4">
								...
								<div className="flex items-center justify-between pt-4 border-t">
									...
									<Button
										...
										data-testid="button-hire-expert"
									>
					...
					<Card data-testid="card-eligible-forms">
						<CardHeader>
							...
							<CardDescription>
								Based on your PAN type:{" "}
								{panContext?.panType?.toUpperCase() || "Individual"}
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
								{eligibleForms.map((form) => {
									const formPricing = pricing?.[form.form] || {
										selfFile: 0,
										expert: 0,
									};
									...
									return (
										<Card
											...
											data-testid={`form-${form.form.toLowerCase()}`}
										>
				...
				>
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Answer simple questions and we'll prepare your return
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							...
							<div className="grid grid-cols-6 gap-2 text-xs text-center">
								{[
									...
									<div
										key={step}
										className={`p-2 rounded ${idx === 0 ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 font-medium" : "bg-muted text-muted-foreground"}`}
									>
										{step}
									</div>
								))}
							...
							<Card className="border-2 border-dashed">
								<CardHeader>
									...
									<CardDescription>
										Select all that apply - we'll auto-select the right ITR form
									</CardDescription>
								</CardHeader>
								<CardContent>
							...
							<div className="flex justify-between">
								...
								<Button
									...
									data-testid="button-continue-self-file"
								>
				...
				<TabsContent
					value="expert"
					className="space-y-6"
					data-testid="content-hire-expert"
				>
					<Card>
						<CardHeader>
							<CardTitle className="flex items-center gap-2">
							...
							<CardDescription>
								Get your ITR filed by a qualified Chartered Accountant
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							{/* Expert Benefits */}
							<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
								<div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
									...
									<p className="text-sm text-muted-foreground">
										Personal tax expert assigned to your case
									</p>
								</div>
								...
								<div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
									...
									<p className="text-sm text-muted-foreground">
										Optimize deductions for maximum refund
									</p>
								</div>
							</div>
							...
							<Card className="border-2 border-dashed">
								<CardHeader>
									...
									<CardDescription>
										Our CA will review and prepare your ITR
									</CardDescription>
								</CardHeader>
								<CardContent>
							...
							<div className="flex justify-between">
								...
								<Button
									onClick={() => navigate("/tax/itr/expert")}
				...
				<TabsContent
					value="status"
					className="space-y-6"
					data-testid="content-filing-status"
				>
					<Card>
						<CardHeader>
							<CardTitle className="flex items-center gap-2">
							...
							<CardDescription>
								Track your current and past filings
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="space-y-4">
								{/* Current Filing */}
								<div
									className="p-4 border rounded-lg bg-yellow-50 dark:bg-yellow-950"
									data-testid="current-filing"
								>
					...
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<p className="text-sm text-muted-foreground">
									Our tax experts are available 24/7
								</p>
							</div>
						</div>
