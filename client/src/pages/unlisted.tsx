	...
	const unlistedCategories = [
		{
			id: "pre-ipo",
			name: "Pre-IPO Shares",
			description: "Exclusive access to companies with DRHP filed or in late-stage Pre-IPO funding",
			icon: "TrendingUp",
			color: "blue",
			...
			count: 45,
			riskLevel: "High",
			companies: ["NSE India", "Tata Play", "Hero FinCorp", "Boat"],
		},
		{
			id: "startup-equity",
			name: "Startup Equity",
		...
		},
		{
			id: "unicorn-stakes",
			name: "Unicorn Stakes",
			description: "Secondary market trading in private unicorn company shares",
			icon: "Star",
			color: "purple",
			...
			count: 18,
			riskLevel: "High",
			companies: ["Dream11", "Zepto", "Pine Labs", "OfBusiness"],
		},
		{
			id: "esop-buybacks",
			name: "ESOP Buybacks",
			description: "Employee stock option buyback and liquidity opportunities",
			icon: "Gem",
			color: "yellow",
			yieldRange: "5-25% p.a.",
			...
			count: 67,
			riskLevel: "Medium",
			companies: ["Flipkart", "Razorpay", "PolicyBazaar", "Urban Company"],
		},
	];
