...
export default function AIPortfolioReport() {
				...
				<Card className="text-center">
					<CardContent className="pt-6">
						...
						<p className="text-muted-foreground mb-4">
							Please log in to generate AI portfolio reports.
						</p>
						<Link href="/auth">
	...
	return (
		<div
			...
			data-testid="ai-portfolio-report-page"
		>
					...
					<Card className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-950 dark:to-indigo-950">
						<CardContent className="pt-6">
							...
							<div className="prose prose-sm dark:prose-invert max-w-none">
								<p className="text-lg">
									Based on my analysis of your portfolio, you have a{" "}
									<span className="font-semibold text-green-600">
										well-balanced
									</span>{" "}
									investment strategy with a few areas for optimization. Your
									portfolio has grown{" "}
									<span className="font-semibold text-green-600">+18.5%</span>{" "}
									this year, outperforming the NIFTY 50 by 3.2%. Here are my key
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-4">
						...
						<Card>
							<CardContent className="pt-6 text-center">
								...
								<Badge className="mt-2 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-200">
									Moderate
								</Badge>
							</CardContent>
						</Card>
						...
						<TabsContent value="recommendations" className="space-y-4">
							<Card>
								<CardHeader>
									...
									<CardDescription>
										AI-generated action items for your portfolio
									</CardDescription>
								</CardHeader>
								<CardContent>
									<div className="space-y-4">
