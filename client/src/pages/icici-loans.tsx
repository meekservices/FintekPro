...
export default function ICICILoans() {
	...
	return (
		<div
			className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 dark:from-background dark:to-card p-4"
			data-testid="icici-loans-page"
		>
					...
					<div className="flex items-center space-x-3">
						...
						<div>
							...
							<p className="text-muted-foreground">
								Personal, Home & Business Loan Solutions
							</p>
						</div>
					</div>
				</div>
					...
					<TabsContent value="eligibility" className="space-y-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Get instant pre-qualification based on your income and
									requirements
								</CardDescription>
							</CardHeader>
							<CardContent>
												...
												render={({ field }) => (
													<FormItem className="flex flex-row items-start space-x-3 space-y-0">
														...
														<div className="space-y-1 leading-none">
															<FormLabel>
																I authorize ICICI Bank to access my CIBIL credit
																report for loan processing
															</FormLabel>
														</div>
														<FormMessage />
													</FormItem>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
							...
							<Card className="hover:shadow-lg transition-shadow">
								<CardHeader>
									...
									<CardDescription>
										Best rates for your dream home
									</CardDescription>
								</CardHeader>
								<CardContent>
									<ul className="space-y-2 text-sm">
