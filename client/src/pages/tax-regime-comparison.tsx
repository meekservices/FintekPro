...
export default function TaxRegimeComparison() {
  ...
  const calculateTax = (income: number, slabs: typeof OLD_REGIME_SLABS): number => {
    let tax = 0;
  ...
  const oldRegimeCalc = useMemo((): TaxCalculation => {
    ...
    const deductions = (parseFloat(section80C) || 0) + 
    ...
    return { grossIncome: gross, deductions: deductions + standardDeduction, taxableIncome, tax: taxAfterRebate, cess, totalTax, effectiveRate };
  }, [grossIncome, section80C, section80D, hra, homeLoan, nps, otherDeductions]);
  ...
  const newRegimeCalc = useMemo((): TaxCalculation => {
    ...
    return { grossIncome: gross, deductions: standardDeduction, taxableIncome, tax: taxAfterRebate, cess, totalTax, effectiveRate };
  }, [grossIncome]);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter your income and eligible deductions</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="pt-2 border-t">
              <p className="text-sm font-medium mb-3 text-muted-foreground">Old Regime Deductions</p>
              
              <div className="space-y-3">
                <div className="space-y-1">
                  <Label htmlFor="section80C" className="text-sm">Section 80C (max 1.5L)</Label>
                  <Input
                    id="section80C"
                    type="number"
                    value={section80C}
                ...
                <div className="space-y-1">
                  <Label htmlFor="section80D" className="text-sm">Section 80D (Health Insurance)</Label>
                  <Input
                    id="section80D"
                    type="number"
                    value={section80D}
                ...
                <div className="space-y-1">
                  <Label htmlFor="hra" className="text-sm">HRA Exemption</Label>
                  <Input
                    id="hra"
                    type="number"
                    value={hra}
                ...
                <div className="space-y-1">
                  <Label htmlFor="homeLoan" className="text-sm">Home Loan Interest (80EEA)</Label>
                  <Input
                    id="homeLoan"
                    type="number"
                    value={homeLoan}
                ...
                <div className="space-y-1">
                  <Label htmlFor="nps" className="text-sm">NPS (80CCD(1B))</Label>
                  <Input
                    id="nps"
                    type="number"
                    value={nps}
                ...
                <div className="space-y-1">
                  <Label htmlFor="otherDeductions" className="text-sm">Other Deductions</Label>
                  <Input
                    id="otherDeductions"
                    type="number"
        ...
        <Card className={`border-2 ${displayRecommendation === 'old' ? 'border-green-500 bg-green-50/50 dark:bg-green-950/50' : ''}`}>
          <CardHeader>
            ...
            <CardDescription>With deductions under various sections</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-green-600">- {formatCurrency(oldRegimeCalc.deductions)}</span>
              </div>
            ...
            <div className="p-4 bg-muted rounded-lg space-y-2">
              ...
              <div className="flex justify-between font-bold text-lg border-t pt-2">
                <span>Total Tax</span>
                <span className="text-red-600">{formatCurrency(oldRegimeCalc.totalTax)}</span>
              </div>
              <div className="flex justify-between text-sm">
        ...
        <Card className={`border-2 ${displayRecommendation === 'new' ? 'border-green-500 bg-green-50/50 dark:bg-green-950/50' : ''}`}>
          <CardHeader>
            ...
            <CardDescription>Simplified slabs, limited deductions</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-green-600">- {formatCurrency(newRegimeCalc.deductions)}</span>
              </div>
              <div className="flex justify-between font-medium border-t pt-2">
                <span>Taxable Income</span>
            ...
            <div className="p-4 bg-muted rounded-lg space-y-2">
              ...
              <div className="flex justify-between font-bold text-lg border-t pt-2">
                <span>Total Tax</span>
                <span className="text-red-600">{formatCurrency(newRegimeCalc.totalTax)}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Effective Rate</span>
            ...
            <div className="text-xs text-muted-foreground">
              <p className="font-medium mb-1">Tax Slabs:</p>
              <p>0-3L: 0% | 3-7L: 5% | 7-10L: 10% | 10-12L: 15% | 12-15L: 20% | 15L+: 30%</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
            <li>This is a simplified calculator for illustrative purposes only</li>
            <li>Actual tax liability may vary based on surcharge, specific exemptions, and other factors</li>
            <li>Consult a tax professional before making any decisions</li>
            <li>The new regime is the default option from FY 2023-24 onwards</li>
          </ul>
        </AlertDescription>
      </Alert>
    </div>
