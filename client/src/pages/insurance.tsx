              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {insuranceProducts && insuranceProducts.length > 0 ? (
                  insuranceProducts.map((product: any) => (
                    <Card key={product.id} className="hover:shadow-lg transition-shadow" data-testid={`insurance-${product.id}`}>
                      <CardHeader>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        <div className="flex gap-2">
                          <Button className="flex-1" size="sm" data-testid={`button-buy-${product.id}`}>
                            Buy Now
                          </Button>
                          <Button variant="outline" size="sm" data-testid={`button-compare-${product.id}`}>
                            Compare
                          </Button>
                        </div>
                      </CardContent>
