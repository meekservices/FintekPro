				...
				<div className="max-w-4xl mx-auto">
					...
					<div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800 mb-8">
						...
						<p className="text-blue-700 dark:text-blue-300 text-sm">
							...
							2000, IT (Reasonable Security Practices) Rules, 2011, SEBI data
							protection requirements, RBI guidelines on customer data, and
							applicable provisions of the Digital Personal Data Protection Act.
						</p>
					</div>
					...
					<div className="space-y-8">
							...
							<CardContent className="space-y-4">
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										...
										<li>
											PAN (mandatory), Aadhaar (for eKYC), passport/voter ID
										</li>
										<li>
											Address, date of birth, nationality, and residency status
										</li>
								...
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Bank account details (account number, IFSC, account type)
										</li>
										<li>Demat account details (DP ID, Client ID)</li>
										<li>Investment portfolio data and transaction history</li>
										<li>
											Income details, occupation, and source of wealth/funds
										</li>
								...
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										...
										<li>
											Ultimate Beneficial Ownership (UBO) information for
											entities
										</li>
									</ul>
								</div>
								<div>
									<h4 className="font-semibold mb-2">
										Auto-Populated Data (With Consent)
									</h4>
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
						...
						<Card>
							...
							<CardContent className="space-y-4">
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Process investment transactions and maintain portfolio
											records
										</li>
										<li>
											Provide personalized investment recommendations and
											advisory
										</li>
								...
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										...
										<li>
											Market updates and investment opportunities (with consent)
										</li>
							...
							<CardContent className="space-y-4">
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										...
										<li>
											Tokenization of payment card and bank account details
										</li>
									</ul>
								</div>
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Mandatory two-factor authentication (OTP via email/SMS)
										</li>
										<li>
							...
							<CardContent className="space-y-4">
								<div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
									...
									<p className="text-amber-700 dark:text-amber-300 text-sm">
										As per SEBI (Intermediaries) Regulations and RBI Master
										Directions, we are required to retain client records,
										transaction data, and KYC documents for a minimum of 7 years
										from account closure or last transaction date.
									</p>
								</div>
								<div>
									<h4 className="font-semibold mb-2">
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											<strong>KYC Documents:</strong> 7 years from account
											closure
										</li>
										<li>
											<strong>Transaction Records:</strong> 7 years from
											transaction date
										</li>
										<li>
											<strong>Tax Documents:</strong> 7 years from relevant
											assessment year
										</li>
										<li>
											<strong>Communication Logs:</strong> 5 years
										</li>
										<li>
											<strong>Session/Login Data:</strong> 1 year
										</li>
										<li>
											<strong>Marketing Preferences:</strong> Until consent
											withdrawal
										</li>
									</ul>
								</div>
						...
						<Card>
							...
							<CardContent className="space-y-4">
								<div>
									<h4 className="font-semibold mb-2">
										Regulatory Authorities (Mandatory)
									</h4>
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
								...
								<div>
									<h4 className="font-semibold mb-2">
										Service Partners (Under Contract)
									</h4>
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										...
										<li>
											Cloud infrastructure providers with data processing
											agreements
										</li>
									</ul>
								</div>
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										...
										<li>
											Transfer data to jurisdictions without adequate protection
										</li>
									</ul>
								</div>
							</CardContent>
							...
							<CardContent className="space-y-4">
								<div>
									...
									<p className="text-muted-foreground mb-2">
										For NRI clients and Global Advisory users, certain data may
										be processed in jurisdictions outside India:
									</p>
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Cloud infrastructure in US/EU regions with SOC 2
											certification
										</li>
										<li>
											FATCA reporting to US IRS via Indian regulatory channels
										</li>
								...
								<div>
									...
									<ul className="list-disc list-inside text-muted-foreground space-y-1">
										<li>
											Standard Contractual Clauses with all international
											processors
										</li>
										<li>
											Data localization for sensitive Indian resident data per
											RBI guidelines
										</li>
										<li>
											Encryption in transit for all cross-border transfers
										</li>
									</ul>
								</div>
							</CardContent>
						...
						<Card>
							...
							<CardContent className="space-y-4">
								<ul className="list-disc list-inside text-muted-foreground space-y-2">
									...
									<li>
										<strong>Right to Erasure:</strong> Request deletion (subject
										to regulatory retention requirements)
									</li>
									<li>
									...
									<li>
										...
										optional data processing and marketing
									</li>
									<li>
										<strong>Right to Grievance:</strong> Lodge complaints with
										our Grievance Officer
									</li>
								</ul>
								<div className="bg-muted p-4 rounded-lg mt-4">
									<p className="text-sm text-muted-foreground">
										<strong>Note:</strong> Certain rights may be limited where
										data is required for regulatory compliance, legal
										proceedings, or legitimate business interests. We will
										explain any limitations when you make a request.
									</p>
								</div>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent className="space-y-4">
								<div>
									<h4 className="font-semibold mb-2">
										Auto-Population Consent
									</h4>
									<p className="text-muted-foreground">
										Our PAN-level portfolio auto-population feature requires
										explicit consent before fetching data from external sources
										(CAMS, KFintech, depositories). You can manage these
										consents in your account settings.
									</p>
								</div>
								<div>
									<h4 className="font-semibold mb-2">
									...
									<p className="text-muted-foreground">
										...
										email preferences or by contacting support. Transactional
										and regulatory communications cannot be opted out.
									</p>
								</div>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								<ul className="list-disc list-inside text-muted-foreground space-y-2">
									...
									<li>
										<strong>Analytics Cookies:</strong> Help us improve platform
							...
							<CardContent>
								<div className="space-y-4">
									<div>
										...
										<p className="text-muted-foreground">
											<strong>Email:</strong> support@fintekpro.com
											<br />
									...
									<div>
										...
										<p className="text-muted-foreground">
											<strong>Name:</strong> Grievance Officer, FintekPro
											<br />
											<strong>Email:</strong> support@fintekpro.com
											<br />
											<strong>Address:</strong> FintekPro Financial Services
											LLP, Mumbai, Maharashtra, India
											<br />
					...
					<div className="mt-12 text-center space-y-4">
						<p className="text-sm text-muted-foreground">
							This privacy policy is effective as of January 3, 2026. We may
							update this policy with 30 days notice to registered users.
