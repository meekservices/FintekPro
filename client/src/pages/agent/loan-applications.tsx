...
> = {
	...
	routed: {
		label: "Routed to Banks",
		color:
			"bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-200",
		icon: Building2,
	},
	pending_with_banks: {
		label: "Pending with Banks",
		color:
...
export default function AgentLoanApplications() {
	...
	const [applicationToRoute, setApplicationToRoute] =
		useState<LoanApplication | null>(null);
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">
						Track all loan leads you've submitted
					</p>
				</div>
			...
			<div className="flex items-center gap-4">
				...
				<Select value={statusFilter} onValueChange={setStatusFilter}>
					...
					<SelectContent>
						...
						<SelectItem value="pending_with_banks">
							Pending with Banks
						</SelectItem>
									...
									<TableRow key={app.id}>
										...
										<TableCell>
											<div className="flex items-center gap-1">
												...
												{(
													Number.parseFloat(app.requestedAmount) / 100000
												).toFixed(2)}
												L
											</div>
										</TableCell>
										<TableCell>
											<Badge
												variant={routedCount > 0 ? "default" : "secondary"}
											>
															...
															<div className="space-y-4">
																<div className="grid grid-cols-2 gap-4">
																	...
																	<div>
																		...
																		<p className="font-medium">
																			{selectedApplication.requestedTenure}{" "}
																			months
																		</p>
																	</div>
																	<div>
																...
																{(selectedApplication.routedBanks || [])
																	.length > 0 && (
																	<div>
																		...
																		<div className="flex flex-wrap gap-2">
																			{selectedApplication.routedBanks.map(
																				(bank) => (
						...
						<div className="py-12 text-center">
							...
							<p className="text-muted-foreground">
								{searchQuery
									...
									: "Submit your first loan lead to get started"}
							</p>
							<Link href="/agent/loan-apply">
					...
					{applicationToRoute && (
						<div className="space-y-4">
							<div className="p-3 bg-muted rounded-lg">
								<p className="font-medium">
									{applicationToRoute.applicantName}
								</p>
								<p className="text-sm text-muted-foreground">
									{loanTypeLabels[applicationToRoute.loanType]} - ₹
									{(
										Number.parseFloat(applicationToRoute.requestedAmount) /
										100000
									).toFixed(2)}
									L
								</p>
							...
							<div className="space-y-2">
								...
								<div className="max-h-64 overflow-y-auto space-y-2 border rounded-lg p-2">
									...
									{getEligibleBanks(applicationToRoute.loanType).length ===
										0 && (
				...
				<DialogContent>
					...
					{applicationToDelete && (
						<div className="p-3 bg-muted rounded-lg">
							...
							<p className="text-sm text-muted-foreground">
								{applicationToDelete.applicationNumber} -{" "}
								{loanTypeLabels[applicationToDelete.loanType]}
							</p>
						</div>
					)}
					<DialogFooter>
