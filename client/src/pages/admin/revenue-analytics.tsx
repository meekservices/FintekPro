				...
				<Card>
					...
					<CardContent>
						<p
							...
							data-testid="text-weekly-revenue"
						>
				...
				<Card>
					...
					<CardContent>
						<p
							...
							data-testid="text-daily-revenue"
						>
							{formatCurrency(metrics.dailyRevenue)}
						</p>
						<p className="text-xs text-muted-foreground mt-1">
							{formatNumber(
								data?.productRevenue?.reduce((a, b) => a + b.transactions, 0) ||
									0,
							)}{" "}
							transactions
						</p>
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
				<Card className="lg:col-span-2">
					<CardHeader>
						...
						<CardDescription>
							Monthly revenue with commissions and net earnings
						</CardDescription>
					</CardHeader>
					<CardContent>
				...
				<TabsContent value="products" className="mt-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Detailed breakdown of revenue across product categories
							</CardDescription>
						</CardHeader>
						<CardContent>
				...
				<TabsContent value="performers" className="mt-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Agents and partners driving the most revenue
							</CardDescription>
						</CardHeader>
						<CardContent>
