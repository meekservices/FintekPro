        ...
        {isLoading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-3xl">{overviewData?.totalAgents || 0}</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <Activity className="h-4 w-4" />
                    <span>{overviewData?.activeAgents || 0} active this period</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-3xl">{overviewData?.growthModeUsage?.total || 0}</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-3xl">{overviewData?.overrideStats?.complianceRate || 0}%</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-2 text-sm text-green-600">
                    <CheckCircle2 className="h-4 w-4" />
                    <span>{overviewData?.overrideStats?.total || 0} total overrides</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className={`text-3xl ${getScoreColor(overviewData?.performanceScores?.average || 0)}`}>
            ...
            <Tabs defaultValue="growth-usage">
              <TabsList>
                <TabsTrigger value="growth-usage">Growth-Optimized Usage</TabsTrigger>
                ...
                <Card>
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <CardDescription>Agents using advanced recommendation mode</CardDescription>
                      </div>
                  ...
                  <CardContent>
                    <Table>
                      ...
                      <TableBody>
                        {overviewData?.growthModeUsage?.byAgent?.map((agent) => (
                          <TableRow key={agent.agentId} data-testid={`agent-row-${agent.agentId}`}>
                            <TableCell className="font-medium">{agent.agentName}</TableCell>
                            <TableCell className="text-center">{agent.count}</TableCell>
                            <TableCell className="text-center">
                              <Badge variant={agent.complianceRate >= 95 ? "default" : "destructive"}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="p-4 border rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm text-muted-foreground">Mode Downgrades</span>
                          <Badge variant="outline">{overviewData?.overrideStats?.byType?.mode_downgrade || 0}</Badge>
                        </div>
                        <Progress value={((overviewData?.overrideStats?.byType?.mode_downgrade || 0) / (overviewData?.overrideStats?.total || 1)) * 100} />
                      </div>
                      <div className="p-4 border rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm text-muted-foreground">Asset Class Locks</span>
                          <Badge variant="outline">{overviewData?.overrideStats?.byType?.asset_class_lock || 0}</Badge>
                        </div>
                        <Progress value={((overviewData?.overrideStats?.byType?.asset_class_lock || 0) / (overviewData?.overrideStats?.total || 1)) * 100} />
                      </div>
                      <div className="p-4 border rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm text-muted-foreground">Allocation Caps</span>
                          <Badge variant="outline">{overviewData?.overrideStats?.byType?.allocation_cap || 0}</Badge>
                        </div>
                        <Progress value={((overviewData?.overrideStats?.byType?.allocation_cap || 0) / (overviewData?.overrideStats?.total || 1)) * 100} />
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <TabsContent value="performance" className="mt-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Agent performance categorization</CardDescription>
                  </CardHeader>
                  <CardContent>
