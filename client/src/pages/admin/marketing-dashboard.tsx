    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card data-testid="card-total-campaigns">
          ...
          <CardContent>
            <div className="text-2xl font-bold" data-testid="text-campaigns-total">
              {stats?.campaigns.total || 0}
            </div>
            <p className="text-xs text-muted-foreground">
              <span className="text-green-600 font-medium">{stats?.campaigns.active || 0} active</span>
              {' • '}
        ...
        <Card data-testid="card-total-leads">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              <span className="text-orange-600 font-medium">{stats?.leads.hot || 0} hot leads</span>
              {' • '}
        ...
        <Card data-testid="card-open-rate">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {stats?.performance.opened || 0} of {stats?.performance.sent || 0} sent
            </p>
          </CardContent>
        </Card>
      ...
      <Tabs defaultValue="campaigns" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="leads" data-testid="tab-leads">Recent Leads</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="campaigns" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Latest email and WhatsApp campaigns</CardDescription>
            </CardHeader>
            <CardContent>
              {!activity?.recentCampaigns || activity.recentCampaigns.length === 0 ? (
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {campaign.campaignType.toUpperCase()} • {campaign.status}
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {lead.annualRevenue && (
                            <p className="text-sm font-medium">
                              ₹{(parseFloat(lead.annualRevenue) / 10000000).toFixed(2)}Cr
                            </p>
                          )}
                        </div>
                      </div>
