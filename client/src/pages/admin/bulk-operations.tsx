	...
	const startOperationMutation = useMutation({
		...
		onSuccess: () => {
			toast({
				...
				description: "Bulk operation has been queued",
			});
				...
				<TabsContent value="new" className="mt-4">
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
						<Card
							...
							onClick={() => startOperationMutation.mutate("user_export")}
						>
							<CardHeader>
						...
						<Card
							...
							onClick={() => startOperationMutation.mutate("kyc_verification")}
						>
							<CardHeader>
								<CardTitle className="flex items-center gap-2">
						...
						<Card
							...
							onClick={() => startOperationMutation.mutate("notification_send")}
						>
							<CardHeader>
								<CardTitle className="flex items-center gap-2">
						...
						<Card
							...
							onClick={() =>
								startOperationMutation.mutate("user_status_update")
							}
						>
							<CardHeader>
								<CardTitle className="flex items-center gap-2">
							...
							<CardContent>
								<Button
									className="w-full"
									variant="outline"
									data-testid="button-user-status"
								>
									<RefreshCw className="w-4 h-4 mr-2" />
									Update Status
								</Button>
						...
						<Card
							...
							onClick={() => startOperationMutation.mutate("product_update")}
						>
							<CardHeader>
								<CardTitle className="flex items-center gap-2">
								...
								<CardDescription>
									Bulk update product pricing/status
								</CardDescription>
							</CardHeader>
							<CardContent>
								<Button
									className="w-full"
									variant="outline"
									data-testid="button-product-update"
								>
						...
						<Card
							...
							onClick={() => startOperationMutation.mutate("data_cleanup")}
						>
							<CardHeader>
								<CardTitle className="flex items-center gap-2">
				...
				<TabsContent value="history" className="mt-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								History of bulk operations with progress tracking
							</CardDescription>
						</CardHeader>
						<CardContent>
