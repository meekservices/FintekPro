...
const TEMPLATE_TYPES = [
	{
		...
		description: "Greet new users joining the platform",
		category: "business",
	},
	{
		id: "ipo_alert",
		name: "IPO Alert",
		description: "Notify users about upcoming IPO opportunities",
		category: "business",
	},
	{
		id: "portfolio_update",
		name: "Portfolio Update",
		description: "Send portfolio performance updates",
		category: "business",
	},
	{
		id: "kyc_reminder",
	...
	{
		id: "mutual_fund",
		name: "Mutual Fund Update",
		description: "Send mutual fund performance alerts",
		category: "business",
	},
	{
		id: "dividend_alert",
		name: "Dividend Alert",
		description: "Notify about dividend announcements",
		category: "business",
	},
	{
		id: "order_update",
	...
	},
	{
		...
		description: "Send Diwali festival wishes to clients",
		category: "festive",
	},
	{
		id: "holi_greeting",
		name: "Holi Greeting",
		description: "Send Holi festival wishes to clients",
		category: "festive",
	},
	{
		id: "eid_greeting",
		name: "Eid Greeting",
		description: "Send Eid Mubarak wishes to clients",
		category: "festive",
	},
	{
		id: "christmas_greeting",
		name: "Christmas Greeting",
		description: "Send Christmas wishes to clients",
		category: "festive",
	},
	{
		id: "new_year_greeting",
		name: "New Year Greeting",
		description: "Send New Year wishes to clients",
		category: "festive",
	},
	{
		id: "independence_day",
		name: "Independence Day",
		description: "Send Independence Day greetings",
		category: "festive",
	},
	{
		id: "republic_day",
		name: "Republic Day",
		description: "Send Republic Day greetings",
		category: "festive",
	},
	{
		id: "dussehra_greeting",
		name: "Dussehra Greeting",
		description: "Send Dussehra wishes to clients",
		category: "festive",
	},
	{
		id: "ganesh_chaturthi",
		name: "Ganesh Chaturthi",
		description: "Send Ganesh Chaturthi wishes to clients",
		category: "festive",
	},
	{
		id: "pongal_greeting",
		name: "Pongal Greeting",
		description: "Send Pongal wishes to clients",
		category: "festive",
	},
	{
		id: "onam_greeting",
		name: "Onam Greeting",
		description: "Send Onam wishes to clients",
		category: "festive",
	},
	{
		id: "raksha_bandhan",
		name: "Raksha Bandhan",
		description: "Send Raksha Bandhan wishes to clients",
		category: "festive",
	},
	{
		id: "navratri_greeting",
		name: "Navratri Greeting",
		description: "Send Navratri wishes to clients",
		category: "festive",
	},
	{
		id: "makar_sankranti",
		name: "Makar Sankranti",
		description: "Send Makar Sankranti wishes to clients",
		category: "festive",
	},
	{
		id: "baisakhi_greeting",
		name: "Baisakhi Greeting",
		description: "Send Baisakhi wishes to clients",
		category: "festive",
	},
	{
		id: "guru_nanak_jayanti",
		name: "Guru Nanak Jayanti",
		description: "Send Guru Nanak Jayanti wishes",
		category: "festive",
	},
	{
...
export default function WhatsAppCampaigns() {
	...
	const { data: serviceStatus, isLoading: statusLoading } =
		useQuery<WhatsAppServiceStatus>({
			queryKey: ["/api/admin/marketing/whatsapp/status"],
		});

	const { data: audienceStats, isLoading: audienceLoading } =
		useQuery<AudienceStats>({
			queryKey: ["/api/admin/marketing/audience/stats"],
		});

	const isConsentRequired =
		audienceFilter.startsWith("consented_") ||
		audienceFilter === "all_consented";
	const actualFilter = audienceFilter
		.replace("consented_", "")
		.replace("all_consented", "all");

	const { data: audienceContacts, isLoading: usersLoading } = useQuery<
		Array<{
			id: string;
			mobile: string;
			email: string;
	...
	>({
		...
		queryFn: async () => {
			const response = await fetch(
				`/api/admin/marketing/audience/all?filter=${actualFilter}&consentOnly=${isConsentRequired}`,
			);
	...
	const { data: campaignHistory, isLoading: campaignsLoading } = useQuery<
		Array<{
			id: string;
			name: string;
			campaignType: string;
	...
	const sendMultiChannelMutation = useMutation({
		...
		onSuccess: (result: any) => {
			...
			if (result.whatsapp)
				channelResults.push(
					`WhatsApp: ${result.whatsapp.sent}/${result.whatsapp.total}`,
				);
			if (result.sms)
				channelResults.push(`SMS: ${result.sms.sent}/${result.sms.total}`);
			if (result.email)
				channelResults.push(
					`Email: ${result.email.sent}/${result.email.total}`,
				);
	...
	const businessTemplates = TEMPLATE_TYPES.filter(
		(t) => t.category === "business",
	);
	const festiveTemplates = TEMPLATE_TYPES.filter(
		(t) => t.category === "festive",
	);
		...
		<div className="space-y-6">
					...
					<Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
						...
						<DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
							<DialogHeader>
								...
								<DialogDescription>
									Send festive greetings or messages via WhatsApp, SMS, and
									Email
								</DialogDescription>
							</DialogHeader>
							<div className="space-y-4">
										...
										<div className="flex items-center space-x-2">
											<Checkbox
												...
												onCheckedChange={(checked) =>
													setChannels({ ...channels, whatsapp: !!checked })
												}
											/>
											<Label
								...
								<div className="space-y-2">
									...
									>
										...
										<SelectContent>
											<div className="px-2 py-1.5 text-xs font-semibold text-muted-foreground">
												Consented (Marketing Opt-in)
											</div>
											<SelectItem value="all_consented">
												All Consented Users
											</SelectItem>
											<SelectItem value="consented_clients">
												Consented Clients Only
											</SelectItem>
											<div className="px-2 py-1.5 text-xs font-semibold text-muted-foreground border-t mt-1 pt-2">
												All Contacts (Greetings)
											</div>
											<SelectItem value="all_contacts">All Contacts</SelectItem>
											<SelectItem value="all_clients">All Clients</SelectItem>
											<SelectItem value="all_prospects">
												All Prospects
											</SelectItem>
									...
									<p className="text-xs text-muted-foreground">
										{usersLoading
											? "Loading..."
											: `${audienceContacts?.length || 0} recipients selected`}
									</p>
								</div>
										...
										<div className="flex items-start gap-2">
											...
											<div className="text-sm">
												...
												<p className="text-amber-700 dark:text-amber-300">
													You are sending to contacts who may not have opted in
													to marketing. Use this only for festive greetings or
								...
								<div className="space-y-2">
									...
									{selectedTemplate && (
										<p className="text-xs text-muted-foreground">
											{
												TEMPLATE_TYPES.find((t) => t.id === selectedTemplate)
													?.description
											}
										</p>
									)}
										...
										<div className="flex items-start gap-2">
											...
											<div className="text-sm">
												...
												<p className="text-green-700 dark:text-green-300">
													Messages will only be sent to users who have opted in
								...
								<div className="flex justify-end gap-2">
									...
									<Button
										...
										disabled={
											...
											!selectedTemplate ||
											(!channels.whatsapp && !channels.sms && !channels.email)
										}
			...
			<div className="grid gap-4 md:grid-cols-4">
				...
				<Card data-testid="card-templates">
					...
					<CardContent>
						<div className="text-2xl font-bold">{TEMPLATE_TYPES.length}</div>
						<p className="text-xs text-muted-foreground">
			...
			<Tabs defaultValue="templates" className="space-y-4">
				<TabsList>
					...
					<TabsTrigger value="quick-send" data-testid="tab-quick-send">
						Quick Send
					</TabsTrigger>
				...
				<TabsContent value="templates">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								WhatsApp Business Policy requires using pre-approved templates
				...
				<TabsContent value="quick-send">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Send a single WhatsApp message to a specific user
							</CardDescription>
						</CardHeader>
						<CardContent>
							<QuickSendForm
				...
				<TabsContent value="history">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								View past WhatsApp campaigns and their performance
							</CardDescription>
						</CardHeader>
						<CardContent>
							{campaignsLoading ? (
								...
								<div className="text-center py-8 text-muted-foreground">
									...
									<p>
										Campaign history will appear here after you send your first
										campaign.
									</p>
								</div>
							) : (
								<div className="space-y-4">
														...
														<td className="p-3">
															...
															{campaign.whatsappTemplateName && (
																<div className="text-xs text-muted-foreground">
																	Template:{" "}
																	{campaign.whatsappTemplateName.replace(
																		/_/g,
																		" ",
																	)}
																</div>
									...
									<div className="text-sm text-muted-foreground text-right">
										Showing {campaignHistory.length} campaign
