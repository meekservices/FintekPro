...
const MODULES: ModuleCard[] = [
	{
		...
		subtitle: "Classify & draft replies",
		icon: "📧",
		href: "/admin/copilot/email",
		phase: 1,
	...
	},
	{
		...
		subtitle: "AI-generated investor proposals",
		icon: "📋",
		href: "/admin/copilot/proposals",
		phase: 1,
	...
	{
		title: "Audit Logs",
		subtitle: "Immutable action history",
		icon: "🔍",
		href: "/admin/copilot/audit-logs",
		phase: 1,
	...
	{
		title: "BI Dashboard",
		subtitle: "Daily business intelligence",
		icon: "📊",
		href: "/admin/copilot/bi",
		phase: 1,
	...
	},
	{
		...
		subtitle: "High-risk flags",
		icon: "⚠️",
		href: "/admin/copilot/compliance",
		phase: 1,
	...
	},
	{
		...
		subtitle: "Lead insights & routing",
		icon: "🤝",
		href: "/admin/copilot/crm",
		phase: 2,
	...
	},
	{
		...
		subtitle: "Ticket classification & SLA",
		icon: "🎫",
		href: "/admin/copilot/desk",
		phase: 2,
	...
	{
		title: "Finance (Books)",
		subtitle: "Invoices, payouts, GST",
		icon: "💰",
		href: "/admin/copilot/finance",
		phase: 2,
	...
	{
		title: "Meetings",
		subtitle: "Schedule, agenda & notes",
		icon: "📅",
		href: "/admin/copilot/meetings",
		phase: 2,
	...
	{
		title: "BI Analytics",
		subtitle: "Zoho Analytics deep-dive",
		icon: "🧠",
		href: "/admin/copilot/bi",
		phase: 3,
		...
		>
			...
			>
				<div>
					...
					<p style={{ color: "#94a3b8", margin: 0, fontSize: "0.95rem" }}>
						AI Decision Support System · FASP-AI v1.0 · All outputs require
						Admin approval
					</p>
				</div>
			...
			>
				...
				<span style={{ fontSize: "0.85rem", color: "#fcd34d" }}>
					<strong>FASP-AI v1.0 Guardrails Active:</strong> All AI outputs are
					DRAFT-only. No emails are sent, invoices issued, meetings scheduled,
					or payouts released without explicit Admin/Superadmin approval.
				</span>
			</div>
			...
			<SectionHeader
				phase={2}
				label="Phase 2 — Planned (CRM, Desk, Books, Meeting)"
				badge="🔵 Coming Soon"
			/>
			<div
				style={{
			...
			>
				{phase2.map((m, i) => (
					<ModuleCardComp key={i} module={m} disabled />
				))}
			</div>
			...
			<SectionHeader
				phase={3}
				label="Phase 3 — Future (Zoho Analytics BI)"
				badge="⚪ Roadmap"
			/>
			<div
				style={{
...
function SectionHeader({
	label,
	badge,
}: { phase: number; label: string; badge: string }) {
	return (
		<div
			style={{
				display: "flex",
...
function ModuleCardComp({
	module: m,
	disabled,
}: { module: ModuleCard; disabled?: boolean }) {
	const card = (
		<div
			style={{
				background: disabled
		...
		>
			...
			<div
				style={{ fontWeight: 700, color: "#f1f5f9", marginBottom: "0.25rem" }}
			>
				{m.title}
			</div>
			<div
			...
			{m.stat && (
				<div style={{ display: "flex", alignItems: "baseline", gap: "0.4rem" }}>
					<span
						style={{ fontSize: "1.5rem", fontWeight: 800, color: "#a78bfa" }}
					>
						{m.stat}
					</span>
