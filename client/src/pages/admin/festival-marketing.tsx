				...
				<div className="lg:col-span-2 space-y-6">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Choose a festival to send greetings for
							</CardDescription>
						</CardHeader>
						<CardContent>
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								How should the greetings be sent?
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="grid grid-cols-3 gap-4">
								...
								<Button
									variant={
										selectedChannel === "whatsapp" ? "default" : "outline"
									}
									className="flex flex-col h-auto py-4"
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Select specific agents or leave empty for master agent
							</CardDescription>
						</CardHeader>
						<CardContent>
							<Select>
							...
							<div className="flex justify-between items-center">
								...
								<span className="font-medium">
									{selectedFestivalData ? (
										<span>
											{selectedFestivalData.emoji} {selectedFestivalData.name}
										</span>
									) : (
