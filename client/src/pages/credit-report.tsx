					...
					<div className="flex items-center gap-3 mb-2">
						...
						<div>
							...
							<p className="text-muted-foreground">
								Detailed credit history and analysis
							</p>
						</div>
					</div>
				...
				<Card className="md:col-span-1">
					...
					<CardContent>
						<div className="text-center">
							<div
								className={`text-5xl font-bold ${getCreditScoreColor(creditScore)}`}
							...
							<div className="pt-4 border-t">
								<div className="flex items-center gap-2 text-green-600">
									...
									<span className="text-sm font-medium">
										Low utilization is good for credit score
									</span>
								</div>
							</div>
						</div>
				...
				<TabsContent value="accounts" className="space-y-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Complete history of your credit accounts
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="space-y-4">
									...
									>
										...
										<div className="grid md:grid-cols-4 gap-4 mt-4">
											...
											<div>
												...
												<p
													className={`font-medium capitalize ${getPaymentHistoryColor(account.paymentHistory)}`}
												>
				...
				<TabsContent value="enquiries" className="space-y-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Track who has accessed your credit report
							</CardDescription>
						</CardHeader>
						<CardContent>
								...
								{enquiries.map((enquiry, index) => (
									...
									>
										...
										<div className="text-right">
											...
											<Badge
												variant={
													enquiry.impact === "low" ? "secondary" : "outline"
												}
												className="mt-1"
											>
								...
								<div className="flex items-start gap-2">
									...
									<div>
										<p className="text-sm font-medium text-blue-900 dark:text-blue-100">
											Hard Enquiries Impact
										</p>
										<p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
											Multiple hard enquiries in a short period can lower your
											credit score. Try to space out credit applications.
										</p>
									</div>
								</div>
							</div>
					...
					<Card>
						...
						<CardContent className="space-y-6">
							...
							<div>
								...
								<p className="text-xs text-muted-foreground mt-1">
									Only 8.3% of available credit used
								</p>
							</div>
							...
							<div>
								...
								<p className="text-xs text-muted-foreground mt-1">
									Only 3 enquiries in last 12 months
								</p>
							</div>
						</CardContent>
					</Card>
								...
								<div className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-sm text-green-700 dark:text-green-300 mt-1">
											Your perfect payment history is the strongest factor. Keep
											it up!
										</p>
									</div>
								</div>
							...
							<div className="p-4 border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
								<div className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
											Your 8.3% utilization is excellent. Try to keep it below
											30% for optimal scores.
										</p>
									</div>
								</div>
							</div>
								...
								<div className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
											Avoid closing your oldest credit card (Axis Bank). It
											helps your credit history length.
										</p>
									</div>
								</div>
							</div>
								...
								<div className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-sm text-purple-700 dark:text-purple-300 mt-1">
											Adding a small installment loan could diversify your
											credit mix and potentially boost your score.
										</p>
									</div>
								</div>
							</div>
