...
export default function ClientTasks() {
	...
	const stats: TaskStats = {
		...
		dueThisWeek: tasks.filter((t) => {
			...
			return (
				t.status === "pending" && dueDate >= today && dueDate <= weekFromNow
			);
		}).length,
	};
		...
		<div className="min-h-screen bg-muted p-6" data-testid="client-tasks-page">
			<div className="max-w-6xl mx-auto space-y-6">
				<div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
					<div>
						...
						<p className="text-muted-foreground mt-1">
							Track your pending actions and deadlines
						</p>
					</div>
				</div>
				...
				<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
					...
					<Card
						className="bg-card border-border shadow-sm"
						data-testid="card-due-week-tasks"
					>
						<CardContent className="p-4">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p
										className="text-2xl font-bold text-foreground"
										data-testid="text-due-week-count"
									>
										{stats.dueThisWeek}
									</p>
								</div>
														...
														<div className="flex flex-col md:flex-row md:items-start justify-between gap-3">
															<div className="flex-1">
																...
																<div className="flex items-center gap-3 flex-wrap">
																	<span
																		className={`text-sm font-medium ${getDueDateColor(task.dueDate, task.status)}`}
					...
					<CardContent className="p-6">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-muted-foreground text-sm">
									Contact your advisor for assistance with any pending tasks.
								</p>
							</div>
							<Button
								variant="outline"
