	...
	const generateProposalMutation = useMutation({
		...
		onSuccess: (data) => {
			toast({
				...
				description:
					"AI has created an investment proposal for your goals. Check My Proposals to review.",
			});
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">
						Plan and achieve your financial goals with AI-powered insights
					</p>
				</div>
				<Button
					size="lg"
					...
					<div className="flex items-center gap-4">
						...
						<div className="flex-1">
							...
							<p className="text-sm text-blue-700 dark:text-blue-300">
								Click "Execute with AI" to generate a tailored investment
								proposal based on your goals
							</p>
						</div>
