		...
		<div className="container mx-auto px-4 py-6 max-w-7xl space-y-6">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						AI-identified opportunities based on your profile
					</CardDescription>
				</CardHeader>
				<CardContent>
							...
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										Your equity allocation is below optimal for your age and
										risk profile
									</p>
								</div>
							</div>
						...
						<div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										Add global exposure to reduce country-specific risk
									</p>
								</div>
							</div>
							<Badge
						...
						<div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										Consider tax-saving instruments to reduce tax liability
									</p>
								</div>
							</div>
							<Badge
