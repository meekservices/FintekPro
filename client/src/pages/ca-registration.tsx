...
const caRegistrationSchema = z
	.object({
		...
		icaiMembershipNumber: z
			.string()
			.min(5, "ICAI membership number is required"),
	...
	const registerMutation = useMutation({
		...
		onSuccess: () => {
			toast({
				...
				description:
					"Your CA registration is under review. We will notify you once approved.",
			});
				...
				<div className="text-center mb-8">
					<div className="flex items-center justify-center gap-2 mb-2">
						...
						<h1 className="text-3xl font-bold text-foreground">
							CA Partner Registration
						</h1>
					</div>
					<p className="text-muted-foreground">
						Join FintekPro as a Chartered Accountant partner and grow your
						practice
					</p>
				</div>
									...
									<div className="space-y-4">
													...
													<FormItem>
														...
														<FormControl>
															<Input
																placeholder="123456"
																{...field}
																data-testid="input-icai-number"
															/>
														</FormControl>
														<FormDescription>
															Your 6-digit ICAI membership number
														</FormDescription>
														<FormMessage />
													</FormItem>
												)}
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													<FormLabel>
														Certificate of Practice Number (Optional)
													</FormLabel>
													<FormControl>
														<Input
													...
													<FormDescription>
														Required if you have a Certificate of Practice
													</FormDescription>
													<FormMessage />
												</FormItem>
											)}
												...
												<FormField
													...
													render={({ field }) => (
														<FormItem>
															...
															<FormControl>
																<Input
																	placeholder="FRN Number"
																	{...field}
																	data-testid="input-frn"
																/>
															</FormControl>
															<FormMessage />
														</FormItem>
									...
									<div className="space-y-6">
													...
													<FormItem>
														...
														<FormControl>
															<Input
																...
																max={200}
																{...field}
																data-testid="input-max-cases"
															/>
														</FormControl>
														<FormDescription>
															How many cases can you handle monthly?
														</FormDescription>
														<FormMessage />
													</FormItem>
												)}
										...
										<div>
											<h4 className="font-medium mb-4">
												Fee Structure (Your Base Fees)
											</h4>
											<p className="text-sm text-muted-foreground mb-4">
												Set your base fees for different ITR types. FintekPro
												adds a platform fee on top.
											</p>
								...
								{currentStep === 5 && (
									<div className="space-y-4">
										<Alert>
											...
											<AlertDescription>
												Banking details are required for commission payouts. All
											...
											<div className="flex flex-wrap gap-2">
												{form.watch("specializations")?.map((spec: string) => (
													<Badge key={spec} variant="secondary">
														{CA_SPECIALIZATIONS.find((s) => s.value === spec)
															?.label || spec}
													</Badge>
												))}
											</div>
											...
											render={({ field }) => (
												<FormItem className="flex items-start space-x-3 space-y-0 rounded-lg border p-4">
													...
													<div className="space-y-1 leading-none">
														<FormLabel>
															I agree to the Terms of Service and Partner
															Agreement
														</FormLabel>
														<FormDescription>
															By registering, you agree to our platform
															policies, revenue sharing terms, and professional
															conduct guidelines.
														</FormDescription>
													</div>
													<FormMessage />
