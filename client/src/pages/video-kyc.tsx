...
type VerificationStep = 'intro' | 'camera-check' | 'face-detection' | 'liveness-blink' | 'liveness-turn' | 'document-capture' | 'review' | 'complete';
...
export default function VideoKYC() {
  ...
  const livenessChecks: LivenessChallenge[] = [
    { id: 'blink', instruction: 'Please blink your eyes twice', icon: Eye, completed: false },
    { id: 'smile', instruction: 'Please smile for the camera', icon: Smile, completed: false },
    { id: 'turn-left', instruction: 'Turn your head slowly to the left', icon: MoveLeft, completed: false },
    { id: 'turn-right', instruction: 'Turn your head slowly to the right', icon: MoveRight, completed: false },
  ];
  ...
  const startCamera = useCallback(async () => {
    try {
      ...
      setErrorMessage('Unable to access camera. Please ensure camera permissions are enabled.');
      toast({
  ...
  const handleSubmit = async () => {
    ...
    toast({
      ...
      description: "Your verification is being processed. You will be notified once complete.",
    });
      ...
      <div className="max-w-2xl mx-auto py-12">
        <Card className="text-center">
          <CardContent className="pt-6">
            ...
            <Link href="/auth">
              <Button data-testid="video-kyc-login-btn">Login to Continue</Button>
            </Link>
          </CardContent>
        </Card>
      </div>
  ...
  const renderStep = () => {
    switch (currentStep) {
        ...
        return (
          <Card className="max-w-2xl mx-auto" data-testid="video-kyc-intro">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Complete your identity verification through our secure video KYC process
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-green-50 dark:bg-green-950 rounded-lg border border-green-200 dark:border-green-800">
                  ...
                  <h4 className="font-medium text-green-800 dark:text-green-200">Good Lighting</h4>
                  <p className="text-sm text-green-600 dark:text-green-400">Natural light preferred</p>
                </div>
                <div className="p-4 bg-green-50 dark:bg-green-950 rounded-lg border border-green-200 dark:border-green-800">
                  <CheckCircle2 className="h-6 w-6 text-green-600 mb-2" />
                  <h4 className="font-medium text-green-800 dark:text-green-200">Clear Background</h4>
                  <p className="text-sm text-green-600 dark:text-green-400">Plain background works best</p>
                </div>
              </div>
      ...
      case 'camera-check':
        return (
          <Card className="max-w-2xl mx-auto" data-testid="video-kyc-camera-check">
            <CardHeader className="text-center">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="bg-blue-50 dark:bg-blue-950 rounded-lg p-4 text-center">
                ...
                <p className="font-medium text-lg">
                  {currentChallenge?.instruction || 'Position your face in the oval'}
                </p>
              </div>
      ...
      case 'complete':
        return (
          <Card className="max-w-2xl mx-auto text-center" data-testid="video-kyc-complete">
            <CardContent className="pt-12 pb-8">
              ...
              <p className="text-muted-foreground mb-6">
                Your video KYC has been submitted successfully. Our team will review it within 24-48 hours.
              </p>
              
              <div className="bg-blue-50 dark:bg-blue-950 rounded-lg p-4 mb-6">
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  You will receive an email and SMS notification once your verification is complete.
                </p>
              </div>
    ...
    <div className="container py-8" data-testid="video-kyc-page">
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
          <Link href="/kyc-dashboard" className="hover:text-foreground">KYC Dashboard</Link>
          <span>/</span>
          <span>Video KYC</span>
        </div>
