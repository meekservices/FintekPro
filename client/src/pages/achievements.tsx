				...
				<div className="mb-8">
					<div className="flex items-center mb-4">
						...
						<h1 className="text-3xl font-bold text-foreground">
							Investment Learning Achievements
						</h1>
					</div>
					<p className="text-lg text-muted-foreground">
						Track your progress, unlock achievements, and compete with other
						investors on your learning journey.
					</p>
				</div>
					...
					<Card className="bg-gradient-to-br from-green-50 dark:from-green-950/30 to-emerald-50 dark:to-emerald-950/30 border-green-200 dark:border-green-800">
						...
						<CardContent>
							<p className="text-sm text-green-600">
								Master the art of building and managing investment portfolios
					...
					<Card className="bg-gradient-to-br from-blue-50 dark:from-blue-950/30 to-indigo-50 dark:to-indigo-950/30 border-blue-200 dark:border-blue-800">
						...
						<CardContent>
							<p className="text-sm text-blue-600">
								Expand your knowledge through educational content, quizzes, and
					...
					<Card className="bg-gradient-to-br from-orange-50 dark:from-orange-950/30 to-red-50 dark:to-red-950/30 border-orange-200 dark:border-orange-800">
						...
						<CardContent>
							<p className="text-sm text-orange-600">
								Develop trading skills through practice trades, technical
								analysis, and market timing strategies.
							</p>
							<div className="mt-3 flex flex-wrap gap-1">
								<span className="bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 text-xs px-2 py-1 rounded">
									Technical Analysis
								</span>
								<span className="bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 text-xs px-2 py-1 rounded">
									Paper Trading
					...
					<Card className="bg-gradient-to-br from-purple-50 dark:from-purple-950/30 to-violet-50 dark:to-violet-950/30 border-purple-200 dark:border-purple-800">
						...
						<CardContent>
							<p className="text-sm text-purple-600">
								Share your achievements, engage with the community, and inspire
								others on their investment journey.
							</p>
							<div className="mt-3 flex flex-wrap gap-1">
