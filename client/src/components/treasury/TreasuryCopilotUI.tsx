...
export function TreasuryCopilotUI() {
	...
	>([
		{
			role: "bot",
			text: "Hello! I am your Treasury Copilot. How can I help you manage your liquidity today?",
		},
	]);
	...
	return (
		<Card
			className={`fixed bottom-6 right-6 w-80 md:w-96 shadow-2xl border-none transition-all z-50 ${isMinimized ? "h-14" : "h-[500px]"} overflow-hidden bg-white dark:bg-slate-900`}
		>
