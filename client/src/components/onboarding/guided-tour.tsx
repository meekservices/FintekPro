...
const tourSteps: TourStep[] = [
	{
		...
		description:
			"Your all-in-one financial services platform. Let us show you around the key features to help you get started.",
		icon: TrendingUp,
		position: "center",
	},
	{
		...
		title: "Quick Actions",
		description:
			"Access your most-used features instantly. Add investments, view your portfolio, generate tax reports, and more with just one click.",
		icon: Calculator,
	...
	},
	{
		...
		description:
			"Track your KYC verification progress. Higher KYC levels unlock premium features like AIF, PMS, and unlisted shares trading.",
		icon: LucideShield,
	...
	},
	{
		...
		description:
			"Use the sidebar to explore all services - from mutual funds to IPOs, bonds to loans. Toggle dark mode at the bottom!",
		icon: PieChart,
	...
	},
	{
		...
		title: "Need Help?",
		description:
			"Our AI assistant is always available via the chat widget in the corner. You can also reach our support team anytime.",
		icon: HelpCircle,
