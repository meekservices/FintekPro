...
export function KYCVerificationDashboard() {
	...
	const { data: verifiedKYCData } = useQuery<{
		success: boolean;
	...
	const { data: productAccessData } = useQuery<{
		success: boolean;
		data: ProductAccess;
	}>({
		...
		if (level === "enhanced") {
			return (
				<Badge
					...
					data-testid="kyc-level-enhanced"
				>
		...
		<div className="space-y-6" data-testid="kyc-verification-dashboard">
					...
					<CardContent>
						<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
							...
							<div>
								...
								<Badge
									className={getTierBadgeColor(verifiedKYC.kycTier)}
							...
							<div>
								...
								<p className="font-medium" data-testid="text-verification-date">
									{verifiedKYC.verificationDate
										? new Date(verifiedKYC.verificationDate).toLocaleDateString(
												"en-IN",
												{
													day: "numeric",
													month: "short",
			...
			{productAccess && productAccess.tier !== "accredited_investor" && (
				<Alert className="border-purple-200 dark:border-purple-900 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-950 dark:to-blue-950">
					...
					<AlertTitle className="text-lg font-semibold">
						Unlock Premium Investment Products
					</AlertTitle>
				...
				<CardContent className="space-y-4">
					...
					{status.requiresReKYC && (
						<Alert variant="destructive">
							...
							<AlertDescription>
								Your KYC has expired. Please complete re-verification to
								continue trading.
							</AlertDescription>
						</Alert>
					)}
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Choose the appropriate verification method based on your account
						type
					</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4">
								...
								<div className="flex items-start justify-between">
									<div className="space-y-2 flex-1">
										...
										<p className="text-sm text-muted-foreground">
											Instantly verify your identity using Aadhaar, PAN, and
											other government documents from DigiLocker
										</p>
									...
									<div className="ml-4">
										<Link href="/digilocker">
											<Button
												variant="default"
												data-testid="button-digilocker-verify"
											>
												{profile.digilockerVerified
													? "Manage Documents"
													: "Verify Now"}
							...
							<div className="border rounded-lg p-4 hover:bg-muted/50 transition-colors">
								<div className="flex items-start justify-between">
									<div className="space-y-2 flex-1">
										...
										<p className="text-sm text-muted-foreground">
											Upload identity and address proof documents manually for
											verification
										</p>
							...
							<div className="border rounded-lg p-4 hover:bg-muted/50 transition-colors">
								<div className="flex items-start justify-between">
									<div className="space-y-2 flex-1">
										...
										<p className="text-sm text-muted-foreground">
											Verify your entity using MCA, GSTIN, Corporate PAN/TAN
											verification via Sandbox API
										</p>
										<ul className="text-sm text-muted-foreground space-y-1">
											<li>
												✓ Real-time entity verification (CIN/GSTIN/PAN/TAN)
											</li>
											<li>
												✓ Automated director/authorized signatory validation
											</li>
								...
								<div className="flex items-start justify-between">
									<div className="space-y-2 flex-1">
										<div className="flex items-center gap-2">
											<FileText className="h-5 w-5 text-primary" />
											<h3 className="font-semibold">
												Manual Entity Documentation
											</h3>
										</div>
										<p className="text-sm text-muted-foreground">
											Upload entity documents: MOA/AOA, Board Resolution,
									...
									<div className="ml-4">
										<Link href="/profile">
											<Button
												variant="outline"
												data-testid="button-entity-upload"
											>
												Upload Documents
											</Button>
										</Link>
				...
				<CardContent className="space-y-2">
					...
					<div className="flex gap-2">
						<Button variant="outline" size="sm" asChild>
							<a href="mailto:support@fintekpro.com">Contact Support</a>
						</Button>
						<Button variant="outline" size="sm" asChild>
							<a href="/help/kyc" target="_blank" rel="noreferrer">
