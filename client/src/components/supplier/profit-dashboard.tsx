		...
		<div className="space-y-6">
						...
						<div className="flex items-center space-x-2">
							...
							<div>
								...
								<p
									...
									data-testid="text-avg-profit-margin"
								>
						...
						<div className="flex items-center space-x-2">
							...
							<div>
								...
								<p
									...
									data-testid="text-best-profit-margin"
								>
					...
					<CardContent className="p-6">
						<div className="flex items-center space-x-2">
							...
							<div>
								...
								<p
									className="text-2xl font-bold"
									data-testid="text-dashboard-total-revenue"
								>
						...
						<div className="flex items-center space-x-2">
							...
							<div>
								...
								<p
									...
									data-testid="text-top-performer"
								>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Compare profit margins across suppliers
						</CardDescription>
					</CardHeader>
					<CardContent>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Comprehensive performance analysis including profit score,
						performance rating, and commission rates
					</CardDescription>
				</CardHeader>
				<CardContent>
			...
			{analysis.recommendations && analysis.recommendations.length > 0 && (
				<Card>
					<CardHeader>
						...
						<CardDescription>
							AI-powered suggestions to maximize profitability
						</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							{analysis.recommendations.map(
								(recommendation: string, index: number) => (
									<div
										key={index}
										className="flex items-start space-x-3 p-4 bg-green-50 dark:bg-green-950 rounded-lg"
									>
										...
										<p
											className="text-sm"
											data-testid={`text-dashboard-recommendation-${index}`}
										>
											{recommendation}
										</p>
									</div>
			...
			{optimalSupplier && (
				<Card className="border-green-500 bg-green-50 dark:bg-green-950">
					<CardHeader>
						...
						<CardDescription>
							Highest profit score based on comprehensive analysis
						</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
							<div>
								...
								<p
									...
									data-testid="text-optimal-supplier-name"
								>
							...
							<div>
								...
								<p
									...
									data-testid="text-optimal-profit-margin"
								>
							...
							<div>
								...
								<div className="flex items-center space-x-2">
									<Progress
										value={optimalSupplier.profitScore}
										className="flex-1"
									/>
									<span
										className="text-sm font-medium"
										data-testid="text-optimal-profit-score"
									>
