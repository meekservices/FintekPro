					...
					<div className="px-4 pb-4 pt-0 space-y-4 border-t bg-muted/30">
						<div className="grid grid-cols-2 gap-4 pt-4">
							...
							<div className="p-3 bg-muted/50 rounded-lg">
								...
								<p className="text-sm">
									{suggestion.metricsComparison ||
										"Lower portfolio contribution"}
								</p>
							</div>
						</div>
	...
	return (
		<Card className="border-amber-200 dark:border-amber-800">
			<CardHeader className="pb-3 bg-amber-50 dark:bg-amber-950/30">
				...
				<CardDescription>
					{suggestions.length} fund(s) identified for potential replacement due
					to high overlap
				</CardDescription>
			</CardHeader>
