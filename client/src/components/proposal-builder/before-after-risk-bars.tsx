...
export function BeforeAfterRiskBars({
	current,
	proposed,
	changesApplied,
}: BeforeAfterRiskBarsProps) {
	const netImprovement =
		proposed.diversificationScore - current.diversificationScore;
		...
		>
			...
			<CardContent className="pt-4 space-y-6">
				...
				>
					...
					>
						{isOverallImproved ? `+${netImprovement}` : netImprovement} Point
						{Math.abs(netImprovement) !== 1 ? "s" : ""}
					</p>
