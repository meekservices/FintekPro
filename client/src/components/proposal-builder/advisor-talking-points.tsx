...
function TalkingPointCard({
  ...
  return (
    <div className={cn("p-3 rounded-lg border", config.bg, "border-opacity-50")}>
        ...
        <CardContent>
          <div className="p-4 bg-muted/50 rounded-lg text-center">
            <p className="text-sm text-muted-foreground">
              No talking points generated. Portfolio analysis will auto-generate recommendations.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            {onInsertToPdf && (
              <Button
                size="sm"
                onClick={() => onInsertToPdf(talkingPoints)}
              >
