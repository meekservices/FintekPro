...
const navCategories: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Compliance Dashboard", href: "/admin/compliance-dashboard", icon: Shield, description: "SEBI/RBI tracking" },
      { title: "Notifications", href: "/admin/notification-management", icon: Activity, description: "Alert configuration" },
      { title: "Feature Flags", href: "/admin/feature-flags", icon: Lightbulb, description: "A/B testing controls" },
      { title: "Report Builder", href: "/admin/report-builder", icon: BarChart3, description: "Custom reports" },
