...
const navCategories: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "KYC Flow", href: "/admin/kyc-flow", icon: FileCheck, description: "KYC step & provider config" },
      { title: "Aadhaar Providers", href: "/admin/aadhaar-config", icon: Shield, description: "Aadhaar verification config" },
      { title: "PAN Providers", href: "/admin/pan-config", icon: Key, description: "PAN verification config" },
      { title: "CKYC Providers", href: "/admin/ckyc-config", icon: ShieldCheck, description: "CKYC for MF/PMS/AIF" },
