...
export function BreadcrumbNavigation() {
	...
	const routeConfigs: RouteConfig[] = useMemo(
		() => [
			...
			{
				pattern: /^\/$/,
				breadcrumbs: () => [{ label: "Dashboard", href: "/", icon: Home }],
			},
	...
	const currentBreadcrumbs = useMemo(() => {
		...
		return [{ label: "Dashboard", href: "/", icon: Home }, { label: "Page" }];
	...
	return (
		<div
			className="flex items-center space-x-2 py-2 px-1 text-sm text-muted-foreground"
