...
export function QuickAccessToolbar() {
	...
	return (
		<div
			className="sticky top-0 z-30 bg-background/95/95 backdrop-blur-sm border-b border-border"
					...
					<Tooltip>
						<TooltipTrigger asChild>
							<Button
								variant="ghost"
								size="sm"
								className="h-8 px-3 text-green-600 hover:text-green-700 dark:text-green-300 hover:bg-green-50 dark:bg-green-950/30"
