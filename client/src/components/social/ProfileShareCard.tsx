	...
	return (
		<Card className="overflow-hidden border-primary/20 bg-gradient-to-br from-background to-primary/5">
			<CardHeader>
				...
				<CardDescription>
					Share your portfolio progress and earn rewards through your unique
					link.
				</CardDescription>
			</CardHeader>
				...
				{user?.shareableProfileEnabled ? (
					...
					<div className="bg-muted/50 rounded-lg p-6 text-center border border-dashed">
						<p className="text-sm text-muted-foreground">
							Turn on public visibility to share your investment journey with
							friends and earn referral bonuses.
						</p>
					</div>
				)}
			</CardContent>
