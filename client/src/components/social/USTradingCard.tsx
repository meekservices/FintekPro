    ...
    <Card className="border-primary/20 shadow-lg">
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          ...
          <Badge variant="outline" className="bg-primary/5 text-primary">Notional</Badge>
        </CardTitle>
        <CardDescription>Buy your favorite stocks in dollars, not shares.</CardDescription>
      </CardHeader>
