...
export function MarketTicker() {
  ...
  return (
    <div className="bg-finance-gray text-white py-3 overflow-hidden" data-testid="market-ticker">
      <div className="flex animate-scroll space-x-8 whitespace-nowrap">
        {indices?.map((index) => (
          ...
          >
            <span className="font-medium" data-testid={`ticker-name-${index.symbol}`}>
