			...
			<Card>
				<CardContent className="p-6">
					<div className="text-center">
						Loading Interactive Brokers accounts...
					</div>
				</CardContent>
			</Card>
		);
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">
						Connect your Interactive Brokers account for advanced trading
						capabilities
					</p>
				</div>
			</div>
						...
						<CardContent>
										...
										>
											<div>
												...
												<div className="text-sm text-muted-foreground">
													{account.host}:{account.port} (Client ID:{" "}
													{account.clientId})
												</div>
											</div>
							...
							<div className="mt-6 p-4 border rounded-lg bg-muted/50">
									...
									<div>
										...
										<Input
											...
											onChange={(e) =>
												setNewAccount((prev) => ({
													...prev,
													clientId: Number.parseInt(e.target.value) || 1,
												}))
											}
									...
									<div>
										...
										<Input
											...
											onChange={(e) =>
												setNewAccount((prev) => ({
													...prev,
													port: Number.parseInt(e.target.value) || 7497,
												}))
											}
								...
								<Button
									...
									disabled={
										createAccountMutation.isPending || !newAccount.accountNumber
									}
						...
						<CardContent>
							<div className="grid grid-cols-2 gap-4">
								<div>
									...
									<Select
										value={newOrder.ibAccountId}
										onValueChange={(value) =>
											setNewOrder((prev) => ({ ...prev, ibAccountId: value }))
										}
									>
								...
								<div>
									...
									<Select
										...
										onValueChange={(value) =>
											setNewOrder((prev) => ({ ...prev, action: value }))
										}
									>
