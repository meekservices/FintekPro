				...
				<div className="flex justify-between items-center">
					...
					<div className="flex space-x-2">
						<Button
							...
							className={
								activeTab === "gainers" ? "bg-finance-green text-white" : ""
							}
						...
						<Button
							...
							className={
								activeTab === "losers" ? "bg-finance-red text-white" : ""
							}
						...
						>
							<div>
								...
								<p
									...
									data-testid={`stock-name-${stock.symbol}`}
								>
									{stock.name}
								</p>
							</div>
							<div className="text-right">
								<p
									...
									data-testid={`stock-price-${stock.symbol}`}
								>
