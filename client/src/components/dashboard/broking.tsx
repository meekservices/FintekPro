			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">
						Trade stocks and commodities across NSE, BSE, MCX, NCDEX and
						Interactive Brokers
					</p>
				</div>
				<Button
			...
			<Tabs defaultValue="overview" className="w-full">
				<div className="overflow-x-auto pb-2">
					<ScrollableTabsList className="inline-flex w-auto min-w-full">
						...
						<TabsTrigger value="indian-trading" className="flex-shrink-0">
							Indian Markets
						</TabsTrigger>
						<TabsTrigger value="derivatives" className="flex-shrink-0">
							Commodities & Derivatives
						</TabsTrigger>
						<TabsTrigger value="sentiment" className="flex-shrink-0">
							Heatmap
						</TabsTrigger>
						<TabsTrigger value="ib-trading" className="flex-shrink-0">
							Global Markets
						</TabsTrigger>
						<TabsTrigger value="order-book" className="flex-shrink-0">
							Order Book
						</TabsTrigger>
						<TabsTrigger value="watchlist" className="flex-shrink-0">
							Watchlist
						</TabsTrigger>
					</ScrollableTabsList>
				</div>
												...
												>
													...
													<div className="text-right">
														<div className="text-green-600 font-medium">
															+{stock.per_chng?.toFixed(2)}%
														</div>
														<div className="text-sm text-green-600">
															+{formatCurrency(stock.chng)}
														</div>
													</div>
												</div>
											))}
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Get real-time quotes for NSE/BSE stocks
								</CardDescription>
							</CardHeader>
									...
									<div className="p-4 border rounded-lg bg-muted/50">
										<div className="grid grid-cols-2 gap-4">
											...
											<div>
												...
												<div className="font-medium">
													{formatCurrency((stockQuote as any).data.price)}
												</div>
											</div>
											<div>
												<div className="text-sm text-muted-foreground">
												...
												<div
													className={`font-medium ${getChangeColor((stockQuote as any).data.change)}`}
												>
													{(stockQuote as any).data.change >= 0 ? "+" : ""}
													{formatCurrency((stockQuote as any).data.change)}
												</div>
											</div>
											<div>
												<div className="text-sm text-muted-foreground">
												...
												<div
													className={`font-medium ${getChangeColor((stockQuote as any).data.percentChange)}`}
												>
													{(stockQuote as any).data.percentChange >= 0
														? "+"
														: ""}
													{(stockQuote as any).data.percentChange?.toFixed(2)}%
												</div>
											</div>
										</div>
									</div>
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Submit buy/sell orders on Indian exchanges
								</CardDescription>
							</CardHeader>
							<CardContent className="space-y-4">
								<div className="grid grid-cols-2 gap-4">
									<div>
										...
										<Select
											...
											onValueChange={(value: "NSE" | "BSE" | "MCX" | "NCDEX") =>
												setOrderForm((prev) => ({ ...prev, exchange: value }))
											}
										>
									...
									<div>
										...
										<Select
											...
											onValueChange={(value: "BUY" | "SELL") =>
												setOrderForm((prev) => ({ ...prev, action: value }))
											}
										>
								...
								<Button
									...
									onClick={() => {
										const txType =
											orderForm.exchange === "MCX" ||
											orderForm.exchange === "NCDEX"
												? "commodities"
												: "equity_india";
								...
								>
									{placeOrderMutation.isPending
										...
										: isChecking
											? "Checking KYC..."
											: `${orderForm.action} ${orderForm.quantity} ${orderForm.symbol}`}
								</Button>
							</CardContent>
						</Card>
					</div>
											...
											.map((index: any, i: number) => (
												<TableRow key={i}>
													...
													<TableCell className={getChangeColor(index.chng)}>
														{index.chng >= 0 ? "+" : ""}
														{formatCurrency(index.chng)}
													</TableCell>
													<TableCell className={getChangeColor(index.per_chng)}>
														{index.per_chng >= 0 ? "+" : ""}
														{index.per_chng?.toFixed(2)}%
													</TableCell>
													<TableCell>
					...
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									MSEI derivatives including futures and options
								</CardDescription>
							</CardHeader>
							<CardContent>
								{(mseiDerivatives as any)?.data ? (
									<Table>
										...
										<TableBody>
											{(mseiDerivatives as any).data.map(
												(derivative: any, i: number) => (
													<TableRow key={i}>
														<TableCell className="font-medium">
															{derivative.name}
														</TableCell>
														...
														<TableCell>
															<Button
																size="sm"
																variant="outline"
																data-testid={`button-trade-${derivative.symbol}`}
															>
																Trade
															</Button>
														</TableCell>
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Multi Commodity Exchange live prices
								</CardDescription>
							</CardHeader>
							<CardContent>
											...
											{(mcxCommodities as any).data
												...
												.map((commodity: any, i: number) => (
													<TableRow key={i}>
														...
														<TableCell
															className={getChangeColor(commodity.change)}
														>
															{commodity.change >= 0 ? "+" : ""}
														...
														<TableCell>
															<Button
																size="sm"
																variant="outline"
																data-testid={`button-trade-commodity-${commodity.symbol}`}
															>
																Trade
															</Button>
														</TableCell>
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Agricultural commodities from NCDEX
								</CardDescription>
							</CardHeader>
							<CardContent>
													...
													<TableRow key={i}>
														...
														<TableCell>
															<Button
																size="sm"
																variant="outline"
																data-testid={`button-trade-agri-${commodity.symbol}`}
															>
																Trade
															</Button>
														</TableCell>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Place orders for derivatives and commodities
								</CardDescription>
							</CardHeader>
							<CardContent className="space-y-4">
								<div className="grid grid-cols-2 gap-4">
									<div>
										...
										<Select>
											...
											<SelectContent>
												<SelectItem value="equity-future">
													Equity Future
												</SelectItem>
												<SelectItem value="call">Call Option</SelectItem>
												<SelectItem value="put">Put Option</SelectItem>
												<SelectItem value="commodity">Commodity</SelectItem>
												<SelectItem value="agri-commodity">
									...
									<div>
										<Label htmlFor="instrument-strike">
								...
								<Button
									className="w-full"
									data-testid="button-place-instrument-order"
								>
									Place Order
								</Button>
							</CardContent>
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Live options chain for NIFTY and BANKNIFTY
								</CardDescription>
							</CardHeader>
							<CardContent>
									...
									<Table>
										<TableHeader>
											<TableRow>
												<TableHead
													colSpan={3}
													className="text-center bg-green-50 dark:bg-green-950/30"
												>
													CALLS
												</TableHead>
												...
												<TableHead
													colSpan={3}
													className="text-center bg-red-50 dark:bg-red-950/30"
												>
													PUTS
												</TableHead>
											</TableRow>
				...
				<TabsContent value="sentiment" className="space-y-6">
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
						<Card className="lg:col-span-2">
							<CardHeader>
								...
								<CardDescription>
									Live sector-wise sentiment analysis based on market movements
									and volume
								</CardDescription>
							</CardHeader>
							<CardContent>
								...
								<div className="text-sm text-muted-foreground">
									Click on any sector tile to view detailed sentiment metrics
									...
									{mockSentimentData
										...
										.map((item, index) => (
											...
											>
												...
												<span
													className={`font-medium ${getChangeColor(item.change)}`}
												>
													{(item.change ?? 0) >= 0 ? "+" : ""}
													{(item.change ?? 0).toFixed(2)}%
												</span>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									AI-generated trading opportunities based on sentiment analysis
								</CardDescription>
							</CardHeader>
							<CardContent>
								<Table>
											...
											.map((item, i) => (
												<TableRow key={i}>
													...
													<TableCell>
														<Badge
															variant={
																item.sentiment > 0 ? "default" : "destructive"
															}
														>
													...
													<TableCell>
														<Button
															size="sm"
															variant="outline"
															data-testid={`button-trade-signal-${item.sector.toLowerCase().replace(" ", "-")}`}
														>
															Trade
														</Button>
													</TableCell>
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Relationship between trading volume and market sentiment
								</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="space-y-4">
									<div className="grid grid-cols-2 gap-4 text-center">
										<div className="p-3 bg-green-50 dark:bg-green-950/30 rounded-lg">
											...
											<div className="text-2xl font-bold text-green-600">
												{
													mockSentimentData.filter(
														(item) =>
															item.sentiment > 0.3 && item.volume > 5000,
													).length
												}
											</div>
											<div className="text-xs text-muted-foreground">
									...
									<div className="pt-3 border-t">
										<div className="text-xs text-muted-foreground">
											High volume with strong sentiment often indicates
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Recent events impacting market sentiment across sectors
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="space-y-3">
								<div className="flex items-start gap-3 p-3 bg-green-50 dark:bg-green-950/30 rounded-lg">
									...
									<div className="flex-1">
										<div className="text-sm font-medium">
											Positive Q3 Earnings Beat
										</div>
										<div className="text-xs text-muted-foreground">
											Technology sector sentiment improved following strong
											quarterly results from major IT companies
										</div>
								...
								<div className="flex items-start gap-3 p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
									...
									<div className="flex-1">
										...
										<div className="text-xs text-muted-foreground">
											Banking sector showing mixed sentiment ahead of monetary
											policy announcement
										</div>
										<div className="text-xs text-muted-foreground mt-1">
											4 hours ago
								...
								<div className="flex items-start gap-3 p-3 bg-yellow-50 dark:bg-yellow-950/30 rounded-lg">
									...
									<div className="flex-1">
										...
										<div className="text-xs text-muted-foreground">
											Energy sector sentiment remains cautious due to
								...
								<div className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-950/30 rounded-lg">
									...
									<div className="flex-1">
										<div className="text-sm font-medium">
											Pharma Regulatory Concerns
										</div>
										<div className="text-xs text-muted-foreground">
											Healthcare sentiment declined following regulatory
											inspection reports
										</div>
										<div className="text-xs text-muted-foreground mt-1">
											8 hours ago
				...
				<TabsContent value="ib-trading" className="space-y-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Trade US stocks, options, and global securities through
								Interactive Brokers
							</CardDescription>
						</CardHeader>
						<CardContent>
				...
				<TabsContent value="order-book" className="space-y-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								All your trading orders across exchanges
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="text-center py-8 text-muted-foreground">
				...
				<TabsContent value="watchlist" className="space-y-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Track your favorite stocks and commodities
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="text-center py-8 text-muted-foreground">
