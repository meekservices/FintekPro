	...
	const newsletters = [
		{
			...
			preview:
				"Sensex crosses 77K milestone as IT and banking sectors lead the charge. Key highlights include...",
			readTime: "2 min read",
			type: "weekly",
			status: "latest",
		},
		{
			...
			date: "January 8, 2025",
			preview:
				"What to expect from Budget 2025 and how it might affect your investments...",
			readTime: "3 min read",
			type: "special",
			status: "popular",
		},
		{
			...
			date: "January 1, 2025",
			preview:
				"A look ahead at 2025 market trends and investment themes to watch...",
			readTime: "2 min read",
			type: "weekly",
			status: "archived",
		},
			...
			<Card data-testid="card-newsletter-subscription">
				<CardHeader>
					...
					<p className="text-muted-foreground">
						Catch up on the entire week's news in two minutes. Read our
						newsletter.
					</p>
				</CardHeader>
				<CardContent>
			...
			<Card data-testid="card-newsletter-archive">
				<CardHeader>
					<CardTitle className="flex items-center justify-between">
						...
						<Badge variant="outline">{newsletters.length} editions</Badge>
					</CardTitle>
				</CardHeader>
				<CardContent>
							...
							>
								<div className="flex items-start justify-between mb-2">
									<div className="flex items-center gap-2">
										<Badge
											variant={
												newsletter.type === "weekly" ? "default" : "secondary"
											}
											className="text-xs"
										>
					...
					<div className="flex justify-center mt-6">
						<Button
							variant="outline"
							data-testid="button-load-more-newsletters"
						>
