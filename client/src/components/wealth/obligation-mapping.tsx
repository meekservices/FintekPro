...
export function ObligationMapping() {
	...
	const totalMonthly = activeObligations.reduce(
		(sum, o) => sum + Number(o.monthlyAmount || 0),
		0,
	);
		...
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">
					Your EMIs, loans, and recurring financial commitments
				</p>
			</div>
						...
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-xs text-muted-foreground mt-1">
									{activeObligations.length} active obligations
								</p>
							</div>
								...
								<p className="text-2xl font-bold text-orange-600">
									{formatCurrency(
										activeObligations.reduce(
											(sum, o) => sum + Number(o.totalOutstanding || 0),
											0,
										),
									)}
								</p>
			...
			{activeObligations.length === 0 ? (
				<Card>
					<CardContent className="p-8 text-center">
						...
						<p className="text-muted-foreground">
							You don't have any active EMIs, loans, or recurring financial
							commitments.
						</p>
					</CardContent>
				</Card>
					...
					<CardContent>
						<div className="space-y-4">
							{activeObligations.map((obligation) => {
								const Icon =
									typeIcons[obligation.obligationType || "other_emi"] ||
									CreditCard;
									...
									>
										...
										<div className="text-right">
											<p className="text-xl font-bold text-foreground">
												{formatCurrency(Number(obligation.monthlyAmount))}
											</p>
