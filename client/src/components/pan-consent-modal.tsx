        ...
        <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">Your PAN is encrypted using military-grade security</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">All access is logged for transparency</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">As per Income Tax Act requirements</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">You can withdraw consent anytime</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4">
            <Button
              ...
              disabled={!allConsentsGiven || !panNumber || storePANConsent.isPending}
              className="flex-1"
          ...
          <div className="text-xs text-gray-500 bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
            ...
            <p>
              <strong>Your Rights:</strong> You have the right to access, modify, or delete your data, and withdraw consent at any time. 
