														...
														<div className="space-y-1">
															<div className="flex items-center gap-2">
																<span className="font-semibold">
																	Version {version.proposalVersion}
																</span>
																{version.id === currentProposalId && (
															...
															<div className="flex items-center gap-3 text-sm mt-2">
																<span className="text-muted-foreground">
																	Investment: ₹
																	{Number.parseFloat(
																		version.totalInvestmentAmount || "0",
														...
														index < versions.length - 1 && (
															<div className="mt-3 pt-3 border-t border-dashed">
																<div className="flex items-center gap-2 text-xs text-muted-foreground">
																	...
																	<span>
																		Created from v
																		{versions[index + 1]?.proposalVersion ||
																			"?"}
																	</span>
																</div>
															</div>
					...
					<DialogContent className="max-w-3xl">
						<DialogHeader>
							...
							<DialogDescription className="flex items-center gap-2">
								...
								This is a historical version. To make changes, create a new
								...
								<Card>
									<CardContent className="pt-4">
										...
										<p className="text-2xl font-bold">
											₹
											{Number.parseFloat(
												selectedVersion.totalInvestmentAmount || "0",
											).toLocaleString("en-IN")}
										</p>
									</CardContent>
								</Card>
							...
							<div className="flex items-center justify-between pt-4 border-t">
								<div className="text-sm text-muted-foreground">
									...
									{selectedVersion.lockedAt && (
										<span className="ml-4">
											Locked:{" "}
											{new Date(selectedVersion.lockedAt).toLocaleString()}
										</span>
									)}
								</div>
								<Button
