									...
									<div className="grid grid-cols-2 md:grid-cols-3 gap-4">
										...
										<div>
											...
											<p className="font-semibold">
												{mockRegulatoryInfo.fundManager}
											</p>
										</div>
										<div>
											<p className="text-xs text-muted-foreground">
											...
											<p className="font-semibold">
												{mockRegulatoryInfo.expenseRatio}
											</p>
										</div>
										<div>
										...
										<div>
											...
											<p className="font-semibold text-xs">
												{mockRegulatoryInfo.benchmark}
											</p>
										</div>
										<div>
											<p className="text-xs text-muted-foreground">Exit Load</p>
											<p className="font-semibold text-xs">
												{mockRegulatoryInfo.exitLoad}
											</p>
										</div>
									</div>
								</CardContent>
								...
								<CardContent className="p-6">
									...
									<div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
										...
										<p className="text-xs text-blue-800 dark:text-blue-200">
											Our financial advisors are available to help you make
											informed investment decisions. Contact us for personalized
											guidance.
										</p>
									</div>
								</CardContent>
