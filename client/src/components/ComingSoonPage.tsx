	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-background to-muted p-6">
			<div className="max-w-3xl mx-auto space-y-6">
				...
				<Card
					className="border-0 shadow-xl bg-card/80/80 backdrop-blur-sm"
				...
				>
					<CardHeader className="text-center pb-4">
						...
						<Badge
							variant="outline"
							className="mx-auto text-orange-600 border-orange-300 bg-orange-50 dark:bg-orange-900/20 mt-2"
						>
