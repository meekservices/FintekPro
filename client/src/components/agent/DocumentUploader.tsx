	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Upload a Word document (.docx, .doc) or PDF for the signature
					workflow. Documents will be converted to a signable format.
				</CardDescription>
			</CardHeader>
			<CardContent className="space-y-4">
							...
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-sm">
										...
										{uploadedDoc.originalFormat.toUpperCase()})
									</p>
				...
				<div className="text-sm text-muted-foreground space-y-1">
					...
					<ul className="list-disc list-inside space-y-1">
						<li>
							<strong>.docx</strong> - Microsoft Word documents (converted to
							viewable format for signing)
						</li>
						<li>
							<strong>.pdf</strong> - PDF documents (ready for signing)
						</li>
					</ul>
				</div>
			</CardContent>
