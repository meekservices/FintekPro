...
export function GDPRConsent() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800" data-testid="gdpr-consent-dialog">
        <DialogHeader>
          ...
          <DialogDescription className="text-base">
            We use cookies and collect data to provide you with the best financial services experience. 
            Please review and customize your privacy preferences.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <p className="text-blue-700 dark:text-blue-300 text-sm">
                  Our platform processes financial data to provide investment services, comply with regulations, 
                  ...
                  <CardContent>
                    <div className="flex items-start justify-between">
                      ...
                      <Checkbox 
                        ...
                        onCheckedChange={(checked) => updatePreference('dataProcessing', !!checked)}
          ...
          <div className="text-xs text-gray-500 dark:text-gray-400 pt-4 border-t">
            ...
            <p>
              <strong>Contact:</strong> For privacy questions, email privacy@fintekpro.com
            </p>
          </div>
        </div>
      </DialogContent>
