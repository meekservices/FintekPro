  ...
  const handleAccept = async () => {
    if (!hasRead || !hasAcknowledged) {
      toast({
        ...
        description: "You must read and acknowledge all terms before proceeding",
        variant: "destructive",
      });
      return;
    }
      ...
      <DialogContent className="max-w-2xl max-h-[90vh]" data-testid="global-advisory-disclaimer-modal">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
            ...
            <div className="text-sm text-amber-800 dark:text-amber-200">
              <strong>Analytics-Only Mode:</strong> This market operates in analytics-only mode. 
              You will receive insights and signals, but cannot execute trades through FintekPro. 
              Please use your own licensed broker for any transactions.
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start space-x-3">
              ...
              />
              <Label htmlFor="hasAcknowledged" className="text-sm cursor-pointer">
                I acknowledge that FintekPro provides analytics-only advisory for {marketName} 
        ...
        <DialogFooter className="flex-col sm:flex-row gap-2">
          ...
          <Button
            ...
            disabled={!hasRead || !hasAcknowledged || recordAcknowledgment.isPending}
...
export function ExecutionRedirectModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-md" data-testid="execution-redirect-modal">
        <DialogHeader>
        ...
        <div className="space-y-4">
          <div className="text-sm text-muted-foreground">
            To execute trades in the {marketName} market, please use your licensed broker. 
            FintekPro provides analytics and signals only for international markets.
          </div>
          
          <div className="p-4 bg-muted rounded-lg space-y-2">
            <div className="font-medium">Recommended Steps:</div>
