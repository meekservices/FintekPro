				...
				<Form {...form}>
					<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
						...
						<div className="space-y-4">
							...
							{eligibilityData && (
								<Card
									className={`${eligibilityData.isEligible ? "border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-950/30" : "border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950/30"}`}
								>
										...
										<div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
											...
											<div>
												...
												<p className="text-blue-600">
													₹{eligibilityData.maxLoanAmount?.toLocaleString()}
												</p>
											</div>
											<div>
												<p className="font-medium">Interest Rate</p>
												<p className="text-blue-600">
													{eligibilityData.interestRate}% p.a.
												</p>
											</div>
											<div>
												<p className="font-medium">Processing Fee</p>
												<p className="text-blue-600">
													₹{eligibilityData.processingFee?.toLocaleString()}
												</p>
											</div>
										</div>
									</CardContent>
						...
						<div className="flex gap-4 justify-end">
							...
							<Button
								type="submit"
								disabled={
									submitLoanMutation.isPending || !eligibilityData?.isEligible
								}
