	...
	const updateProfileMutation = useMutation({
		mutationFn: async (data: { notes: string; reviewDate: string }) => {
			...
			const response = await apiRequest(
				"PUT",
				`/api/risk-profiles/${selectedProfile.id}`,
				data,
			);
		...
		<div className="space-y-6" data-testid="risk-profile-viewer">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Select a customer to view their investment risk assessment and
						profile
					</CardDescription>
				</CardHeader>
				<CardContent>
								...
								<Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
									...
									<DialogContent>
										<DialogHeader>
											...
											<DialogDescription>
												Update notes and review date for this customer's risk
												profile
											</DialogDescription>
										</DialogHeader>
										<div className="space-y-4">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<div className="space-y-3">
									<div className="flex items-center justify-between">
										...
										<Badge
											variant="secondary"
											data-testid="badge-risk-tolerance"
										>
									...
									<div className="flex items-center justify-between">
										...
										<Badge
											variant="secondary"
											data-testid="badge-investment-horizon"
										>
								...
								<div className="space-y-3">
									<div className="flex items-center justify-between">
										...
										<Badge
											variant="secondary"
											data-testid="badge-income-stability"
										>
									...
									<div className="flex items-center justify-between">
										...
										<Badge
											variant="secondary"
											data-testid="badge-liquidity-needs"
										>
							...
							<div className="space-y-4">
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									...
									<div className="space-y-2">
										...
										<p
											...
											data-testid="text-existing-assets"
										>
									...
									<div className="space-y-2">
										...
										<p
											...
											data-testid="text-existing-liabilities"
										>
								...
								<div className="space-y-2">
									...
									>
										{formatCurrency(
											(
												Number.parseFloat(selectedProfile.existingAssets) -
												Number.parseFloat(selectedProfile.existingLiabilities)
											).toString(),
										)}
									</p>
								</div>
						...
						<Card>
							...
							<CardContent className="space-y-4">
								<div>
									...
									<p className="font-medium" data-testid="text-assessed-by">
										{selectedProfile.assessedBy}
									</p>
								</div>
								<div>
									<span className="text-sm text-muted-foreground">
									...
									<p className="font-medium" data-testid="text-assessment-date">
										{new Date(
											selectedProfile.assessmentDate,
										).toLocaleDateString()}
									</p>
								</div>
								<div>
									...
									<div className="flex items-center gap-2">
										<p className="font-medium" data-testid="text-review-date">
											{new Date(
												selectedProfile.reviewDate,
											).toLocaleDateString()}
										</p>
										{new Date(selectedProfile.reviewDate) <= new Date() && (
											<Badge
												variant="destructive"
												data-testid="badge-review-overdue"
											>
								...
								<div>
									...
									<p className="font-medium" data-testid="text-dependents">
										{selectedProfile.dependents}
									</p>
								</div>
							</CardContent>
						</Card>
									...
									{selectedProfile.riskScore <= 30 && (
										<div className="p-3 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-800">
											...
											<p className="text-green-600">
												Recommend low-risk investments like fixed deposits,
												government bonds, and conservative mutual funds.
											</p>
										</div>
									)}
									{selectedProfile.riskScore > 30 &&
										selectedProfile.riskScore <= 50 && (
											<div className="p-3 bg-yellow-50 dark:bg-yellow-950/30 rounded-lg border border-yellow-200 dark:border-yellow-800">
												<p className="font-medium text-yellow-800 dark:text-yellow-200">
													Moderate Investor
												</p>
												<p className="text-yellow-600">
													Suitable for balanced portfolios with mix of debt and
													equity investments.
												</p>
											</div>
										)}
									{selectedProfile.riskScore > 50 &&
										selectedProfile.riskScore <= 70 && (
											<div className="p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
												<p className="font-medium text-blue-800 dark:text-blue-200">
													Balanced Investor
												</p>
												<p className="text-blue-600">
													Can consider diversified equity funds and balanced
													asset allocation.
												</p>
											</div>
										)}
										...
										selectedProfile.riskScore <= 85 && (
											<div className="p-3 bg-orange-50 dark:bg-orange-950/30 rounded-lg border border-orange-200 dark:border-orange-800">
												...
												<p className="text-orange-600">
													Suitable for growth-oriented equity funds and
									...
									{selectedProfile.riskScore > 85 && (
										<div className="p-3 bg-red-50 dark:bg-red-950/30 rounded-lg border border-red-200 dark:border-red-800">
											...
											<p className="text-red-600">
												Can handle high-risk, high-reward investments like
												small-cap funds and sectoral investments.
											</p>
										</div>
									)}
								</div>
					...
					<CardContent className="flex items-center justify-center py-8">
						<div className="text-center">
							...
							<p className="text-muted-foreground">
								The selected customer does not have a risk assessment profile
								yet.
							</p>
						</div>
					</CardContent>
				...
				<Card>
					<CardContent className="flex items-center justify-center py-8">
						<div className="text-center">
							...
							<p className="text-muted-foreground">
								Choose a customer from the dropdown above to view their risk
								profile and assessment details.
							</p>
						</div>
					</CardContent>
				</Card>
