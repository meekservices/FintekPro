...
const riskAssessmentSchema = z.object({
	...
	existingLiabilities: z
		.string()
		.min(1, "Existing liabilities value is required"),
...
export function RiskAssessmentForm() {
	...
	const createProfileMutation = useMutation({
		...
		onSuccess: () => {
			...
			toast({
				...
				description:
					"Customer risk assessment has been successfully completed.",
			});
			// Reset form
			form.reset();
			setCurrentStep(1);
	...
	const calculateRiskScore = () => {
		...
		const finalScore =
			totalWeightage > 0 ? Math.round(totalScore / totalWeightage) : 0;
							...
							render={({ field }) => (
								<FormItem>
									...
									<Select
										...
										value={field.value}
										data-testid="select-customer-assessment"
									>
										<FormControl>
											<SelectTrigger>
									...
									<FormItem>
										...
										<FormControl>
											<Input
												{...field}
												placeholder="1000000"
												data-testid="input-existing-assets"
											/>
										</FormControl>
										<FormMessage />
									</FormItem>
									...
									<FormItem>
										...
										<FormControl>
											<Input
												{...field}
												placeholder="500000"
												data-testid="input-existing-liabilities"
											/>
										</FormControl>
										<FormMessage />
									</FormItem>
				...
				return (
					<div className="space-y-6">
						<div className="text-center mb-6">
							...
							<p className="text-muted-foreground">
								Answer questions to determine risk profile
							</p>
						</div>
								...
								<div className="text-center space-y-2">
									...
									<div className="flex items-center justify-center gap-4">
										<Progress
											...
											className="h-3 flex-1 max-w-xs"
										/>
										<Badge
											variant="outline"
											className="text-lg px-4 py-2"
											data-testid="badge-calculated-score"
										>
