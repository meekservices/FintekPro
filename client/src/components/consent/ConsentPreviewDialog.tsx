	...
	return (
		<Dialog open={open} onOpenChange={handleClose}>
			<DialogContent
				...
				data-testid="dialog-consent-preview"
			>
				<DialogHeader>
					...
					<div className="space-y-6">
						...
						<div className="flex items-center gap-2">
							...
							<span className="text-sm text-muted-foreground">
								...
								<Badge variant="secondary">90 days</Badge> and can be revoked
								anytime
							</span>
						</div>
						...
						<div className="space-y-4">
							<div className="flex items-start gap-3">
								...
								>
									I have read and agree to the consent terms. I understand that
									my data will be fetched from {provider} and stored securely.
								</label>
							</div>
							...
							<div className="flex items-start gap-3">
								<Checkbox
									...
									onCheckedChange={(checked) =>
										setAcceptedDataUsage(checked === true)
									}
									data-testid="checkbox-accept-data-usage"
								/>
								<label
									htmlFor="accept-data-usage"
									className="text-sm cursor-pointer"
								>
									I consent to FintekPro using my {sourceLabel} data for
									portfolio analysis, financial planning, and personalized
									recommendations.
								</label>
							</div>
						</div>
...
function getDataUsageText(dataSource: string): string[] {
	...
	const sourceSpecificUsage: Record<string, string[]> = {
		mutual_funds: [
			...baseUsage,
			"Track SIP performance and suggest rebalancing",
		],
		...
		loans: [
			...baseUsage,
			"Calculate net worth and suggest debt repayment strategies",
		],
		insurance: [
			...baseUsage,
			"Analyze coverage gaps and suggest policy renewals",
		],
