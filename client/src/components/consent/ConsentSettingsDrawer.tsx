	...
	return (
		<Sheet open={open} onOpenChange={onOpenChange}>
			<SheetContent
				...
				data-testid="drawer-consent-settings"
			>
				<SheetHeader>
				...
				<div className="mt-6 space-y-6">
					<div className="space-y-4">
						...
						<div className="grid grid-cols-2 gap-4">
							<div className="p-3 bg-muted rounded-lg">
								...
								<Badge
									variant={
										consent.status === "active" ? "default" : "destructive"
									}
					...
					<div className="space-y-3">
						...
						<p className="text-sm text-muted-foreground">
							Revoking consent will stop all data fetching from this source.
							Previously fetched data will be retained as per regulations.
						</p>
						<Button
							variant="destructive"
							className="w-full"
