...
const getStatusIcon = (status: SourceStatus['status']) => {
  switch (status) {
    ...
    case 'pending':
      return <Clock className="h-5 w-5 text-gray-400 dark:text-gray-500" data-testid={`icon-pending`} />;
  }
};
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    sourceStatus.status === 'pending' && 'border-gray-200 dark:border-gray-800'
                  )}
