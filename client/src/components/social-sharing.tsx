...
export function SocialSharing({ achievement, userAchievement, userId }: SocialSharingProps) {
  ...
  const getAchievementIcon = (category: string) => {
    switch (category.toLowerCase()) {
      case 'portfolio': return <TrendingUp className="h-8 w-8" />;
      case 'learning': return <BookOpen className="h-8 w-8" />;
      case 'trading': return <Target className="h-8 w-8" />;
      ...
      <DialogContent className="max-w-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800">
        ...
        <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0">
                  {achievement.badgeImage ? (
                    ...
                    <div className="w-16 h-16 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-lg flex items-center justify-center text-white">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {userAchievement?.sharedCount && userAchievement.sharedCount > 0 && (
          ...
          <div className="bg-muted p-4 rounded-lg">
            ...
            <p className="text-sm whitespace-pre-line">{generateShareContent()}</p>
          </div>
