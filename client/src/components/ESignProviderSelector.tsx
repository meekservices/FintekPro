...
export function ESignProviderSelector({
	...
	const [selectedMethod, setSelectedMethod] =
		useState<ESignMethod>("aadhaar_otp");
				...
				<CardContent className="space-y-6">
								...
								<div className="flex-1">
									...
									{!signerAadhaar && (
										<Alert className="mt-3">
											...
											<AlertDescription>
												You'll need to provide your Aadhaar number for OTP
												verification
											</AlertDescription>
										</Alert>
									)}
							...
							>
								...
								<div className="flex-1">
									...
									<Alert className="mt-3">
										<Info className="h-4 w-4" />
										<AlertDescription>
											Requires DSC token software installed. Signing works
											offline but submission requires internet.
										</AlertDescription>
									</Alert>
								</div>
					...
					<div className="pt-2">
						...
						>
							...
							Proceed with{" "}
							{selectedMethod === "aadhaar_otp" ? "Aadhaar OTP" : "DSC Token"}
					...
					<div className="text-xs text-muted-foreground text-center pt-2">
						<p>
							Both methods are legally valid under IT Act 2000 and SEBI
							regulations.
							<br />
