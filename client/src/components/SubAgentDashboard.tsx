...
const clientReferralSchema = z.object({
	...
	mobile: z
		.string()
		.regex(/^[0-9]{10}$/, "Valid 10-digit mobile number is required"),
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				...
				<Card data-testid="card-total-earnings">
					...
					<CardContent>
						...
						<p className="text-xs text-muted-foreground">
							+₹
							{(referralStats?.earningsThisMonth || 0).toLocaleString("en-IN")}{" "}
							this month
						</p>
					</CardContent>
				</Card>
						...
						<div className="flex gap-2">
							...
							>
								...
								<DialogContent className="max-w-2xl">
									...
									<Form {...referralForm}>
										<form
											onSubmit={referralForm.handleSubmit((data) =>
												referClientMutation.mutate(data),
											)}
											className="space-y-4"
										>
									...
									<TableBody>
										{clientsLoading ? (
											...
											referredClients.map((client: ReferredClient) => (
												...
												>
													...
													<TableCell className="text-right font-medium">
														₹
														{(client.totalEarnings || 0).toLocaleString(
															"en-IN",
														)}
													</TableCell>
												</TableRow>
											...
											<TableRow>
												...
												>
													No referred clients yet. Start referring clients to
													earn commissions!
												</TableCell>
											</TableRow>
										)}
									...
									<TableBody>
										{earningsLoading ? (
											...
											earnings.map((earning: Earning) => (
												<TableRow
													key={earning.id}
													data-testid={`row-earning-${earning.id}`}
												>
											...
											<TableRow>
												<TableCell
													...
													className="text-center text-muted-foreground"
												>
													No earnings yet. Refer clients and earn commissions on
													their transactions!
												</TableCell>
											</TableRow>
										)}
