...
const DISCLOSURE_TEXT = {
	...
	footer:
		"This recommendation emphasizes growth opportunities within your risk profile. Returns may vary. Past performance is not indicative of future results. Please consult your financial advisor before making investment decisions.",
};
		...
		return (
			...
			>
				...
				<AlertTitle className="text-orange-800 dark:text-orange-200 font-medium flex items-center gap-2">
					...
					<Badge
						variant="outline"
						className="text-xs border-orange-400 text-orange-700 dark:text-orange-300"
					>
	...
	if (variant === "card") {
		return (
			<Card
				...
				data-testid="growth-disclosure-card"
			>
				...
				<div className="space-y-3">
					<div className="space-y-1">
						<div className="flex justify-between text-sm">
							...
							<span className="font-medium">
								{suitabilityScore}/100 × {weightings.suitability}%
							</span>
						</div>
					...
					<div className="space-y-1">
						<div className="flex justify-between text-sm">
							...
							<span className="font-medium">
								{upsideScore}/100 × {weightings.upside}%
							</span>
						</div>
						<div className="h-2 bg-muted rounded-full overflow-hidden">
							<div
					...
					<div className="pt-2 border-t">
						...
						<p className="text-xs text-muted-foreground mt-1">
							= ({suitabilityScore} × {weightings.suitability / 100}) + (
							{upsideScore} × {weightings.upside / 100})
						</p>
					</div>
				</div>
			</CardContent>
