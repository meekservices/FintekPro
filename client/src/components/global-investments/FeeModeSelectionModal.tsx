...
export function FeeModeSelectionModal({
	open,
	onOpenChange,
	onModeSelected,
}: FeeModeSelectionModalProps) {
	...
	const selectModeMutation = useMutation({
		...
		onError: (error: any) => {
			toast({
				...
				description:
					error.message || "Failed to save your selection. Please try again.",
				variant: "destructive",
			});
		},
	});
	...
	const isSubmitDisabled =
		!selectedMode || !disclaimerAcknowledged || selectModeMutation.isPending;

	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent
				className="max-w-2xl max-h-[90vh] overflow-y-auto"
				data-testid="fee-mode-selection-modal"
			>
				<DialogHeader>
					...
					<DialogDescription>
						Select how you'd like to invest in Global Markets. This choice
						affects the services and fees applicable to you.
					</DialogDescription>
				</DialogHeader>
				...
				<div className="grid gap-4 py-4">
					...
					>
						...
						<CardContent className="space-y-3">
							<p className="text-sm text-muted-foreground">
								Get personalized AI-powered recommendations and expert advisory
								services for your global investments.
							</p>
					...
					{currentSettings?.platformOnlyEnabled && (
						...
						>
							...
							<CardContent className="space-y-3">
								<p className="text-sm text-muted-foreground">
									Use our platform for self-directed trading without advisory
									services. You make your own investment decisions.
								</p>
						...
						>
							...
							<AlertDescription className="text-sm">
								...
								<ul className="list-disc ml-4 mt-2 space-y-1">
									...
									<li>
										FintekPro is not responsible for your investment choices
									</li>
								</ul>
							</AlertDescription>
						</Alert>
					...
					<div className="flex items-start space-x-3 pt-4 border-t">
						<Checkbox
							...
							onCheckedChange={(checked) =>
								setDisclaimerAcknowledged(checked as boolean)
							}
						...
						>
							I understand and acknowledge the fee structure and service
							offerings for my selected mode. I confirm this selection is made
							voluntarily.
						</label>
					</div>
				</div>
