...
const RBAC_RULES: RBACRule[] = [
	{
		role: "client",
		action: "view",
		networkStates: ["online", "offline", "slow"],
		allowed: true,
	},
	{
		role: "client",
	...
	},
	{
		role: "client",
		action: "execute",
		networkStates: ["offline", "slow"],
		allowed: false,
		message: "Trade execution requires a stable internet connection.",
	},
	{
		role: "client",
		action: "submit",
	...
	},
	{
		...
		networkStates: ["offline", "slow"],
		allowed: false,
		message: "Form submission requires an internet connection.",
	},
	{ role: "client", action: "trade", networkStates: ["online"], allowed: true },
	{
		...
		networkStates: ["offline", "slow"],
		allowed: false,
		message: "Trading requires a stable internet connection.",
	},
	{
		role: "client",
		action: "payment",
	...
	},
	{
		...
		networkStates: ["offline", "slow"],
		allowed: false,
		message: "Order execution requires a stable internet connection.",
	},
	{ role: "agent", action: "submit", networkStates: ["online"], allowed: true },
	{
		...
		networkStates: ["offline", "slow"],
		allowed: false,
		message: "Client consent capture requires an internet connection.",
	},
	{
		role: "agent",
		action: "approve",
	...
	},
	{
		...
		networkStates: ["offline", "slow"],
		allowed: false,
		message: "Approvals require an internet connection.",
	},
	...
	},
	{
		...
		networkStates: ["offline", "slow"],
		allowed: false,
		message: "Execution requires a stable internet connection.",
	},
	{
		role: "admin",
		action: "approve",
	...
	},
	{
		...
		networkStates: ["offline", "slow"],
		allowed: false,
		message: "Configuration changes require an internet connection.",
	},
...
export function getDisallowedActions(
	role: UserRole,
	networkState: NetworkState,
): ActionCategory[] {
