  ...
  return (
    <Switch>
      ...
      <Route path="/partner/register">
        {() => (
          <Suspense fallback={<div className="min-h-screen bg-indigo-950 flex items-center justify-center"><div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-violet-500" /></div>}>
            <PartnerRegister />
          </Suspense>
        )}
      </Route>
