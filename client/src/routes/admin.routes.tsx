...
import {
  AdminDashboard, GoldenPricingDashboard, SystemHealthMonitor, EngineHealthCheck,
  MFAnalyticsOps, RevenueAnalytics, UserActivityTimeline, BulkOperations,
  ComplianceDashboardPage, SEBIMFCompliance, RegulatoryAuditNormsPage,
  AdminApprovalQueue, NotificationManagement, FeatureFlags, ParserConfigPage,
  AdminESignManagement, ReportBuilder, StakeholdersPage, KycCompliancePage,
  KycV2ManagementPage, FinancialOperationsPage, APIConfiguration,
  ProductionReadiness, ActivityCentre, CkycDeferredDashboard, ZohoDashboardPage,
  ...
  AdminThemeSettings, InstitutionalData, MarketingDashboard, FestivalMarketing,
  EmailCampaigns, WhatsAppCampaigns, WhatsAppSetup, SMSCampaigns, SmsInbox,
  LeadProspecting, McaIntelligence, McaCompanyProfile, ProspectAnalytics,
  ClientIntelligence, MarketingAnalytics, AgentPerformanceDashboard,
  DemoProposalsTracking, AdminTaskOversight, UserManagement, CAManagement,
  UnlistedCompaniesAdmin, UnlistedNegotiations, UnlistedDashboard,
  BondMarketplaceDashboard, GlobalAdvisoryManagement, UnlistedOrders,
  OrderAuditDashboard, UnlistedAuditLog, UnlistedComplianceAlerts,
  UnlistedRegulatoryCompliance, FixedIncomeAdmin, BondCommissionSettings,
  CommissionMaster, AdminPartnerHierarchy, AdminFirmInventory, AdminLoanManagement,
  ...
  NotificationPreferences, PortfolioGoals, PortfolioRetirement, PortfolioAIInsights,
  PortfolioRebalancing, PortfolioImport, TrackerPortfolioReport,
  AgentExternalPortfolios, AgentInvestmentBaskets, AgentSipHealth,
  AgentPortfolioDrift, AgentMarketAlerts, PublicProfilePage, AgentTracker,
  AlpacaMarketExplorer, TreasuryDashboard, Profile, PublicProposalPage,
  AdminAgentPayouts, AgentProspectProposals, AgentIrisHub, AgentESign,
  AgentKycEmpanelment, KycRejectionRekyc, OnboardingPage, SettingsPage,
  PredictiveAnalytics, ComprehensivePortfolio, AdminProposalsPage,
  ClientProposalsPage, MyProposalsPage, ClientSmartProposals, ClientTasks,
  ClientAIRecommendations, ClientReports, AgentProspectWizard, GoalsPage,
  AIProposalsPage, AIProposalReviewPage, AIStockPicks, AgentPicks, AgentDashboard,
  FieldAgentPortal, AgentPortal, AgentClientsPage, AgentClientProfile, AgentTasks,
  FestivalGreetingPreview, AgentResearchLists, AgentResearchListDetail,
  ResearchNoteGenerator, AlpacaHubAgent,
  // Admin-only copilot pages
  AdminCopilotHub, CopilotAuditLogs, CopilotBiDashboard, CopilotBooksFinance,
  CopilotComplianceAlerts, CopilotCrmIntelligence, CopilotDeskIntelligence,
  CopilotEmailIntelligence, CopilotMeetings, CopilotProposalDrafts,
  CopilotTaskManager,
  // Additional pages used in admin routes
  BiometricSettingsPage, VideoKYC, PortfolioHoldings,
