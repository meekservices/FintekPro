...
import {
	...
	TaxITRVerifyPage,
	TaxNoticesPage,
	TaxDocumentVaultPage,
	TaxCADeskPage,
	IntelligentTaxHub,
	TaxReminderSubscription,
	MLDs,
	UnifiedCart,
	Insurance,
	BankingProducts,
	...
	return (
		<ProfileCompletionGuard>
			<Switch>
				...
				<Route
					path="/agent/external-portfolios"
					component={AgentExternalPortfolios}
				/>
				<Route
				...
				<Route
					path="/partner/agent-performance"
					component={PartnerAgentDashboard}
				/>
				...
				<Route
					path="/reports/tracker-portfolio"
					component={TrackerPortfolioReport}
				/>
				...
				<Route
					path="/tax-reminder-subscription"
					component={TaxReminderSubscription}
				/>
				...
				<Route
					path="/tax-compliance/form15"
					component={TaxComplianceForm15Page}
				/>
				...
				<Route
					path="/ai-proposal-review/:id"
					component={AIProposalReviewPage}
				/>
				...
				<Route
					path="/alpaca-market-explorer"
					component={AlpacaMarketExplorer}
				/>
