    ...
    sections: [
      {
        ...
        content: 'All investments are subject to market risks. The value of investments can go down as well as up, and investors may get back less than they invested. Past performance is not a reliable indicator of future results.',
      },
      {
        title: 'Data Sources',
        content: 'The data presented in this report is sourced from market data providers, regulatory filings, and internal calculations. While every effort has been made to ensure accuracy, we cannot guarantee the completeness or accuracy of all information.',
      },
      {
        title: 'Calculation Methodology',
        content: 'Returns are calculated using time-weighted methodology. Risk metrics are based on historical volatility and may not accurately predict future risk. All calculations are performed in INR unless otherwise specified.',
      },
      {
        title: 'SEBI Compliance',
        content: 'This report is prepared in accordance with SEBI (Investment Advisers) Regulations, 2013. The information provided is for informational purposes only and should not be construed as investment advice.',
      },
      {
        title: 'Conflicts of Interest',
        content: 'The advisor may have positions in some of the securities mentioned in this report. Any potential conflicts of interest are disclosed in accordance with regulatory requirements.',
      },
    ],
    riskWarnings: [
