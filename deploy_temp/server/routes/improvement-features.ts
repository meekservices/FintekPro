...
router.get("/dashboard/widgets", async (req: Request, res: Response) => {
  try {
    ...
    const widgets = await improvementFeaturesService.getDashboardWidgets(userId);
...
router.put("/dashboard/widgets", async (req: Request, res: Response) => {
  try {
    ...
    const success = await improvementFeaturesService.updateDashboardWidgets(userId, widgets);
...
router.post("/referral/invite", async (req: Request, res: Response) => {
  try {
    ...
    const result = await improvementFeaturesService.sendReferralInvite(userId, email, phone);
...
router.get("/reports/scheduled", async (req: Request, res: Response) => {
  try {
    ...
    const reports = await improvementFeaturesService.getScheduledReports(userId);
...
router.post("/reports/scheduled", async (req: Request, res: Response) => {
  try {
    ...
    const result = await improvementFeaturesService.createScheduledReport(userId, data);
...
router.post("/alerts/compound", async (req: Request, res: Response) => {
  try {
    ...
    const result = await improvementFeaturesService.createCompoundAlert(userId, data);
...
router.get("/trending", async (req: Request, res: Response) => {
  try {
    ...
    const investments = await improvementFeaturesService.getTrendingInvestments(category);
...
router.get("/theme", async (req: Request, res: Response) => {
  try {
    ...
    const preferences = await improvementFeaturesService.getThemePreferences(userId);
...
router.put("/theme", async (req: Request, res: Response) => {
  try {
    ...
    const success = await improvementFeaturesService.updateThemePreferences(userId, prefs);
