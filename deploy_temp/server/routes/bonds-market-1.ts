...
export function registerBondsMarkPart1Routes(app: Express): void {
  app.get("/api/bonds/yield-curve/public", async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  app.get("/api/bonds/categories", async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  app.get("/api/bonds/live-rates", async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  app.get("/api/ipo-news", async (req: Request, res: Response): Promise<void> => {
    try {
      // Mock IPO news data
      const ipoNews = [
        {
  ...
  // Get product by slug
  app.get("/api/products/slug/:slug", async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  app.get("/api/products/top-performers", async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  app.get("/api/products/category/:category", async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  app.get("/api/products/theme/:theme", async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  app.get("/api/products/featured/all", async (req: Request, res: Response): Promise<void> => {
    try {
      const { limit } = req.query;
  ...
  // Get new products
  app.get("/api/products/new/all", async (req: Request, res: Response): Promise<void> => {
    try {
      const { limit } = req.query;
