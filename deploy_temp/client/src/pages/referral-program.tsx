...
import { 
  Gift, Users, Copy, Share2, Mail, Phone, CheckCircle, 
  Clock, IndianRupee, Trophy, Sparkles, ArrowRight, QrCode
} from "lucide-react";
...
export default function ReferralProgram() {
  ...
  const { data: codeData } = useQuery<{ success: boolean; referralCode: string }>({
  ...
  const inviteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setInviteEmail("");
      setInvitePhone("");
      queryClient.invalidateQueries({ queryKey: ["/api/features/referral/stats"] });
    },
    onError: () => {
      toast({
  ...
  const shareVia = (platform: string) => {
    ...
    switch (platform) {
      case "whatsapp":
        ...
        break;
      case "email":
        window.open(`mailto:?subject=Join FintekPro&body=${encodeURIComponent(message)}`, "_blank");
        break;
      case "twitter":
  ...
  const handleInvite = () => {
    ...
    inviteMutation.mutate({ email: inviteEmail, phone: invitePhone || undefined });
  };
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">Friends Invested</p>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="flex-1 bg-muted rounded-lg p-4 text-center">
                <span className="text-2xl font-mono font-bold tracking-wider" data-testid="referral-code">
                  {referralCode}
                </span>
              </div>
              <Button 
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { step: 1, title: "Share Code", desc: "Share your unique referral code with friends", icon: Share2 },
              { step: 2, title: "Friend Registers", desc: "They sign up using your referral code", icon: Users },
              { step: 3, title: "Complete KYC", desc: "Your friend completes their KYC verification", icon: CheckCircle },
              { step: 4, title: "Earn Rewards", desc: "Both of you earn rewards when they invest", icon: Gift }
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{stats?.totalInvites || 0} friends invited</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{stats?.registered || 0} friends signed up</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{stats?.kycComplete || 0} verified accounts</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{stats?.invested || 0} started investing</p>
                </div>
              </div>
