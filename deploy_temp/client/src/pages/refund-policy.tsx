...
import { 
  RefreshCcw, CreditCard, XCircle, CheckCircle, Clock, 
  AlertTriangle, HelpCircle, Phone, Ban
} from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800 mb-8">
            ...
            <p className="text-amber-700 dark:text-amber-300 text-sm">
              FintekPro is a financial services platform. Unlike physical goods, financial transactions and advisory services 
              have specific refund considerations based on regulatory requirements and the nature of services provided.
            </p>
          </div>
              ...
              <CardContent className="space-y-4">
                <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border border-red-200 dark:border-red-800 mb-4">
                  <p className="text-red-700 dark:text-red-300 text-sm">
                    The following charges are non-refundable as they represent services already rendered or regulatory costs incurred.
                  </p>
                </div>
                <div>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-1">
                    ...
                    <li>ELSS SIPs: Units subject to 3-year lock-in from each investment date</li>
                  </ul>
                </div>
                <div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-1">
                    ...
                    <li>Unlisted orders: Cancellation subject to deal status (contact support)</li>
                  </ul>
                </div>
                <div>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-1">
                    ...
                    <li>Check scheme documents for exact exit load structure</li>
                  </ul>
                </div>
                <div>
