    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold text-blue-600">{data?.stats?.activeFlags || 0}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-purple-600">{data?.stats?.runningTests || 0}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-emerald-600">{data?.stats?.totalUsers || 0}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Tabs defaultValue="flags" className="w-full">
        <TabsList>
          ...
          <TabsTrigger value="tests" data-testid="tab-tests">A/B Tests</TabsTrigger>
        </TabsList>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Toggle features on/off and control rollout percentage</CardDescription>
                </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Active experiments and their results</CardDescription>
              </div>
                  ...
                  (data?.abTests || []).map((test) => (
                    ...
                    >
                        ...
                        {test.variants.map((variant) => (
                          ...
                          >
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <span className="text-sm text-muted-foreground">{variant.percentage}%</span>
                            </div>
                      ...
                      <div className="mt-4 text-sm text-muted-foreground">
                        ...
                        <span>Sample: {test.sampleSize.toLocaleString()} users</span>
                      </div>
                    </div>
                  ))
                )}
