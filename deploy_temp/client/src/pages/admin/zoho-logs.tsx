  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={handleExport} disabled={!data?.logs?.length} data-testid="button-export-logs">
                    ...
                    <TableRow key={log.id} data-testid={`log-row-${log.id}`}>
                      ...
                      <TableCell className="text-right">
                        <div className="text-sm">
                          ...
                          {log.recordsFailed > 0 && (
                            <div className="text-xs text-destructive">{log.recordsFailed} failed</div>
                          )}
                        </div>
                      </TableCell>
      ...
      {data && data.pagination && (
        <div className="flex items-center justify-between">
          <div className="text-sm text-muted-foreground">
            Showing {page * limit + 1} to {Math.min((page + 1) * limit, data.pagination.total)} of {data.pagination.total} logs
          </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="mt-1">{selectedLog.recordsProcessed || 0}</div>
                </div>
                <div>
