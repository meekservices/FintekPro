    ...
    <div className="container mx-auto py-6 px-4 max-w-7xl">
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-3xl font-bold" data-testid="derivatives-title">Derivatives Trading</h1>
            <p className="text-muted-foreground">Trade Futures & Options on NSE</p>
          </div>
        </div>
      </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input type="number" defaultValue="1" data-testid="input-quantity" />
                  </div>
                </div>
                ...
                <div className="pt-4 space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-green-600">₹7,50,000</span>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {popularContracts.map((contract) => (
                  <div key={contract.symbol} className="p-3 border rounded-lg cursor-pointer hover:bg-accent transition-colors">
                    <div className="flex justify-between items-start mb-2">
                      <h4 className="font-semibold">{contract.symbol}</h4>
                      <Badge variant={contract.change >= 0 ? "default" : "destructive"}>
                        {contract.change >= 0 ? "+" : ""}{contract.change}%
                      </Badge>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-muted-foreground">LTP: ₹{contract.ltp.toLocaleString()}</span>
                      <span className="text-muted-foreground">Vol: {contract.volume}</span>
                    </div>
                  </div>
                ))}
              </CardContent>
            ...
            <Card className="lg:col-span-2">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label>Quantity (Lot)</Label>
                    <Input type="number" defaultValue="1" data-testid="input-options-quantity" />
                  </div>
                </div>

                <div className="space-y-2">
                  <Label>Premium Price</Label>
                  <Input type="number" placeholder="0.00" data-testid="input-premium" />
                </div>

                <Button className="w-full" size="lg" data-testid="button-place-options-order">
                  Place Options Order
                </Button>
              </CardContent>
            </Card>
        ...
        <TabsContent value="positions" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monitor your active derivative positions</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                {positions.map((position) => (
                  <div key={position.id} className="border rounded-lg p-4" data-testid={`position-${position.id}`}>
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h4 className="font-semibold text-lg">
                          {position.symbol}
                          {position.type !== "future" && ` ${position.strike} ${position.type.toUpperCase()}`}
                        </h4>
                        <p className="text-sm text-muted-foreground">
                          <Clock className="h-3 w-3 inline mr-1" />
                          Expiry: {new Date(position.expiry).toLocaleDateString()}
                        </p>
                      </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium">₹{position.buyPrice.toLocaleString()}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        <p className="text-xs text-muted-foreground">P&L %</p>
                        <p className={`font-medium ${position.pnlPercentage >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <TabsContent value="chain" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Call and Put option chain for NIFTY</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    <tr className="border-b hover:bg-accent">
                      ...
                      <td className="text-center p-2 font-bold bg-muted">21500</td>
              ...
              <div className="mt-4 p-4 bg-muted rounded-lg">
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <p className="text-muted-foreground">Put-Call Ratio (PCR)</p>
