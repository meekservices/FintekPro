...
export default function ClientAutoPopulatePage() {
  ...
  const [autoPopulatedData, setAutoPopulatedData] = useState<AutoPopulatedData | null>(null);
              ...
              <CardContent>
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setFormData(prev => ({ ...prev, investmentPreference: value }))}
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="ultra_aggressive">Ultra Aggressive - Very High Risk</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-green-600 dark:text-green-400">Personal Details</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-700 dark:text-blue-300">
                      {autoPopulatedData.bankingData?.accounts?.length || 0}
                    </div>
                    <div className="text-sm text-blue-600 dark:text-blue-400">Bank Accounts</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-purple-700 dark:text-purple-300">
                      {autoPopulatedData.productRecommendations?.length || 0}
                    </div>
                    <div className="text-sm text-purple-600 dark:text-purple-400">Product Matches</div>
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  <CardContent>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">₹{autoPopulatedData.bankingData.totalBalance?.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Monthly Average:</span>
                        <span>₹{autoPopulatedData.bankingData.monthlyAverage?.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Risk Profile:</span>
                        <span className="capitalize">{autoPopulatedData.bankingData.inferredRiskProfile}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      {autoPopulatedData.productRecommendations.slice(0, 5).map((product: any, index: number) => (
