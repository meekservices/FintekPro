    ...
    onSuccess: (data) => {
      if (data.success) {
        ...
        toast({
          ...
          description: "Your document has been digitally signed using Aadhaar eSign.",
        });
          ...
          {step === "initiate" && (
            <div className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  Your document will be signed electronically using Aadhaar OTP verification.
                  This is legally valid under IT Act 2000.
                </AlertDescription>
              </Alert>
          ...
          {step === "verifying" && (
            <div className="text-center py-8 space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Please wait while we verify your OTP and generate the digital signature.
              </p>
            </div>
          )}
          ...
          {step === "failed" && (
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={handleRetry} className="flex-1" data-testid="btn-retry-esign">
                  <RefreshCw className="mr-2 h-4 w-4" />
                  Try Again
                </Button>
              </div>
