...
const dialLabels = {
  ...
  moderate: { range: [40, 70], label: "Moderately Diversified", color: "text-amber-600" },
  well: { range: [70, 100], label: "Well Diversified", color: "text-green-600" },
};
        ...
        {isClientMode ? (
          <div className="flex flex-col items-center py-4">
            ...
            <div className="flex justify-between w-full px-4 mb-4">
              ...
              <span className="text-xs text-amber-500 font-medium">Moderate</span>
          ...
          <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <Badge
                    ...
                    className={cn(
                      "mt-1",
                      grade === "EXCELLENT" ? "bg-green-50 dark:bg-green-950/30 text-green-700 dark:text-green-300 border-green-200 dark:border-green-800" :
                      grade === "GOOD" ? "bg-blue-50 dark:bg-blue-950/30 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800" :
                      grade === "FAIR" ? "bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-300 border-amber-200 dark:border-amber-800" :
            ...
            <div className="p-3 bg-muted/50 rounded-lg">
              <p className="text-xs text-muted-foreground">
                Score based on stock overlap penalties ({">"}10% = -15pts), sector concentration ({">"}30% = -10pts),
                and fund crowding ({">"}3 funds = -5pts each).
              </p>
            </div>
          </div>
        )}
