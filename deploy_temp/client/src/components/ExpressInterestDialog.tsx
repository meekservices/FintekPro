        ...
        {submitted ? (
          <div className="py-8 text-center" data-testid="success-message">
            ...
            <DialogDescription className="mt-2 text-base">
              We have received your interest in <strong>{productName}</strong>. Our investment advisor will contact you within 24 hours.
            </DialogDescription>
            <Button onClick={handleClose} className="mt-6" data-testid="btn-close-success">
              Close
            </Button>
          </div>
        ) : (
              ...
              <DialogDescription>
                ...
                {minInvestment && (
                  <span className="block mt-1 text-sm">
                    <IndianRupee className="inline h-3 w-3" /> Minimum Investment: {formatCurrency(minInvestment)}
                  </span>
                )}
              </DialogDescription>
            </DialogHeader>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g., 1 Crore" {...field} data-testid="input-amount" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <DialogFooter className="pt-4">
                  <Button type="button" variant="outline" onClick={handleClose} data-testid="btn-cancel">
                    Cancel
                  </Button>
