    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            <div className={cn("p-0.5 rounded-full", isFresh ? "" : config.bgColor)}>
...
export function DataFreshnessBar({
  ...
  const minutesSinceUpdate = Math.min((Date.now() - updateDate.getTime()) / (1000 * 60), 60);
      ...
      <div className="h-1 bg-muted rounded-full overflow-hidden">
        <div 
          className={cn(
            ...
            freshnessPercent > 66 ? "bg-green-500" : 
            freshnessPercent > 33 ? "bg-yellow-500" : "bg-orange-500"
          )}
