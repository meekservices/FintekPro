...
import { goalInvestmentLinks, insertSuitabilityCheckSchema, sebiGoalRiskProfiles, goalMilestones, suitabilityChecks, financialGoals, goalProgressSnapshots, insertGoalProgressSnapshotSchema } from './schema/advisory';
import { marketData } from './schema/market-data';
import { insertReitSchema } from './schema/screener';
...
// prospectProposals moved to shared/schema/proposals.ts
...
// prospectClients moved to shared/schema/proposals.ts
