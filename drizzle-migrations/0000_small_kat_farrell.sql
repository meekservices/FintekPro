...
CREATE TYPE "public"."pick_category" AS ENUM('listed_stocks', 'mutual_funds', 'bonds', 'unlisted', 'global_stocks', 'etfs', 'reits_invits', 'fixed_deposits', 'sgb', 'derivatives');--> statement-breakpoint
...
CREATE TABLE "user_profiles" (
	...
	"video_kyc_status" varchar,
	"video_kyc_expiry_date" timestamp,
	"kyc_tier" varchar DEFAULT 'standard',
	"accredited_investor_status" varchar DEFAULT 'none',
	...
	"minor_identity" jsonb,
	"net_worth" numeric(15, 2),
	"liquid_net_worth" numeric(15, 2),
	"liquidity_needs" varchar,
	"investment_risk_tolerance" varchar,
	"investment_objective" varchar,
	"investment_time_horizon" varchar,
...
CREATE TABLE "users" (
	...
	"plan_tier" varchar DEFAULT 'free' NOT NULL,
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	"iris_investor_id" varchar,
	"alpaca_account_id" varchar,
	"alpaca_account_type" varchar DEFAULT 'individual',
	"referral_code" varchar,
	"is_pin_set" boolean DEFAULT false,
	"login_pin" text,
	"shareable_profile_enabled" boolean DEFAULT false,
...
--> statement-breakpoint
CREATE TABLE "agent_basket_items" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"basket_id" uuid NOT NULL,
	"instrument_type" varchar(50) DEFAULT 'stock' NOT NULL,
	"symbol" varchar(50),
	"isin" varchar(20),
	"name" text NOT NULL,
	"allocation_percent" numeric(5, 2) DEFAULT '0' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "b2b_api_usage_logs" (
	"id" varchar(255) PRIMARY KEY NOT NULL,
	"client_id" varchar(255) NOT NULL,
...
CREATE TABLE "b2b_clients" (
	...
	"governance_mode" varchar(50) DEFAULT 'STRICT',
	"created_at" timestamp DEFAULT now()
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "client_unlisted_disclosure_log" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"client_id" varchar NOT NULL,
	"company_id" varchar,
	"proposal_id" varchar,
...
CREATE TABLE "referral_payout_config" (
	...
	"payout_type" varchar DEFAULT 'percentage',
	"is_active" boolean DEFAULT true,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now()
);
...
--> statement-breakpoint
CREATE TABLE "agent_baskets" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"agent_id" varchar(100) NOT NULL,
	"name" text NOT NULL,
	"theme" varchar(100) DEFAULT 'Custom' NOT NULL,
	"description" text,
...
CREATE TABLE "agent_notifications" (
	...
	"body" text NOT NULL,
	"message" text,
	"type" varchar(30) DEFAULT 'prospect' NOT NULL,
	"link" text,
	"read_at" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL
);
...
--> statement-breakpoint
CREATE TABLE "firm_dp_holdings" (
	"id" serial PRIMARY KEY NOT NULL,
	"partner_id" varchar(100) DEFAULT 'platform-partner-001' NOT NULL,
	"company_id" varchar(100),
	"isin" varchar(20),
	"security_name" varchar(500) NOT NULL,
	"security_type" varchar(50) DEFAULT 'unlisted_equity' NOT NULL,
	"quantity" numeric(18, 4) DEFAULT '0' NOT NULL,
	"avg_cost_price" numeric(18, 4),
	"current_price" numeric(18, 4),
	"total_cost_value" numeric(18, 4),
	"current_market_value" numeric(18, 4),
	"zoho_item_id" varchar(100),
	"zoho_item_sku" varchar(100),
	"last_zoho_sync_at" timestamp,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now()
);
--> statement-breakpoint
...
CREATE TABLE "kyc_verification_sessions" (
	...
	"initiated_by" varchar DEFAULT 'customer',
	"entity_type_detected" varchar,
	"entity_locked" boolean DEFAULT false,
	"aml_risk_level" varchar,
	"aml_screening_id" varchar,
	"ckyc_confidence_score" numeric(4, 2),
	"ckyc_missing_fields" text[] DEFAULT '{}'::text[],
...
CREATE TABLE "lrs_compliance_tracking" (
	...
	"form15ca_filed" boolean DEFAULT false,
	"form15cb_obtained" boolean DEFAULT false,
...
--> statement-breakpoint
CREATE TABLE "mf_categorization_audit_log" (
	"id" serial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "mf_compliance_state_log" (
	"id" serial PRIMARY KEY NOT NULL,
	"scheme_code" varchar NOT NULL,
...
CREATE TABLE "golden_prices" (
	...
	"symbol" varchar(50),
	"price_date" date NOT NULL,
	"asset_class" varchar(30) DEFAULT 'equity' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "mf_category_master" (
	"id" serial PRIMARY KEY NOT NULL,
	"taxonomy_version" varchar(20) NOT NULL,
...
CREATE TABLE "mf_orders" (
	...
	"gain_type" varchar,
	"holding_period_days" integer,
	"grandfathered_value" numeric(15, 2),
	"indexed_cost" numeric(15, 2),
...
--> statement-breakpoint
CREATE TABLE "mf_overlap_matrix" (
	"id" serial PRIMARY KEY NOT NULL,
	"scheme_code_a" varchar NOT NULL,
	"scheme_code_b" varchar NOT NULL,
	"overlap_percent" numeric(7, 4) NOT NULL,
...
CREATE TABLE "mf_portfolio_holdings" (
	...
	"as_of_date" date NOT NULL,
	"source" varchar DEFAULT 'mf_scheme_stock_holdings',
	"created_at" timestamp DEFAULT now()
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "mf_subcategory_master" (
	"id" serial PRIMARY KEY NOT NULL,
	"taxonomy_version" varchar(20) NOT NULL,
	"group_code" varchar(20) NOT NULL,
	...
	"overlap_threshold_pct" numeric(5, 2) DEFAULT '60',
	"notes" text,
	"is_active" boolean DEFAULT true,
	CONSTRAINT "mf_subcategory_master_subcategory_code_unique" UNIQUE("subcategory_code")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "mf_taxonomy_versions" (
	"id" serial PRIMARY KEY NOT NULL,
	"version" varchar(20) NOT NULL,
	"sebi_circular_ref" varchar(100) NOT NULL,
	"effective_date" date NOT NULL,
	"description" text,
	"is_active" boolean DEFAULT true,
	"created_at" timestamp DEFAULT now(),
	CONSTRAINT "mf_taxonomy_versions_version_unique" UNIQUE("version")
);
--> statement-breakpoint
...
CREATE TABLE "mutual_funds" (
	...
	"last_verified_at" timestamp,
	"data_source" varchar,
	"isin_dividend_payout" varchar,
	"isin_dividend_reinvest" varchar,
	"isin_growth" varchar,
	...
	"amc_code" varchar,
	"exit_load_percent" numeric(8, 4),
	"exit_load_days" integer,
	"scheme_sub_category" varchar,
	"benchmark_index" varchar,
	"benchmark_index_code" varchar,
	"benchmark_confidence_score" numeric(3, 2),
	"taxonomy_version" varchar(20) DEFAULT 'SEBI_2017',
	"compliance_status" varchar(30) DEFAULT 'PENDING',
	"naming_validation_status" varchar(10) DEFAULT 'PENDING',
	"lifecycle_metadata" jsonb,
	"compliance_blocked_reason" text,
	"kfintech_id" varchar(100),
	"folio_nature" varchar(50),
	"last_updated" timestamp DEFAULT now(),
...
CREATE TABLE "us_broker_accounts" (
	...
	"client_id" varchar NOT NULL,
	"alpaca_account_id" varchar,
	"alpaca_account_number" varchar,
	"alpaca_status" varchar DEFAULT 'not_applied',
	"action_required" text,
	"status" varchar DEFAULT 'pending' NOT NULL,
	"application_step" varchar DEFAULT 'identity',
	"application_data" text,
	"agreements_signed_at" timestamp,
	"cip_submitted_at" timestamp,
...
CREATE TABLE "ca_verification_status" (
	...
	"issue_date" date,
	"expiry_date" date,
	"verified_networth" numeric(20, 2),
	"verified_income" numeric(20, 2),
	"financial_year" varchar,
	"udin" varchar,
	"udin_verified" boolean DEFAULT false,
	"udin_verified_at" timestamp,
	"notes" text,
	"rejection_reason" text,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
...
CREATE TABLE "partners" (
	...
	"ca_bio" text,
	"parent_partner_id" varchar,
	"partner_level" varchar DEFAULT 'L1',
	"hierarchy_partner_type" varchar DEFAULT 'MASTER',
	"hierarchy_status" varchar DEFAULT 'ACTIVE',
	"kyc_status" varchar DEFAULT 'PENDING',
	"approval_status" varchar DEFAULT 'PENDING',
...
CREATE TABLE "comprehensive_holdings" (
	...
	"kyc_status" varchar,
	"exit_load_rules" text,
	"nav_date" date,
	"opening_unit_balance" numeric(15, 6),
	"registrar_type" varchar,
	"advisor_arn_code" varchar,
	"metadata" jsonb,
	"last_updated" timestamp DEFAULT now(),
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now()
...
CREATE TABLE "product_account_preferences" (
	...
	"preferred_bank_account_id" varchar,
	"preferred_demat_account_id" varchar,
	"distribution_mode" varchar DEFAULT 'physical',
...
CREATE TABLE "product_applications" (
	...
	"ai_recommendation" text,
	"kyc_verified" boolean DEFAULT false,
	"esign_status" varchar DEFAULT 'not_started',
	"esign_request_ids" text[],
	"payment_status" varchar DEFAULT 'pending',
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "product_applications_application_number_unique" UNIQUE("application_number")
);
--> statement-breakpoint
...
CREATE TABLE "esign_requests" (
	...
	"created_at" timestamp DEFAULT now(),
	CONSTRAINT "esign_requests_certificate_serial_unique" UNIQUE("certificate_serial")
);
--> statement-breakpoint
...
CREATE TABLE "prospect_clients" (
	...
	"readiness_status" varchar DEFAULT 'INITIAL' NOT NULL,
	"readiness_status_updated_at" timestamp,
...
CREATE TABLE "prospect_proposals" (
	...
	"parent_proposal_id" varchar,
	"is_latest_version" boolean DEFAULT true,
	"locked_at" timestamp,
	"is_public" boolean DEFAULT false,
	"expires_at" timestamp,
	"watermark_advisor_name" varchar,
...
CREATE TABLE "unlisted_companies" (
	...
	"risk_category" varchar DEFAULT 'very_high',
	"rebalance_eligible" boolean DEFAULT false,
	"liquidity_weight" numeric(5, 2) DEFAULT '0',
	"valuation_status" varchar DEFAULT 'pending',
	"last_valuation_date" date,
	"enrichment_failed_at" timestamp,
	"website" varchar,
	"description" text,
	"logo" varchar,
...
CREATE TABLE "unlisted_deals" (
	...
	"fmv_at_transaction" numeric(20, 2),
	"valuation_deviation" numeric(10, 2),
	"compliance_checked" boolean DEFAULT false,
	"compliance_notes" text,
	"market_type" varchar,
	"inventory_sale" boolean DEFAULT false,
...
--> statement-breakpoint
CREATE TABLE "unlisted_equity_valuation_history" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"company_id" varchar NOT NULL,
...
CREATE TABLE "global_advisory_acknowledgments" (
	...
	"user_id" varchar NOT NULL,
	"session_id" varchar,
	"acknowledgment_type" varchar NOT NULL,
...
CREATE TABLE "goal_benchmark_mapping" (
	...
	"horizon_years_min" integer DEFAULT 0,
	"horizon_years_max" integer DEFAULT 99,
...
ALTER TABLE "agent_basket_items" ADD CONSTRAINT "agent_basket_items_basket_id_agent_baskets_id_fk" FOREIGN KEY ("basket_id") REFERENCES "public"."agent_baskets"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "b2b_api_keys" ADD CONSTRAINT "b2b_api_keys_client_id_b2b_clients_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."b2b_clients"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "client_unlisted_disclosure_log" ADD CONSTRAINT "client_unlisted_disclosure_log_client_id_users_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "client_unlisted_disclosure_log" ADD CONSTRAINT "client_unlisted_disclosure_log_company_id_unlisted_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."unlisted_companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "agent_baskets" ADD CONSTRAINT "agent_baskets_agent_id_users_id_fk" FOREIGN KEY ("agent_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "firm_transactions" ADD CONSTRAINT "firm_transactions_holding_id_firm_dp_holdings_id_fk" FOREIGN KEY ("holding_id") REFERENCES "public"."firm_dp_holdings"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_webauthn_credentials" ADD CONSTRAINT "user_webauthn_credentials_user_id_user_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user_profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "unlisted_equity_valuation_history" ADD CONSTRAINT "unlisted_equity_valuation_history_company_id_unlisted_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."unlisted_companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "unlisted_equity_valuation_history" ADD CONSTRAINT "unlisted_equity_valuation_history_added_by_users_id_fk" FOREIGN KEY ("added_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_agent_basket_items_basket" ON "agent_basket_items" USING btree ("basket_id");--> statement-breakpoint
...
CREATE INDEX "idx_b2b_key_hash" ON "b2b_api_keys" USING btree ("key_hash");--> statement-breakpoint
CREATE INDEX "idx_b2b_key_client" ON "b2b_api_keys" USING btree ("client_id");--> statement-breakpoint
CREATE INDEX "idx_b2b_usage_client" ON "b2b_api_usage_logs" USING btree ("client_id");--> statement-breakpoint
...
CREATE INDEX "idx_disclosure_log_client" ON "client_unlisted_disclosure_log" USING btree ("client_id");--> statement-breakpoint
CREATE INDEX "idx_disclosure_log_company" ON "client_unlisted_disclosure_log" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_disclosure_log_proposal" ON "client_unlisted_disclosure_log" USING btree ("proposal_id");--> statement-breakpoint
CREATE INDEX "idx_disclosure_log_acknowledged" ON "client_unlisted_disclosure_log" USING btree ("acknowledged_at");--> statement-breakpoint
...
CREATE INDEX "idx_agent_baskets_agent" ON "agent_baskets" USING btree ("agent_id");--> statement-breakpoint
CREATE INDEX "idx_agent_baskets_created" ON "agent_baskets" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "idx_agent_notifications_agent" ON "agent_notifications" USING btree ("agent_id");--> statement-breakpoint
CREATE INDEX "idx_agent_notifications_created" ON "agent_notifications" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "idx_firm_dp_holdings_partner" ON "firm_dp_holdings" USING btree ("partner_id");--> statement-breakpoint
CREATE INDEX "idx_firm_dp_holdings_isin" ON "firm_dp_holdings" USING btree ("isin");--> statement-breakpoint
CREATE INDEX "idx_firm_txn_partner" ON "firm_transactions" USING btree ("partner_id");--> statement-breakpoint
CREATE INDEX "idx_firm_txn_date" ON "firm_transactions" USING btree ("transaction_date");--> statement-breakpoint
CREATE INDEX "idx_firm_txn_zoho_status" ON "firm_transactions" USING btree ("zoho_status");--> statement-breakpoint
CREATE INDEX "idx_firm_txn_holding" ON "firm_transactions" USING btree ("holding_id");--> statement-breakpoint
...
CREATE INDEX "idx_mf_categorization_audit_scheme" ON "mf_categorization_audit_log" USING btree ("scheme_code");--> statement-breakpoint
CREATE INDEX "idx_mf_categorization_audit_at" ON "mf_categorization_audit_log" USING btree ("changed_at");--> statement-breakpoint
CREATE INDEX "idx_mf_categorization_audit_version" ON "mf_categorization_audit_log" USING btree ("taxonomy_version");--> statement-breakpoint
CREATE INDEX "idx_mf_compliance_state_log_scheme" ON "mf_compliance_state_log" USING btree ("scheme_code");--> statement-breakpoint
CREATE INDEX "idx_mf_compliance_state_log_at" ON "mf_compliance_state_log" USING btree ("triggered_at");--> statement-breakpoint
...
CREATE INDEX "idx_webauthn_creds_user" ON "user_webauthn_credentials" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_webauthn_creds_credential_id" ON "user_webauthn_credentials" USING btree ("credential_id");--> statement-breakpoint
...
CREATE INDEX "idx_webauthn_audit_user" ON "webauthn_audit_log" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_webauthn_audit_event" ON "webauthn_audit_log" USING btree ("event");--> statement-breakpoint
CREATE INDEX "idx_webauthn_audit_created" ON "webauthn_audit_log" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "idx_credit_ratings_isin" ON "credit_ratings" USING btree ("isin");--> statement-breakpoint
CREATE INDEX "idx_credit_ratings_agency" ON "credit_ratings" USING btree ("agency");--> statement-breakpoint
CREATE INDEX "idx_credit_ratings_date" ON "credit_ratings" USING btree ("rating_date");--> statement-breakpoint
CREATE INDEX "idx_credit_ratings_current" ON "credit_ratings" USING btree ("is_current");--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_golden_prices_isin_date" ON "golden_prices" USING btree ("isin","price_date");--> statement-breakpoint
CREATE INDEX "idx_golden_prices_date" ON "golden_prices" USING btree ("price_date");--> statement-breakpoint
CREATE INDEX "idx_golden_prices_symbol" ON "golden_prices" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "idx_golden_prices_asset_class" ON "golden_prices" USING btree ("asset_class");--> statement-breakpoint
CREATE INDEX "idx_golden_prices_flagged" ON "golden_prices" USING btree ("is_flagged");--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_mf_category_master_version_code" ON "mf_category_master" USING btree ("taxonomy_version","group_code");--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_mf_overlap_matrix_pair" ON "mf_overlap_matrix" USING btree ("scheme_code_a","scheme_code_b");--> statement-breakpoint
CREATE INDEX "idx_mf_overlap_matrix_a" ON "mf_overlap_matrix" USING btree ("scheme_code_a");--> statement-breakpoint
CREATE INDEX "idx_mf_overlap_matrix_b" ON "mf_overlap_matrix" USING btree ("scheme_code_b");--> statement-breakpoint
CREATE INDEX "idx_mf_overlap_matrix_breach" ON "mf_overlap_matrix" USING btree ("breach_flag");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_mf_portfolio_holdings_unique" ON "mf_portfolio_holdings" USING btree ("scheme_code","isin","as_of_date");--> statement-breakpoint
CREATE INDEX "idx_mf_portfolio_holdings_scheme" ON "mf_portfolio_holdings" USING btree ("scheme_code");--> statement-breakpoint
CREATE INDEX "idx_mf_portfolio_holdings_isin" ON "mf_portfolio_holdings" USING btree ("isin");--> statement-breakpoint
...
CREATE INDEX "idx_mf_subcategory_master_version" ON "mf_subcategory_master" USING btree ("taxonomy_version");--> statement-breakpoint
CREATE INDEX "idx_mf_subcategory_master_group" ON "mf_subcategory_master" USING btree ("group_code");--> statement-breakpoint
CREATE INDEX "idx_mf_taxonomy_versions_active" ON "mf_taxonomy_versions" USING btree ("is_active");--> statement-breakpoint
...
CREATE INDEX "idx_symbol_mapping_isin" ON "symbol_mapping" USING btree ("isin");--> statement-breakpoint
CREATE INDEX "idx_symbol_mapping_provider" ON "symbol_mapping" USING btree ("provider");--> statement-breakpoint
CREATE INDEX "idx_symbol_mapping_symbol" ON "symbol_mapping" USING btree ("provider_symbol");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_symbol_mapping_isin_provider" ON "symbol_mapping" USING btree ("isin","provider");--> statement-breakpoint
...
CREATE INDEX "idx_unlisted_val_history_company" ON "unlisted_equity_valuation_history" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_unlisted_val_history_date" ON "unlisted_equity_valuation_history" USING btree ("valuation_date");--> statement-breakpoint
CREATE INDEX "idx_unlisted_val_history_method" ON "unlisted_equity_valuation_history" USING btree ("valuation_method");--> statement-breakpoint
...
CREATE INDEX "idx_suitability_checks_client" ON "suitability_checks" USING btree ("client_id");